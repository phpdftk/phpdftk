...
Generated: 2026-06-10 02:09:54 UTC
PHP: 8.4.21
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 90.93s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 33.16s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.28s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 18.27s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 18.46s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 11.29s |
| &#x2705; JHOVE + PDF 2.0 + Security + Preflight | PASS | 25 | 24 | 0 | 1 | 8.48s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 33.16s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 282ms |
| testGeneratesAnnotationsPdf | AnnotationsTest | PASS | 186ms |
| testGeneratesBookmarksPdf | BookmarksTest | PASS | 247ms |
...
| testGeneratesPdfWithEmbeddedTrueTypeFont | DocumentFeaturesTest | PASS | 247ms |
...
| testGeneratesPdfWithEmbeddedType1 | EmbeddedType1FontTest | PASS | 193ms |
| testPdfOutputContainsFontData | EmbeddedType1FontTest | PASS | <1ms |
| testGeneratesExtGStatePdf | ExtGStateIntegrationTest | PASS | 191ms |
| testGeneratesFormWithAppearances | FormAppearancesIntegrationTest | PASS | 185ms |
| testGeneratesFormPdf | FormFieldsTest | PASS | 188ms |
| testGeneratesGraphicsPipelinePdf | GraphicsPipelineIntegrationTest | PASS | 191ms |
| testGeneratesGraphicsPdf | GraphicsTest | PASS | 185ms |
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 625ms |
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 243ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 225ms |
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 614ms |
...
| testGeneratesPageLabelsPdf | PageLabelsTest | PASS | 196ms |
| testGeneratesSignatureFieldPdf | SignatureFieldIntegrationTest | PASS | 191ms |
...
| testGeneratesPdfWithXrefAndObjectStreams | XRefStreamIntegrationTest | PASS | 191ms |
| testEnableOutlineThenHeadingRegistersOutlinesEntry | AutoOutlineTest | PASS | 198ms |
...
| testStyleOverridesBarAndBackgroundColors | CalloutTest | PASS | 7ms |
...
| testAddTextWithLinkStyleProducesLinkAnnotation | InlineLinkTest | PASS | 203ms |
...
| testShowPageNumbersDefaultFormat | PageNumbersTest | PASS | 185ms |
...
| testAddPageDelegatesToWriter | PdfDocTest | PASS | 195ms |
...
| testGeneratesHighLevelDocument | PdfIntegrationTest | PASS | 399ms |
...
| testAddHeadingEmitsLargerText | PdfTest | PASS | 185ms |
| testExplicitNewPageCreatesSecondPage | PdfTest | PASS | 191ms |
| testLongTextAutoPaginates | PdfTest | PASS | 197ms |
| testAddSpacerConsumesVerticalSpace | PdfTest | PASS | 196ms |
...
| testBoldAndItalicResolveToCorrectPostScriptName | PdfTest | PASS | 188ms |
| testUnknownFamilyIsRejected | PdfTest | PASS | <1ms |
| testCustomTheme | PdfTest | PASS | 192ms |
| testSaveWritesFile | PdfTest | PASS | 190ms |
...
| testAddTableRendersAllCellValues | TableTest | PASS | 198ms |
...
| testAddCompositeFontSavesToFile | UnicodeFontTest | PASS | 199ms |
...
| testCompositeFontPerPage | UnicodeFontTest | PASS | 199ms |
| testPdfWriterGeneratesValidPdfHeader | WriterTest | PASS | 187ms |
...
| testPdfWriterContainsPage | WriterTest | PASS | 182ms |
...
| testPdfWriterAddContentStream | WriterTest | PASS | 186ms |
...
| testPdfWriterContainsXref | WriterTest | PASS | 188ms |
| testPdfWriterContainsTrailer | WriterTest | PASS | <1ms |
| testPdfWriterAddPageWithRectangle | WriterTest | PASS | 183ms |
...
| testSetEncryptionAes256RoundTrip | WriterTest | PASS | 205ms |
...
| testSyncInfoToMetadata | XmpMetadataTest | PASS | 200ms |
| testSyncInfoToMetadataNoInfoIsNoOp | XmpMetadataTest | PASS | 181ms |
...
| testSetBookmarksWithChildren | BookmarkEditorTest | PASS | 191ms |
| testAddBookmark | BookmarkEditorTest | PASS | 379ms |
| testHasBookmarksReturnsFalseForCleanPdf | BookmarkEditorTest | PASS | <1ms |
| testRemoveBookmarks | BookmarkEditorTest | PASS | 195ms |
...
| testSetMetadataOnPdfWithoutInfo | MetadataEditorTest | PASS | 185ms |
...
| testSetLabelsWithArabic | PageLabelerTest | PASS | 188ms |
| testSetRomanNumerals | PageLabelerTest | PASS | 193ms |
| testSetRomanNumeralsUppercase | PageLabelerTest | PASS | 190ms |
...
| testMultipleRanges | PageLabelerTest | PASS | 189ms |
| testGetPageCount | PageLabelerTest | PASS | 1ms |
| testGetReader | PageLabelerTest | PASS | <1ms |
| testSaveToFile | PageLabelerTest | PASS | 190ms |
...
| testNoOpsKeepsAllPages | PageSlicerTest | PASS | 198ms |
...
| testRotateCumulative | PageTransformerTest | PASS | 184ms |
| testRotateInvalidAngle | PageTransformerTest | PASS | <1ms |
| testSetCropBox | PageTransformerTest | PASS | 191ms |
| testSetCropBoxSpecificPage | PageTransformerTest | PASS | 188ms |
| testSetMediaBox | PageTransformerTest | PASS | 194ms |
| testSetTrimBox | PageTransformerTest | PASS | 188ms |
| testSetBleedBox | PageTransformerTest | PASS | 191ms |
| testScale | PageTransformerTest | PASS | 187ms |
| testScaleSpecificPages | PageTransformerTest | PASS | 192ms |
...
| testOddPages | PageTransformerTest | PASS | 191ms |
| testRange | PageTransformerTest | PASS | 190ms |
...
| testChangePasswordsDefaultsToAes256 | PdfEncryptTest | PASS | 11ms |
...
| testMergeTwoPdfs | PdfMergerTest | PASS | 184ms |
| testMergeWithPageSelection | PdfMergerTest | PASS | 183ms |
...
| testSaveToFile | PdfMergerTest | PASS | 181ms |
...
| testStampOnSpecificPages | PdfStamperTest | PASS | 188ms |
...
| testStampImageWithScaleWidth | PdfStamperTest | PASS | 189ms |
...
| testStampImageOnSpecificPages | PdfStamperTest | PASS | 187ms |
...
**4 tests** | 3 passed | 0 failed | 1 skipped | 18.27s
...
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 9.23s |
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 18.46s
...
| testPopplerCorpus with data set "poppler-test/unittestcases/vis_policy_test.pdf" | Tier2CorpusTest | PASS | 8ms |
...
| testQpdfCorpus with data set "qpdf/many-nulls.pdf" | Tier2CorpusTest | PASS | 696ms |
...
| testQpdfCorpus with data set "qpdf/page-labels-num-tree.pdf" | Tier2CorpusTest | PASS | 24ms |
...
| testQpdfCorpus with data set "qpdf/test80a1.pdf" | Tier2CorpusTest | PASS | 4ms |
...
| testPdfBoxCorpus with data set "pdfbox/pdfbox/src/test/resources/input/merge/multitiff.pdf" | Tier2PdfBoxCorpusTest | PASS | 3ms |
...
| testPdfBoxCorpus with data set "pdfbox/pdfbox/src/test/resources/org/apache/pdfbox/pdmodel/test_pagelabels.pdf" | Tier2PdfBoxCorpusTest | PASS | 7ms |
...
| testPdfiumCorpus with data set "pdfium/feature_linearized_loading.pdf" | Tier2PdfiumCorpusTest | PASS | 4ms |
...
**6 tests** | 6 passed | 0 failed | 0 skipped | 11.29s

| Test | Class | Status | Time |
|---|---|---|---|
| testTaggedDocumentValidatesWithUa1 | Tier3MatterhornTest | PASS | 2.19s |
| testAnnotationWithContentsPassesClause718 | Tier3MatterhornTest | PASS | 2.06s |
...
**25 tests** | 24 passed | 0 failed | 1 skipped | 8.48s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWellFormedAndValid | Tier4JhoveTest | PASS | 942ms |
| testMultiPagePdfWellFormedAndValid | Tier4JhoveTest | PASS | 899ms |
| testPdfWithMetadataWellFormedAndValid | Tier4JhoveTest | PASS | 863ms |
| testPdfWithEmbeddedFontWellFormedAndValid | Tier4JhoveTest | PASS | 861ms |
| testJhoveToolchainWorks | Tier4JhoveTest | PASS | 676ms |
| testPdfA1bPassesPdfBoxPreflight | Tier4PdfBoxPreflightTest | SKIP | <1ms |
| testPdfBoxPreflightToolchainWorks | Tier4PdfBoxPreflightTest | PASS | 778ms |
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 708ms |
| testPdfWithMetadataHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 540ms |
| testPdfWithEmbeddedFontHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 544ms |
| testPdfIdToolchainWorks | Tier4PdfIdTest | PASS | 349ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 via incremental save.pdf" | Tier4Pdf20ExamplesTest | PASS | 187ms |
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 with offset start.pdf" | Tier4Pdf20ExamplesTest | PASS | 185ms |
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 with page level output intent.pdf" | Tier4Pdf20ExamplesTest | PASS | 182ms |
| testPdf20ExampleQpdfValid with data set "pdf20/Simple PDF 2.0 file.pdf" | Tier4Pdf20ExamplesTest | PASS | 182ms |
| testPdf20ExampleQpdfValid with data set "pdf20/pdf20-utf8-test.pdf" | Tier4Pdf20ExamplesTest | PASS | 198ms |
