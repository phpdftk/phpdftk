...
Generated: 2026-06-10 17:26:37 UTC
PHP: 8.4.21
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 89.06s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 32.17s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.24s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 18.59s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 17.34s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 11.43s |
| &#x2705; JHOVE + PDF 2.0 + Security + Preflight | PASS | 25 | 24 | 0 | 1 | 8.28s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 32.17s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 320ms |
| testGeneratesAnnotationsPdf | AnnotationsTest | PASS | 186ms |
| testGeneratesBookmarksPdf | BookmarksTest | PASS | 239ms |
| testGeneratesFormWithCustomFontAppearances | CustomFontFormAppearancesTest | PASS | 199ms |
| testGeneratesDocumentFeaturesPdf | DocumentFeaturesTest | PASS | 197ms |
| testGeneratesPdfWithEmbeddedTrueTypeFont | DocumentFeaturesTest | PASS | 204ms |
| testGeneratesPdfWithEmbeddedFont | EmbeddedFontsTest | PASS | 193ms |
...
| testGeneratesFormWithAppearances | FormAppearancesIntegrationTest | PASS | 212ms |
| testGeneratesFormPdf | FormFieldsTest | PASS | 192ms |
| testGeneratesGraphicsPipelinePdf | GraphicsPipelineIntegrationTest | PASS | 188ms |
| testGeneratesGraphicsPdf | GraphicsTest | PASS | 185ms |
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 334ms |
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 144ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 160ms |
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 209ms |
...
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 415ms |
...
| testEnableOutlineThenHeadingRegistersOutlinesEntry | AutoOutlineTest | PASS | 188ms |
...
| testAddPageDelegatesToWriter | PdfDocTest | PASS | 193ms |
...
| testGeneratesHighLevelDocument | PdfIntegrationTest | PASS | 401ms |
...
| testAddHeadingEmitsLargerText | PdfTest | PASS | 180ms |
...
| testCustomTheme | PdfTest | PASS | 184ms |
| testSaveWritesFile | PdfTest | PASS | 186ms |
...
| testUnderlineEmitsStrokeBelowBaseline | TextDecorationTest | PASS | 193ms |
...
| testAddCompositeFontGeneratesValidPdf | UnicodeFontTest | PASS | 209ms |
| testAddCompositeFontSavesToFile | UnicodeFontTest | PASS | 204ms |
| testCompositeFontRoundTripsThroughReader | UnicodeFontTest | PASS | 209ms |
...
| testSetEncryptionProducesEncryptedPdf | WriterTest | PASS | 187ms |
| testSetEncryptionAes256RoundTrip | WriterTest | PASS | 202ms |
| testSetMetadataAddsStreamToPdf | XmpMetadataTest | PASS | 179ms |
| testMetadataStreamContainsXmp | XmpMetadataTest | PASS | 186ms |
| testMetadataRoundTrip | XmpMetadataTest | PASS | 189ms |
| testSyncInfoToMetadata | XmpMetadataTest | PASS | 186ms |
...
| testSaveToFile | AnnotationFlattenerTest | PASS | 185ms |
...
| testReplaceExistingBookmarks | BookmarkEditorTest | PASS | 194ms |
...
| testCheckCheckbox | FormFillerTest | PASS | 185ms |
...
| testSetTitleRoundTrip | MetadataEditorTest | PASS | 196ms |
...
| testSetAlphabetic | PageLabelerTest | PASS | 193ms |
| testSetArabicWithStartNumber | PageLabelerTest | PASS | 185ms |
| testSetLabelsWithPrefix | PageLabelerTest | PASS | 192ms |
| testRemoveLabels | PageLabelerTest | PASS | 204ms |
| testMultipleRanges | PageLabelerTest | PASS | 201ms |
...
| testRemovePages | PageSlicerTest | PASS | 193ms |
| testReorder | PageSlicerTest | PASS | 193ms |
| testReverse | PageSlicerTest | PASS | 182ms |
| testSplit | PageSlicerTest | PASS | 367ms |
...
| testRotateSpecificPages | PageTransformerTest | PASS | 183ms |
...
| testSetCropBoxSpecificPage | PageTransformerTest | PASS | 184ms |
...
| testScaleSpecificPages | PageTransformerTest | PASS | 184ms |
...
| testEncryptAes256 | PdfEncryptTest | PASS | 208ms |
...
| testMergeTwoPdfs | PdfMergerTest | PASS | 217ms |
| testMergeWithPageSelection | PdfMergerTest | PASS | 179ms |
...
| testWatermarkWithStyle | PdfStamperTest | PASS | 182ms |
...
| testSaveToFile | PdfStamperTest | PASS | 184ms |
| testStampImageJpeg | PdfStamperTest | PASS | 229ms |
| testStampImagePng | PdfStamperTest | PASS | 184ms |
| testStampImageWithScaleWidth | PdfStamperTest | PASS | 194ms |
| testStampImageWithScaleHeight | PdfStamperTest | PASS | 184ms |
...
| testStampPdfDefaultsToCenter | PdfStamperTest | PASS | 198ms |
...
| testRedactArea | TextRedactorTest | PASS | 187ms |
...
| testSaveToFile | TextRedactorTest | PASS | 197ms |

### Arlington PDF Model — Dictionary-level spec conformance (keys, types, required fields, version constraints)

**6 tests** | 6 passed | 0 failed | 0 skipped | 1.24s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesBookmarksPdf | BookmarksTest | PASS | 301ms |
...
| testGeneratesFormPdf | FormFieldsTest | PASS | 175ms |
...
**4 tests** | 3 passed | 0 failed | 1 skipped | 18.59s
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 17.34s
...
| testQpdfCorpus with data set "qpdf/good17-not-recompressed.pdf" | Tier2CorpusTest | PASS | 12ms |
...
| testQpdfCorpus with data set "qpdf/many-nulls.pdf" | Tier2CorpusTest | PASS | 717ms |
...
| testQpdfCorpus with data set "qpdf/resource-from-dr.pdf" | Tier2CorpusTest | PASS | 2ms |
...
| testQpdfCorpus with data set "qpdf/uo-8.pdf" | Tier2CorpusTest | PASS | 28ms |
...
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 8.75s |
...
| testPdfiumCorpus with data set "pdfium/weblinks_across_lines.pdf" | Tier2PdfiumCorpusTest | PASS | 6ms |
...
**6 tests** | 6 passed | 0 failed | 0 skipped | 11.43s

| Test | Class | Status | Time |
|---|---|---|---|
| testTaggedDocumentValidatesWithUa1 | Tier3MatterhornTest | PASS | 2.13s |
| testAnnotationWithContentsPassesClause718 | Tier3MatterhornTest | PASS | 2.05s |
| testUntaggedDocumentFailsUa1 | Tier3MatterhornTest | PASS | 1.77s |
| testMissingLangFailsUa1 | Tier3MatterhornTest | PASS | 1.8s |
...
**25 tests** | 24 passed | 0 failed | 1 skipped | 8.28s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWellFormedAndValid | Tier4JhoveTest | PASS | 961ms |
| testMultiPagePdfWellFormedAndValid | Tier4JhoveTest | PASS | 895ms |
| testPdfWithMetadataWellFormedAndValid | Tier4JhoveTest | PASS | 870ms |
...
| testPdfBoxPreflightToolchainWorks | Tier4PdfBoxPreflightTest | PASS | 771ms |
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 560ms |
| testPdfWithMetadataHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 526ms |
| testPdfWithEmbeddedFontHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 518ms |
| testPdfIdToolchainWorks | Tier4PdfIdTest | PASS | 336ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 image with BPC.pdf" | Tier4Pdf20ExamplesTest | PASS | 201ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/Simple PDF 2.0 file.pdf" | Tier4Pdf20ExamplesTest | PASS | 180ms |
| testPdf20ExampleQpdfValid with data set "pdf20/pdf20-utf8-test.pdf" | Tier4Pdf20ExamplesTest | PASS | 184ms |
