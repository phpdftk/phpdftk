...
Generated: 2026-06-08 00:15:58 UTC
PHP: 8.4.21
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 93.69s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 33.78s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.31s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 19.6s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 18.89s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 11.67s |
| &#x2705; JHOVE + PDF 2.0 + Security + Preflight | PASS | 25 | 24 | 0 | 1 | 8.43s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 33.78s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 297ms |
| testGeneratesAnnotationsPdf | AnnotationsTest | PASS | 200ms |
| testGeneratesBookmarksPdf | BookmarksTest | PASS | 250ms |
| testGeneratesFormWithCustomFontAppearances | CustomFontFormAppearancesTest | PASS | 216ms |
...
| testGeneratesExtGStatePdf | ExtGStateIntegrationTest | PASS | 200ms |
| testGeneratesFormWithAppearances | FormAppearancesIntegrationTest | PASS | 199ms |
...
| testGeneratesGraphicsPdf | GraphicsTest | PASS | 198ms |
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 638ms |
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 143ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 341ms |
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 158ms |
| testGeneratesPdfWithMarkupFields | MarkupAnnotationsIntegrationTest | PASS | 198ms |
...
| testGeneratesPdfWithType3Font | Type3FontIntegrationTest | PASS | 204ms |
...
| testNoteCalloutEmitsLabelAndBody | CalloutTest | PASS | 199ms |
...
| testBulletListRendersEachItem | ListTest | PASS | 193ms |
...
| testAddPageDelegatesToWriter | PdfDocTest | PASS | 197ms |
...
| testGeneratesHighLevelDocument | PdfIntegrationTest | PASS | 405ms |
| testAddHtmlRendersIntoPdf | PdfTest | PASS | 38ms |
| testEmptyDocumentHasNoPages | PdfTest | PASS | 194ms |
| testAddTextCreatesFirstPageAutomatically | PdfTest | PASS | 211ms |
| testAddHeadingEmitsLargerText | PdfTest | PASS | 195ms |
| testExplicitNewPageCreatesSecondPage | PdfTest | PASS | 186ms |
| testLongTextAutoPaginates | PdfTest | PASS | 196ms |
| testAddSpacerConsumesVerticalSpace | PdfTest | PASS | 209ms |
| testAddRuleDrawsStroke | PdfTest | PASS | 197ms |
| testAlignmentCenterEmitsCenteredText | PdfTest | PASS | 190ms |
| testSetFontSwitchesFontFamily | PdfTest | PASS | 195ms |
...
| testSaveWritesFile | PdfTest | PASS | 211ms |
| testWriteToStream | PdfTest | PASS | 196ms |
| testWriteToRejectsNonResource | PdfTest | PASS | <1ms |
| testToBytesProducesValidPdfOnEachCall | PdfTest | PASS | 389ms |
...
| testAddTableRendersAllCellValues | TableTest | PASS | 204ms |
...
| testAddCompositeFontGeneratesValidPdf | UnicodeFontTest | PASS | 204ms |
...
| testPdfWriterGeneratesValidPdfHeader | WriterTest | PASS | 198ms |
...
| testPdfWriterContainsPage | WriterTest | PASS | 192ms |
...
| testPdfWriterWithInfo | WriterTest | PASS | 206ms |
| testPdfWriterGetCatalog | WriterTest | PASS | <1ms |
| testPdfWriterGetPageTree | WriterTest | PASS | <1ms |
| testPdfWriterSavesToFile | WriterTest | PASS | 194ms |
| testPdfWriterContainsXref | WriterTest | PASS | 196ms |
| testPdfWriterContainsTrailer | WriterTest | PASS | <1ms |
| testPdfWriterAddPageWithRectangle | WriterTest | PASS | 193ms |
| testPdfWriterRegisterObject | WriterTest | PASS | 187ms |
| testPdfWriterFontAddedToPage | WriterTest | PASS | 196ms |
| testSetNamedDestinations | WriterTest | PASS | 200ms |
| testSetEncryptionProducesEncryptedPdf | WriterTest | PASS | 205ms |
| testSetEncryptionAes256RoundTrip | WriterTest | PASS | 266ms |
| testSetMetadataAddsStreamToPdf | XmpMetadataTest | PASS | 197ms |
| testMetadataStreamContainsXmp | XmpMetadataTest | PASS | 194ms |
| testMetadataRoundTrip | XmpMetadataTest | PASS | 198ms |
| testSyncInfoToMetadata | XmpMetadataTest | PASS | 201ms |
...
| testFillTextField | FormFillerTest | PASS | 200ms |
| testFillManyFields | FormFillerTest | PASS | 189ms |
| testCheckCheckbox | FormFillerTest | PASS | 198ms |
| testUncheckCheckbox | FormFillerTest | PASS | 200ms |
| testSelectChoiceField | FormFillerTest | PASS | 200ms |
| testFillMultipleFieldTypes | FormFillerTest | PASS | 206ms |
...
| testSaveWritesFile | FormFillerTest | PASS | 196ms |
| testEscapeHatch | FormFillerTest | PASS | 2ms |
| testRoundTripPreservesOtherFields | FormFillerTest | PASS | 196ms |
...
| testSetMetadataOnPdfWithoutInfo | MetadataEditorTest | PASS | 205ms |
...
| testSaveToFile | PageLabelerTest | PASS | 188ms |
| testNoBytesChangedWhenNoOperations | PageLabelerTest | PASS | 1ms |
| testOpenFromFile | PageLabelerTest | PASS | 1ms |
| testKeepPages | PageSlicerTest | PASS | 192ms |
| testKeepRange | PageSlicerTest | PASS | 207ms |
| testRemovePages | PageSlicerTest | PASS | 199ms |
| testReorder | PageSlicerTest | PASS | 197ms |
| testReverse | PageSlicerTest | PASS | 199ms |
| testSplit | PageSlicerTest | PASS | 395ms |
...
| testRotateAllPages | PageTransformerTest | PASS | 205ms |
| testRotate180 | PageTransformerTest | PASS | 196ms |
| testRotate270 | PageTransformerTest | PASS | 202ms |
| testRotateSpecificPages | PageTransformerTest | PASS | 195ms |
| testRotateCumulative | PageTransformerTest | PASS | 200ms |
| testRotateInvalidAngle | PageTransformerTest | PASS | <1ms |
| testSetCropBox | PageTransformerTest | PASS | 201ms |
| testSetCropBoxSpecificPage | PageTransformerTest | PASS | 203ms |
| testSetMediaBox | PageTransformerTest | PASS | 205ms |
| testSetTrimBox | PageTransformerTest | PASS | 194ms |
| testSetBleedBox | PageTransformerTest | PASS | 186ms |
| testScale | PageTransformerTest | PASS | 190ms |
| testScaleSpecificPages | PageTransformerTest | PASS | 188ms |
| testScaleInvalidFactor | PageTransformerTest | PASS | <1ms |
| testScaleTo | PageTransformerTest | PASS | 195ms |
| testScaleToNonUniform | PageTransformerTest | PASS | 194ms |
| testMultipleOperations | PageTransformerTest | PASS | 196ms |
| testNoBytesChangedWithoutOperations | PageTransformerTest | PASS | <1ms |
| testEvenPages | PageTransformerTest | PASS | 189ms |
| testOddPages | PageTransformerTest | PASS | 195ms |
| testRange | PageTransformerTest | PASS | 200ms |
| testGetReader | PageTransformerTest | PASS | <1ms |
| testGetPageCount | PageTransformerTest | PASS | <1ms |
| testSaveToFile | PageTransformerTest | PASS | 193ms |
...
| testMergeTwoPdfs | PdfMergerTest | PASS | 195ms |
| testMergeWithPageSelection | PdfMergerTest | PASS | 188ms |
...
| testStampText | PdfStamperTest | PASS | 190ms |
| testWatermark | PdfStamperTest | PASS | 197ms |
| testWatermarkWithStyle | PdfStamperTest | PASS | 192ms |
| testPageNumbers | PdfStamperTest | PASS | 188ms |
| testStampOnSpecificPages | PdfStamperTest | PASS | 190ms |
| testHeaderAndFooter | PdfStamperTest | PASS | 189ms |
| testStampWithOpacity | PdfStamperTest | PASS | 183ms |
...
| testSaveToFile | PdfStamperTest | PASS | 204ms |
| testStampImageJpeg | PdfStamperTest | PASS | 235ms |
| testStampImagePng | PdfStamperTest | PASS | 181ms |
| testStampImageWithScaleWidth | PdfStamperTest | PASS | 191ms |
| testStampImageWithScaleHeight | PdfStamperTest | PASS | 189ms |
| testStampImageWithExplicitDimensions | PdfStamperTest | PASS | 195ms |
| testStampImageWithOpacity | PdfStamperTest | PASS | 186ms |
| testStampImageOnSpecificPages | PdfStamperTest | PASS | 199ms |
| testStampImageCombinedWithText | PdfStamperTest | PASS | 184ms |
| testStampImageThrowsOnMissingFile | PdfStamperTest | PASS | <1ms |
| testStampImageThrowsOnUnsupportedFormat | PdfStamperTest | PASS | 1ms |
| testStampPdf | PdfStamperTest | PASS | 192ms |
| testStampPdfWithScaling | PdfStamperTest | PASS | 192ms |
| testStampPdfWithOpacity | PdfStamperTest | PASS | 201ms |
...
| testRedactMultipleAreas | TextRedactorTest | PASS | 197ms |
| testRedactByText | TextRedactorTest | PASS | 198ms |
| testRedactByPattern | TextRedactorTest | PASS | 1ms |
| testCustomRedactionColor | TextRedactorTest | PASS | 211ms |
...
| testSaveToFile | TextRedactorTest | PASS | 208ms |
...
| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesBookmarksPdf | BookmarksTest | PASS | 321ms |
...
| testGeneratesFormPdf | FormFieldsTest | PASS | 195ms |
| testGeneratesMultiPageComplexPdf | MultiPageComplexTest | PASS | 197ms |
| testGeneratesSimpleTextPdf | SimpleTextTest | PASS | 197ms |

### veraPDF — PDF/A archival conformance (ISO 19005)

**4 tests** | 3 passed | 0 failed | 1 skipped | 19.6s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWithOutputIntent | PdfAConformanceTest | SKIP | 5ms |
| testVeraPdfToolchainWorks | PdfAConformanceTest | PASS | 2.12s |
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 7.45s |
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 10.03s |
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 18.89s
...
| testQpdfCorpus with data set "qpdf/inline-images-ii-some.pdf" | Tier2CorpusTest | PASS | 19ms |
...
| testQpdfCorpus with data set "qpdf/sample-form.pdf" | Tier2CorpusTest | PASS | 8ms |
...
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 10.02s |
...
| testPdfBoxCorpus with data set "pdfbox/pdfbox/src/test/resources/org/apache/pdfbox/pdmodel/documentinterchange/logicalstructure/PDFBOX-2725-878725.pdf" | Tier2PdfBoxCorpusTest | PASS | 5ms |
...
| testPdfiumCorpus with data set "pdfium/bug_1506.pdf" | Tier2PdfiumCorpusTest | PASS | 4ms |
...
**6 tests** | 6 passed | 0 failed | 0 skipped | 11.67s
...
| testUntaggedDocumentFailsUa1 | Tier3MatterhornTest | PASS | 1.87s |
| testMissingLangFailsUa1 | Tier3MatterhornTest | PASS | 1.89s |
| testMissingDisplayDocTitleFailsUa1 | Tier3MatterhornTest | PASS | 1.83s |
| testAnnotationWithoutContentsFailsUa1 | Tier3MatterhornTest | PASS | 1.88s |
...
**25 tests** | 24 passed | 0 failed | 1 skipped | 8.43s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWellFormedAndValid | Tier4JhoveTest | PASS | 951ms |
| testMultiPagePdfWellFormedAndValid | Tier4JhoveTest | PASS | 892ms |
| testPdfWithMetadataWellFormedAndValid | Tier4JhoveTest | PASS | 906ms |
| testPdfWithEmbeddedFontWellFormedAndValid | Tier4JhoveTest | PASS | 885ms |
| testJhoveToolchainWorks | Tier4JhoveTest | PASS | 701ms |
| testPdfA1bPassesPdfBoxPreflight | Tier4PdfBoxPreflightTest | SKIP | <1ms |
| testPdfBoxPreflightToolchainWorks | Tier4PdfBoxPreflightTest | PASS | 777ms |
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 561ms |
| testPdfWithMetadataHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 538ms |
| testPdfWithEmbeddedFontHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 537ms |
| testPdfIdToolchainWorks | Tier4PdfIdTest | PASS | 348ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 image with BPC.pdf" | Tier4Pdf20ExamplesTest | PASS | 188ms |
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 via incremental save.pdf" | Tier4Pdf20ExamplesTest | PASS | 183ms |
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 with offset start.pdf" | Tier4Pdf20ExamplesTest | PASS | 186ms |
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 with page level output intent.pdf" | Tier4Pdf20ExamplesTest | PASS | 187ms |
| testPdf20ExampleQpdfValid with data set "pdf20/Simple PDF 2.0 file.pdf" | Tier4Pdf20ExamplesTest | PASS | 187ms |
| testPdf20ExampleQpdfValid with data set "pdf20/pdf20-utf8-test.pdf" | Tier4Pdf20ExamplesTest | PASS | 207ms |
