...
Generated: 2026-06-10 20:59:33 UTC
PHP: 8.4.21
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 91.71s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 32.8s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.29s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 18.8s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 18.67s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 32.8s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 381ms |
...
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 425ms |
...
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 256ms |
...
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 393ms |
...
| testAddHeadingEmitsLargerText | PdfTest | PASS | 183ms |
...
| testNoOpsKeepsAllPages | PageSlicerTest | PASS | 230ms |
...
| testSetCropBoxSpecificPage | PageTransformerTest | PASS | 220ms |
| testSetMediaBox | PageTransformerTest | PASS | 221ms |
| testSetTrimBox | PageTransformerTest | PASS | 214ms |
...
| testScaleToNonUniform | PageTransformerTest | PASS | 227ms |
...
| testWatermarkWithStyle | PdfStamperTest | PASS | 211ms |
...
| testStampWithOpacity | PdfStamperTest | PASS | 214ms |
...
| testSaveToFile | TextRedactorTest | PASS | 204ms |
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 18.67s
...
| testQpdfCorpus with data set "qpdf/enc-R3,V2,U=view,O=master.pdf" | Tier2CorpusTest | PASS | 13ms |
...
| testQpdfCorpus with data set "qpdf/sample-form.pdf" | Tier2CorpusTest | PASS | 32ms |
...
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 582ms |
| testPdfWithMetadataHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 513ms |
| testPdfWithEmbeddedFontHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 558ms |
