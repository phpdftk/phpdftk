...
Generated: 2026-06-10 20:46:34 UTC
PHP: 8.4.21
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 92s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 32.84s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.24s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 19.13s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 18.06s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 11.95s |
| &#x2705; JHOVE + PDF 2.0 + Security + Preflight | PASS | 25 | 24 | 0 | 1 | 8.78s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 32.84s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 715ms |
...
| testGeneratesPdfWithEmbeddedFont | EmbeddedFontsTest | PASS | 199ms |
...
| testGeneratesFormWithAppearances | FormAppearancesIntegrationTest | PASS | 190ms |
...
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 184ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 325ms |
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 313ms |
...
| testGeneratesMultimediaAnd3DPdf | MultimediaAndThreeDIntegrationTest | PASS | 191ms |
...
| testGeneratesPageLabelsPdf | PageLabelsTest | PASS | 204ms |
| testGeneratesSignatureFieldPdf | SignatureFieldIntegrationTest | PASS | 189ms |
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 471ms |
...
| testAddTextWithLinkStyleProducesLinkAnnotation | InlineLinkTest | PASS | 212ms |
...
| testAddPageDelegatesToWriter | PdfDocTest | PASS | 186ms |
...
| testAlignmentCenterEmitsCenteredText | PdfTest | PASS | 184ms |
...
| testWriteToStream | PdfTest | PASS | 179ms |
...
| testStrikethroughEmitsStroke | TextDecorationTest | PASS | 7ms |
...
| testCompositeFontPerPage | UnicodeFontTest | PASS | 209ms |
| testPdfWriterGeneratesValidPdfHeader | WriterTest | PASS | 193ms |
...
| testPdfWriterAddContentStream | WriterTest | PASS | 189ms |
...
| testPdfWriterSavesToFile | WriterTest | PASS | 183ms |
...
| testSetEncryptionProducesEncryptedPdf | WriterTest | PASS | 189ms |
| testSetEncryptionAes256RoundTrip | WriterTest | PASS | 224ms |
...
| testSaveToFile | AnnotationFlattenerTest | PASS | 178ms |
...
| testSetBookmarks | BookmarkEditorTest | PASS | 186ms |
| testSetBookmarksWithChildren | BookmarkEditorTest | PASS | 188ms |
| testAddBookmark | BookmarkEditorTest | PASS | 365ms |
| testHasBookmarksReturnsFalseForCleanPdf | BookmarkEditorTest | PASS | <1ms |
| testRemoveBookmarks | BookmarkEditorTest | PASS | 194ms |
| testGetPageCount | BookmarkEditorTest | PASS | <1ms |
| testGetReader | BookmarkEditorTest | PASS | <1ms |
| testSaveToFile | BookmarkEditorTest | PASS | 213ms |
| testNoBytesChangedWhenNoOperations | BookmarkEditorTest | PASS | <1ms |
| testReplaceExistingBookmarks | BookmarkEditorTest | PASS | 220ms |
| testOpenString | FormFillerTest | PASS | 3ms |
| testGetFieldNames | FormFillerTest | PASS | 2ms |
| testHasField | FormFillerTest | PASS | 2ms |
...
| testSelectChoiceField | FormFillerTest | PASS | 185ms |
| testFillMultipleFieldTypes | FormFillerTest | PASS | 178ms |
...
| testSaveWritesFile | FormFillerTest | PASS | 176ms |
| testEscapeHatch | FormFillerTest | PASS | 1ms |
| testRoundTripPreservesOtherFields | FormFillerTest | PASS | 179ms |
...
| testSetLabelsWithArabic | PageLabelerTest | PASS | 197ms |
| testSetRomanNumerals | PageLabelerTest | PASS | 181ms |
...
| testRemoveLabels | PageLabelerTest | PASS | 198ms |
...
| testSplit | PageSlicerTest | PASS | 371ms |
| testKeepWithPageSelector | PageSlicerTest | PASS | 181ms |
...
| testRotateAllPages | PageTransformerTest | PASS | 189ms |
| testRotate180 | PageTransformerTest | PASS | 203ms |
| testRotate270 | PageTransformerTest | PASS | 213ms |
| testRotateSpecificPages | PageTransformerTest | PASS | 185ms |
| testRotateCumulative | PageTransformerTest | PASS | 182ms |
...
| testSetMediaBox | PageTransformerTest | PASS | 203ms |
...
| testScaleTo | PageTransformerTest | PASS | 178ms |
| testScaleToNonUniform | PageTransformerTest | PASS | 174ms |
...
| testOddPages | PageTransformerTest | PASS | 194ms |
| testRange | PageTransformerTest | PASS | 186ms |
| testGetReader | PageTransformerTest | PASS | <1ms |
| testGetPageCount | PageTransformerTest | PASS | <1ms |
| testSaveToFile | PageTransformerTest | PASS | 179ms |
...
| testEncryptRc440 | PdfEncryptTest | PASS | 4ms |
...
| testMergeWithPageSelection | PdfMergerTest | PASS | 182ms |
...
| testSaveToFile | PdfMergerTest | PASS | 186ms |
...
| testSaveToFile | PdfStamperTest | PASS | 191ms |
| testStampImageJpeg | PdfStamperTest | PASS | 241ms |
...
| testStampPdfWithOpacity | PdfStamperTest | PASS | 183ms |
| testStampPdfSpecificPage | PdfStamperTest | PASS | 180ms |
| testStampPdfOnSelectedPages | PdfStamperTest | PASS | 185ms |
| testStampPdfDefaultsToCenter | PdfStamperTest | PASS | 188ms |
...
| testRedactMultipleAreas | TextRedactorTest | PASS | 180ms |
...
| testGeneratesMultiPageComplexPdf | MultiPageComplexTest | PASS | 186ms |
| testGeneratesSimpleTextPdf | SimpleTextTest | PASS | 185ms |

### veraPDF — PDF/A archival conformance (ISO 19005)

**4 tests** | 3 passed | 0 failed | 1 skipped | 19.13s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWithOutputIntent | PdfAConformanceTest | SKIP | 6ms |
| testVeraPdfToolchainWorks | PdfAConformanceTest | PASS | 2.09s |
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 7.54s |
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 9.49s |
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 18.06s
...
| testQpdfCorpus with data set "qpdf/enc-R3,V2,U=view,O=master.pdf" | Tier2CorpusTest | PASS | 14ms |
...
| testQpdfCorpus with data set "qpdf/inline-images-ii-all.pdf" | Tier2CorpusTest | PASS | 16ms |
...
| testQpdfCorpus with data set "qpdf/many-nulls.pdf" | Tier2CorpusTest | PASS | 678ms |
...
| testPdfiumCorpus with data set "pdfium/bug_707673.pdf" | Tier2PdfiumCorpusTest | PASS | 12ms |
...
| Test | Class | Status | Time |
|---|---|---|---|
| testTaggedDocumentValidatesWithUa1 | Tier3MatterhornTest | PASS | 2.24s |
...
| testMissingLangFailsUa1 | Tier3MatterhornTest | PASS | 1.9s |
| testMissingDisplayDocTitleFailsUa1 | Tier3MatterhornTest | PASS | 1.8s |
| testAnnotationWithoutContentsFailsUa1 | Tier3MatterhornTest | PASS | 2s |
...
**25 tests** | 24 passed | 0 failed | 1 skipped | 8.78s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWellFormedAndValid | Tier4JhoveTest | PASS | 958ms |
| testMultiPagePdfWellFormedAndValid | Tier4JhoveTest | PASS | 857ms |
| testPdfWithMetadataWellFormedAndValid | Tier4JhoveTest | PASS | 847ms |
...
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 829ms |
| testPdfWithMetadataHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 572ms |
| testPdfWithEmbeddedFontHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 544ms |
| testPdfIdToolchainWorks | Tier4PdfIdTest | PASS | 386ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 UTF-8 string and annotation.pdf" | Tier4Pdf20ExamplesTest | PASS | 216ms |
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 image with BPC.pdf" | Tier4Pdf20ExamplesTest | PASS | 215ms |
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 via incremental save.pdf" | Tier4Pdf20ExamplesTest | PASS | 194ms |
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 with offset start.pdf" | Tier4Pdf20ExamplesTest | PASS | 196ms |
