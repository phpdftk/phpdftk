...
Generated: 2026-06-10 18:10:46 UTC
PHP: 8.4.21
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 86.29s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 27.87s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.11s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 19.74s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 19.17s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 10.8s |
| &#x2705; JHOVE + PDF 2.0 + Security + Preflight | PASS | 25 | 24 | 0 | 1 | 7.6s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 27.87s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 273ms |
| testGeneratesAnnotationsPdf | AnnotationsTest | PASS | 157ms |
| testGeneratesBookmarksPdf | BookmarksTest | PASS | 206ms |
| testGeneratesFormWithCustomFontAppearances | CustomFontFormAppearancesTest | PASS | 185ms |
...
| testGeneratesExtGStatePdf | ExtGStateIntegrationTest | PASS | 160ms |
| testGeneratesFormWithAppearances | FormAppearancesIntegrationTest | PASS | 170ms |
...
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 327ms |
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 145ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 238ms |
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 278ms |
| testGeneratesPdfWithMarkupFields | MarkupAnnotationsIntegrationTest | PASS | 181ms |
...
| testGeneratesSignatureFieldPdf | SignatureFieldIntegrationTest | PASS | 203ms |
...
| testGeneratesPdfWithType3Font | Type3FontIntegrationTest | PASS | 176ms |
| testGeneratesPdfWithXrefAndObjectStreams | XRefStreamIntegrationTest | PASS | 161ms |
...
| testAddQuoteAutoPaginatesAndDrawsBarOnEachPage | BlockquoteTest | PASS | 7ms |
...
| testNoteCalloutEmitsLabelAndBody | CalloutTest | PASS | 166ms |
...
| testWinAnsiRoundTripFromShowText | EncodingIntegrationTest | PASS | 159ms |
...
| testGeneratesHighLevelDocument | PdfIntegrationTest | PASS | 343ms |
| testAddHtmlRendersIntoPdf | PdfTest | PASS | 34ms |
| testEmptyDocumentHasNoPages | PdfTest | PASS | 161ms |
...
| testAddTableRendersAllCellValues | TableTest | PASS | 159ms |
...
| testUnderlineEmitsStrokeBelowBaseline | TextDecorationTest | PASS | 165ms |
...
| testCompositeFontPerPage | UnicodeFontTest | PASS | 165ms |
...
| testPdfWriterContainsPage | WriterTest | PASS | 155ms |
...
| testPdfWriterAddContentStream | WriterTest | PASS | 153ms |
...
| testPdfWriterSavesToFile | WriterTest | PASS | 162ms |
| testPdfWriterContainsXref | WriterTest | PASS | 163ms |
| testPdfWriterContainsTrailer | WriterTest | PASS | <1ms |
| testPdfWriterAddPageWithRectangle | WriterTest | PASS | 158ms |
...
| testSetMetadataAddsStreamToPdf | XmpMetadataTest | PASS | 161ms |
| testMetadataStreamContainsXmp | XmpMetadataTest | PASS | 160ms |
| testMetadataRoundTrip | XmpMetadataTest | PASS | 162ms |
| testSyncInfoToMetadata | XmpMetadataTest | PASS | 163ms |
| testSyncInfoToMetadataNoInfoIsNoOp | XmpMetadataTest | PASS | 168ms |
| testFlattenAll | AnnotationFlattenerTest | PASS | 160ms |
...
| testSaveToFile | AnnotationFlattenerTest | PASS | 171ms |
...
| testAddBookmark | BookmarkEditorTest | PASS | 328ms |
...
| testReplaceExistingBookmarks | BookmarkEditorTest | PASS | 176ms |
...
| testUncheckCheckbox | FormFillerTest | PASS | 172ms |
| testSelectChoiceField | FormFillerTest | PASS | 170ms |
| testFillMultipleFieldTypes | FormFillerTest | PASS | 166ms |
...
| testSetTitleRoundTrip | MetadataEditorTest | PASS | 170ms |
| testSetMultipleFieldsRoundTrip | MetadataEditorTest | PASS | 158ms |
| testSetMetadataOnPdfWithoutInfo | MetadataEditorTest | PASS | 162ms |
| testSetCreatorProducerDatesAndTrappedRoundTrip | MetadataEditorTest | PASS | 2ms |
...
| testSetRomanNumeralsUppercase | PageLabelerTest | PASS | 173ms |
| testSetAlphabetic | PageLabelerTest | PASS | 175ms |
| testSetArabicWithStartNumber | PageLabelerTest | PASS | 175ms |
...
| testRotate180 | PageTransformerTest | PASS | 166ms |
| testRotate270 | PageTransformerTest | PASS | 163ms |
| testRotateSpecificPages | PageTransformerTest | PASS | 163ms |
| testRotateCumulative | PageTransformerTest | PASS | 169ms |
| testRotateInvalidAngle | PageTransformerTest | PASS | <1ms |
| testSetCropBox | PageTransformerTest | PASS | 167ms |
| testSetCropBoxSpecificPage | PageTransformerTest | PASS | 171ms |
| testSetMediaBox | PageTransformerTest | PASS | 166ms |
| testSetTrimBox | PageTransformerTest | PASS | 162ms |
| testSetBleedBox | PageTransformerTest | PASS | 165ms |
| testScale | PageTransformerTest | PASS | 167ms |
| testScaleSpecificPages | PageTransformerTest | PASS | 161ms |
...
| testEvenPages | PageTransformerTest | PASS | 165ms |
...
| testSaveToFile | PageTransformerTest | PASS | 162ms |
| testEncryptAes128 | PdfEncryptTest | PASS | 165ms |
...
| testMergeTwoPdfs | PdfMergerTest | PASS | 161ms |
| testMergeWithPageSelection | PdfMergerTest | PASS | 163ms |
...
| testPageNumbers | PdfStamperTest | PASS | 169ms |
...
| testSaveToFile | PdfStamperTest | PASS | 164ms |
...
| testStampImageWithOpacity | PdfStamperTest | PASS | 160ms |
| testStampImageOnSpecificPages | PdfStamperTest | PASS | 161ms |
| testStampImageCombinedWithText | PdfStamperTest | PASS | 157ms |
| testStampImageThrowsOnMissingFile | PdfStamperTest | PASS | <1ms |
| testStampImageThrowsOnUnsupportedFormat | PdfStamperTest | PASS | <1ms |
| testStampPdf | PdfStamperTest | PASS | 164ms |
| testStampPdfWithScaling | PdfStamperTest | PASS | 156ms |
| testStampPdfWithOpacity | PdfStamperTest | PASS | 169ms |
| testStampPdfSpecificPage | PdfStamperTest | PASS | 163ms |
...
| testRedactArea | TextRedactorTest | PASS | 159ms |
| testRedactMultipleAreas | TextRedactorTest | PASS | 163ms |
| testRedactByText | TextRedactorTest | PASS | 159ms |
...
| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesBookmarksPdf | BookmarksTest | PASS | 281ms |
| testGeneratesDocumentFeaturesPdf | DocumentFeaturesTest | PASS | 163ms |
| testGeneratesPdfWithEmbeddedTrueTypeFont | DocumentFeaturesTest | PASS | 172ms |
...
**4 tests** | 3 passed | 0 failed | 1 skipped | 19.74s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWithOutputIntent | PdfAConformanceTest | SKIP | 4ms |
| testVeraPdfToolchainWorks | PdfAConformanceTest | PASS | 1.8s |
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 7.32s |
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 10.61s |
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 19.17s
...
| testPopplerCorpus with data set "poppler-test/unittestcases/signature/invalid/etsi_esscertid_10.pdf" | Tier2CorpusTest | PASS | 2ms |
...
| testQpdfCorpus with data set "qpdf/good16.pdf" | Tier2CorpusTest | PASS | 10ms |
...
| testQpdfCorpus with data set "qpdf/uo-7.pdf" | Tier2CorpusTest | PASS | 27ms |
...
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 7.48s |
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 10.33s |
...
| testPdfiumCorpus with data set "pdfium/utf-8.pdf" | Tier2PdfiumCorpusTest | PASS | 6ms |
...
**6 tests** | 6 passed | 0 failed | 0 skipped | 10.8s

| Test | Class | Status | Time |
|---|---|---|---|
| testTaggedDocumentValidatesWithUa1 | Tier3MatterhornTest | PASS | 2.08s |
| testAnnotationWithContentsPassesClause718 | Tier3MatterhornTest | PASS | 1.97s |
| testUntaggedDocumentFailsUa1 | Tier3MatterhornTest | PASS | 1.61s |
| testMissingLangFailsUa1 | Tier3MatterhornTest | PASS | 1.73s |
| testMissingDisplayDocTitleFailsUa1 | Tier3MatterhornTest | PASS | 1.74s |
| testAnnotationWithoutContentsFailsUa1 | Tier3MatterhornTest | PASS | 1.67s |
...
**25 tests** | 24 passed | 0 failed | 1 skipped | 7.6s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWellFormedAndValid | Tier4JhoveTest | PASS | 871ms |
| testMultiPagePdfWellFormedAndValid | Tier4JhoveTest | PASS | 830ms |
| testPdfWithMetadataWellFormedAndValid | Tier4JhoveTest | PASS | 797ms |
| testPdfWithEmbeddedFontWellFormedAndValid | Tier4JhoveTest | PASS | 794ms |
| testJhoveToolchainWorks | Tier4JhoveTest | PASS | 629ms |
...
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 649ms |
| testPdfWithMetadataHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 460ms |
| testPdfWithEmbeddedFontHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 460ms |
