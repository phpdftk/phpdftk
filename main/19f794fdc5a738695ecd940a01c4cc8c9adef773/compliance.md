...
Generated: 2026-05-25 02:44:39 UTC
PHP: 8.4.21
...
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 454 | 450 | 0 | 4 | 32.43s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.26s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 18.74s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 18.26s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 11.77s |
...
**454 tests** | 450 passed | 0 failed | 4 skipped | 32.43s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 554ms |
...
| testGeneratesPdfWithEmbeddedType1 | EmbeddedType1FontTest | PASS | 181ms |
| testPdfOutputContainsFontData | EmbeddedType1FontTest | PASS | <1ms |
| testGeneratesExtGStatePdf | ExtGStateIntegrationTest | PASS | 177ms |
| testGeneratesFormWithAppearances | FormAppearancesIntegrationTest | PASS | 193ms |
...
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 444ms |
...
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 237ms |
...
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 338ms |
...
| testAddTextCreatesFirstPageAutomatically | PdfTest | PASS | 188ms |
| testAddHeadingEmitsLargerText | PdfTest | PASS | 194ms |
| testExplicitNewPageCreatesSecondPage | PdfTest | PASS | 184ms |
...
| testPdfWriterSavesToFile | WriterTest | PASS | 189ms |
...
| testFillManyFields | FormFillerTest | PASS | 202ms |
...
| testSaveToFile | MetadataEditorTest | PASS | 199ms |
| testSetLabelsWithArabic | PageLabelerTest | PASS | 186ms |
...
| testSaveToFile | PageTransformerTest | PASS | 191ms |
...
| testSaveToFile | PdfStamperTest | PASS | 176ms |
...
| testStampImageWithExplicitDimensions | PdfStamperTest | PASS | 178ms |
...
| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesBookmarksPdf | BookmarksTest | PASS | 302ms |
...
**4 tests** | 3 passed | 0 failed | 1 skipped | 18.74s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWithOutputIntent | PdfAConformanceTest | SKIP | 5ms |
| testVeraPdfToolchainWorks | PdfAConformanceTest | PASS | 2.17s |
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 7.04s |
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 9.53s |
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 18.26s
...
| testPopplerCorpus with data set "poppler-test/unittestcases/Gday garçon - open.pdf" | Tier2CorpusTest | PASS | 5ms |
...
| testPopplerCorpus with data set "poppler-test/unittestcases/PasswordEncrypted.pdf" | Tier2CorpusTest | PASS | 4ms |
...
| testQpdfCorpus with data set "qpdf/duplicate-pages.pdf" | Tier2CorpusTest | PASS | 6ms |
...
| testQpdfCorpus with data set "qpdf/no-space-compressed-object.pdf" | Tier2CorpusTest | PASS | 22ms |
...
| testPdfBoxCorpus with data set "pdfbox/pdfbox/src/test/resources/input/PDFBOX-5747-unicode-surrogate-with-diacritic-reduced.pdf" | Tier2PdfBoxCorpusTest | PASS | 4ms |
...
| testPdfBoxCorpus with data set "pdfbox/pdfbox/src/test/resources/org/apache/pdfbox/pdmodel/interactive/form/DifferentDALevels.pdf" | Tier2PdfBoxCorpusTest | PASS | 2ms |
...
**6 tests** | 6 passed | 0 failed | 0 skipped | 11.77s
...
| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWellFormedAndValid | Tier4JhoveTest | PASS | 912ms |
| testMultiPagePdfWellFormedAndValid | Tier4JhoveTest | PASS | 900ms |
| testPdfWithMetadataWellFormedAndValid | Tier4JhoveTest | PASS | 837ms |
| testPdfWithEmbeddedFontWellFormedAndValid | Tier4JhoveTest | PASS | 840ms |
| testJhoveToolchainWorks | Tier4JhoveTest | PASS | 663ms |
| testPdfA1bPassesPdfBoxPreflight | Tier4PdfBoxPreflightTest | SKIP | <1ms |
| testPdfBoxPreflightToolchainWorks | Tier4PdfBoxPreflightTest | PASS | 775ms |
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 564ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 UTF-8 string and annotation.pdf" | Tier4Pdf20ExamplesTest | PASS | 175ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 with page level output intent.pdf" | Tier4Pdf20ExamplesTest | PASS | 178ms |
| testPdf20ExampleQpdfValid with data set "pdf20/Simple PDF 2.0 file.pdf" | Tier4Pdf20ExamplesTest | PASS | 184ms |
| testPdf20ExampleQpdfValid with data set "pdf20/pdf20-utf8-test.pdf" | Tier4Pdf20ExamplesTest | PASS | 180ms |
