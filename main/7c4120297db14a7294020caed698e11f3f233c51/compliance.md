...
Generated: 2026-06-16 23:13:34 UTC
PHP: 8.4.22
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 95.82s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 33.4s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.32s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 20.23s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 19.93s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 33.4s
...
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 133ms |
...
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 575ms |
...
| testPdfWriterRegisterObject | WriterTest | PASS | 198ms |
...
| testSetEncryptionAes256RoundTrip | WriterTest | PASS | 242ms |
...
| testStampImageCombinedWithText | PdfStamperTest | PASS | 210ms |
...
| testCustomRedactionColor | TextRedactorTest | PASS | 209ms |
...
**4 tests** | 3 passed | 0 failed | 1 skipped | 20.23s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWithOutputIntent | PdfAConformanceTest | SKIP | 5ms |
| testVeraPdfToolchainWorks | PdfAConformanceTest | PASS | 2.05s |
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 7.84s |
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 10.34s |
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 19.93s
...
| testQpdfCorpus with data set "qpdf/deterministic-id-in.pdf" | Tier2CorpusTest | PASS | 14ms |
...
| testQpdfCorpus with data set "qpdf/rotated-shared-annotations-2.pdf" | Tier2CorpusTest | PASS | 27ms |
...
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 10.65s |
...
| testUntaggedDocumentFailsUa1 | Tier3MatterhornTest | PASS | 1.97s |
...
| testMultiPagePdfWellFormedAndValid | Tier4JhoveTest | PASS | 918ms |
...
| testPdfBoxPreflightToolchainWorks | Tier4PdfBoxPreflightTest | PASS | 826ms |
