...
Generated: 2026-05-25 20:22:16 UTC
PHP: 8.4.21
...
**Overall: PASS** | 1662 tests | 1656 passed | 0 failed | 6 skipped | 91.97s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 454 | 450 | 0 | 4 | 32.25s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.28s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 19.41s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 18.63s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 12.1s |
| &#x2705; JHOVE + PDF 2.0 + Security + Preflight | PASS | 25 | 24 | 0 | 1 | 8.29s |
...
**454 tests** | 450 passed | 0 failed | 4 skipped | 32.25s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 364ms |
...
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 307ms |
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 151ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 168ms |
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 231ms |
...
| testSetFontSwitchesFontFamily | PdfTest | PASS | 179ms |
...
| testToBytesProducesValidPdfOnEachCall | PdfTest | PASS | 374ms |
...
| testPdfWriterGeneratesValidPdfHeader | WriterTest | PASS | 178ms |
...
| testPdfWriterWithInfo | WriterTest | PASS | 185ms |
...
| testSetEncryptionAes256RoundTrip | WriterTest | PASS | 203ms |
...
| testKeepRange | PageSlicerTest | PASS | 194ms |
...
| testRedactByText | TextRedactorTest | PASS | 194ms |
...
**4 tests** | 3 passed | 0 failed | 1 skipped | 19.41s
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 18.63s
...
| testQpdfCorpus with data set "qpdf/deterministic-id-in.pdf" | Tier2CorpusTest | PASS | 9ms |
...
| testPdfBoxCorpus with data set "pdfbox/pdfbox/src/test/resources/input/PDFBOX-3062-005717-p1.pdf" | Tier2PdfBoxCorpusTest | PASS | 4ms |
...
| testPdfBoxCorpus with data set "pdfbox/pdfbox/src/test/resources/org/apache/pdfbox/pdmodel/interactive/form/AcroFormsRotation.pdf" | Tier2PdfBoxCorpusTest | PASS | 3ms |
...
| testPdfiumCorpus with data set "pdfium/bug_455199.pdf" | Tier2PdfiumCorpusTest | PASS | 2ms |
...
**6 tests** | 6 passed | 0 failed | 0 skipped | 12.1s
...
**25 tests** | 24 passed | 0 failed | 1 skipped | 8.29s
...
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 572ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 image with BPC.pdf" | Tier4Pdf20ExamplesTest | PASS | 173ms |
