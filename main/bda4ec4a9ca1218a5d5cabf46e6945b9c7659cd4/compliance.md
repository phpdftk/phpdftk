...
Generated: 2026-06-17 03:28:43 UTC
PHP: 8.4.22
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 98.59s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 35.15s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.37s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 21.09s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 19.79s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 12.29s |
| &#x2705; JHOVE + PDF 2.0 + Security + Preflight | PASS | 25 | 24 | 0 | 1 | 8.9s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 35.15s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 340ms |
| testGeneratesAnnotationsPdf | AnnotationsTest | PASS | 201ms |
| testGeneratesBookmarksPdf | BookmarksTest | PASS | 272ms |
| testGeneratesFormWithCustomFontAppearances | CustomFontFormAppearancesTest | PASS | 228ms |
| testGeneratesDocumentFeaturesPdf | DocumentFeaturesTest | PASS | 222ms |
| testGeneratesPdfWithEmbeddedTrueTypeFont | DocumentFeaturesTest | PASS | 233ms |
| testGeneratesPdfWithEmbeddedFont | EmbeddedFontsTest | PASS | 224ms |
| testEmbeddedFontHasFontDescriptor | EmbeddedFontsTest | PASS | 9ms |
...
| testGeneratesPdfWithEmbeddedType1 | EmbeddedType1FontTest | PASS | 212ms |
| testPdfOutputContainsFontData | EmbeddedType1FontTest | PASS | 1ms |
| testGeneratesExtGStatePdf | ExtGStateIntegrationTest | PASS | 214ms |
| testGeneratesFormWithAppearances | FormAppearancesIntegrationTest | PASS | 216ms |
| testGeneratesFormPdf | FormFieldsTest | PASS | 224ms |
| testGeneratesGraphicsPipelinePdf | GraphicsPipelineIntegrationTest | PASS | 216ms |
| testGeneratesGraphicsPdf | GraphicsTest | PASS | 216ms |
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 381ms |
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 78ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 164ms |
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 208ms |
| testGeneratesPdfWithMarkupFields | MarkupAnnotationsIntegrationTest | PASS | 220ms |
| testGeneratesMultiPageComplexPdf | MultiPageComplexTest | PASS | 224ms |
| testGeneratesMultimediaAnd3DPdf | MultimediaAndThreeDIntegrationTest | PASS | 224ms |
...
| testGeneratesPageLabelsPdf | PageLabelsTest | PASS | 215ms |
| testGeneratesSignatureFieldPdf | SignatureFieldIntegrationTest | PASS | 214ms |
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 383ms |
| testGeneratesSimpleTextPdf | SimpleTextTest | PASS | 216ms |
| testGeneratesPdfWithType3Font | Type3FontIntegrationTest | PASS | 208ms |
| testGeneratesPdfWithXrefAndObjectStreams | XRefStreamIntegrationTest | PASS | 197ms |
| testEnableOutlineThenHeadingRegistersOutlinesEntry | AutoOutlineTest | PASS | 201ms |
...
| testNoteCalloutEmitsLabelAndBody | CalloutTest | PASS | 201ms |
...
| testCalloutAutoBreaksToNewPageWhenItWontFit | CalloutTest | PASS | 2ms |
...
| testWinAnsiRoundTripFromShowText | EncodingIntegrationTest | PASS | 203ms |
| testHighLevelPdfRoundTrip | EncodingIntegrationTest | PASS | 5ms |
| testAddTextWithLinkStyleProducesLinkAnnotation | InlineLinkTest | PASS | 200ms |
...
| testBulletListRendersEachItem | ListTest | PASS | 199ms |
...
| testLongListAutoPaginates | ListTest | PASS | 10ms |
...
| testPageBreakAfterLastColumnResetsToColumnZero | MultiColumnTest | PASS | 8ms |
...
| testShowPageNumbersDefaultFormat | PageNumbersTest | PASS | 205ms |
...
| testAddPageDelegatesToWriter | PdfDocTest | PASS | 210ms |
...
| testGeneratesHighLevelDocument | PdfIntegrationTest | PASS | 433ms |
| testAddHtmlRendersIntoPdf | PdfTest | PASS | 42ms |
| testEmptyDocumentHasNoPages | PdfTest | PASS | 195ms |
| testAddTextCreatesFirstPageAutomatically | PdfTest | PASS | 204ms |
| testAddHeadingEmitsLargerText | PdfTest | PASS | 208ms |
| testExplicitNewPageCreatesSecondPage | PdfTest | PASS | 212ms |
| testLongTextAutoPaginates | PdfTest | PASS | 208ms |
| testAddSpacerConsumesVerticalSpace | PdfTest | PASS | 223ms |
| testAddRuleDrawsStroke | PdfTest | PASS | 205ms |
| testAlignmentCenterEmitsCenteredText | PdfTest | PASS | 204ms |
| testSetFontSwitchesFontFamily | PdfTest | PASS | 196ms |
| testBoldAndItalicResolveToCorrectPostScriptName | PdfTest | PASS | 203ms |
| testUnknownFamilyIsRejected | PdfTest | PASS | <1ms |
| testCustomTheme | PdfTest | PASS | 204ms |
| testSaveWritesFile | PdfTest | PASS | 208ms |
| testWriteToStream | PdfTest | PASS | 208ms |
| testWriteToRejectsNonResource | PdfTest | PASS | <1ms |
| testToBytesProducesValidPdfOnEachCall | PdfTest | PASS | 403ms |
...
| testAddTableAutoPaginatesAndRepeatsHeader | TableTest | PASS | 4ms |
| testAddTableEmptyRowsIsNoOp | TableTest | PASS | <1ms |
| testAddTableWrapsLongCellContentAcrossMultipleLines | TableTest | PASS | <1ms |
| testAddTableHonoursPerColumnAlignment | TableTest | PASS | 11ms |
...
| testUnderlineEmitsStrokeBelowBaseline | TextDecorationTest | PASS | 201ms |
...
| testType0FontFactoryCreatesValidStack | UnicodeFontTest | PASS | 6ms |
| testAddCompositeFontGeneratesValidPdf | UnicodeFontTest | PASS | 213ms |
| testAddCompositeFontSavesToFile | UnicodeFontTest | PASS | 210ms |
| testCompositeFontRoundTripsThroughReader | UnicodeFontTest | PASS | 225ms |
| testCompositeFontAppearsInFontList | UnicodeFontTest | PASS | 6ms |
| testShowTextHexOperator | UnicodeFontTest | PASS | <1ms |
| testCompositeFontPerPage | UnicodeFontTest | PASS | 213ms |
| testPdfWriterGeneratesValidPdfHeader | WriterTest | PASS | 208ms |
...
| testPdfWriterContainsPage | WriterTest | PASS | 202ms |
...
| testPdfWriterAddContentStream | WriterTest | PASS | 214ms |
| testPdfWriterGetContentStreams | WriterTest | PASS | <1ms |
| testPdfWriterWithInfo | WriterTest | PASS | 205ms |
| testPdfWriterGetCatalog | WriterTest | PASS | <1ms |
| testPdfWriterGetPageTree | WriterTest | PASS | <1ms |
| testPdfWriterSavesToFile | WriterTest | PASS | 202ms |
| testPdfWriterContainsXref | WriterTest | PASS | 200ms |
| testPdfWriterContainsTrailer | WriterTest | PASS | <1ms |
| testPdfWriterAddPageWithRectangle | WriterTest | PASS | 193ms |
| testPdfWriterRegisterObject | WriterTest | PASS | 206ms |
| testPdfWriterFontAddedToPage | WriterTest | PASS | 200ms |
| testSetNamedDestinations | WriterTest | PASS | 196ms |
| testSetEncryptionProducesEncryptedPdf | WriterTest | PASS | 213ms |
| testSetEncryptionAes256RoundTrip | WriterTest | PASS | 213ms |
| testSetMetadataAddsStreamToPdf | XmpMetadataTest | PASS | 202ms |
| testMetadataStreamContainsXmp | XmpMetadataTest | PASS | 208ms |
| testMetadataRoundTrip | XmpMetadataTest | PASS | 210ms |
| testSyncInfoToMetadata | XmpMetadataTest | PASS | 212ms |
| testSyncInfoToMetadataNoInfoIsNoOp | XmpMetadataTest | PASS | 194ms |
| testFlattenAll | AnnotationFlattenerTest | PASS | 205ms |
...
| testSaveToFile | AnnotationFlattenerTest | PASS | 200ms |
...
| testSetBookmarks | BookmarkEditorTest | PASS | 197ms |
| testSetBookmarksWithChildren | BookmarkEditorTest | PASS | 201ms |
| testAddBookmark | BookmarkEditorTest | PASS | 413ms |
...
| testGetFieldValues | FormFillerTest | PASS | 2ms |
| testFillTextField | FormFillerTest | PASS | 217ms |
| testFillManyFields | FormFillerTest | PASS | 209ms |
| testCheckCheckbox | FormFillerTest | PASS | 200ms |
| testUncheckCheckbox | FormFillerTest | PASS | 215ms |
| testSelectChoiceField | FormFillerTest | PASS | 200ms |
| testFillMultipleFieldTypes | FormFillerTest | PASS | 204ms |
...
| testRoundTripPreservesOtherFields | FormFillerTest | PASS | 205ms |
...
| testSetTitleRoundTrip | MetadataEditorTest | PASS | 207ms |
| testSetMultipleFieldsRoundTrip | MetadataEditorTest | PASS | 210ms |
| testSetMetadataOnPdfWithoutInfo | MetadataEditorTest | PASS | 203ms |
...
| testPageCount | MetadataEditorTest | PASS | 8ms |
| testEscapeHatch | MetadataEditorTest | PASS | <1ms |
| testCustomField | MetadataEditorTest | PASS | 202ms |
| testSaveToFile | MetadataEditorTest | PASS | 208ms |
| testSetLabelsWithArabic | PageLabelerTest | PASS | 212ms |
| testSetRomanNumerals | PageLabelerTest | PASS | 201ms |
| testSetRomanNumeralsUppercase | PageLabelerTest | PASS | 194ms |
| testSetAlphabetic | PageLabelerTest | PASS | 207ms |
| testSetArabicWithStartNumber | PageLabelerTest | PASS | 201ms |
| testSetLabelsWithPrefix | PageLabelerTest | PASS | 210ms |
| testRemoveLabels | PageLabelerTest | PASS | 221ms |
| testMultipleRanges | PageLabelerTest | PASS | 213ms |
| testGetPageCount | PageLabelerTest | PASS | 1ms |
| testGetReader | PageLabelerTest | PASS | 1ms |
| testSaveToFile | PageLabelerTest | PASS | 210ms |
| testNoBytesChangedWhenNoOperations | PageLabelerTest | PASS | 1ms |
| testOpenFromFile | PageLabelerTest | PASS | 1ms |
| testKeepPages | PageSlicerTest | PASS | 209ms |
| testKeepRange | PageSlicerTest | PASS | 220ms |
| testRemovePages | PageSlicerTest | PASS | 213ms |
| testReorder | PageSlicerTest | PASS | 214ms |
| testReverse | PageSlicerTest | PASS | 212ms |
| testSplit | PageSlicerTest | PASS | 403ms |
| testKeepWithPageSelector | PageSlicerTest | PASS | 205ms |
| testNoOpsKeepsAllPages | PageSlicerTest | PASS | 217ms |
| testPageCount | PageSlicerTest | PASS | 1ms |
| testEscapeHatch | PageSlicerTest | PASS | <1ms |
| testRotateAllPages | PageTransformerTest | PASS | 206ms |
| testRotate180 | PageTransformerTest | PASS | 217ms |
| testRotate270 | PageTransformerTest | PASS | 198ms |
| testRotateSpecificPages | PageTransformerTest | PASS | 213ms |
| testRotateCumulative | PageTransformerTest | PASS | 205ms |
| testRotateInvalidAngle | PageTransformerTest | PASS | <1ms |
| testSetCropBox | PageTransformerTest | PASS | 206ms |
| testSetCropBoxSpecificPage | PageTransformerTest | PASS | 205ms |
| testSetMediaBox | PageTransformerTest | PASS | 214ms |
| testSetTrimBox | PageTransformerTest | PASS | 202ms |
| testSetBleedBox | PageTransformerTest | PASS | 202ms |
| testScale | PageTransformerTest | PASS | 202ms |
| testScaleSpecificPages | PageTransformerTest | PASS | 203ms |
| testScaleInvalidFactor | PageTransformerTest | PASS | <1ms |
| testScaleTo | PageTransformerTest | PASS | 216ms |
| testScaleToNonUniform | PageTransformerTest | PASS | 204ms |
...
| testRange | PageTransformerTest | PASS | 222ms |
| testGetReader | PageTransformerTest | PASS | 7ms |
| testGetPageCount | PageTransformerTest | PASS | <1ms |
| testSaveToFile | PageTransformerTest | PASS | 210ms |
| testEncryptAes128 | PdfEncryptTest | PASS | 214ms |
| testEncryptAes256 | PdfEncryptTest | PASS | 236ms |
| testDecrypt | PdfEncryptTest | PASS | 208ms |
...
| testEncryptRc4128 | PdfEncryptTest | PASS | 4ms |
| testChangePasswordsDefaultsToAes256 | PdfEncryptTest | PASS | 7ms |
| testSetPermissionsBeforeEncrypt | PdfEncryptTest | PASS | 4ms |
...
| testMergeTwoPdfs | PdfMergerTest | PASS | 222ms |
| testMergeWithPageSelection | PdfMergerTest | PASS | 210ms |
...
| testSaveToFile | PdfMergerTest | PASS | 204ms |
| testStampText | PdfStamperTest | PASS | 205ms |
| testWatermark | PdfStamperTest | PASS | 220ms |
| testWatermarkWithStyle | PdfStamperTest | PASS | 220ms |
| testPageNumbers | PdfStamperTest | PASS | 200ms |
| testStampOnSpecificPages | PdfStamperTest | PASS | 207ms |
| testHeaderAndFooter | PdfStamperTest | PASS | 224ms |
| testStampWithOpacity | PdfStamperTest | PASS | 208ms |
...
| testSaveToFile | PdfStamperTest | PASS | 215ms |
| testStampImageJpeg | PdfStamperTest | PASS | 225ms |
| testStampImagePng | PdfStamperTest | PASS | 219ms |
| testStampImageWithScaleWidth | PdfStamperTest | PASS | 218ms |
| testStampImageWithScaleHeight | PdfStamperTest | PASS | 228ms |
| testStampImageWithExplicitDimensions | PdfStamperTest | PASS | 202ms |
| testStampImageWithOpacity | PdfStamperTest | PASS | 206ms |
| testStampImageOnSpecificPages | PdfStamperTest | PASS | 206ms |
| testStampImageCombinedWithText | PdfStamperTest | PASS | 209ms |
...
| testStampPdfWithScaling | PdfStamperTest | PASS | 211ms |
| testStampPdfWithOpacity | PdfStamperTest | PASS | 204ms |
| testStampPdfSpecificPage | PdfStamperTest | PASS | 205ms |
| testStampPdfOnSelectedPages | PdfStamperTest | PASS | 201ms |
| testStampPdfDefaultsToCenter | PdfStamperTest | PASS | 200ms |
| testStampPdfThrowsOnMissingFile | PdfStamperTest | PASS | 1ms |
| testStampPdfThrowsOnInvalidPageIndex | PdfStamperTest | PASS | 2ms |
| testStampPdfThrowsOnNegativePageIndex | PdfStamperTest | PASS | 1ms |
| testImageStampStyleDefaults | PdfStamperTest | PASS | <1ms |
| testRedactArea | TextRedactorTest | PASS | 211ms |
| testRedactMultipleAreas | TextRedactorTest | PASS | 209ms |
| testRedactByText | TextRedactorTest | PASS | 201ms |
| testRedactByPattern | TextRedactorTest | PASS | 1ms |
| testCustomRedactionColor | TextRedactorTest | PASS | 208ms |
...
| testSaveToFile | TextRedactorTest | PASS | 206ms |

### Arlington PDF Model — Dictionary-level spec conformance (keys, types, required fields, version constraints)

**6 tests** | 6 passed | 0 failed | 0 skipped | 1.37s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesBookmarksPdf | BookmarksTest | PASS | 333ms |
| testGeneratesDocumentFeaturesPdf | DocumentFeaturesTest | PASS | 205ms |
...
| testGeneratesSimpleTextPdf | SimpleTextTest | PASS | 203ms |

### veraPDF — PDF/A archival conformance (ISO 19005)

**4 tests** | 3 passed | 0 failed | 1 skipped | 21.09s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWithOutputIntent | PdfAConformanceTest | SKIP | 5ms |
| testVeraPdfToolchainWorks | PdfAConformanceTest | PASS | 2.28s |
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 8.21s |
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 10.6s |
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 19.79s
...
| testQpdfCorpus with data set "qpdf/big-ostream.pdf" | Tier2CorpusTest | PASS | 8ms |
...
| testQpdfCorpus with data set "qpdf/default-da-q.pdf" | Tier2CorpusTest | PASS | 17ms |
...
| testQpdfCorpus with data set "qpdf/issue-202.pdf" | Tier2CorpusTest | PASS | 59ms |
...
| testQpdfCorpus with data set "qpdf/many-nulls.pdf" | Tier2CorpusTest | PASS | 692ms |
...
| testQpdfCorpus with data set "qpdf/resource-from-dr.pdf" | Tier2CorpusTest | PASS | 34ms |
...
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 8.03s |
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 10.1s |
...
| testPdfBoxCorpus with data set "pdfbox/pdfbox/src/test/resources/org/apache/pdfbox/multipdf/PDFBOX-6049-Source.pdf" | Tier2PdfBoxCorpusTest | PASS | 2ms |
...
| testPdfiumCorpus with data set "pdfium/bug_620428.pdf" | Tier2PdfiumCorpusTest | PASS | 7ms |
...
**6 tests** | 6 passed | 0 failed | 0 skipped | 12.29s

| Test | Class | Status | Time |
|---|---|---|---|
| testTaggedDocumentValidatesWithUa1 | Tier3MatterhornTest | PASS | 2.17s |
| testAnnotationWithContentsPassesClause718 | Tier3MatterhornTest | PASS | 2.34s |
| testUntaggedDocumentFailsUa1 | Tier3MatterhornTest | PASS | 1.78s |
| testMissingLangFailsUa1 | Tier3MatterhornTest | PASS | 1.83s |
| testMissingDisplayDocTitleFailsUa1 | Tier3MatterhornTest | PASS | 2.06s |
| testAnnotationWithoutContentsFailsUa1 | Tier3MatterhornTest | PASS | 2.11s |
...
**25 tests** | 24 passed | 0 failed | 1 skipped | 8.9s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWellFormedAndValid | Tier4JhoveTest | PASS | 995ms |
| testMultiPagePdfWellFormedAndValid | Tier4JhoveTest | PASS | 947ms |
| testPdfWithMetadataWellFormedAndValid | Tier4JhoveTest | PASS | 918ms |
| testPdfWithEmbeddedFontWellFormedAndValid | Tier4JhoveTest | PASS | 909ms |
| testJhoveToolchainWorks | Tier4JhoveTest | PASS | 716ms |
| testPdfA1bPassesPdfBoxPreflight | Tier4PdfBoxPreflightTest | SKIP | <1ms |
| testPdfBoxPreflightToolchainWorks | Tier4PdfBoxPreflightTest | PASS | 858ms |
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 595ms |
| testPdfWithMetadataHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 579ms |
| testPdfWithEmbeddedFontHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 566ms |
| testPdfIdToolchainWorks | Tier4PdfIdTest | PASS | 370ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 UTF-8 string and annotation.pdf" | Tier4Pdf20ExamplesTest | PASS | 207ms |
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 image with BPC.pdf" | Tier4Pdf20ExamplesTest | PASS | 203ms |
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 via incremental save.pdf" | Tier4Pdf20ExamplesTest | PASS | 210ms |
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 with offset start.pdf" | Tier4Pdf20ExamplesTest | PASS | 207ms |
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 with page level output intent.pdf" | Tier4Pdf20ExamplesTest | PASS | 205ms |
| testPdf20ExampleQpdfValid with data set "pdf20/Simple PDF 2.0 file.pdf" | Tier4Pdf20ExamplesTest | PASS | 203ms |
| testPdf20ExampleQpdfValid with data set "pdf20/pdf20-utf8-test.pdf" | Tier4Pdf20ExamplesTest | PASS | 203ms |
