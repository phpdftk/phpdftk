...
Generated: 2026-06-17 03:33:16 UTC
PHP: 8.4.22
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 91.93s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 34.23s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.28s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 18.12s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 18.83s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 11.29s |
| &#x2705; JHOVE + PDF 2.0 + Security + Preflight | PASS | 25 | 24 | 0 | 1 | 8.17s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 34.23s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 300ms |
| testGeneratesAnnotationsPdf | AnnotationsTest | PASS | 189ms |
...
| testGeneratesPdfWithEmbeddedFont | EmbeddedFontsTest | PASS | 205ms |
...
| testGeneratesGraphicsPipelinePdf | GraphicsPipelineIntegrationTest | PASS | 186ms |
| testGeneratesGraphicsPdf | GraphicsTest | PASS | 210ms |
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 478ms |
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 324ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 348ms |
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 185ms |
...
| testGeneratesMultimediaAnd3DPdf | MultimediaAndThreeDIntegrationTest | PASS | 204ms |
...
| testGeneratesSignatureFieldPdf | SignatureFieldIntegrationTest | PASS | 213ms |
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 522ms |
| testGeneratesSimpleTextPdf | SimpleTextTest | PASS | 215ms |
| testGeneratesPdfWithType3Font | Type3FontIntegrationTest | PASS | 207ms |
| testGeneratesPdfWithXrefAndObjectStreams | XRefStreamIntegrationTest | PASS | 215ms |
...
| testNoteCalloutEmitsLabelAndBody | CalloutTest | PASS | 207ms |
...
| testWinAnsiRoundTripFromShowText | EncodingIntegrationTest | PASS | 213ms |
| testHighLevelPdfRoundTrip | EncodingIntegrationTest | PASS | 5ms |
| testAddTextWithLinkStyleProducesLinkAnnotation | InlineLinkTest | PASS | 219ms |
...
| testShowPageNumbersDefaultFormat | PageNumbersTest | PASS | 219ms |
...
| testAddPageDelegatesToWriter | PdfDocTest | PASS | 203ms |
...
| testGeneratesHighLevelDocument | PdfIntegrationTest | PASS | 444ms |
| testAddHtmlRendersIntoPdf | PdfTest | PASS | 40ms |
| testEmptyDocumentHasNoPages | PdfTest | PASS | 206ms |
| testAddTextCreatesFirstPageAutomatically | PdfTest | PASS | 209ms |
| testAddHeadingEmitsLargerText | PdfTest | PASS | 213ms |
| testExplicitNewPageCreatesSecondPage | PdfTest | PASS | 202ms |
| testLongTextAutoPaginates | PdfTest | PASS | 215ms |
| testAddSpacerConsumesVerticalSpace | PdfTest | PASS | 194ms |
| testAddRuleDrawsStroke | PdfTest | PASS | 210ms |
| testAlignmentCenterEmitsCenteredText | PdfTest | PASS | 204ms |
| testSetFontSwitchesFontFamily | PdfTest | PASS | 214ms |
| testBoldAndItalicResolveToCorrectPostScriptName | PdfTest | PASS | 218ms |
| testUnknownFamilyIsRejected | PdfTest | PASS | <1ms |
| testCustomTheme | PdfTest | PASS | 206ms |
| testSaveWritesFile | PdfTest | PASS | 213ms |
| testWriteToStream | PdfTest | PASS | 217ms |
| testWriteToRejectsNonResource | PdfTest | PASS | <1ms |
| testToBytesProducesValidPdfOnEachCall | PdfTest | PASS | 419ms |
...
| testUnderlineEmitsStrokeBelowBaseline | TextDecorationTest | PASS | 195ms |
...
| testAddCompositeFontGeneratesValidPdf | UnicodeFontTest | PASS | 221ms |
| testAddCompositeFontSavesToFile | UnicodeFontTest | PASS | 196ms |
| testCompositeFontRoundTripsThroughReader | UnicodeFontTest | PASS | 201ms |
| testCompositeFontAppearsInFontList | UnicodeFontTest | PASS | 5ms |
| testShowTextHexOperator | UnicodeFontTest | PASS | <1ms |
| testCompositeFontPerPage | UnicodeFontTest | PASS | 197ms |
...
| testPdfWriterAddContentStream | WriterTest | PASS | 202ms |
...
| testPdfWriterSavesToFile | WriterTest | PASS | 206ms |
| testPdfWriterContainsXref | WriterTest | PASS | 197ms |
| testPdfWriterContainsTrailer | WriterTest | PASS | <1ms |
| testPdfWriterAddPageWithRectangle | WriterTest | PASS | 205ms |
| testPdfWriterRegisterObject | WriterTest | PASS | 189ms |
| testPdfWriterFontAddedToPage | WriterTest | PASS | 194ms |
| testSetNamedDestinations | WriterTest | PASS | 193ms |
| testSetEncryptionProducesEncryptedPdf | WriterTest | PASS | 216ms |
| testSetEncryptionAes256RoundTrip | WriterTest | PASS | 246ms |
| testSetMetadataAddsStreamToPdf | XmpMetadataTest | PASS | 211ms |
...
| testSyncInfoToMetadataNoInfoIsNoOp | XmpMetadataTest | PASS | 205ms |
...
| testFillTextField | FormFillerTest | PASS | 208ms |
| testFillManyFields | FormFillerTest | PASS | 203ms |
| testCheckCheckbox | FormFillerTest | PASS | 209ms |
| testUncheckCheckbox | FormFillerTest | PASS | 199ms |
| testSelectChoiceField | FormFillerTest | PASS | 197ms |
...
| testSaveWritesFile | FormFillerTest | PASS | 212ms |
| testEscapeHatch | FormFillerTest | PASS | 2ms |
| testRoundTripPreservesOtherFields | FormFillerTest | PASS | 209ms |
...
| testSetTitleRoundTrip | MetadataEditorTest | PASS | 205ms |
| testSetMultipleFieldsRoundTrip | MetadataEditorTest | PASS | 207ms |
| testSetMetadataOnPdfWithoutInfo | MetadataEditorTest | PASS | 206ms |
...
| testSaveToFile | MetadataEditorTest | PASS | 215ms |
| testSetLabelsWithArabic | PageLabelerTest | PASS | 189ms |
| testSetRomanNumerals | PageLabelerTest | PASS | 185ms |
...
| testSetLabelsWithPrefix | PageLabelerTest | PASS | 218ms |
| testRemoveLabels | PageLabelerTest | PASS | 212ms |
| testMultipleRanges | PageLabelerTest | PASS | 211ms |
| testGetPageCount | PageLabelerTest | PASS | 1ms |
| testGetReader | PageLabelerTest | PASS | <1ms |
| testSaveToFile | PageLabelerTest | PASS | 216ms |
| testNoBytesChangedWhenNoOperations | PageLabelerTest | PASS | 1ms |
| testOpenFromFile | PageLabelerTest | PASS | 2ms |
| testKeepPages | PageSlicerTest | PASS | 204ms |
| testKeepRange | PageSlicerTest | PASS | 239ms |
| testRemovePages | PageSlicerTest | PASS | 204ms |
| testReorder | PageSlicerTest | PASS | 201ms |
| testReverse | PageSlicerTest | PASS | 185ms |
| testSplit | PageSlicerTest | PASS | 364ms |
...
| testRotateSpecificPages | PageTransformerTest | PASS | 193ms |
| testRotateCumulative | PageTransformerTest | PASS | 188ms |
| testRotateInvalidAngle | PageTransformerTest | PASS | <1ms |
| testSetCropBox | PageTransformerTest | PASS | 179ms |
| testSetCropBoxSpecificPage | PageTransformerTest | PASS | 218ms |
...
| testScale | PageTransformerTest | PASS | 211ms |
...
| testScaleToNonUniform | PageTransformerTest | PASS | 192ms |
...
| testRange | PageTransformerTest | PASS | 183ms |
...
| testStampText | PdfStamperTest | PASS | 186ms |
...
| testStampWithOpacity | PdfStamperTest | PASS | 187ms |
...
| testStampImageJpeg | PdfStamperTest | PASS | 223ms |
| testStampImagePng | PdfStamperTest | PASS | 193ms |
...
| testStampImageOnSpecificPages | PdfStamperTest | PASS | 184ms |
...
| testStampPdf | PdfStamperTest | PASS | 182ms |
| testStampPdfWithScaling | PdfStamperTest | PASS | 190ms |
| testStampPdfWithOpacity | PdfStamperTest | PASS | 184ms |
| testStampPdfSpecificPage | PdfStamperTest | PASS | 193ms |
...
| testRedactArea | TextRedactorTest | PASS | 202ms |
...
**4 tests** | 3 passed | 0 failed | 1 skipped | 18.12s
...
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 9.08s |
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 18.83s
...
| testQpdfCorpus with data set "qpdf/default-da-q.pdf" | Tier2CorpusTest | PASS | 13ms |
...
| testQpdfCorpus with data set "qpdf/many-nulls.pdf" | Tier2CorpusTest | PASS | 730ms |
...
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 7.37s |
...
**25 tests** | 24 passed | 0 failed | 1 skipped | 8.17s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWellFormedAndValid | Tier4JhoveTest | PASS | 931ms |
| testMultiPagePdfWellFormedAndValid | Tier4JhoveTest | PASS | 861ms |
| testPdfWithMetadataWellFormedAndValid | Tier4JhoveTest | PASS | 871ms |
| testPdfWithEmbeddedFontWellFormedAndValid | Tier4JhoveTest | PASS | 868ms |
| testJhoveToolchainWorks | Tier4JhoveTest | PASS | 672ms |
| testPdfA1bPassesPdfBoxPreflight | Tier4PdfBoxPreflightTest | SKIP | <1ms |
| testPdfBoxPreflightToolchainWorks | Tier4PdfBoxPreflightTest | PASS | 739ms |
...
| testPdfIdToolchainWorks | Tier4PdfIdTest | PASS | 337ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 UTF-8 string and annotation.pdf" | Tier4Pdf20ExamplesTest | PASS | 174ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 with page level output intent.pdf" | Tier4Pdf20ExamplesTest | PASS | 188ms |
| testPdf20ExampleQpdfValid with data set "pdf20/Simple PDF 2.0 file.pdf" | Tier4Pdf20ExamplesTest | PASS | 195ms |
| testPdf20ExampleQpdfValid with data set "pdf20/pdf20-utf8-test.pdf" | Tier4Pdf20ExamplesTest | PASS | 185ms |
