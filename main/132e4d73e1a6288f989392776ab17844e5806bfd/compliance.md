...
Generated: 2026-06-13 07:18:37 UTC
PHP: 8.4.22
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 81.45s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 27.96s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.11s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 18.1s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 16.68s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 10.41s |
| &#x2705; JHOVE + PDF 2.0 + Security + Preflight | PASS | 25 | 24 | 0 | 1 | 7.19s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 27.96s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 262ms |
| testGeneratesAnnotationsPdf | AnnotationsTest | PASS | 162ms |
| testGeneratesBookmarksPdf | BookmarksTest | PASS | 203ms |
| testGeneratesFormWithCustomFontAppearances | CustomFontFormAppearancesTest | PASS | 246ms |
...
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 438ms |
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 119ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 129ms |
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 188ms |
...
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 329ms |
| testGeneratesSimpleTextPdf | SimpleTextTest | PASS | 165ms |
| testGeneratesPdfWithType3Font | Type3FontIntegrationTest | PASS | 162ms |
| testGeneratesPdfWithXrefAndObjectStreams | XRefStreamIntegrationTest | PASS | 172ms |
| testEnableOutlineThenHeadingRegistersOutlinesEntry | AutoOutlineTest | PASS | 173ms |
...
| testNoteCalloutEmitsLabelAndBody | CalloutTest | PASS | 172ms |
...
| testWinAnsiRoundTripFromShowText | EncodingIntegrationTest | PASS | 165ms |
...
| testAddPageDelegatesToWriter | PdfDocTest | PASS | 167ms |
...
| testExplicitNewPageCreatesSecondPage | PdfTest | PASS | 162ms |
| testLongTextAutoPaginates | PdfTest | PASS | 167ms |
| testAddSpacerConsumesVerticalSpace | PdfTest | PASS | 156ms |
| testAddRuleDrawsStroke | PdfTest | PASS | 164ms |
| testAlignmentCenterEmitsCenteredText | PdfTest | PASS | 157ms |
| testSetFontSwitchesFontFamily | PdfTest | PASS | 158ms |
| testBoldAndItalicResolveToCorrectPostScriptName | PdfTest | PASS | 174ms |
| testUnknownFamilyIsRejected | PdfTest | PASS | <1ms |
| testCustomTheme | PdfTest | PASS | 167ms |
| testSaveWritesFile | PdfTest | PASS | 159ms |
| testWriteToStream | PdfTest | PASS | 168ms |
| testWriteToRejectsNonResource | PdfTest | PASS | <1ms |
| testToBytesProducesValidPdfOnEachCall | PdfTest | PASS | 329ms |
...
| testAddTableRendersAllCellValues | TableTest | PASS | 172ms |
...
| testAddCompositeFontSavesToFile | UnicodeFontTest | PASS | 170ms |
...
| testPdfWriterGeneratesValidPdfHeader | WriterTest | PASS | 166ms |
...
| testPdfWriterContainsPage | WriterTest | PASS | 174ms |
...
| testPdfWriterWithInfo | WriterTest | PASS | 174ms |
...
| testSetNamedDestinations | WriterTest | PASS | 167ms |
| testSetEncryptionProducesEncryptedPdf | WriterTest | PASS | 174ms |
| testSetEncryptionAes256RoundTrip | WriterTest | PASS | 186ms |
| testSetMetadataAddsStreamToPdf | XmpMetadataTest | PASS | 162ms |
| testMetadataStreamContainsXmp | XmpMetadataTest | PASS | 159ms |
| testMetadataRoundTrip | XmpMetadataTest | PASS | 161ms |
| testSyncInfoToMetadata | XmpMetadataTest | PASS | 166ms |
| testSyncInfoToMetadataNoInfoIsNoOp | XmpMetadataTest | PASS | 162ms |
...
| testSaveToFile | AnnotationFlattenerTest | PASS | 169ms |
...
| testSetBookmarksWithChildren | BookmarkEditorTest | PASS | 163ms |
| testAddBookmark | BookmarkEditorTest | PASS | 331ms |
| testHasBookmarksReturnsFalseForCleanPdf | BookmarkEditorTest | PASS | <1ms |
| testRemoveBookmarks | BookmarkEditorTest | PASS | 167ms |
...
| testFillTextField | FormFillerTest | PASS | 165ms |
...
| testFillMultipleFieldTypes | FormFillerTest | PASS | 160ms |
...
| testKeepRange | PageSlicerTest | PASS | 163ms |
| testRemovePages | PageSlicerTest | PASS | 159ms |
| testReorder | PageSlicerTest | PASS | 165ms |
| testReverse | PageSlicerTest | PASS | 155ms |
| testSplit | PageSlicerTest | PASS | 317ms |
| testKeepWithPageSelector | PageSlicerTest | PASS | 166ms |
...
| testRotate180 | PageTransformerTest | PASS | 162ms |
| testRotate270 | PageTransformerTest | PASS | 162ms |
| testRotateSpecificPages | PageTransformerTest | PASS | 166ms |
| testRotateCumulative | PageTransformerTest | PASS | 160ms |
| testRotateInvalidAngle | PageTransformerTest | PASS | <1ms |
| testSetCropBox | PageTransformerTest | PASS | 163ms |
| testSetCropBoxSpecificPage | PageTransformerTest | PASS | 166ms |
...
| testScale | PageTransformerTest | PASS | 172ms |
| testScaleSpecificPages | PageTransformerTest | PASS | 164ms |
| testScaleInvalidFactor | PageTransformerTest | PASS | <1ms |
| testScaleTo | PageTransformerTest | PASS | 161ms |
| testScaleToNonUniform | PageTransformerTest | PASS | 209ms |
| testMultipleOperations | PageTransformerTest | PASS | 167ms |
| testNoBytesChangedWithoutOperations | PageTransformerTest | PASS | <1ms |
| testEvenPages | PageTransformerTest | PASS | 162ms |
| testOddPages | PageTransformerTest | PASS | 162ms |
...
| testDecrypt | PdfEncryptTest | PASS | 166ms |
...
| testMergeWithPageSelection | PdfMergerTest | PASS | 169ms |
...
| testWatermark | PdfStamperTest | PASS | 164ms |
| testWatermarkWithStyle | PdfStamperTest | PASS | 158ms |
| testPageNumbers | PdfStamperTest | PASS | 171ms |
| testStampOnSpecificPages | PdfStamperTest | PASS | 168ms |
| testHeaderAndFooter | PdfStamperTest | PASS | 164ms |
...
| testStampPdf | PdfStamperTest | PASS | 158ms |
| testStampPdfWithScaling | PdfStamperTest | PASS | 156ms |
| testStampPdfWithOpacity | PdfStamperTest | PASS | 164ms |
| testStampPdfSpecificPage | PdfStamperTest | PASS | 168ms |
| testStampPdfOnSelectedPages | PdfStamperTest | PASS | 165ms |
| testStampPdfDefaultsToCenter | PdfStamperTest | PASS | 171ms |
| testStampPdfThrowsOnMissingFile | PdfStamperTest | PASS | <1ms |
| testStampPdfThrowsOnInvalidPageIndex | PdfStamperTest | PASS | 4ms |
...
| testRedactByText | TextRedactorTest | PASS | 162ms |
...
| testVeraPdfToolchainWorks | PdfAConformanceTest | PASS | 2.06s |
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 7.12s |
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 8.91s |
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 16.68s
...
| testQpdfCorpus with data set "qpdf/direct-outlines.pdf" | Tier2CorpusTest | PASS | 11ms |
...
| testQpdfCorpus with data set "qpdf/sample-form-out.pdf" | Tier2CorpusTest | PASS | 29ms |
...
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 7.21s |
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 8.12s |
...
| testPdfiumCorpus with data set "pdfium/bug_707673.pdf" | Tier2PdfiumCorpusTest | PASS | 11ms |
...
**6 tests** | 6 passed | 0 failed | 0 skipped | 10.41s
...
| testMissingLangFailsUa1 | Tier3MatterhornTest | PASS | 1.55s |
| testMissingDisplayDocTitleFailsUa1 | Tier3MatterhornTest | PASS | 1.75s |
| testAnnotationWithoutContentsFailsUa1 | Tier3MatterhornTest | PASS | 1.59s |
...
**25 tests** | 24 passed | 0 failed | 1 skipped | 7.19s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWellFormedAndValid | Tier4JhoveTest | PASS | 851ms |
| testMultiPagePdfWellFormedAndValid | Tier4JhoveTest | PASS | 781ms |
| testPdfWithMetadataWellFormedAndValid | Tier4JhoveTest | PASS | 773ms |
| testPdfWithEmbeddedFontWellFormedAndValid | Tier4JhoveTest | PASS | 779ms |
| testJhoveToolchainWorks | Tier4JhoveTest | PASS | 601ms |
| testPdfA1bPassesPdfBoxPreflight | Tier4PdfBoxPreflightTest | SKIP | <1ms |
| testPdfBoxPreflightToolchainWorks | Tier4PdfBoxPreflightTest | PASS | 689ms |
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 461ms |
| testPdfWithMetadataHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 439ms |
| testPdfWithEmbeddedFontHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 436ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 with page level output intent.pdf" | Tier4Pdf20ExamplesTest | PASS | 158ms |
