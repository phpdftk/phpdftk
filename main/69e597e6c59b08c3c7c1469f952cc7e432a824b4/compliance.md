...
Generated: 2026-06-25 01:48:40 UTC
PHP: 8.4.22
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 33.09s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 699ms |
...
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 342ms |
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 171ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 426ms |
...
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 376ms |
...
| testMultipleRanges | PageLabelerTest | PASS | 207ms |
...
| testStampText | PdfStamperTest | PASS | 202ms |
...
| testVeraPdfToolchainWorks | PdfAConformanceTest | PASS | 2.35s |
...
| testQpdfCorpus with data set "qpdf/copy-foreign-objects-in.pdf" | Tier2CorpusTest | PASS | 10ms |
...
**6 tests** | 6 passed | 0 failed | 0 skipped | 12.42s

| Test | Class | Status | Time |
|---|---|---|---|
| testTaggedDocumentValidatesWithUa1 | Tier3MatterhornTest | PASS | 2.28s |
| testAnnotationWithContentsPassesClause718 | Tier3MatterhornTest | PASS | 2.23s |
| testUntaggedDocumentFailsUa1 | Tier3MatterhornTest | PASS | 1.89s |
| testMissingLangFailsUa1 | Tier3MatterhornTest | PASS | 2.01s |
...
| testMultiPagePdfWellFormedAndValid | Tier4JhoveTest | PASS | 890ms |
| testPdfWithMetadataWellFormedAndValid | Tier4JhoveTest | PASS | 903ms |
...
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 552ms |
