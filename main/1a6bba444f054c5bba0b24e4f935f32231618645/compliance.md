...
Generated: 2026-06-10 19:31:45 UTC
PHP: 8.4.21
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 92.93s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 33.14s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.27s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 19.66s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 18.9s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 11.48s |
| &#x2705; JHOVE + PDF 2.0 + Security + Preflight | PASS | 25 | 24 | 0 | 1 | 8.47s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 33.14s
...
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 266ms |
...
| testNoDecorationByDefaultEmitsNoStroke | TextDecorationTest | PASS | 8ms |
...
| testPdfWriterAddContentStream | WriterTest | PASS | 192ms |
...
| testSetEncryptionAes256RoundTrip | WriterTest | PASS | 220ms |
...
| testWatermark | PdfStamperTest | PASS | 200ms |
...
| testStampImageJpeg | PdfStamperTest | PASS | 218ms |
...
| testStampImageCombinedWithText | PdfStamperTest | PASS | 203ms |
| testStampImageThrowsOnMissingFile | PdfStamperTest | PASS | <1ms |
| testStampImageThrowsOnUnsupportedFormat | PdfStamperTest | PASS | <1ms |
| testStampPdf | PdfStamperTest | PASS | 216ms |
| testStampPdfWithScaling | PdfStamperTest | PASS | 228ms |
...
| testRedactByText | TextRedactorTest | PASS | 184ms |
...
**4 tests** | 3 passed | 0 failed | 1 skipped | 19.66s
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 18.9s
...
| testQpdfCorpus with data set "qpdf/enc-XI-base.pdf" | Tier2CorpusTest | PASS | 14ms |
...
| testQpdfCorpus with data set "qpdf/issue-202.pdf" | Tier2CorpusTest | PASS | 64ms |
...
| testQpdfCorpus with data set "qpdf/many-nulls.pdf" | Tier2CorpusTest | PASS | 708ms |
...
| testQpdfCorpus with data set "qpdf/shared-form-images.pdf" | Tier2CorpusTest | PASS | 29ms |
...
| testPdfiumCorpus with data set "pdfium/bug_925981.pdf" | Tier2PdfiumCorpusTest | PASS | 7ms |
...
**6 tests** | 6 passed | 0 failed | 0 skipped | 11.48s
...
| testMissingDisplayDocTitleFailsUa1 | Tier3MatterhornTest | PASS | 1.89s |
...
**25 tests** | 24 passed | 0 failed | 1 skipped | 8.47s
...
| testPdfWithEmbeddedFontWellFormedAndValid | Tier4JhoveTest | PASS | 878ms |
| testJhoveToolchainWorks | Tier4JhoveTest | PASS | 690ms |
| testPdfA1bPassesPdfBoxPreflight | Tier4PdfBoxPreflightTest | SKIP | <1ms |
| testPdfBoxPreflightToolchainWorks | Tier4PdfBoxPreflightTest | PASS | 808ms |
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 608ms |
| testPdfWithMetadataHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 537ms |
| testPdfWithEmbeddedFontHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 535ms |
