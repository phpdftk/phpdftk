...
Generated: 2026-05-25 01:19:41 UTC
PHP: 8.4.21
...
**Overall: PASS** | 1662 tests | 1656 passed | 0 failed | 6 skipped | 88.99s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 454 | 450 | 0 | 4 | 32.42s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.27s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 17.96s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 17.8s |
...
**454 tests** | 450 passed | 0 failed | 4 skipped | 32.42s
...
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 222ms |
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 447ms |
...
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 620ms |
...
**4 tests** | 3 passed | 0 failed | 1 skipped | 17.96s
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 17.8s
...
| testQpdfCorpus with data set "qpdf/empty-stream-compressed.pdf" | Tier2CorpusTest | PASS | 9ms |
...
| testQpdfCorpus with data set "qpdf/nontrivial-crypt-filter-decrypted.pdf" | Tier2CorpusTest | PASS | 27ms |
...
| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWellFormedAndValid | Tier4JhoveTest | PASS | 916ms |
...
| testPdfWithEmbeddedFontWellFormedAndValid | Tier4JhoveTest | PASS | 830ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 with page level output intent.pdf" | Tier4Pdf20ExamplesTest | PASS | 176ms |
