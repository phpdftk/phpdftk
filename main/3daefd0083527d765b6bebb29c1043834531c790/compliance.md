...
Generated: 2026-06-17 02:45:18 UTC
PHP: 8.4.22
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 98.28s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 33.99s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.32s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 20.99s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 20.89s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 12.45s |
| &#x2705; JHOVE + PDF 2.0 + Security + Preflight | PASS | 25 | 24 | 0 | 1 | 8.63s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 33.99s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 663ms |
...
| testGeneratesPdfWithEmbeddedFont | EmbeddedFontsTest | PASS | 213ms |
...
| testGeneratesExtGStatePdf | ExtGStateIntegrationTest | PASS | 198ms |
...
| testGeneratesGraphicsPdf | GraphicsTest | PASS | 206ms |
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 376ms |
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 247ms |
...
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 299ms |
...
| testAddRuleDrawsStroke | PdfTest | PASS | 208ms |
| testAlignmentCenterEmitsCenteredText | PdfTest | PASS | 206ms |
...
| testWriteToStream | PdfTest | PASS | 197ms |
| testWriteToRejectsNonResource | PdfTest | PASS | <1ms |
| testToBytesProducesValidPdfOnEachCall | PdfTest | PASS | 395ms |
...
| testAddCompositeFontGeneratesValidPdf | UnicodeFontTest | PASS | 210ms |
...
| testCompositeFontPerPage | UnicodeFontTest | PASS | 214ms |
...
| testPdfWriterContainsPage | WriterTest | PASS | 199ms |
...
| testSetEncryptionAes256RoundTrip | WriterTest | PASS | 227ms |
| testSetMetadataAddsStreamToPdf | XmpMetadataTest | PASS | 210ms |
...
| testSyncInfoToMetadataNoInfoIsNoOp | XmpMetadataTest | PASS | 204ms |
...
| testSetBookmarksWithChildren | BookmarkEditorTest | PASS | 210ms |
...
| testSetRomanNumerals | PageLabelerTest | PASS | 210ms |
| testSetRomanNumeralsUppercase | PageLabelerTest | PASS | 210ms |
| testSetAlphabetic | PageLabelerTest | PASS | 190ms |
| testSetArabicWithStartNumber | PageLabelerTest | PASS | 212ms |
| testSetLabelsWithPrefix | PageLabelerTest | PASS | 206ms |
| testRemoveLabels | PageLabelerTest | PASS | 223ms |
| testMultipleRanges | PageLabelerTest | PASS | 216ms |
| testGetPageCount | PageLabelerTest | PASS | <1ms |
| testGetReader | PageLabelerTest | PASS | <1ms |
| testSaveToFile | PageLabelerTest | PASS | 205ms |
| testNoBytesChangedWhenNoOperations | PageLabelerTest | PASS | 1ms |
| testOpenFromFile | PageLabelerTest | PASS | 1ms |
| testKeepPages | PageSlicerTest | PASS | 216ms |
| testKeepRange | PageSlicerTest | PASS | 204ms |
| testRemovePages | PageSlicerTest | PASS | 223ms |
| testReorder | PageSlicerTest | PASS | 192ms |
| testReverse | PageSlicerTest | PASS | 190ms |
| testSplit | PageSlicerTest | PASS | 394ms |
| testKeepWithPageSelector | PageSlicerTest | PASS | 202ms |
| testNoOpsKeepsAllPages | PageSlicerTest | PASS | 200ms |
| testPageCount | PageSlicerTest | PASS | <1ms |
| testEscapeHatch | PageSlicerTest | PASS | <1ms |
| testRotateAllPages | PageTransformerTest | PASS | 202ms |
| testRotate180 | PageTransformerTest | PASS | 187ms |
| testRotate270 | PageTransformerTest | PASS | 196ms |
...
| testSetBleedBox | PageTransformerTest | PASS | 196ms |
| testScale | PageTransformerTest | PASS | 205ms |
...
| testMultipleOperations | PageTransformerTest | PASS | 208ms |
...
| testRange | PageTransformerTest | PASS | 203ms |
| testGetReader | PageTransformerTest | PASS | 5ms |
| testGetPageCount | PageTransformerTest | PASS | <1ms |
| testSaveToFile | PageTransformerTest | PASS | 205ms |
| testEncryptAes128 | PdfEncryptTest | PASS | 204ms |
...
| testSaveToFile | PdfMergerTest | PASS | 215ms |
...
| testPageNumbers | PdfStamperTest | PASS | 204ms |
...
| testStampImageJpeg | PdfStamperTest | PASS | 209ms |
| testStampImagePng | PdfStamperTest | PASS | 207ms |
...
| testStampPdfWithOpacity | PdfStamperTest | PASS | 193ms |
| testStampPdfSpecificPage | PdfStamperTest | PASS | 193ms |
| testStampPdfOnSelectedPages | PdfStamperTest | PASS | 210ms |
| testStampPdfDefaultsToCenter | PdfStamperTest | PASS | 201ms |
...
| testRedactMultipleAreas | TextRedactorTest | PASS | 201ms |
...
**6 tests** | 6 passed | 0 failed | 0 skipped | 1.32s
...
**4 tests** | 3 passed | 0 failed | 1 skipped | 20.99s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWithOutputIntent | PdfAConformanceTest | SKIP | 5ms |
| testVeraPdfToolchainWorks | PdfAConformanceTest | PASS | 2.32s |
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 8.11s |
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 10.56s |
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 20.89s
...
| testQpdfCorpus with data set "qpdf/many-nulls.pdf" | Tier2CorpusTest | PASS | 684ms |
...
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 11.26s |
...
| testPdfiumCorpus with data set "pdfium/bug_620428.pdf" | Tier2PdfiumCorpusTest | PASS | 8ms |
...
**6 tests** | 6 passed | 0 failed | 0 skipped | 12.45s

| Test | Class | Status | Time |
|---|---|---|---|
| testTaggedDocumentValidatesWithUa1 | Tier3MatterhornTest | PASS | 2.36s |
...
| testMissingLangFailsUa1 | Tier3MatterhornTest | PASS | 2.05s |
| testMissingDisplayDocTitleFailsUa1 | Tier3MatterhornTest | PASS | 2.04s |
...
**25 tests** | 24 passed | 0 failed | 1 skipped | 8.63s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWellFormedAndValid | Tier4JhoveTest | PASS | 1.02s |
| testMultiPagePdfWellFormedAndValid | Tier4JhoveTest | PASS | 915ms |
| testPdfWithMetadataWellFormedAndValid | Tier4JhoveTest | PASS | 904ms |
| testPdfWithEmbeddedFontWellFormedAndValid | Tier4JhoveTest | PASS | 911ms |
| testJhoveToolchainWorks | Tier4JhoveTest | PASS | 714ms |
| testPdfA1bPassesPdfBoxPreflight | Tier4PdfBoxPreflightTest | SKIP | <1ms |
| testPdfBoxPreflightToolchainWorks | Tier4PdfBoxPreflightTest | PASS | 810ms |
