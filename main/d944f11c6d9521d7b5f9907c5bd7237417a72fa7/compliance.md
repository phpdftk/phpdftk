...
Generated: 2026-06-10 02:47:07 UTC
PHP: 8.4.21
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 93.29s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 33.04s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.31s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 19.32s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 18.97s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 12.26s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 33.04s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 315ms |
| testGeneratesAnnotationsPdf | AnnotationsTest | PASS | 185ms |
| testGeneratesBookmarksPdf | BookmarksTest | PASS | 247ms |
| testGeneratesFormWithCustomFontAppearances | CustomFontFormAppearancesTest | PASS | 293ms |
...
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 157ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 114ms |
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 132ms |
...
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 334ms |
| testGeneratesSimpleTextPdf | SimpleTextTest | PASS | 215ms |
| testGeneratesPdfWithType3Font | Type3FontIntegrationTest | PASS | 205ms |
...
| testEachTypeUsesItsOwnBarColor | CalloutTest | PASS | 13ms |
...
| testSetTitleRoundTrip | MetadataEditorTest | PASS | 208ms |
...
| testSetArabicWithStartNumber | PageLabelerTest | PASS | 214ms |
| testSetLabelsWithPrefix | PageLabelerTest | PASS | 215ms |
...
| testRotate180 | PageTransformerTest | PASS | 204ms |
...
| testScaleSpecificPages | PageTransformerTest | PASS | 212ms |
| testScaleInvalidFactor | PageTransformerTest | PASS | <1ms |
| testScaleTo | PageTransformerTest | PASS | 208ms |
...
| testStampImageWithScaleWidth | PdfStamperTest | PASS | 206ms |
...
| testStampPdfWithOpacity | PdfStamperTest | PASS | 200ms |
...
| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesBookmarksPdf | BookmarksTest | PASS | 334ms |
...
**4 tests** | 3 passed | 0 failed | 1 skipped | 19.32s
...
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 10.13s |
...
| testQpdfCorpus with data set "qpdf/good19.pdf" | Tier2CorpusTest | PASS | 10ms |
...
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 7.66s |
...
**6 tests** | 6 passed | 0 failed | 0 skipped | 12.26s
...
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 615ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/Simple PDF 2.0 file.pdf" | Tier4Pdf20ExamplesTest | PASS | 174ms |
