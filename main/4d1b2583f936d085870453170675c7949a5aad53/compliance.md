...
Generated: 2026-06-10 15:33:59 UTC
PHP: 8.4.21
...
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 32.98s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.29s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 20.72s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 20.03s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 12.03s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 32.98s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 352ms |
...
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 315ms |
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 445ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 121ms |
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 484ms |
...
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 305ms |
| testGeneratesSimpleTextPdf | SimpleTextTest | PASS | 202ms |
| testGeneratesPdfWithType3Font | Type3FontIntegrationTest | PASS | 201ms |
...
| testToBytesProducesValidPdfOnEachCall | PdfTest | PASS | 358ms |
...
| testSetRomanNumerals | PageLabelerTest | PASS | 207ms |
...
| testSplit | PageSlicerTest | PASS | 393ms |
...
| testStampImageJpeg | PdfStamperTest | PASS | 232ms |
...
| testStampPdfWithOpacity | PdfStamperTest | PASS | 199ms |
...
**4 tests** | 3 passed | 0 failed | 1 skipped | 20.72s
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 20.03s
...
| testQpdfCorpus with data set "qpdf/good17-not-recompressed.pdf" | Tier2CorpusTest | PASS | 13ms |
...
| testQpdfCorpus with data set "qpdf/many-nulls.pdf" | Tier2CorpusTest | PASS | 688ms |
...
| testQpdfCorpus with data set "qpdf/update-stream-dict-only-updated.pdf" | Tier2CorpusTest | PASS | 28ms |
...
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 10.45s |
...
| testPdfiumCorpus with data set "pdfium/xfa/email_recommended.pdf" | Tier2PdfiumCorpusTest | PASS | 8ms |
...
**6 tests** | 6 passed | 0 failed | 0 skipped | 12.03s
...
| testPdfWithEmbeddedFontWellFormedAndValid | Tier4JhoveTest | PASS | 891ms |
...
| testPdfWithEmbeddedFontHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 571ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 UTF-8 string and annotation.pdf" | Tier4Pdf20ExamplesTest | PASS | 197ms |
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 image with BPC.pdf" | Tier4Pdf20ExamplesTest | PASS | 206ms |
