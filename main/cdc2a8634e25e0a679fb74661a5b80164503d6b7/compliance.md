...
Generated: 2026-06-10 13:45:02 UTC
PHP: 8.4.21
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 90.16s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 31.69s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.25s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 18.26s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 18.8s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 11.93s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 31.69s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 287ms |
...
| testGeneratesExtGStatePdf | ExtGStateIntegrationTest | PASS | 179ms |
...
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 553ms |
...
| testSyncInfoToMetadata | XmpMetadataTest | PASS | 177ms |
...
| testSetBookmarksWithChildren | BookmarkEditorTest | PASS | 179ms |
| testAddBookmark | BookmarkEditorTest | PASS | 357ms |
...
| testReplaceExistingBookmarks | BookmarkEditorTest | PASS | 181ms |
...
| testKeepRange | PageSlicerTest | PASS | 177ms |
...
| testMergeWithPageSelection | PdfMergerTest | PASS | 177ms |
...
| testStampPdfWithScaling | PdfStamperTest | PASS | 179ms |
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 18.8s
...
| testQpdfCorpus with data set "qpdf/good17.pdf" | Tier2CorpusTest | PASS | 13ms |
...
**6 tests** | 6 passed | 0 failed | 0 skipped | 11.93s
...
| testPdfWithEmbeddedFontWellFormedAndValid | Tier4JhoveTest | PASS | 846ms |
...
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 555ms |
| testPdfWithMetadataHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 559ms |
