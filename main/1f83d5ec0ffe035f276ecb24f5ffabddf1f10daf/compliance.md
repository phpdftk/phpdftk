...
Generated: 2026-05-25 00:42:53 UTC
PHP: 8.4.21
...
**Overall: PASS** | 1662 tests | 1656 passed | 0 failed | 6 skipped | 90.6s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 454 | 450 | 0 | 4 | 33.01s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.25s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 18.27s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 18.45s |
...
**454 tests** | 450 passed | 0 failed | 4 skipped | 33.01s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 484ms |
| testGeneratesAnnotationsPdf | AnnotationsTest | PASS | 185ms |
...
| testEmbeddedFontHasFontDescriptor | EmbeddedFontsTest | PASS | 10ms |
...
| testGeneratesExtGStatePdf | ExtGStateIntegrationTest | PASS | 196ms |
| testGeneratesFormWithAppearances | FormAppearancesIntegrationTest | PASS | 209ms |
...
| testGeneratesGraphicsPdf | GraphicsTest | PASS | 214ms |
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 585ms |
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 397ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 266ms |
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 161ms |
...
| testShowPageNumbersDefaultFormat | PageNumbersTest | PASS | 187ms |
...
| testToBytesProducesValidPdfOnEachCall | PdfTest | PASS | 375ms |
...
| testAddTableRendersAllCellValues | TableTest | PASS | 202ms |
...
| testMetadataRoundTrip | XmpMetadataTest | PASS | 185ms |
| testSyncInfoToMetadata | XmpMetadataTest | PASS | 179ms |
| testSyncInfoToMetadataNoInfoIsNoOp | XmpMetadataTest | PASS | 192ms |
...
| testKeepWithPageSelector | PageSlicerTest | PASS | 207ms |
...
| testRotateCumulative | PageTransformerTest | PASS | 225ms |
| testRotateInvalidAngle | PageTransformerTest | PASS | <1ms |
| testSetCropBox | PageTransformerTest | PASS | 196ms |
...
| testSetBleedBox | PageTransformerTest | PASS | 184ms |
...
| testRedactMultipleAreas | TextRedactorTest | PASS | 178ms |
...
| testSaveToFile | TextRedactorTest | PASS | 191ms |
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 18.45s
...
| testQpdfCorpus with data set "qpdf/many-nulls.pdf" | Tier2CorpusTest | PASS | 734ms |
...
| testQpdfCorpus with data set "qpdf/nontrivial-crypt-filter.pdf" | Tier2CorpusTest | PASS | 29ms |
...
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 7.31s |
...
| testPdfBoxCorpus with data set "pdfbox/pdfbox/src/test/resources/org/apache/pdfbox/pdmodel/interactive/form/MultilineFields.pdf" | Tier2PdfBoxCorpusTest | PASS | 3ms |
...
| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWellFormedAndValid | Tier4JhoveTest | PASS | 924ms |
| testMultiPagePdfWellFormedAndValid | Tier4JhoveTest | PASS | 873ms |
| testPdfWithMetadataWellFormedAndValid | Tier4JhoveTest | PASS | 842ms |
...
| testPdfWithEmbeddedFontHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 549ms |
