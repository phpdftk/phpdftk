...
Generated: 2026-06-10 12:35:16 UTC
PHP: 8.4.21
...
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 701ms |
| testGeneratesAnnotationsPdf | AnnotationsTest | PASS | 200ms |
| testGeneratesBookmarksPdf | BookmarksTest | PASS | 237ms |
| testGeneratesFormWithCustomFontAppearances | CustomFontFormAppearancesTest | PASS | 244ms |
...
| testGeneratesGraphicsPipelinePdf | GraphicsPipelineIntegrationTest | PASS | 178ms |
| testGeneratesGraphicsPdf | GraphicsTest | PASS | 191ms |
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 423ms |
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 88ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 213ms |
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 228ms |
...
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 666ms |
...
| testEachTypeUsesItsOwnBarColor | CalloutTest | PASS | 12ms |
...
| testAlignmentCenterEmitsCenteredText | PdfTest | PASS | 195ms |
...
| testCustomTheme | PdfTest | PASS | 194ms |
...
| testCheckCheckbox | FormFillerTest | PASS | 187ms |
...
| testSplit | PageSlicerTest | PASS | 401ms |
...
| testRotateSpecificPages | PageTransformerTest | PASS | 198ms |
...
| testMultipleOperations | PageTransformerTest | PASS | 200ms |
...
| testStampText | PdfStamperTest | PASS | 188ms |
...
| testStampImageCombinedWithText | PdfStamperTest | PASS | 199ms |
...
| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesBookmarksPdf | BookmarksTest | PASS | 326ms |
...
**4 tests** | 3 passed | 0 failed | 1 skipped | 18.82s
...
| testQpdfCorpus with data set "qpdf/many-nulls.pdf" | Tier2CorpusTest | PASS | 674ms |
...
| testQpdfCorpus with data set "qpdf/weird-tokens.pdf" | Tier2CorpusTest | PASS | 28ms |
...
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 10.01s |
...
| testPdfiumCorpus with data set "pdfium/zero_length_stream.pdf" | Tier2PdfiumCorpusTest | PASS | 7ms |
...
| testMultiPagePdfWellFormedAndValid | Tier4JhoveTest | PASS | 912ms |
...
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 668ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/Simple PDF 2.0 file.pdf" | Tier4Pdf20ExamplesTest | PASS | 175ms |
