...
Generated: 2026-05-15 07:02:17 UTC
PHP: 8.4.21
...
**Overall: PASS** | 1471 tests | 1465 passed | 0 failed | 6 skipped | 89.7s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 263 | 259 | 0 | 4 | 31.4s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.28s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 18.85s |
...
**263 tests** | 259 passed | 0 failed | 4 skipped | 31.4s
...
| testGeneratesFormWithCustomFontAppearances | CustomFontFormAppearancesTest | PASS | 298ms |
...
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 325ms |
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 464ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 264ms |
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 179ms |
...
| testSetNamedDestinations | WriterTest | PASS | 198ms |
...
| testSelectThrowsForUnknownField | FormFillerTest | PASS | 3ms |
...
| testDecrypt | PdfEncryptTest | PASS | 206ms |
...
| testStampImageJpeg | PdfStamperTest | PASS | 182ms |
...
| testStampPdfWithScaling | PdfStamperTest | PASS | 223ms |
...
**4 tests** | 3 passed | 0 failed | 1 skipped | 18.85s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWithOutputIntent | PdfAConformanceTest | SKIP | 4ms |
| testVeraPdfToolchainWorks | PdfAConformanceTest | PASS | 2.33s |
...
| testQpdfCorpus with data set "qpdf/big-ostream.pdf" | Tier2CorpusTest | PASS | 12ms |
...
| testQpdfCorpus with data set "qpdf/labels-split-01-06.pdf" | Tier2CorpusTest | PASS | 2ms |
...
| testQpdfCorpus with data set "qpdf/many-nulls.pdf" | Tier2CorpusTest | PASS | 662ms |
...
| testQpdfCorpus with data set "qpdf/outlines-with-old-root-dests.pdf" | Tier2CorpusTest | PASS | 21ms |
...
| testQpdfCorpus with data set "qpdf/shared-form-split-3.pdf" | Tier2CorpusTest | PASS | 2ms |
