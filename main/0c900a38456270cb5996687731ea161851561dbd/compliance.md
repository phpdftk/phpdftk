...
Generated: 2026-06-17 01:25:30 UTC
PHP: 8.4.22
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 32.43s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 696ms |
...
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 470ms |
...
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 78ms |
...
| testStampImageJpeg | PdfStamperTest | PASS | 266ms |
...
| testQpdfCorpus with data set "qpdf/remove-info-no-moddate.pdf" | Tier2CorpusTest | PASS | 2ms |
| testQpdfCorpus with data set "qpdf/remove-info.pdf" | Tier2CorpusTest | PASS | 2ms |
| testQpdfCorpus with data set "qpdf/remove-labels.pdf" | Tier2CorpusTest | PASS | <1ms |
| testQpdfCorpus with data set "qpdf/remove-metadata-no-moddate.pdf" | Tier2CorpusTest | PASS | 2ms |
| testQpdfCorpus with data set "qpdf/remove-metadata.pdf" | Tier2CorpusTest | PASS | 2ms |
...
**6 tests** | 6 passed | 0 failed | 0 skipped | 11.74s
...
| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWellFormedAndValid | Tier4JhoveTest | PASS | 933ms |
...
| testJhoveToolchainWorks | Tier4JhoveTest | PASS | 740ms |
