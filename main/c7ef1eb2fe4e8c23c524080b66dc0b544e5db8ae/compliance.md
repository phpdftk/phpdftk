...
Generated: 2026-06-10 12:45:36 UTC
PHP: 8.4.21
...
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 32.56s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.25s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 18.56s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 18.95s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 32.56s
...
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 154ms |
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 162ms |
...
| testPdfDocCreateBarcodeReturnsFormXObject | BarcodeAdapterTest | PASS | 2ms |
...
| testLongTextAutoPaginates | PdfTest | PASS | 179ms |
...
| testSetBookmarks | BookmarkEditorTest | PASS | 211ms |
...
| testSetBleedBox | PageTransformerTest | PASS | 207ms |
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 18.95s
...
| testQpdfCorpus with data set "qpdf/good17.pdf" | Tier2CorpusTest | PASS | 14ms |
...
| testQpdfCorpus with data set "qpdf/warn-replace.pdf" | Tier2CorpusTest | PASS | 30ms |
...
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 10.16s |
...
| testPdfiumCorpus with data set "pdfium/xfa/xfa_multiline_textfield.pdf" | Tier2PdfiumCorpusTest | PASS | 7ms |
...
| testMultiPagePdfWellFormedAndValid | Tier4JhoveTest | PASS | 886ms |
...
| testJhoveToolchainWorks | Tier4JhoveTest | PASS | 670ms |
...
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 717ms |
