...
Generated: 2026-06-25 03:33:48 UTC
PHP: 8.4.22
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 88.53s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 32.57s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.27s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 17.9s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 17.26s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 11.01s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 32.57s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 396ms |
...
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 386ms |
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 315ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 311ms |
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 300ms |
| testGeneratesPdfWithMarkupFields | MarkupAnnotationsIntegrationTest | PASS | 180ms |
...
| testGeneratesSignatureFieldPdf | SignatureFieldIntegrationTest | PASS | 185ms |
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 598ms |
| testGeneratesSimpleTextPdf | SimpleTextTest | PASS | 183ms |
| testGeneratesPdfWithType3Font | Type3FontIntegrationTest | PASS | 185ms |
| testGeneratesPdfWithXrefAndObjectStreams | XRefStreamIntegrationTest | PASS | 187ms |
...
| testAddTextWithLinkStyleProducesLinkAnnotation | InlineLinkTest | PASS | 179ms |
...
| testShowPageNumbersDefaultFormat | PageNumbersTest | PASS | 183ms |
...
| testAddPageDelegatesToWriter | PdfDocTest | PASS | 184ms |
...
| testGeneratesHighLevelDocument | PdfIntegrationTest | PASS | 380ms |
...
| testBoldAndItalicResolveToCorrectPostScriptName | PdfTest | PASS | 179ms |
...
| testToBytesProducesValidPdfOnEachCall | PdfTest | PASS | 366ms |
...
| testAddTableAutoPaginatesAndRepeatsHeader | TableTest | PASS | 10ms |
...
| testPdfWriterContainsPage | WriterTest | PASS | 186ms |
...
| testPdfWriterWithInfo | WriterTest | PASS | 182ms |
...
| testRemoveBookmarks | BookmarkEditorTest | PASS | 183ms |
...
| testSetMultipleFieldsRoundTrip | MetadataEditorTest | PASS | 185ms |
...
| testReorder | PageSlicerTest | PASS | 186ms |
| testReverse | PageSlicerTest | PASS | 185ms |
| testSplit | PageSlicerTest | PASS | 387ms |
...
| testSetCropBoxSpecificPage | PageTransformerTest | PASS | 221ms |
...
| testEvenPages | PageTransformerTest | PASS | 186ms |
| testOddPages | PageTransformerTest | PASS | 183ms |
| testRange | PageTransformerTest | PASS | 195ms |
...
| testEncryptAes128 | PdfEncryptTest | PASS | 181ms |
...
| testStampText | PdfStamperTest | PASS | 180ms |
...
| testStampPdfOnSelectedPages | PdfStamperTest | PASS | 184ms |
...
| testRedactArea | TextRedactorTest | PASS | 185ms |
...
**4 tests** | 3 passed | 0 failed | 1 skipped | 17.9s
...
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 9.21s |
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 17.26s
...
| testPopplerCorpus with data set "poppler-test/unittestcases/signature/digest_mismatch/sha1_hash_mismatch.pdf" | Tier2CorpusTest | PASS | 2ms |
...
| testQpdfCorpus with data set "qpdf/many-nulls.pdf" | Tier2CorpusTest | PASS | 715ms |
...
| testQpdfCorpus with data set "qpdf/resolved-appearance-conflicts-generate.pdf" | Tier2CorpusTest | PASS | 27ms |
...
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 6.75s |
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 8.88s |
...
**6 tests** | 6 passed | 0 failed | 0 skipped | 11.01s
...
| testMultiPagePdfWellFormedAndValid | Tier4JhoveTest | PASS | 873ms |
| testPdfWithMetadataWellFormedAndValid | Tier4JhoveTest | PASS | 858ms |
| testPdfWithEmbeddedFontWellFormedAndValid | Tier4JhoveTest | PASS | 839ms |
| testJhoveToolchainWorks | Tier4JhoveTest | PASS | 677ms |
| testPdfA1bPassesPdfBoxPreflight | Tier4PdfBoxPreflightTest | SKIP | <1ms |
| testPdfBoxPreflightToolchainWorks | Tier4PdfBoxPreflightTest | PASS | 760ms |
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 855ms |
| testPdfWithMetadataHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 554ms |
| testPdfWithEmbeddedFontHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 509ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 UTF-8 string and annotation.pdf" | Tier4Pdf20ExamplesTest | PASS | 186ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/Simple PDF 2.0 file.pdf" | Tier4Pdf20ExamplesTest | PASS | 181ms |
| testPdf20ExampleQpdfValid with data set "pdf20/pdf20-utf8-test.pdf" | Tier4Pdf20ExamplesTest | PASS | 186ms |
