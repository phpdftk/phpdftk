...
Generated: 2026-05-08 20:17:47 UTC
PHP: 8.4.21
...
**Overall: PASS** | 1444 tests | 1438 passed | 0 failed | 6 skipped | 99.37s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 236 | 232 | 0 | 4 | 33.18s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.37s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 21.84s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 21.37s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 12.7s |
...
**236 tests** | 232 passed | 0 failed | 4 skipped | 33.18s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 646ms |
| testGeneratesAnnotationsPdf | AnnotationsTest | PASS | 197ms |
| testGeneratesBookmarksPdf | BookmarksTest | PASS | 243ms |
| testGeneratesFormWithCustomFontAppearances | CustomFontFormAppearancesTest | PASS | 259ms |
...
| testGeneratesPdfWithEmbeddedFont | EmbeddedFontsTest | PASS | 210ms |
...
| testGeneratesFormPdf | FormFieldsTest | PASS | 210ms |
| testGeneratesGraphicsPipelinePdf | GraphicsPipelineIntegrationTest | PASS | 218ms |
| testGeneratesGraphicsPdf | GraphicsTest | PASS | 200ms |
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 501ms |
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 394ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 235ms |
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 131ms |
...
| testGeneratesMultimediaAnd3DPdf | MultimediaAndThreeDIntegrationTest | PASS | 218ms |
...
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 468ms |
| testGeneratesSimpleTextPdf | SimpleTextTest | PASS | 206ms |
...
| testAddTextCreatesFirstPageAutomatically | PdfTest | PASS | 200ms |
| testAddHeadingEmitsLargerText | PdfTest | PASS | 201ms |
| testExplicitNewPageCreatesSecondPage | PdfTest | PASS | 195ms |
| testLongTextAutoPaginates | PdfTest | PASS | 220ms |
| testAddSpacerConsumesVerticalSpace | PdfTest | PASS | 213ms |
...
| testBoldAndItalicResolveToCorrectPostScriptName | PdfTest | PASS | 204ms |
...
| testAddCompositeFontGeneratesValidPdf | UnicodeFontTest | PASS | 224ms |
...
| testPdfWriterContainsXref | WriterTest | PASS | 205ms |
| testPdfWriterContainsTrailer | WriterTest | PASS | <1ms |
| testPdfWriterAddPageWithRectangle | WriterTest | PASS | 207ms |
| testPdfWriterRegisterObject | WriterTest | PASS | 211ms |
| testPdfWriterFontAddedToPage | WriterTest | PASS | 212ms |
| testSetNamedDestinations | WriterTest | PASS | 213ms |
| testSetEncryptionProducesEncryptedPdf | WriterTest | PASS | 217ms |
| testSetEncryptionAes256RoundTrip | WriterTest | PASS | 223ms |
| testSetMetadataAddsStreamToPdf | XmpMetadataTest | PASS | 216ms |
| testMetadataStreamContainsXmp | XmpMetadataTest | PASS | 206ms |
| testMetadataRoundTrip | XmpMetadataTest | PASS | 212ms |
| testSyncInfoToMetadata | XmpMetadataTest | PASS | 217ms |
| testSyncInfoToMetadataNoInfoIsNoOp | XmpMetadataTest | PASS | 215ms |
...
| testSetBookmarksWithChildren | BookmarkEditorTest | PASS | 221ms |
| testAddBookmark | BookmarkEditorTest | PASS | 433ms |
| testHasBookmarksReturnsFalseForCleanPdf | BookmarkEditorTest | PASS | <1ms |
| testRemoveBookmarks | BookmarkEditorTest | PASS | 223ms |
| testGetPageCount | BookmarkEditorTest | PASS | <1ms |
| testGetReader | BookmarkEditorTest | PASS | <1ms |
| testSaveToFile | BookmarkEditorTest | PASS | 211ms |
...
| testHasField | FormFillerTest | PASS | 4ms |
...
| testSelectChoiceField | FormFillerTest | PASS | 215ms |
...
| testSetMultipleFieldsRoundTrip | MetadataEditorTest | PASS | 214ms |
| testSetMetadataOnPdfWithoutInfo | MetadataEditorTest | PASS | 200ms |
| testNoBytesChangedWithoutModifications | MetadataEditorTest | PASS | 4ms |
| testPageCount | MetadataEditorTest | PASS | <1ms |
| testEscapeHatch | MetadataEditorTest | PASS | <1ms |
| testCustomField | MetadataEditorTest | PASS | 212ms |
| testSaveToFile | MetadataEditorTest | PASS | 214ms |
| testSetLabelsWithArabic | PageLabelerTest | PASS | 210ms |
| testSetRomanNumerals | PageLabelerTest | PASS | 215ms |
| testSetRomanNumeralsUppercase | PageLabelerTest | PASS | 215ms |
| testSetAlphabetic | PageLabelerTest | PASS | 216ms |
...
| testRotate270 | PageTransformerTest | PASS | 199ms |
| testRotateSpecificPages | PageTransformerTest | PASS | 209ms |
...
| testSetCropBoxSpecificPage | PageTransformerTest | PASS | 207ms |
...
| testRange | PageTransformerTest | PASS | 212ms |
...
| testPageNumbers | PdfStamperTest | PASS | 197ms |
...
| testPageCount | PdfStamperTest | PASS | 4ms |
...
| testStampPdf | PdfStamperTest | PASS | 202ms |
...
| testStampPdfOnSelectedPages | PdfStamperTest | PASS | 219ms |
| testStampPdfDefaultsToCenter | PdfStamperTest | PASS | 211ms |
...
| testRedactArea | TextRedactorTest | PASS | 207ms |
| testRedactMultipleAreas | TextRedactorTest | PASS | 195ms |
| testRedactByText | TextRedactorTest | PASS | 206ms |
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 21.37s

| Test | Class | Status | Time |
|---|---|---|---|
| testPopplerCorpus with data set "poppler-test/tests/blend.pdf" | Tier2CorpusTest | PASS | 6ms |
...
| testPopplerCorpus with data set "poppler-test/unittestcases/fakebold.pdf" | Tier2CorpusTest | PASS | 4ms |
...
| testQpdfCorpus with data set "qpdf/inline-images-ii-all.pdf" | Tier2CorpusTest | PASS | 21ms |
...
| testQpdfCorpus with data set "qpdf/job-json-empty-input.pdf" | Tier2CorpusTest | PASS | 2ms |
...
| testQpdfCorpus with data set "qpdf/many-nulls.pdf" | Tier2CorpusTest | PASS | 676ms |
...
| testQpdfCorpus with data set "qpdf/other-file-first.pdf" | Tier2CorpusTest | PASS | 22ms |
...
| testQpdfCorpus with data set "qpdf/sample-form.pdf" | Tier2CorpusTest | PASS | 9ms |
...
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 8.58s |
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 11.29s |
...
| testPdfBoxCorpus with data set "pdfbox/pdfbox/src/test/resources/org/apache/pdfbox/pdmodel/interactive/form/PDFBOX-3835-input-acrobat-wrap.pdf" | Tier2PdfBoxCorpusTest | PASS | 2ms |
...
| testPdfBoxCorpus with data set "pdfbox/pdfbox/src/test/resources/org/apache/pdfbox/pdmodel/interactive/form/PDFBOX-5784.pdf" | Tier2PdfBoxCorpusTest | PASS | 12ms |
...
| testPdfBoxCorpus with data set "pdfbox/pdfbox/src/test/resources/org/apache/pdfbox/pdmodel/test.unc.pdf" | Tier2PdfBoxCorpusTest | PASS | 2ms |
...
**6 tests** | 6 passed | 0 failed | 0 skipped | 12.7s

| Test | Class | Status | Time |
|---|---|---|---|
| testTaggedDocumentValidatesWithUa1 | Tier3MatterhornTest | PASS | 2.44s |
| testAnnotationWithContentsPassesClause718 | Tier3MatterhornTest | PASS | 2.08s |
| testUntaggedDocumentFailsUa1 | Tier3MatterhornTest | PASS | 1.99s |
| testMissingLangFailsUa1 | Tier3MatterhornTest | PASS | 1.92s |
| testMissingDisplayDocTitleFailsUa1 | Tier3MatterhornTest | PASS | 2.09s |
| testAnnotationWithoutContentsFailsUa1 | Tier3MatterhornTest | PASS | 2.18s |
...
| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWellFormedAndValid | Tier4JhoveTest | PASS | 1.03s |
| testMultiPagePdfWellFormedAndValid | Tier4JhoveTest | PASS | 957ms |
| testPdfWithMetadataWellFormedAndValid | Tier4JhoveTest | PASS | 921ms |
| testPdfWithEmbeddedFontWellFormedAndValid | Tier4JhoveTest | PASS | 944ms |
| testJhoveToolchainWorks | Tier4JhoveTest | PASS | 723ms |
...
| testPdfWithEmbeddedFontHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 579ms |
| testPdfIdToolchainWorks | Tier4PdfIdTest | PASS | 377ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/pdf20-utf8-test.pdf" | Tier4Pdf20ExamplesTest | PASS | 206ms |
