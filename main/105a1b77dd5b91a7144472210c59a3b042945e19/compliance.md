...
Generated: 2026-06-17 03:39:18 UTC
PHP: 8.4.22
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 89.12s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 32.31s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.26s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 18.18s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 17.96s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 11.2s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 32.31s
...
| testGeneratesPdfWithEmbeddedTrueTypeFont | DocumentFeaturesTest | PASS | 223ms |
...
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 287ms |
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 238ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 104ms |
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 385ms |
...
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 344ms |
...
| testAddRuleDrawsStroke | PdfTest | PASS | 191ms |
...
| testCustomTheme | PdfTest | PASS | 186ms |
...
| testSyncInfoToMetadataNoInfoIsNoOp | XmpMetadataTest | PASS | 180ms |
...
| testStampWithOpacity | PdfStamperTest | PASS | 206ms |
...
| testSaveToFile | TextRedactorTest | PASS | 185ms |
...
**4 tests** | 3 passed | 0 failed | 1 skipped | 18.18s
...
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 9s |
...
| testQpdfCorpus with data set "qpdf/default-da-q.pdf" | Tier2CorpusTest | PASS | 11ms |
...
| testQpdfCorpus with data set "qpdf/many-nulls.pdf" | Tier2CorpusTest | PASS | 722ms |
...
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 9.24s |
...
**6 tests** | 6 passed | 0 failed | 0 skipped | 11.2s
...
| testMissingLangFailsUa1 | Tier3MatterhornTest | PASS | 1.74s |
| testMissingDisplayDocTitleFailsUa1 | Tier3MatterhornTest | PASS | 1.7s |
| testAnnotationWithoutContentsFailsUa1 | Tier3MatterhornTest | PASS | 1.71s |
...
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 545ms |
