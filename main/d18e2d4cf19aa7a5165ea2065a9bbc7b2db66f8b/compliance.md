...
Generated: 2026-09-25 12:52:44 UTC
PHP: 8.4.26
...
**Overall: PASS** | 1673 tests | 1667 passed | 0 failed | 6 skipped | 94.86s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 465 | 461 | 0 | 4 | 35.37s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.29s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 18.3s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 18.66s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 12.43s |
| &#x2705; JHOVE + PDF 2.0 + Security + Preflight | PASS | 25 | 24 | 0 | 1 | 8.8s |
...
**465 tests** | 461 passed | 0 failed | 4 skipped | 35.37s
...
| testGeneratesFormWithCustomFontAppearances | CustomFontFormAppearancesTest | PASS | 217ms |
| testGeneratesDocumentFeaturesPdf | DocumentFeaturesTest | PASS | 197ms |
| testGeneratesPdfWithEmbeddedTrueTypeFont | DocumentFeaturesTest | PASS | 213ms |
...
| testGeneratesGraphicsPipelinePdf | GraphicsPipelineIntegrationTest | PASS | 206ms |
| testGeneratesGraphicsPdf | GraphicsTest | PASS | 197ms |
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 367ms |
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 103ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 417ms |
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 227ms |
...
| testGeneratesMultimediaAnd3DPdf | MultimediaAndThreeDIntegrationTest | PASS | 203ms |
...
| testGeneratesSignatureFieldPdf | SignatureFieldIntegrationTest | PASS | 205ms |
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 306ms |
...
| testCreateTransparencyGroupEmitsGroupForm | PdfDocTest | PASS | 195ms |
| testEnsureSoftMaskStateRegistersSMaskExtGState | PdfDocTest | PASS | 200ms |
| testAddLinearAlphaShadingEmitsDeviceGrayShading | PdfDocTest | PASS | 207ms |
| testAddLinearAlphaShadingWithThreeStopsStitches | PdfDocTest | PASS | 204ms |
| testAddRadialAlphaShadingEmitsDeviceGrayType3 | PdfDocTest | PASS | 187ms |
| testAddConicShadingStopsEmitsFunctionBasedShading | PdfDocTest | PASS | 192ms |
| testAddConicShadingStopsRepeatingWrapsTheSweep | PdfDocTest | PASS | 192ms |
...
| testEmptyDocumentHasNoPages | PdfTest | PASS | 196ms |
| testAddTextCreatesFirstPageAutomatically | PdfTest | PASS | 203ms |
| testAddHeadingEmitsLargerText | PdfTest | PASS | 198ms |
| testExplicitNewPageCreatesSecondPage | PdfTest | PASS | 220ms |
| testLongTextAutoPaginates | PdfTest | PASS | 198ms |
| testAddSpacerConsumesVerticalSpace | PdfTest | PASS | 190ms |
...
| testSaveWritesFile | PdfTest | PASS | 203ms |
| testWriteToStream | PdfTest | PASS | 200ms |
| testWriteToRejectsNonResource | PdfTest | PASS | <1ms |
| testToBytesProducesValidPdfOnEachCall | PdfTest | PASS | 407ms |
...
| testUnderlineEmitsStrokeBelowBaseline | TextDecorationTest | PASS | 194ms |
...
| testAddCompositeFontGeneratesValidPdf | UnicodeFontTest | PASS | 207ms |
| testAddCompositeFontSavesToFile | UnicodeFontTest | PASS | 195ms |
| testCompositeFontRoundTripsThroughReader | UnicodeFontTest | PASS | 193ms |
...
| testPdfWriterContainsPage | WriterTest | PASS | 200ms |
...
| testSetMetadataAddsStreamToPdf | XmpMetadataTest | PASS | 192ms |
...
| testSyncInfoToMetadataNoInfoIsNoOp | XmpMetadataTest | PASS | 201ms |
| testFlattenAll | AnnotationFlattenerTest | PASS | 198ms |
...
| testSaveToFile | BookmarkEditorTest | PASS | 195ms |
...
| testGetFieldNames | FormFillerTest | PASS | 7ms |
...
| testCheckCheckbox | FormFillerTest | PASS | 205ms |
| testUncheckCheckbox | FormFillerTest | PASS | 194ms |
| testSelectChoiceField | FormFillerTest | PASS | 201ms |
| testFillMultipleFieldTypes | FormFillerTest | PASS | 205ms |
...
| testRoundTripPreservesOtherFields | FormFillerTest | PASS | 203ms |
...
| testSetLabelsWithArabic | PageLabelerTest | PASS | 200ms |
...
| testMultipleRanges | PageLabelerTest | PASS | 197ms |
...
| testRotate180 | PageTransformerTest | PASS | 206ms |
...
| testSetCropBox | PageTransformerTest | PASS | 205ms |
| testSetCropBoxSpecificPage | PageTransformerTest | PASS | 199ms |
| testSetMediaBox | PageTransformerTest | PASS | 192ms |
| testSetTrimBox | PageTransformerTest | PASS | 185ms |
...
| testSaveToFile | PageTransformerTest | PASS | 196ms |
...
| testMergeTwoPdfs | PdfMergerTest | PASS | 194ms |
| testMergeWithPageSelection | PdfMergerTest | PASS | 197ms |
...
| testStampWithOpacity | PdfStamperTest | PASS | 212ms |
...
| testStampImageJpeg | PdfStamperTest | PASS | 195ms |
...
| testStampImageWithExplicitDimensions | PdfStamperTest | PASS | 201ms |
...
| testStampPdfWithScaling | PdfStamperTest | PASS | 225ms |
| testStampPdfWithOpacity | PdfStamperTest | PASS | 206ms |
| testStampPdfSpecificPage | PdfStamperTest | PASS | 197ms |
| testStampPdfOnSelectedPages | PdfStamperTest | PASS | 206ms |
...
| testCustomRedactionColor | TextRedactorTest | PASS | 201ms |
...
| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesBookmarksPdf | BookmarksTest | PASS | 331ms |
...
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 8.78s |
...
| testQpdfCorpus with data set "qpdf/appearances-b.pdf" | Tier2CorpusTest | PASS | 15ms |
...
| testQpdfCorpus with data set "qpdf/many-nulls.pdf" | Tier2CorpusTest | PASS | 693ms |
...
| testQpdfCorpus with data set "qpdf/need-appearances2.pdf" | Tier2CorpusTest | PASS | 28ms |
...
| testPdfBoxCorpus with data set "pdfbox/pdfbox/src/test/resources/org/apache/pdfbox/pdmodel/interactive/form/ControlCharacters.pdf" | Tier2PdfBoxCorpusTest | PASS | 8ms |
...
**6 tests** | 6 passed | 0 failed | 0 skipped | 12.43s

| Test | Class | Status | Time |
|---|---|---|---|
| testTaggedDocumentValidatesWithUa1 | Tier3MatterhornTest | PASS | 2.37s |
| testAnnotationWithContentsPassesClause718 | Tier3MatterhornTest | PASS | 2.27s |
| testUntaggedDocumentFailsUa1 | Tier3MatterhornTest | PASS | 1.95s |
| testMissingLangFailsUa1 | Tier3MatterhornTest | PASS | 1.79s |
| testMissingDisplayDocTitleFailsUa1 | Tier3MatterhornTest | PASS | 2.01s |
...
**25 tests** | 24 passed | 0 failed | 1 skipped | 8.8s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWellFormedAndValid | Tier4JhoveTest | PASS | 973ms |
| testMultiPagePdfWellFormedAndValid | Tier4JhoveTest | PASS | 934ms |
| testPdfWithMetadataWellFormedAndValid | Tier4JhoveTest | PASS | 896ms |
| testPdfWithEmbeddedFontWellFormedAndValid | Tier4JhoveTest | PASS | 921ms |
| testJhoveToolchainWorks | Tier4JhoveTest | PASS | 726ms |
| testPdfA1bPassesPdfBoxPreflight | Tier4PdfBoxPreflightTest | SKIP | <1ms |
| testPdfBoxPreflightToolchainWorks | Tier4PdfBoxPreflightTest | PASS | 841ms |
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 586ms |
| testPdfWithMetadataHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 573ms |
| testPdfWithEmbeddedFontHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 573ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 with offset start.pdf" | Tier4Pdf20ExamplesTest | PASS | 206ms |
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 with page level output intent.pdf" | Tier4Pdf20ExamplesTest | PASS | 207ms |
