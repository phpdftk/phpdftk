...
Generated: 2026-06-10 12:11:39 UTC
PHP: 8.4.21
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 90.95s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 32.95s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.28s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 18.67s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 17.97s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 32.95s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 452ms |
...
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 479ms |
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 171ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 186ms |
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 222ms |
...
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 578ms |
...
| testExplicitNewPageCreatesSecondPage | PdfTest | PASS | 211ms |
...
| testUnderlineEmitsStrokeBelowBaseline | TextDecorationTest | PASS | 206ms |
...
| testStampImagePng | PdfStamperTest | PASS | 212ms |
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 17.97s
...
| testPdfiumCorpus with data set "pdfium/encrypted_hello_world_r3_bad_okey.pdf" | Tier2PdfiumCorpusTest | PASS | 4ms |
| testPdfiumCorpus with data set "pdfium/encrypted_hello_world_r5.pdf" | Tier2PdfiumCorpusTest | PASS | 4ms |
| testPdfiumCorpus with data set "pdfium/encrypted_hello_world_r6.pdf" | Tier2PdfiumCorpusTest | PASS | 4ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 via incremental save.pdf" | Tier4Pdf20ExamplesTest | PASS | 202ms |
