...
Generated: 2026-06-29 02:58:19 UTC
PHP: 8.4.22
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 91.29s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 33.48s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.31s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 18.64s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 17.42s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 11.83s |
| &#x2705; JHOVE + PDF 2.0 + Security + Preflight | PASS | 25 | 24 | 0 | 1 | 8.62s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 33.48s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 697ms |
...
| testGeneratesExtGStatePdf | ExtGStateIntegrationTest | PASS | 212ms |
...
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 502ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 260ms |
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 87ms |
...
| testFillTextField | FormFillerTest | PASS | 207ms |
...
| testSetBleedBox | PageTransformerTest | PASS | 217ms |
...
| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesBookmarksPdf | BookmarksTest | PASS | 348ms |
...
**4 tests** | 3 passed | 0 failed | 1 skipped | 18.64s
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 17.42s
...
| testPopplerCorpus with data set "poppler-test/unittestcases/type3.pdf" | Tier2CorpusTest | PASS | 2ms |
...
| testQpdfCorpus with data set "qpdf/many-nulls.pdf" | Tier2CorpusTest | PASS | 673ms |
...
| testQpdfCorpus with data set "qpdf/replace-input.pdf" | Tier2CorpusTest | PASS | 25ms |
...
**25 tests** | 24 passed | 0 failed | 1 skipped | 8.62s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWellFormedAndValid | Tier4JhoveTest | PASS | 943ms |
| testMultiPagePdfWellFormedAndValid | Tier4JhoveTest | PASS | 871ms |
...
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 820ms |
