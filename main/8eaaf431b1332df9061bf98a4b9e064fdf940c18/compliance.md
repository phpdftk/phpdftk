...
Generated: 2026-06-11 03:59:02 UTC
PHP: 8.4.21
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 87.77s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 32.62s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.28s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 17.74s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 16.94s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 10.97s |
| &#x2705; JHOVE + PDF 2.0 + Security + Preflight | PASS | 25 | 24 | 0 | 1 | 8.22s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 32.62s
...
| testGeneratesBookmarksPdf | BookmarksTest | PASS | 231ms |
...
| testGeneratesFormPdf | FormFieldsTest | PASS | 206ms |
...
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 416ms |
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 251ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 528ms |
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 207ms |
...
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 446ms |
...
| testAddTextCreatesFirstPageAutomatically | PdfTest | PASS | 183ms |
...
| testStrikethroughEmitsStroke | TextDecorationTest | PASS | 8ms |
...
| testCompositeFontRoundTripsThroughReader | UnicodeFontTest | PASS | 186ms |
...
| testSetRomanNumerals | PageLabelerTest | PASS | 183ms |
| testSetRomanNumeralsUppercase | PageLabelerTest | PASS | 188ms |
| testSetAlphabetic | PageLabelerTest | PASS | 205ms |
| testSetArabicWithStartNumber | PageLabelerTest | PASS | 190ms |
...
| testRemovePages | PageSlicerTest | PASS | 183ms |
...
| testRotate270 | PageTransformerTest | PASS | 194ms |
...
| testSetMediaBox | PageTransformerTest | PASS | 198ms |
...
| testScaleSpecificPages | PageTransformerTest | PASS | 190ms |
...
| testEvenPages | PageTransformerTest | PASS | 187ms |
...
| testSaveToFile | PageTransformerTest | PASS | 197ms |
...
| testPageCount | PdfEncryptTest | PASS | 4ms |
...
| testPageCount | PdfStamperTest | PASS | 3ms |
...
| testStampPdfWithScaling | PdfStamperTest | PASS | 181ms |
...
| testStampPdfThrowsOnNegativePageIndex | PdfStamperTest | PASS | 4ms |
| testImageStampStyleDefaults | PdfStamperTest | PASS | <1ms |
| testRedactArea | TextRedactorTest | PASS | 179ms |
...
| testSaveToFile | TextRedactorTest | PASS | 186ms |
...
**4 tests** | 3 passed | 0 failed | 1 skipped | 17.74s
...
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 8.93s |
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 16.94s
...
| testQpdfCorpus with data set "qpdf/enc-R3,V2,O=master.pdf" | Tier2CorpusTest | PASS | 13ms |
...
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 6.57s |
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 8.77s |
...
**6 tests** | 6 passed | 0 failed | 0 skipped | 10.97s
...
**25 tests** | 24 passed | 0 failed | 1 skipped | 8.22s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWellFormedAndValid | Tier4JhoveTest | PASS | 943ms |
| testMultiPagePdfWellFormedAndValid | Tier4JhoveTest | PASS | 878ms |
| testPdfWithMetadataWellFormedAndValid | Tier4JhoveTest | PASS | 873ms |
...
| testPdfBoxPreflightToolchainWorks | Tier4PdfBoxPreflightTest | PASS | 742ms |
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 543ms |
| testPdfWithMetadataHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 523ms |
| testPdfWithEmbeddedFontHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 526ms |
| testPdfIdToolchainWorks | Tier4PdfIdTest | PASS | 346ms |
