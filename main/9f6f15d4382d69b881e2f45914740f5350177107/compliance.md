...
Generated: 2026-06-09 21:57:30 UTC
PHP: 8.4.21
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 87.2s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 32.09s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.26s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 17.53s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 16.73s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 11.41s |
| &#x2705; JHOVE + PDF 2.0 + Security + Preflight | PASS | 25 | 24 | 0 | 1 | 8.19s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 32.09s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 285ms |
| testGeneratesAnnotationsPdf | AnnotationsTest | PASS | 194ms |
| testGeneratesBookmarksPdf | BookmarksTest | PASS | 243ms |
| testGeneratesFormWithCustomFontAppearances | CustomFontFormAppearancesTest | PASS | 228ms |
| testGeneratesDocumentFeaturesPdf | DocumentFeaturesTest | PASS | 200ms |
| testGeneratesPdfWithEmbeddedTrueTypeFont | DocumentFeaturesTest | PASS | 195ms |
| testGeneratesPdfWithEmbeddedFont | EmbeddedFontsTest | PASS | 191ms |
...
| testGeneratesFormWithAppearances | FormAppearancesIntegrationTest | PASS | 191ms |
| testGeneratesFormPdf | FormFieldsTest | PASS | 184ms |
| testGeneratesGraphicsPipelinePdf | GraphicsPipelineIntegrationTest | PASS | 187ms |
| testGeneratesGraphicsPdf | GraphicsTest | PASS | 181ms |
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 341ms |
...
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 107ms |
...
| testGeneratesMultimediaAnd3DPdf | MultimediaAndThreeDIntegrationTest | PASS | 179ms |
...
| testGeneratesPageLabelsPdf | PageLabelsTest | PASS | 192ms |
| testGeneratesSignatureFieldPdf | SignatureFieldIntegrationTest | PASS | 187ms |
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 580ms |
| testGeneratesSimpleTextPdf | SimpleTextTest | PASS | 190ms |
...
| testEnableOutlineThenHeadingRegistersOutlinesEntry | AutoOutlineTest | PASS | 192ms |
...
| testWriterPageDrawCalloutRendersPositioned | CalloutTest | PASS | 7ms |
...
| testWinAnsiRoundTripFromShowText | EncodingIntegrationTest | PASS | 189ms |
| testHighLevelPdfRoundTrip | EncodingIntegrationTest | PASS | 4ms |
| testAddTextWithLinkStyleProducesLinkAnnotation | InlineLinkTest | PASS | 188ms |
...
| testAddPageDelegatesToWriter | PdfDocTest | PASS | 181ms |
...
| testEmptyDocumentHasNoPages | PdfTest | PASS | 180ms |
| testAddTextCreatesFirstPageAutomatically | PdfTest | PASS | 182ms |
| testAddHeadingEmitsLargerText | PdfTest | PASS | 188ms |
| testExplicitNewPageCreatesSecondPage | PdfTest | PASS | 190ms |
| testLongTextAutoPaginates | PdfTest | PASS | 190ms |
| testAddSpacerConsumesVerticalSpace | PdfTest | PASS | 191ms |
| testAddRuleDrawsStroke | PdfTest | PASS | 183ms |
| testAlignmentCenterEmitsCenteredText | PdfTest | PASS | 187ms |
| testSetFontSwitchesFontFamily | PdfTest | PASS | 183ms |
| testBoldAndItalicResolveToCorrectPostScriptName | PdfTest | PASS | 189ms |
| testUnknownFamilyIsRejected | PdfTest | PASS | <1ms |
| testCustomTheme | PdfTest | PASS | 190ms |
| testSaveWritesFile | PdfTest | PASS | 184ms |
...
| testAddTableRendersAllCellValues | TableTest | PASS | 194ms |
...
| testUnderlineEmitsStrokeBelowBaseline | TextDecorationTest | PASS | 185ms |
...
| testAddCompositeFontGeneratesValidPdf | UnicodeFontTest | PASS | 191ms |
| testAddCompositeFontSavesToFile | UnicodeFontTest | PASS | 194ms |
| testCompositeFontRoundTripsThroughReader | UnicodeFontTest | PASS | 189ms |
...
| testPdfWriterAddContentStream | WriterTest | PASS | 187ms |
...
| testPdfWriterContainsXref | WriterTest | PASS | 183ms |
...
| testPdfWriterFontAddedToPage | WriterTest | PASS | 186ms |
...
| testSetMetadataAddsStreamToPdf | XmpMetadataTest | PASS | 183ms |
| testMetadataStreamContainsXmp | XmpMetadataTest | PASS | 186ms |
| testMetadataRoundTrip | XmpMetadataTest | PASS | 189ms |
| testSyncInfoToMetadata | XmpMetadataTest | PASS | 189ms |
| testSyncInfoToMetadataNoInfoIsNoOp | XmpMetadataTest | PASS | 186ms |
...
| testSaveToFile | AnnotationFlattenerTest | PASS | 183ms |
...
| testRemoveBookmarks | BookmarkEditorTest | PASS | 189ms |
...
| testFillTextField | FormFillerTest | PASS | 199ms |
...
| testSelectChoiceField | FormFillerTest | PASS | 208ms |
...
| testRoundTripPreservesOtherFields | FormFillerTest | PASS | 186ms |
...
| testSetMetadataOnPdfWithoutInfo | MetadataEditorTest | PASS | 184ms |
...
| testSaveToFile | PageLabelerTest | PASS | 183ms |
| testNoBytesChangedWhenNoOperations | PageLabelerTest | PASS | 1ms |
| testOpenFromFile | PageLabelerTest | PASS | 1ms |
| testKeepPages | PageSlicerTest | PASS | 186ms |
| testKeepRange | PageSlicerTest | PASS | 189ms |
| testRemovePages | PageSlicerTest | PASS | 190ms |
| testReorder | PageSlicerTest | PASS | 191ms |
| testReverse | PageSlicerTest | PASS | 187ms |
| testSplit | PageSlicerTest | PASS | 373ms |
| testKeepWithPageSelector | PageSlicerTest | PASS | 187ms |
| testNoOpsKeepsAllPages | PageSlicerTest | PASS | 188ms |
...
| testRotateSpecificPages | PageTransformerTest | PASS | 185ms |
| testRotateCumulative | PageTransformerTest | PASS | 194ms |
| testRotateInvalidAngle | PageTransformerTest | PASS | <1ms |
| testSetCropBox | PageTransformerTest | PASS | 189ms |
| testSetCropBoxSpecificPage | PageTransformerTest | PASS | 190ms |
| testSetMediaBox | PageTransformerTest | PASS | 193ms |
| testSetTrimBox | PageTransformerTest | PASS | 189ms |
| testSetBleedBox | PageTransformerTest | PASS | 192ms |
| testScale | PageTransformerTest | PASS | 193ms |
| testScaleSpecificPages | PageTransformerTest | PASS | 183ms |
| testScaleInvalidFactor | PageTransformerTest | PASS | <1ms |
| testScaleTo | PageTransformerTest | PASS | 180ms |
| testScaleToNonUniform | PageTransformerTest | PASS | 185ms |
| testMultipleOperations | PageTransformerTest | PASS | 195ms |
| testNoBytesChangedWithoutOperations | PageTransformerTest | PASS | <1ms |
| testEvenPages | PageTransformerTest | PASS | 196ms |
| testOddPages | PageTransformerTest | PASS | 187ms |
...
| testSaveWritesEncryptedFile | PdfEncryptTest | PASS | 4ms |
...
| testMergeWithPageSelection | PdfMergerTest | PASS | 181ms |
...
| testStampText | PdfStamperTest | PASS | 189ms |
| testWatermark | PdfStamperTest | PASS | 184ms |
| testWatermarkWithStyle | PdfStamperTest | PASS | 191ms |
| testPageNumbers | PdfStamperTest | PASS | 192ms |
| testStampOnSpecificPages | PdfStamperTest | PASS | 181ms |
...
| testStampImageWithScaleWidth | PdfStamperTest | PASS | 193ms |
| testStampImageWithScaleHeight | PdfStamperTest | PASS | 185ms |
| testStampImageWithExplicitDimensions | PdfStamperTest | PASS | 189ms |
...
| testRedactArea | TextRedactorTest | PASS | 195ms |
...
| testCustomRedactionColor | TextRedactorTest | PASS | 185ms |
...
| testSaveToFile | TextRedactorTest | PASS | 195ms |

### Arlington PDF Model — Dictionary-level spec conformance (keys, types, required fields, version constraints)

**6 tests** | 6 passed | 0 failed | 0 skipped | 1.26s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesBookmarksPdf | BookmarksTest | PASS | 309ms |
| testGeneratesDocumentFeaturesPdf | DocumentFeaturesTest | PASS | 190ms |
| testGeneratesPdfWithEmbeddedTrueTypeFont | DocumentFeaturesTest | PASS | 193ms |
...
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 6.61s |
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 16.73s
...
| testQpdfCorpus with data set "qpdf/annotations-rotated-270.pdf" | Tier2CorpusTest | PASS | 7ms |
...
| testQpdfCorpus with data set "qpdf/many-nulls.pdf" | Tier2CorpusTest | PASS | 683ms |
...
| testQpdfCorpus with data set "qpdf/recover-xref-stream.pdf" | Tier2CorpusTest | PASS | 24ms |
...
| testQpdfCorpus with data set "qpdf/uo-7.pdf" | Tier2CorpusTest | PASS | 3ms |
...
| testPdfBoxCorpus with data set "pdfbox/pdfbox/src/test/resources/org/apache/pdfbox/multipdf/Overlayed-with-rot0.pdf" | Tier2PdfBoxCorpusTest | PASS | 3ms |
...
**6 tests** | 6 passed | 0 failed | 0 skipped | 11.41s

| Test | Class | Status | Time |
|---|---|---|---|
| testTaggedDocumentValidatesWithUa1 | Tier3MatterhornTest | PASS | 2.15s |
| testAnnotationWithContentsPassesClause718 | Tier3MatterhornTest | PASS | 2.04s |
...
**25 tests** | 24 passed | 0 failed | 1 skipped | 8.19s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWellFormedAndValid | Tier4JhoveTest | PASS | 914ms |
| testMultiPagePdfWellFormedAndValid | Tier4JhoveTest | PASS | 876ms |
| testPdfWithMetadataWellFormedAndValid | Tier4JhoveTest | PASS | 863ms |
| testPdfWithEmbeddedFontWellFormedAndValid | Tier4JhoveTest | PASS | 859ms |
| testJhoveToolchainWorks | Tier4JhoveTest | PASS | 661ms |
| testPdfA1bPassesPdfBoxPreflight | Tier4PdfBoxPreflightTest | SKIP | <1ms |
| testPdfBoxPreflightToolchainWorks | Tier4PdfBoxPreflightTest | PASS | 761ms |
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 540ms |
| testPdfWithMetadataHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 528ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 with offset start.pdf" | Tier4Pdf20ExamplesTest | PASS | 185ms |
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 with page level output intent.pdf" | Tier4Pdf20ExamplesTest | PASS | 186ms |
| testPdf20ExampleQpdfValid with data set "pdf20/Simple PDF 2.0 file.pdf" | Tier4Pdf20ExamplesTest | PASS | 188ms |
