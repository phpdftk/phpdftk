...
Generated: 2026-06-10 18:21:00 UTC
PHP: 8.4.21
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 92.77s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 33.66s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.28s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 19.01s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 19s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 11.42s |
| &#x2705; JHOVE + PDF 2.0 + Security + Preflight | PASS | 25 | 24 | 0 | 1 | 8.4s |
...
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 706ms |
...
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 647ms |
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 474ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 141ms |
...
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 546ms |
...
| testToBytesProducesValidPdfOnEachCall | PdfTest | PASS | 385ms |
...
| testSetEncryptionAes256RoundTrip | WriterTest | PASS | 248ms |
...
| testSetMetadataOnPdfWithoutInfo | MetadataEditorTest | PASS | 197ms |
...
| testSetAlphabetic | PageLabelerTest | PASS | 204ms |
...
| testSaveToFile | PdfStamperTest | PASS | 211ms |
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 19s
...
| testQpdfCorpus with data set "qpdf/good15.pdf" | Tier2CorpusTest | PASS | 13ms |
...
| testQpdfCorpus with data set "qpdf/uo-6.pdf" | Tier2CorpusTest | PASS | 29ms |
...
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 9.91s |
...
**6 tests** | 6 passed | 0 failed | 0 skipped | 11.42s
...
**25 tests** | 24 passed | 0 failed | 1 skipped | 8.4s
...
| testPdfBoxPreflightToolchainWorks | Tier4PdfBoxPreflightTest | PASS | 782ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/pdf20-utf8-test.pdf" | Tier4Pdf20ExamplesTest | PASS | 222ms |
