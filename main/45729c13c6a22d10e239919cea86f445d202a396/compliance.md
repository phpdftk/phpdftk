...
Generated: 2026-05-08 20:03:33 UTC
PHP: 8.4.21
...
**Overall: PASS** | 1444 tests | 1438 passed | 0 failed | 6 skipped | 88.25s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 236 | 232 | 0 | 4 | 29.91s |
...
**236 tests** | 232 passed | 0 failed | 4 skipped | 29.91s
...
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 345ms |
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 181ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 139ms |
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 483ms |
...
| testNoBytesChangedWithoutModifications | MetadataEditorTest | PASS | 2ms |
...
| testStampImageJpeg | PdfStamperTest | PASS | 172ms |
...
| testStampPdf | PdfStamperTest | PASS | 199ms |
...
| testStampPdfThrowsOnNegativePageIndex | PdfStamperTest | PASS | 2ms |
...
| testPdfBoxCorpus with data set "pdfbox/pdfbox/src/test/resources/input/PDFBOX-5920-Y5U2XZCKG2U6TO3FC36NCGOZECHQA2PY-p39-reduced.pdf" | Tier2PdfBoxCorpusTest | PASS | 4ms |
