...
Generated: 2026-06-11 05:16:50 UTC
PHP: 8.4.21
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 90.83s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 34.14s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.31s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 17.84s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 17.93s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 11.28s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 34.14s
...
| testGeneratesDocumentFeaturesPdf | DocumentFeaturesTest | PASS | 251ms |
...
| testGeneratesGraphicsPdf | GraphicsTest | PASS | 220ms |
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 344ms |
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 511ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 362ms |
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 165ms |
...
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 939ms |
...
| testLongTextAutoPaginates | PdfTest | PASS | 184ms |
...
| testReplaceExistingBookmarks | BookmarkEditorTest | PASS | 191ms |
...
| testSetAlphabetic | PageLabelerTest | PASS | 232ms |
| testSetArabicWithStartNumber | PageLabelerTest | PASS | 208ms |
...
| testRotate180 | PageTransformerTest | PASS | 188ms |
...
| testStampText | PdfStamperTest | PASS | 209ms |
...
| testStampImageJpeg | PdfStamperTest | PASS | 210ms |
...
| testStampPdfDefaultsToCenter | PdfStamperTest | PASS | 197ms |
...
| testGeneratesSimpleTextPdf | SimpleTextTest | PASS | 214ms |
...
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 6.6s |
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 9.18s |
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 17.93s
...
**6 tests** | 6 passed | 0 failed | 0 skipped | 11.28s
...
| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWellFormedAndValid | Tier4JhoveTest | PASS | 944ms |
...
| testPdfBoxPreflightToolchainWorks | Tier4PdfBoxPreflightTest | PASS | 759ms |
...
| testPdfWithEmbeddedFontHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 555ms |
