...
Generated: 2026-06-07 23:39:37 UTC
PHP: 8.4.21
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 89.87s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 33.66s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.29s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 17.67s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 17.28s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 11.46s |
| &#x2705; JHOVE + PDF 2.0 + Security + Preflight | PASS | 25 | 24 | 0 | 1 | 8.51s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 33.66s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 301ms |
| testGeneratesAnnotationsPdf | AnnotationsTest | PASS | 183ms |
| testGeneratesBookmarksPdf | BookmarksTest | PASS | 250ms |
| testGeneratesFormWithCustomFontAppearances | CustomFontFormAppearancesTest | PASS | 225ms |
...
| testGeneratesPdfWithEmbeddedFont | EmbeddedFontsTest | PASS | 258ms |
...
| testGeneratesFormPdf | FormFieldsTest | PASS | 196ms |
| testGeneratesGraphicsPipelinePdf | GraphicsPipelineIntegrationTest | PASS | 189ms |
| testGeneratesGraphicsPdf | GraphicsTest | PASS | 184ms |
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 361ms |
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 441ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 282ms |
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 706ms |
| testGeneratesPdfWithMarkupFields | MarkupAnnotationsIntegrationTest | PASS | 193ms |
...
| testGeneratesPageLabelsPdf | PageLabelsTest | PASS | 191ms |
| testGeneratesSignatureFieldPdf | SignatureFieldIntegrationTest | PASS | 196ms |
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 317ms |
...
| testNoteCalloutEmitsLabelAndBody | CalloutTest | PASS | 211ms |
...
| testAddTextWithLinkStyleProducesLinkAnnotation | InlineLinkTest | PASS | 184ms |
...
| testAddTextCreatesFirstPageAutomatically | PdfTest | PASS | 212ms |
| testAddHeadingEmitsLargerText | PdfTest | PASS | 196ms |
| testExplicitNewPageCreatesSecondPage | PdfTest | PASS | 193ms |
| testLongTextAutoPaginates | PdfTest | PASS | 188ms |
| testAddSpacerConsumesVerticalSpace | PdfTest | PASS | 183ms |
| testAddRuleDrawsStroke | PdfTest | PASS | 192ms |
| testAlignmentCenterEmitsCenteredText | PdfTest | PASS | 189ms |
| testSetFontSwitchesFontFamily | PdfTest | PASS | 231ms |
...
| testSaveWritesFile | PdfTest | PASS | 218ms |
| testWriteToStream | PdfTest | PASS | 194ms |
| testWriteToRejectsNonResource | PdfTest | PASS | <1ms |
| testToBytesProducesValidPdfOnEachCall | PdfTest | PASS | 377ms |
...
| testAddTableRendersAllCellValues | TableTest | PASS | 186ms |
...
| testAddCompositeFontGeneratesValidPdf | UnicodeFontTest | PASS | 192ms |
...
| testCompositeFontPerPage | UnicodeFontTest | PASS | 191ms |
...
| testPdfWriterContainsPage | WriterTest | PASS | 189ms |
...
| testPdfWriterAddContentStream | WriterTest | PASS | 191ms |
| testPdfWriterGetContentStreams | WriterTest | PASS | <1ms |
| testPdfWriterWithInfo | WriterTest | PASS | 186ms |
...
| testSetNamedDestinations | WriterTest | PASS | 181ms |
...
| testFlattenAll | AnnotationFlattenerTest | PASS | 295ms |
...
| testSaveToFile | AnnotationFlattenerTest | PASS | 184ms |
...
| testAddBookmark | BookmarkEditorTest | PASS | 401ms |
...
| testUncheckCheckbox | FormFillerTest | PASS | 183ms |
| testSelectChoiceField | FormFillerTest | PASS | 189ms |
| testFillMultipleFieldTypes | FormFillerTest | PASS | 193ms |
...
| testSetMultipleFieldsRoundTrip | MetadataEditorTest | PASS | 189ms |
...
| testCustomField | MetadataEditorTest | PASS | 190ms |
| testSaveToFile | MetadataEditorTest | PASS | 202ms |
| testSetLabelsWithArabic | PageLabelerTest | PASS | 192ms |
| testSetRomanNumerals | PageLabelerTest | PASS | 197ms |
| testSetRomanNumeralsUppercase | PageLabelerTest | PASS | 196ms |
| testSetAlphabetic | PageLabelerTest | PASS | 192ms |
| testSetArabicWithStartNumber | PageLabelerTest | PASS | 195ms |
| testSetLabelsWithPrefix | PageLabelerTest | PASS | 193ms |
| testRemoveLabels | PageLabelerTest | PASS | 222ms |
| testMultipleRanges | PageLabelerTest | PASS | 208ms |
...
| testSplit | PageSlicerTest | PASS | 385ms |
...
| testRotateCumulative | PageTransformerTest | PASS | 196ms |
...
| testScaleSpecificPages | PageTransformerTest | PASS | 187ms |
| testScaleInvalidFactor | PageTransformerTest | PASS | <1ms |
| testScaleTo | PageTransformerTest | PASS | 193ms |
...
| testEvenPages | PageTransformerTest | PASS | 197ms |
...
| testEncryptAes256 | PdfEncryptTest | PASS | 206ms |
| testDecrypt | PdfEncryptTest | PASS | 188ms |
...
| testMergeTwoPdfs | PdfMergerTest | PASS | 208ms |
...
| testStampImageWithScaleWidth | PdfStamperTest | PASS | 200ms |
| testStampImageWithScaleHeight | PdfStamperTest | PASS | 186ms |
| testStampImageWithExplicitDimensions | PdfStamperTest | PASS | 191ms |
...
| testRedactArea | TextRedactorTest | PASS | 189ms |
...
| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesBookmarksPdf | BookmarksTest | PASS | 318ms |
| testGeneratesDocumentFeaturesPdf | DocumentFeaturesTest | PASS | 189ms |
| testGeneratesPdfWithEmbeddedTrueTypeFont | DocumentFeaturesTest | PASS | 208ms |
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 17.28s
...
| testQpdfCorpus with data set "qpdf/appearances-a-more2.pdf" | Tier2CorpusTest | PASS | 8ms |
...
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 6.71s |
...
| testPdfBoxCorpus with data set "pdfbox/pdfbox/src/test/resources/input/PDFBOX-5920-4MQTG6ZXOYSMTQ444KGQOVC6ZFQHWFNY-spaces-reduced.pdf" | Tier2PdfBoxCorpusTest | PASS | 2ms |
| testPdfBoxCorpus with data set "pdfbox/pdfbox/src/test/resources/input/PDFBOX-5920-Y5U2XZCKG2U6TO3FC36NCGOZECHQA2PY-p39-reduced.pdf" | Tier2PdfBoxCorpusTest | PASS | 3ms |
| testPdfBoxCorpus with data set "pdfbox/pdfbox/src/test/resources/input/compression/acroform.pdf" | Tier2PdfBoxCorpusTest | PASS | 3ms |
...
**6 tests** | 6 passed | 0 failed | 0 skipped | 11.46s

| Test | Class | Status | Time |
|---|---|---|---|
| testTaggedDocumentValidatesWithUa1 | Tier3MatterhornTest | PASS | 2.09s |
| testAnnotationWithContentsPassesClause718 | Tier3MatterhornTest | PASS | 2.08s |
| testUntaggedDocumentFailsUa1 | Tier3MatterhornTest | PASS | 1.83s |
| testMissingLangFailsUa1 | Tier3MatterhornTest | PASS | 1.7s |
| testMissingDisplayDocTitleFailsUa1 | Tier3MatterhornTest | PASS | 1.85s |
...
**25 tests** | 24 passed | 0 failed | 1 skipped | 8.51s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWellFormedAndValid | Tier4JhoveTest | PASS | 939ms |
| testMultiPagePdfWellFormedAndValid | Tier4JhoveTest | PASS | 894ms |
| testPdfWithMetadataWellFormedAndValid | Tier4JhoveTest | PASS | 863ms |
| testPdfWithEmbeddedFontWellFormedAndValid | Tier4JhoveTest | PASS | 857ms |
| testJhoveToolchainWorks | Tier4JhoveTest | PASS | 682ms |
...
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 725ms |
| testPdfWithMetadataHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 532ms |
| testPdfWithEmbeddedFontHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 540ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 UTF-8 string and annotation.pdf" | Tier4Pdf20ExamplesTest | PASS | 185ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 with page level output intent.pdf" | Tier4Pdf20ExamplesTest | PASS | 196ms |
