...
Generated: 2026-05-25 02:34:07 UTC
PHP: 8.4.21
...
**Overall: PASS** | 1662 tests | 1656 passed | 0 failed | 6 skipped | 89.06s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 454 | 450 | 0 | 4 | 30.85s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.24s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 18.86s |
...
**454 tests** | 450 passed | 0 failed | 4 skipped | 30.85s
...
| testGeneratesFormWithAppearances | FormAppearancesIntegrationTest | PASS | 181ms |
...
| testGeneratesGraphicsPdf | GraphicsTest | PASS | 174ms |
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 319ms |
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 140ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 291ms |
...
| testGeneratesMultimediaAnd3DPdf | MultimediaAndThreeDIntegrationTest | PASS | 174ms |
...
| testGeneratesSignatureFieldPdf | SignatureFieldIntegrationTest | PASS | 177ms |
...
| testWinAnsiRoundTripFromShowText | EncodingIntegrationTest | PASS | 180ms |
| testHighLevelPdfRoundTrip | EncodingIntegrationTest | PASS | 4ms |
| testAddTextWithLinkStyleProducesLinkAnnotation | InlineLinkTest | PASS | 177ms |
...
| testAddPageDelegatesToWriter | PdfDocTest | PASS | 179ms |
...
| testGeneratesHighLevelDocument | PdfIntegrationTest | PASS | 362ms |
| testAddHtmlRendersIntoPdf | PdfTest | PASS | 25ms |
| testEmptyDocumentHasNoPages | PdfTest | PASS | 185ms |
| testAddTextCreatesFirstPageAutomatically | PdfTest | PASS | 177ms |
| testAddHeadingEmitsLargerText | PdfTest | PASS | 176ms |
...
| testAlignmentCenterEmitsCenteredText | PdfTest | PASS | 172ms |
| testSetFontSwitchesFontFamily | PdfTest | PASS | 180ms |
| testBoldAndItalicResolveToCorrectPostScriptName | PdfTest | PASS | 178ms |
| testUnknownFamilyIsRejected | PdfTest | PASS | <1ms |
| testCustomTheme | PdfTest | PASS | 176ms |
| testSaveWritesFile | PdfTest | PASS | 183ms |
| testWriteToStream | PdfTest | PASS | 181ms |
| testWriteToRejectsNonResource | PdfTest | PASS | <1ms |
| testToBytesProducesValidPdfOnEachCall | PdfTest | PASS | 352ms |
...
| testAddCompositeFontSavesToFile | UnicodeFontTest | PASS | 179ms |
...
| testMetadataRoundTrip | XmpMetadataTest | PASS | 178ms |
...
| testAddBookmark | BookmarkEditorTest | PASS | 359ms |
...
| testSaveToFile | BookmarkEditorTest | PASS | 176ms |
...
| testFillMultipleFieldTypes | FormFillerTest | PASS | 177ms |
...
| testSaveWritesFile | FormFillerTest | PASS | 178ms |
...
| testSetMetadataOnPdfWithoutInfo | MetadataEditorTest | PASS | 174ms |
...
| testSetLabelsWithArabic | PageLabelerTest | PASS | 184ms |
...
| testReverse | PageSlicerTest | PASS | 180ms |
| testSplit | PageSlicerTest | PASS | 351ms |
...
| testMergeTwoPdfs | PdfMergerTest | PASS | 177ms |
...
| testPageNumbers | PdfStamperTest | PASS | 177ms |
...
| testStampImageCombinedWithText | PdfStamperTest | PASS | 178ms |
...
| testStampPdfSpecificPage | PdfStamperTest | PASS | 178ms |
...
| testRedactMultipleAreas | TextRedactorTest | PASS | 174ms |
...
**4 tests** | 3 passed | 0 failed | 1 skipped | 18.86s
...
| testQpdfCorpus with data set "qpdf/empty-decode-parms.pdf" | Tier2CorpusTest | PASS | 7ms |
...
| testQpdfCorpus with data set "qpdf/many-nulls.pdf" | Tier2CorpusTest | PASS | 679ms |
...
| testQpdfCorpus with data set "qpdf/nontrivial-crypt-filter-decrypted.pdf" | Tier2CorpusTest | PASS | 23ms |
...
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 7.26s |
...
| testPdfBoxCorpus with data set "pdfbox/pdfbox/src/test/resources/input/PDFBOX-5838-0024320-reduced.pdf" | Tier2PdfBoxCorpusTest | PASS | 4ms |
...
| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWellFormedAndValid | Tier4JhoveTest | PASS | 890ms |
| testMultiPagePdfWellFormedAndValid | Tier4JhoveTest | PASS | 859ms |
| testPdfWithMetadataWellFormedAndValid | Tier4JhoveTest | PASS | 833ms |
...
| testPdfBoxPreflightToolchainWorks | Tier4PdfBoxPreflightTest | PASS | 763ms |
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 719ms |
| testPdfWithMetadataHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 513ms |
| testPdfWithEmbeddedFontHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 508ms |
| testPdfIdToolchainWorks | Tier4PdfIdTest | PASS | 327ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 via incremental save.pdf" | Tier4Pdf20ExamplesTest | PASS | 176ms |
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 with offset start.pdf" | Tier4Pdf20ExamplesTest | PASS | 178ms |
