...
Generated: 2026-06-17 00:34:01 UTC
PHP: 8.4.22
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 88.27s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 32.48s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.25s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 18.06s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 17.09s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 32.48s
...
| testGeneratesFormWithCustomFontAppearances | CustomFontFormAppearancesTest | PASS | 256ms |
...
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 332ms |
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 291ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 87ms |
...
| testGeneratesMultimediaAnd3DPdf | MultimediaAndThreeDIntegrationTest | PASS | 248ms |
...
| testPdfWriterWithInfo | WriterTest | PASS | 222ms |
...
| testSetEncryptionProducesEncryptedPdf | WriterTest | PASS | 181ms |
...
| testSyncInfoToMetadataNoInfoIsNoOp | XmpMetadataTest | PASS | 243ms |
...
| testSaveToFile | AnnotationFlattenerTest | PASS | 223ms |
...
| testRotate270 | PageTransformerTest | PASS | 231ms |
...
| testSetCropBox | PageTransformerTest | PASS | 229ms |
...
| testStampImageJpeg | PdfStamperTest | PASS | 226ms |
...
| testStampImageWithOpacity | PdfStamperTest | PASS | 223ms |
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 17.09s
...
| testQpdfCorpus with data set "qpdf/deterministic-id-in.pdf" | Tier2CorpusTest | PASS | 13ms |
...
| testQpdfCorpus with data set "qpdf/rotated-shared-annotations-2.pdf" | Tier2CorpusTest | PASS | 29ms |
...
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 6.66s |
