...
Generated: 2026-06-17 14:30:36 UTC
PHP: 8.4.22
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 96.52s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 34.26s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.3s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 20.16s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 20.06s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 12.15s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 34.26s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 679ms |
| testGeneratesAnnotationsPdf | AnnotationsTest | PASS | 218ms |
...
| testGeneratesDocumentFeaturesPdf | DocumentFeaturesTest | PASS | 204ms |
| testGeneratesPdfWithEmbeddedTrueTypeFont | DocumentFeaturesTest | PASS | 208ms |
| testGeneratesPdfWithEmbeddedFont | EmbeddedFontsTest | PASS | 217ms |
...
| testGeneratesPdfWithEmbeddedType1 | EmbeddedType1FontTest | PASS | 201ms |
...
| testGeneratesFormPdf | FormFieldsTest | PASS | 212ms |
| testGeneratesGraphicsPipelinePdf | GraphicsPipelineIntegrationTest | PASS | 196ms |
| testGeneratesGraphicsPdf | GraphicsTest | PASS | 199ms |
...
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 279ms |
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 125ms |
...
| testGeneratesSignatureFieldPdf | SignatureFieldIntegrationTest | PASS | 199ms |
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 417ms |
| testGeneratesSimpleTextPdf | SimpleTextTest | PASS | 188ms |
| testGeneratesPdfWithType3Font | Type3FontIntegrationTest | PASS | 202ms |
| testGeneratesPdfWithXrefAndObjectStreams | XRefStreamIntegrationTest | PASS | 218ms |
| testEnableOutlineThenHeadingRegistersOutlinesEntry | AutoOutlineTest | PASS | 220ms |
...
| testNoteCalloutEmitsLabelAndBody | CalloutTest | PASS | 227ms |
...
| testEmptyDocumentHasNoPages | PdfTest | PASS | 203ms |
...
| testAddSpacerConsumesVerticalSpace | PdfTest | PASS | 203ms |
| testAddRuleDrawsStroke | PdfTest | PASS | 192ms |
| testAlignmentCenterEmitsCenteredText | PdfTest | PASS | 201ms |
...
| testToBytesProducesValidPdfOnEachCall | PdfTest | PASS | 402ms |
...
| testCompositeFontRoundTripsThroughReader | UnicodeFontTest | PASS | 217ms |
...
| testSetEncryptionAes256RoundTrip | WriterTest | PASS | 233ms |
...
| testRemoveBookmarks | BookmarkEditorTest | PASS | 211ms |
...
| testCheckCheckbox | FormFillerTest | PASS | 211ms |
| testUncheckCheckbox | FormFillerTest | PASS | 220ms |
...
| testSetTitleRoundTrip | MetadataEditorTest | PASS | 210ms |
...
| testSaveToFile | MetadataEditorTest | PASS | 205ms |
...
| testSaveToFile | PageLabelerTest | PASS | 207ms |
...
| testRemovePages | PageSlicerTest | PASS | 198ms |
...
| testRotateAllPages | PageTransformerTest | PASS | 215ms |
| testRotate180 | PageTransformerTest | PASS | 210ms |
| testRotate270 | PageTransformerTest | PASS | 214ms |
| testRotateSpecificPages | PageTransformerTest | PASS | 203ms |
| testRotateCumulative | PageTransformerTest | PASS | 210ms |
| testRotateInvalidAngle | PageTransformerTest | PASS | <1ms |
| testSetCropBox | PageTransformerTest | PASS | 217ms |
| testSetCropBoxSpecificPage | PageTransformerTest | PASS | 209ms |
...
| testRange | PageTransformerTest | PASS | 205ms |
...
| testEncryptAes128 | PdfEncryptTest | PASS | 203ms |
| testEncryptAes256 | PdfEncryptTest | PASS | 215ms |
| testDecrypt | PdfEncryptTest | PASS | 215ms |
...
| testMergeTwoPdfs | PdfMergerTest | PASS | 199ms |
| testMergeWithPageSelection | PdfMergerTest | PASS | 205ms |
...
| testPageNumbers | PdfStamperTest | PASS | 213ms |
...
| testStampPdfWithScaling | PdfStamperTest | PASS | 195ms |
...
| testRedactArea | TextRedactorTest | PASS | 196ms |
...
**4 tests** | 3 passed | 0 failed | 1 skipped | 20.16s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWithOutputIntent | PdfAConformanceTest | SKIP | 5ms |
| testVeraPdfToolchainWorks | PdfAConformanceTest | PASS | 2.07s |
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 20.06s
...
| testPopplerCorpus with data set "poppler-test/unittestcases/signature/invalid/etsi_rsa_mismatch.pdf" | Tier2CorpusTest | PASS | 2ms |
...
| testQpdfCorpus with data set "qpdf/inline-images-ii-all.pdf" | Tier2CorpusTest | PASS | 20ms |
...
| testQpdfCorpus with data set "qpdf/json-changed-need-appearances.pdf" | Tier2CorpusTest | PASS | 2ms |
...
| testQpdfCorpus with data set "qpdf/lin-delete-and-reuse.pdf" | Tier2CorpusTest | PASS | 2ms |
...
| testQpdfCorpus with data set "qpdf/lin1.pdf" | Tier2CorpusTest | PASS | 2ms |
| testQpdfCorpus with data set "qpdf/lin2.pdf" | Tier2CorpusTest | PASS | 2ms |
...
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 10.97s |
...
**6 tests** | 6 passed | 0 failed | 0 skipped | 12.15s
...
| testMissingLangFailsUa1 | Tier3MatterhornTest | PASS | 1.99s |
| testMissingDisplayDocTitleFailsUa1 | Tier3MatterhornTest | PASS | 1.75s |
| testAnnotationWithoutContentsFailsUa1 | Tier3MatterhornTest | PASS | 2.08s |
...
| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWellFormedAndValid | Tier4JhoveTest | PASS | 981ms |
| testMultiPagePdfWellFormedAndValid | Tier4JhoveTest | PASS | 923ms |
| testPdfWithMetadataWellFormedAndValid | Tier4JhoveTest | PASS | 874ms |
...
| testPdfIdToolchainWorks | Tier4PdfIdTest | PASS | 357ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 UTF-8 string and annotation.pdf" | Tier4Pdf20ExamplesTest | PASS | 213ms |
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 image with BPC.pdf" | Tier4Pdf20ExamplesTest | PASS | 197ms |
