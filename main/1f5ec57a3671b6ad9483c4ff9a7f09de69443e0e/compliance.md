...
Generated: 2026-06-17 01:26:06 UTC
PHP: 8.4.22
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 86.02s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 31.55s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 31.55s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 275ms |
...
| testGeneratesPdfWithEmbeddedFont | EmbeddedFontsTest | PASS | 186ms |
...
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 382ms |
...
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 298ms |
...
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 517ms |
...
| testAddCompositeFontGeneratesValidPdf | UnicodeFontTest | PASS | 185ms |
...
| testCustomField | MetadataEditorTest | PASS | 179ms |
| testSaveToFile | MetadataEditorTest | PASS | 175ms |
...
| testSetLabelsWithPrefix | PageLabelerTest | PASS | 181ms |
...
| testStampImageWithScaleHeight | PdfStamperTest | PASS | 214ms |
...
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 8.45s |
...
| testAnnotationWithContentsPassesClause718 | Tier3MatterhornTest | PASS | 1.84s |
...
| testPdfWithMetadataWellFormedAndValid | Tier4JhoveTest | PASS | 840ms |
...
| testPdfBoxPreflightToolchainWorks | Tier4PdfBoxPreflightTest | PASS | 746ms |
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 523ms |
