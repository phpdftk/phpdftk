...
Generated: 2026-06-17 14:57:52 UTC
PHP: 8.4.22
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 88.77s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 32.1s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.27s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 18.31s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 17.82s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 11s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 32.1s
...
| testGeneratesBookmarksPdf | BookmarksTest | PASS | 235ms |
| testGeneratesFormWithCustomFontAppearances | CustomFontFormAppearancesTest | PASS | 200ms |
...
| testGeneratesPdfWithEmbeddedType1 | EmbeddedType1FontTest | PASS | 205ms |
...
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 317ms |
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 115ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 204ms |
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 352ms |
...
| testGeneratesPageLabelsPdf | PageLabelsTest | PASS | 194ms |
...
| testCustomTheme | PdfTest | PASS | 188ms |
| testSaveWritesFile | PdfTest | PASS | 195ms |
| testWriteToStream | PdfTest | PASS | 190ms |
...
| testAddCompositeFontSavesToFile | UnicodeFontTest | PASS | 201ms |
...
| testCompositeFontPerPage | UnicodeFontTest | PASS | 187ms |
...
| testSetBookmarksWithChildren | BookmarkEditorTest | PASS | 186ms |
| testAddBookmark | BookmarkEditorTest | PASS | 386ms |
...
| testUncheckCheckbox | FormFillerTest | PASS | 184ms |
...
| testSetLabelsWithPrefix | PageLabelerTest | PASS | 189ms |
| testRemoveLabels | PageLabelerTest | PASS | 186ms |
...
| testRotate270 | PageTransformerTest | PASS | 186ms |
...
| testSetCropBox | PageTransformerTest | PASS | 184ms |
...
| testScaleToNonUniform | PageTransformerTest | PASS | 216ms |
...
| testMergeWithPageSelection | PdfMergerTest | PASS | 180ms |
...
| testCustomRedactionColor | TextRedactorTest | PASS | 180ms |
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 17.82s
...
| testQpdfCorpus with data set "qpdf/many-nulls.pdf" | Tier2CorpusTest | PASS | 689ms |
...
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 6.99s |
...
**6 tests** | 6 passed | 0 failed | 0 skipped | 11s
...
| testMissingDisplayDocTitleFailsUa1 | Tier3MatterhornTest | PASS | 1.79s |
...
| testMultiPagePdfWellFormedAndValid | Tier4JhoveTest | PASS | 889ms |
...
| testJhoveToolchainWorks | Tier4JhoveTest | PASS | 674ms |
| testPdfA1bPassesPdfBoxPreflight | Tier4PdfBoxPreflightTest | SKIP | <1ms |
| testPdfBoxPreflightToolchainWorks | Tier4PdfBoxPreflightTest | PASS | 768ms |
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 543ms |
...
| testPdfIdToolchainWorks | Tier4PdfIdTest | PASS | 338ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 via incremental save.pdf" | Tier4Pdf20ExamplesTest | PASS | 190ms |
