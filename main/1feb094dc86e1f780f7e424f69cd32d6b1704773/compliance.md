...
Generated: 2026-06-17 02:51:48 UTC
PHP: 8.4.22
...
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 18.06s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 17.59s |
...
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 465ms |
| testGeneratesAnnotationsPdf | AnnotationsTest | PASS | 180ms |
| testGeneratesBookmarksPdf | BookmarksTest | PASS | 232ms |
| testGeneratesFormWithCustomFontAppearances | CustomFontFormAppearancesTest | PASS | 251ms |
...
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 66ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 270ms |
...
| testAddTextWithLinkStyleProducesLinkAnnotation | InlineLinkTest | PASS | 176ms |
...
| testLongTextAutoPaginates | PdfTest | PASS | 178ms |
...
| testRoundTripPreservesOtherFields | FormFillerTest | PASS | 181ms |
...
| testKeepWithPageSelector | PageSlicerTest | PASS | 171ms |
...
| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesBookmarksPdf | BookmarksTest | PASS | 286ms |
...
**4 tests** | 3 passed | 0 failed | 1 skipped | 18.06s
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 17.59s
...
| testQpdfCorpus with data set "qpdf/delete-and-reuse.pdf" | Tier2CorpusTest | PASS | 10ms |
...
| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWellFormedAndValid | Tier4JhoveTest | PASS | 901ms |
...
| testPdfBoxPreflightToolchainWorks | Tier4PdfBoxPreflightTest | PASS | 758ms |
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 527ms |
| testPdfWithMetadataHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 523ms |
| testPdfWithEmbeddedFontHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 499ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 image with BPC.pdf" | Tier4Pdf20ExamplesTest | PASS | 174ms |
