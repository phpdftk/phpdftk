...
Generated: 2026-06-13 13:10:34 UTC
PHP: 8.4.22
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 91s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 33.69s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.35s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 18.33s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 33.69s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 283ms |
...
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 362ms |
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 250ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 299ms |
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 238ms |
...
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 555ms |
...
| testSelectChoiceField | FormFillerTest | PASS | 210ms |
...
| testSetMetadataOnPdfWithoutInfo | MetadataEditorTest | PASS | 204ms |
...
| testReorder | PageSlicerTest | PASS | 206ms |
| testReverse | PageSlicerTest | PASS | 189ms |
| testSplit | PageSlicerTest | PASS | 396ms |
| testKeepWithPageSelector | PageSlicerTest | PASS | 210ms |
...
| testRotate180 | PageTransformerTest | PASS | 205ms |
...
| testStampText | PdfStamperTest | PASS | 207ms |
| testWatermark | PdfStamperTest | PASS | 221ms |
...
| testStampPdfOnSelectedPages | PdfStamperTest | PASS | 214ms |
| testStampPdfDefaultsToCenter | PdfStamperTest | PASS | 227ms |
| testStampPdfThrowsOnMissingFile | PdfStamperTest | PASS | 1ms |
| testStampPdfThrowsOnInvalidPageIndex | PdfStamperTest | PASS | 6ms |
...
| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesBookmarksPdf | BookmarksTest | PASS | 330ms |
| testGeneratesDocumentFeaturesPdf | DocumentFeaturesTest | PASS | 205ms |
| testGeneratesPdfWithEmbeddedTrueTypeFont | DocumentFeaturesTest | PASS | 221ms |
...
**4 tests** | 3 passed | 0 failed | 1 skipped | 18.33s
...
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 9.45s |
...
| testQpdfCorpus with data set "qpdf/sample-form-out.pdf" | Tier2CorpusTest | PASS | 32ms |
...
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 9.29s |
...
| testAnnotationWithoutContentsFailsUa1 | Tier3MatterhornTest | PASS | 1.93s |
...
| testPdfBoxPreflightToolchainWorks | Tier4PdfBoxPreflightTest | PASS | 744ms |
