...
Generated: 2026-06-19 18:18:27 UTC
PHP: 8.4.22
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 88.61s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 31.51s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.23s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 18.08s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 31.51s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 359ms |
| testGeneratesAnnotationsPdf | AnnotationsTest | PASS | 208ms |
...
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 300ms |
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 129ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 251ms |
...
| testFillManyFields | FormFillerTest | PASS | 178ms |
...
| testSetMultipleFieldsRoundTrip | MetadataEditorTest | PASS | 205ms |
...
| testScaleTo | PageTransformerTest | PASS | 198ms |
...
**4 tests** | 3 passed | 0 failed | 1 skipped | 18.08s
