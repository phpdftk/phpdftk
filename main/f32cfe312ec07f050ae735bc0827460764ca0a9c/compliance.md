...
Generated: 2026-05-24 20:55:51 UTC
PHP: 8.4.21
...
**Overall: PASS** | 1662 tests | 1656 passed | 0 failed | 6 skipped | 92.23s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 454 | 450 | 0 | 4 | 32.91s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.29s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 18.93s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 18.61s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 12.07s |
| &#x2705; JHOVE + PDF 2.0 + Security + Preflight | PASS | 25 | 24 | 0 | 1 | 8.42s |
...
**454 tests** | 450 passed | 0 failed | 4 skipped | 32.91s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 419ms |
...
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 460ms |
...
| testGeneratesSignatureFieldPdf | SignatureFieldIntegrationTest | PASS | 201ms |
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 439ms |
...
| testGeneratesHighLevelDocument | PdfIntegrationTest | PASS | 396ms |
...
| testSetEncryptionAes256RoundTrip | WriterTest | PASS | 244ms |
...
| testFlattenAll | AnnotationFlattenerTest | PASS | 217ms |
...
| testSetBookmarks | BookmarkEditorTest | PASS | 193ms |
| testSetBookmarksWithChildren | BookmarkEditorTest | PASS | 195ms |
| testAddBookmark | BookmarkEditorTest | PASS | 384ms |
...
| testFillManyFields | FormFillerTest | PASS | 194ms |
...
| testSetRomanNumeralsUppercase | PageLabelerTest | PASS | 195ms |
| testSetAlphabetic | PageLabelerTest | PASS | 192ms |
| testSetArabicWithStartNumber | PageLabelerTest | PASS | 196ms |
| testSetLabelsWithPrefix | PageLabelerTest | PASS | 204ms |
...
| testSaveToFile | PageLabelerTest | PASS | 206ms |
...
| testNoOpsKeepsAllPages | PageSlicerTest | PASS | 191ms |
...
| testRotate180 | PageTransformerTest | PASS | 193ms |
...
| testEncryptRc440 | PdfEncryptTest | PASS | 3ms |
...
| testStampImageJpeg | PdfStamperTest | PASS | 214ms |
...
**4 tests** | 3 passed | 0 failed | 1 skipped | 18.93s
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 18.61s
...
| testQpdfCorpus with data set "qpdf/c-normalized-content.pdf" | Tier2CorpusTest | PASS | 2ms |
...
| testQpdfCorpus with data set "qpdf/c-object-streams.pdf" | Tier2CorpusTest | PASS | 7ms |
...
| testQpdfCorpus with data set "qpdf/c-r3.pdf" | Tier2CorpusTest | PASS | 4ms |
...
| testQpdfCorpus with data set "qpdf/c-r6-in.pdf" | Tier2CorpusTest | PASS | 4ms |
...
| testQpdfCorpus with data set "qpdf/extensions-adbe-other-force-1.8.5.pdf" | Tier2CorpusTest | PASS | 8ms |
...
| testQpdfCorpus with data set "qpdf/overlay-copy-annotations-p6.pdf" | Tier2CorpusTest | PASS | 24ms |
...
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 7.6s |
...
| testPdfBoxCorpus with data set "pdfbox/pdfbox/src/test/resources/input/merge/PDFBOX-4417-054080.pdf" | Tier2PdfBoxCorpusTest | PASS | 4ms |
...
| testPdfiumCorpus with data set "pdfium/bug_861842.pdf" | Tier2PdfiumCorpusTest | PASS | 3ms |
...
**6 tests** | 6 passed | 0 failed | 0 skipped | 12.07s

| Test | Class | Status | Time |
|---|---|---|---|
| testTaggedDocumentValidatesWithUa1 | Tier3MatterhornTest | PASS | 2.3s |
...
**25 tests** | 24 passed | 0 failed | 1 skipped | 8.42s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWellFormedAndValid | Tier4JhoveTest | PASS | 920ms |
| testMultiPagePdfWellFormedAndValid | Tier4JhoveTest | PASS | 907ms |
| testPdfWithMetadataWellFormedAndValid | Tier4JhoveTest | PASS | 844ms |
| testPdfWithEmbeddedFontWellFormedAndValid | Tier4JhoveTest | PASS | 856ms |
| testJhoveToolchainWorks | Tier4JhoveTest | PASS | 653ms |
| testPdfA1bPassesPdfBoxPreflight | Tier4PdfBoxPreflightTest | SKIP | <1ms |
| testPdfBoxPreflightToolchainWorks | Tier4PdfBoxPreflightTest | PASS | 770ms |
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 762ms |
| testPdfWithMetadataHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 513ms |
