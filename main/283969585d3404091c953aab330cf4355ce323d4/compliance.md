...
Generated: 2026-06-10 13:49:44 UTC
PHP: 8.4.21
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 89.86s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 32.08s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.24s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 18.32s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 18.08s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 11.72s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 32.08s
...
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 298ms |
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 303ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 255ms |
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 265ms |
...
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 777ms |
...
| testGeneratesHighLevelDocument | PdfIntegrationTest | PASS | 366ms |
...
| testCustomTheme | PdfTest | PASS | 178ms |
...
| testPdfWriterGeneratesValidPdfHeader | WriterTest | PASS | 173ms |
...
| testPdfWriterContainsPage | WriterTest | PASS | 175ms |
...
| testSetEncryptionProducesEncryptedPdf | WriterTest | PASS | 180ms |
| testSetEncryptionAes256RoundTrip | WriterTest | PASS | 197ms |
...
| testSetBookmarksWithChildren | BookmarkEditorTest | PASS | 181ms |
| testAddBookmark | BookmarkEditorTest | PASS | 358ms |
...
| testReplaceExistingBookmarks | BookmarkEditorTest | PASS | 187ms |
...
| testSaveWritesFile | FormFillerTest | PASS | 184ms |
...
| testCustomField | MetadataEditorTest | PASS | 175ms |
...
| testSetRomanNumeralsUppercase | PageLabelerTest | PASS | 178ms |
...
| testMultipleRanges | PageLabelerTest | PASS | 186ms |
...
| testOddPages | PageTransformerTest | PASS | 180ms |
...
| testMergeTwoPdfs | PdfMergerTest | PASS | 176ms |
...
| testStampPdf | PdfStamperTest | PASS | 206ms |
| testStampPdfWithScaling | PdfStamperTest | PASS | 198ms |
...
**4 tests** | 3 passed | 0 failed | 1 skipped | 18.32s
...
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 9.33s |
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 18.08s
...
| testQpdfCorpus with data set "qpdf/good17.pdf" | Tier2CorpusTest | PASS | 11ms |
...
| testQpdfCorpus with data set "qpdf/utf16le.pdf" | Tier2CorpusTest | PASS | 24ms |
...
**6 tests** | 6 passed | 0 failed | 0 skipped | 11.72s
...
| testPdfWithMetadataWellFormedAndValid | Tier4JhoveTest | PASS | 848ms |
| testPdfWithEmbeddedFontWellFormedAndValid | Tier4JhoveTest | PASS | 872ms |
| testJhoveToolchainWorks | Tier4JhoveTest | PASS | 684ms |
| testPdfA1bPassesPdfBoxPreflight | Tier4PdfBoxPreflightTest | SKIP | <1ms |
| testPdfBoxPreflightToolchainWorks | Tier4PdfBoxPreflightTest | PASS | 802ms |
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 553ms |
| testPdfWithMetadataHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 516ms |
| testPdfWithEmbeddedFontHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 512ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 UTF-8 string and annotation.pdf" | Tier4Pdf20ExamplesTest | PASS | 182ms |
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 image with BPC.pdf" | Tier4Pdf20ExamplesTest | PASS | 368ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 with page level output intent.pdf" | Tier4Pdf20ExamplesTest | PASS | 179ms |
