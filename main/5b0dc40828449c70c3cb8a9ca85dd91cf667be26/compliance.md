...
Generated: 2026-05-24 15:13:37 UTC
PHP: 8.4.21
...
**Overall: PASS** | 1662 tests | 1656 passed | 0 failed | 6 skipped | 87.9s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 454 | 450 | 0 | 4 | 31.08s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.22s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 17.98s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 17.76s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 11.57s |
...
**454 tests** | 450 passed | 0 failed | 4 skipped | 31.08s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 370ms |
...
| testGeneratesPdfWithEmbeddedType1 | EmbeddedType1FontTest | PASS | 178ms |
| testPdfOutputContainsFontData | EmbeddedType1FontTest | PASS | <1ms |
| testGeneratesExtGStatePdf | ExtGStateIntegrationTest | PASS | 176ms |
| testGeneratesFormWithAppearances | FormAppearancesIntegrationTest | PASS | 178ms |
...
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 490ms |
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 262ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 85ms |
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 173ms |
...
| testAddQuoteIndentsTextByThemeQuoteIndent | BlockquoteTest | PASS | 7ms |
...
| testAddHtmlRendersIntoPdf | PdfTest | PASS | 22ms |
| testEmptyDocumentHasNoPages | PdfTest | PASS | 178ms |
| testAddTextCreatesFirstPageAutomatically | PdfTest | PASS | 175ms |
| testAddHeadingEmitsLargerText | PdfTest | PASS | 179ms |
...
| testToBytesProducesValidPdfOnEachCall | PdfTest | PASS | 351ms |
...
| testAddTableWithBorderWidthZeroSkipsBorderOps | TableTest | PASS | 4ms |
...
| testPdfWriterAddPageWithRectangle | WriterTest | PASS | 174ms |
| testPdfWriterRegisterObject | WriterTest | PASS | 184ms |
| testPdfWriterFontAddedToPage | WriterTest | PASS | 175ms |
...
| testSetMetadataAddsStreamToPdf | XmpMetadataTest | PASS | 175ms |
...
| testAddBookmark | BookmarkEditorTest | PASS | 367ms |
...
| testGetFieldInfoReturnsNullForMissing | FormFillerTest | PASS | 4ms |
...
| testCheckThrowsForUnknownField | FormFillerTest | PASS | 2ms |
...
| testSetMultipleFieldsRoundTrip | MetadataEditorTest | PASS | 173ms |
...
| testEscapeHatch | MetadataEditorTest | PASS | 2ms |
...
| testSetRomanNumerals | PageLabelerTest | PASS | 178ms |
| testSetRomanNumeralsUppercase | PageLabelerTest | PASS | 207ms |
| testSetAlphabetic | PageLabelerTest | PASS | 177ms |
...
| testKeepRange | PageSlicerTest | PASS | 181ms |
| testRemovePages | PageSlicerTest | PASS | 175ms |
...
| testSetTrimBox | PageTransformerTest | PASS | 175ms |
...
| testGetReader | PageTransformerTest | PASS | 2ms |
...
| testMergeWithPageSelection | PdfMergerTest | PASS | 175ms |
...
| testStampWithOpacity | PdfStamperTest | PASS | 171ms |
...
| testSaveToFile | PdfStamperTest | PASS | 178ms |
| testStampImageJpeg | PdfStamperTest | PASS | 206ms |
| testStampImagePng | PdfStamperTest | PASS | 177ms |
| testStampImageWithScaleWidth | PdfStamperTest | PASS | 176ms |
| testStampImageWithScaleHeight | PdfStamperTest | PASS | 181ms |
| testStampImageWithExplicitDimensions | PdfStamperTest | PASS | 179ms |
| testStampImageWithOpacity | PdfStamperTest | PASS | 181ms |
| testStampImageOnSpecificPages | PdfStamperTest | PASS | 174ms |
...
| testRedactArea | TextRedactorTest | PASS | 175ms |
...
| testSaveToFile | TextRedactorTest | PASS | 175ms |
...
| testGeneratesDocumentFeaturesPdf | DocumentFeaturesTest | PASS | 174ms |
...
**4 tests** | 3 passed | 0 failed | 1 skipped | 17.98s
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 17.76s
...
| testQpdfCorpus with data set "qpdf/form-filled-by-acrobat.pdf" | Tier2CorpusTest | PASS | 8ms |
...
| testQpdfCorpus with data set "qpdf/many-nulls.pdf" | Tier2CorpusTest | PASS | 759ms |
...
| testQpdfCorpus with data set "qpdf/pages-is-page.pdf" | Tier2CorpusTest | PASS | 23ms |
...
| testPdfBoxCorpus with data set "pdfbox/pdfbox/src/test/resources/org/apache/pdfbox/encryption/Acroform-PDFBOX-2333.pdf" | Tier2PdfBoxCorpusTest | PASS | 5ms |
...
| testPdfBoxCorpus with data set "pdfbox/pdfbox/src/test/resources/org/apache/pdfbox/pdmodel/with_outline.pdf" | Tier2PdfBoxCorpusTest | PASS | 2ms |
...
| testPdfiumCorpus with data set "pdfium/page_labels.pdf" | Tier2PdfiumCorpusTest | PASS | 2ms |
...
**6 tests** | 6 passed | 0 failed | 0 skipped | 11.57s
...
| testMultiPagePdfWellFormedAndValid | Tier4JhoveTest | PASS | 854ms |
| testPdfWithMetadataWellFormedAndValid | Tier4JhoveTest | PASS | 833ms |
| testPdfWithEmbeddedFontWellFormedAndValid | Tier4JhoveTest | PASS | 819ms |
...
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 819ms |
| testPdfWithMetadataHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 512ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 image with BPC.pdf" | Tier4Pdf20ExamplesTest | PASS | 175ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 with page level output intent.pdf" | Tier4Pdf20ExamplesTest | PASS | 173ms |
