...
Generated: 2026-06-08 00:37:20 UTC
PHP: 8.4.21
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 91.63s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 32.18s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.29s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 19.1s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 18.81s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 11.83s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 32.18s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 413ms |
| testGeneratesAnnotationsPdf | AnnotationsTest | PASS | 184ms |
| testGeneratesBookmarksPdf | BookmarksTest | PASS | 244ms |
| testGeneratesFormWithCustomFontAppearances | CustomFontFormAppearancesTest | PASS | 222ms |
...
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 84ms |
...
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 346ms |
...
| testBulletListRendersEachItem | ListTest | PASS | 187ms |
...
| testAlignmentCenterEmitsCenteredText | PdfTest | PASS | 191ms |
...
| testWriteToStream | PdfTest | PASS | 192ms |
| testWriteToRejectsNonResource | PdfTest | PASS | <1ms |
| testToBytesProducesValidPdfOnEachCall | PdfTest | PASS | 369ms |
...
| testAddCompositeFontSavesToFile | UnicodeFontTest | PASS | 191ms |
...
| testSetEncryptionAes256RoundTrip | WriterTest | PASS | 237ms |
...
| testCustomField | MetadataEditorTest | PASS | 186ms |
...
| testSetRomanNumeralsUppercase | PageLabelerTest | PASS | 180ms |
...
| testSaveToFile | PageLabelerTest | PASS | 182ms |
...
| testRotateCumulative | PageTransformerTest | PASS | 193ms |
...
| testScaleToNonUniform | PageTransformerTest | PASS | 181ms |
...
| testEncryptAes128 | PdfEncryptTest | PASS | 198ms |
| testEncryptAes256 | PdfEncryptTest | PASS | 197ms |
| testDecrypt | PdfEncryptTest | PASS | 185ms |
...
| testStampText | PdfStamperTest | PASS | 192ms |
...
**4 tests** | 3 passed | 0 failed | 1 skipped | 19.1s
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 18.81s
...
**6 tests** | 6 passed | 0 failed | 0 skipped | 11.83s

| Test | Class | Status | Time |
|---|---|---|---|
| testTaggedDocumentValidatesWithUa1 | Tier3MatterhornTest | PASS | 2.26s |
...
| testMissingDisplayDocTitleFailsUa1 | Tier3MatterhornTest | PASS | 1.95s |
| testAnnotationWithoutContentsFailsUa1 | Tier3MatterhornTest | PASS | 1.83s |
...
| testPdfWithMetadataWellFormedAndValid | Tier4JhoveTest | PASS | 884ms |
| testPdfWithEmbeddedFontWellFormedAndValid | Tier4JhoveTest | PASS | 879ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/Simple PDF 2.0 file.pdf" | Tier4Pdf20ExamplesTest | PASS | 176ms |
