...
Generated: 2026-06-10 17:34:54 UTC
PHP: 8.4.21
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 94.26s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 33.39s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.33s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 19.7s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 19.52s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 11.73s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 33.39s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 305ms |
| testGeneratesAnnotationsPdf | AnnotationsTest | PASS | 189ms |
| testGeneratesBookmarksPdf | BookmarksTest | PASS | 239ms |
| testGeneratesFormWithCustomFontAppearances | CustomFontFormAppearancesTest | PASS | 274ms |
...
| testGeneratesExtGStatePdf | ExtGStateIntegrationTest | PASS | 202ms |
...
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 303ms |
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 220ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 206ms |
...
| testGeneratesMultimediaAnd3DPdf | MultimediaAndThreeDIntegrationTest | PASS | 207ms |
...
| testBulletListRendersEachItem | ListTest | PASS | 195ms |
...
| testExplicitNewPageCreatesSecondPage | PdfTest | PASS | 204ms |
...
| testSetBookmarksWithChildren | BookmarkEditorTest | PASS | 206ms |
| testAddBookmark | BookmarkEditorTest | PASS | 403ms |
| testHasBookmarksReturnsFalseForCleanPdf | BookmarkEditorTest | PASS | <1ms |
| testRemoveBookmarks | BookmarkEditorTest | PASS | 205ms |
| testGetPageCount | BookmarkEditorTest | PASS | 1ms |
| testGetReader | BookmarkEditorTest | PASS | <1ms |
| testSaveToFile | BookmarkEditorTest | PASS | 204ms |
...
| testFillMultipleFieldTypes | FormFillerTest | PASS | 198ms |
...
| testRoundTripPreservesOtherFields | FormFillerTest | PASS | 208ms |
...
| testReorder | PageSlicerTest | PASS | 207ms |
...
| testRotateCumulative | PageTransformerTest | PASS | 198ms |
...
| testRange | PageTransformerTest | PASS | 204ms |
...
| testMergeTwoPdfs | PdfMergerTest | PASS | 200ms |
...
| testWatermarkWithStyle | PdfStamperTest | PASS | 234ms |
| testPageNumbers | PdfStamperTest | PASS | 196ms |
| testStampOnSpecificPages | PdfStamperTest | PASS | 196ms |
| testHeaderAndFooter | PdfStamperTest | PASS | 202ms |
...
| testStampImageOnSpecificPages | PdfStamperTest | PASS | 201ms |
...
| testCustomRedactionColor | TextRedactorTest | PASS | 198ms |
...
| testGeneratesFormPdf | FormFieldsTest | PASS | 213ms |
...
**4 tests** | 3 passed | 0 failed | 1 skipped | 19.7s
...
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 10.3s |
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 19.52s
...
| testQpdfCorpus with data set "qpdf/uo-8.pdf" | Tier2CorpusTest | PASS | 31ms |
...
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 7.59s |
...
| testPdfiumCorpus with data set "pdfium/viewer_ref.pdf" | Tier2PdfiumCorpusTest | PASS | 7ms |
...
**6 tests** | 6 passed | 0 failed | 0 skipped | 11.73s
...
| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWellFormedAndValid | Tier4JhoveTest | PASS | 1.01s |
| testMultiPagePdfWellFormedAndValid | Tier4JhoveTest | PASS | 921ms |
...
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 603ms |
| testPdfWithMetadataHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 549ms |
