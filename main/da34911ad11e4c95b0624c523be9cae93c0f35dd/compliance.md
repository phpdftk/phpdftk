...
Generated: 2026-06-10 16:03:00 UTC
PHP: 8.4.21
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 89.46s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 31.6s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.26s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 18.18s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 17.98s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 12.11s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 31.6s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 377ms |
| testGeneratesAnnotationsPdf | AnnotationsTest | PASS | 188ms |
| testGeneratesBookmarksPdf | BookmarksTest | PASS | 231ms |
| testGeneratesFormWithCustomFontAppearances | CustomFontFormAppearancesTest | PASS | 229ms |
...
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 306ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 125ms |
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 70ms |
...
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 358ms |
...
| testEnableOutlineThenHeadingRegistersOutlinesEntry | AutoOutlineTest | PASS | 185ms |
...
| testCalloutTallerThanPageThrows | CalloutTest | PASS | 19ms |
...
| testAddCompositeFontGeneratesValidPdf | UnicodeFontTest | PASS | 183ms |
...
| testPdfWriterGeneratesValidPdfHeader | WriterTest | PASS | 175ms |
...
| testMetadataStreamContainsXmp | XmpMetadataTest | PASS | 181ms |
| testMetadataRoundTrip | XmpMetadataTest | PASS | 177ms |
...
| testSetTitleRoundTrip | MetadataEditorTest | PASS | 177ms |
...
| testRemovePages | PageSlicerTest | PASS | 179ms |
| testReorder | PageSlicerTest | PASS | 180ms |
| testReverse | PageSlicerTest | PASS | 185ms |
| testSplit | PageSlicerTest | PASS | 363ms |
| testKeepWithPageSelector | PageSlicerTest | PASS | 178ms |
...
| testSetCropBox | PageTransformerTest | PASS | 173ms |
...
| testScaleToNonUniform | PageTransformerTest | PASS | 176ms |
...
| testOddPages | PageTransformerTest | PASS | 181ms |
...
| testSaveToFile | PdfMergerTest | PASS | 171ms |
...
| testVeraPdfToolchainWorks | PdfAConformanceTest | PASS | 2.23s |
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 7.16s |
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 8.79s |
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 17.98s
...
| testQpdfCorpus with data set "qpdf/issue-202.pdf" | Tier2CorpusTest | PASS | 55ms |
...
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 9.51s |
...
| testPdfiumCorpus with data set "pdfium/xfa/email_recommended.pdf" | Tier2PdfiumCorpusTest | PASS | 7ms |
...
**6 tests** | 6 passed | 0 failed | 0 skipped | 12.11s
...
| testUntaggedDocumentFailsUa1 | Tier3MatterhornTest | PASS | 1.94s |
...
| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWellFormedAndValid | Tier4JhoveTest | PASS | 930ms |
| testMultiPagePdfWellFormedAndValid | Tier4JhoveTest | PASS | 865ms |
| testPdfWithMetadataWellFormedAndValid | Tier4JhoveTest | PASS | 843ms |
...
| testPdfBoxPreflightToolchainWorks | Tier4PdfBoxPreflightTest | PASS | 786ms |
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 755ms |
...
| testPdfIdToolchainWorks | Tier4PdfIdTest | PASS | 326ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 via incremental save.pdf" | Tier4Pdf20ExamplesTest | PASS | 175ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/Simple PDF 2.0 file.pdf" | Tier4Pdf20ExamplesTest | PASS | 179ms |
