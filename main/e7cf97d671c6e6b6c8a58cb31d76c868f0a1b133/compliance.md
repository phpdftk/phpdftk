...
Generated: 2026-06-09 18:13:30 UTC
PHP: 8.4.21
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 114.11s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 58.22s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 2.64s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 14.5s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 14.76s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 11.75s |
| &#x2705; JHOVE + PDF 2.0 + Security + Preflight | PASS | 25 | 24 | 0 | 1 | 12.24s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 58.22s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 2.03s |
| testGeneratesAnnotationsPdf | AnnotationsTest | PASS | 442ms |
| testGeneratesBookmarksPdf | BookmarksTest | PASS | 213ms |
| testGeneratesFormWithCustomFontAppearances | CustomFontFormAppearancesTest | PASS | 212ms |
| testGeneratesDocumentFeaturesPdf | DocumentFeaturesTest | PASS | 169ms |
| testGeneratesPdfWithEmbeddedTrueTypeFont | DocumentFeaturesTest | PASS | 178ms |
...
| testGeneratesPdfWithEmbeddedType1 | EmbeddedType1FontTest | PASS | 459ms |
| testPdfOutputContainsFontData | EmbeddedType1FontTest | PASS | <1ms |
| testGeneratesExtGStatePdf | ExtGStateIntegrationTest | PASS | 363ms |
| testGeneratesFormWithAppearances | FormAppearancesIntegrationTest | PASS | 457ms |
| testGeneratesFormPdf | FormFieldsTest | PASS | 164ms |
| testGeneratesGraphicsPipelinePdf | GraphicsPipelineIntegrationTest | PASS | 901ms |
| testGeneratesGraphicsPdf | GraphicsTest | PASS | 158ms |
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 651ms |
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 210ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 101ms |
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 187ms |
| testGeneratesPdfWithMarkupFields | MarkupAnnotationsIntegrationTest | PASS | 719ms |
| testGeneratesMultiPageComplexPdf | MultiPageComplexTest | PASS | 1.01s |
| testGeneratesMultimediaAnd3DPdf | MultimediaAndThreeDIntegrationTest | PASS | 176ms |
...
| testGeneratesPageLabelsPdf | PageLabelsTest | PASS | 654ms |
| testGeneratesSignatureFieldPdf | SignatureFieldIntegrationTest | PASS | 880ms |
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 1.44s |
| testGeneratesSimpleTextPdf | SimpleTextTest | PASS | 170ms |
| testGeneratesPdfWithType3Font | Type3FontIntegrationTest | PASS | 385ms |
| testGeneratesPdfWithXrefAndObjectStreams | XRefStreamIntegrationTest | PASS | 403ms |
| testEnableOutlineThenHeadingRegistersOutlinesEntry | AutoOutlineTest | PASS | 161ms |
...
| testNoteCalloutEmitsLabelAndBody | CalloutTest | PASS | 377ms |
...
| testThemeColorIsUsedForBodyTextWhenStyleHasNoOverride | CalloutTest | PASS | 5ms |
| testCalloutTypeDefaultLabelMatchesEnumValue | CalloutTest | PASS | <1ms |
| testWinAnsiRoundTripFromShowText | EncodingIntegrationTest | PASS | 166ms |
| testHighLevelPdfRoundTrip | EncodingIntegrationTest | PASS | 3ms |
| testAddTextWithLinkStyleProducesLinkAnnotation | InlineLinkTest | PASS | 414ms |
...
| testBulletListRendersEachItem | ListTest | PASS | 1.12s |
...
| testShowPageNumbersDefaultFormat | PageNumbersTest | PASS | 339ms |
...
| testAddPageDelegatesToWriter | PdfDocTest | PASS | 182ms |
...
| testGeneratesHighLevelDocument | PdfIntegrationTest | PASS | 1.34s |
| testAddHtmlRendersIntoPdf | PdfTest | PASS | 28ms |
| testEmptyDocumentHasNoPages | PdfTest | PASS | 619ms |
| testAddTextCreatesFirstPageAutomatically | PdfTest | PASS | 553ms |
| testAddHeadingEmitsLargerText | PdfTest | PASS | 703ms |
| testExplicitNewPageCreatesSecondPage | PdfTest | PASS | 471ms |
| testLongTextAutoPaginates | PdfTest | PASS | 702ms |
| testAddSpacerConsumesVerticalSpace | PdfTest | PASS | 643ms |
| testAddRuleDrawsStroke | PdfTest | PASS | 354ms |
| testAlignmentCenterEmitsCenteredText | PdfTest | PASS | 667ms |
| testSetFontSwitchesFontFamily | PdfTest | PASS | 396ms |
| testBoldAndItalicResolveToCorrectPostScriptName | PdfTest | PASS | 252ms |
| testUnknownFamilyIsRejected | PdfTest | PASS | <1ms |
| testCustomTheme | PdfTest | PASS | 402ms |
| testSaveWritesFile | PdfTest | PASS | 263ms |
| testWriteToStream | PdfTest | PASS | 207ms |
| testWriteToRejectsNonResource | PdfTest | PASS | <1ms |
| testToBytesProducesValidPdfOnEachCall | PdfTest | PASS | 592ms |
...
| testAddHighlightUsesQuadPointsAndDerivedRect | Phase4WrappingTest | PASS | 3ms |
...
| testAddTableRendersAllCellValues | TableTest | PASS | 1.67s |
...
| testUnderlineEmitsStrokeBelowBaseline | TextDecorationTest | PASS | 725ms |
...
| testAddCompositeFontGeneratesValidPdf | UnicodeFontTest | PASS | 907ms |
| testAddCompositeFontSavesToFile | UnicodeFontTest | PASS | 432ms |
| testCompositeFontRoundTripsThroughReader | UnicodeFontTest | PASS | 427ms |
| testCompositeFontAppearsInFontList | UnicodeFontTest | PASS | 4ms |
| testShowTextHexOperator | UnicodeFontTest | PASS | <1ms |
| testCompositeFontPerPage | UnicodeFontTest | PASS | 725ms |
| testPdfWriterGeneratesValidPdfHeader | WriterTest | PASS | 368ms |
...
| testPdfWriterContainsPage | WriterTest | PASS | 340ms |
...
| testPdfWriterAddContentStream | WriterTest | PASS | 247ms |
| testPdfWriterGetContentStreams | WriterTest | PASS | <1ms |
| testPdfWriterWithInfo | WriterTest | PASS | 197ms |
| testPdfWriterGetCatalog | WriterTest | PASS | <1ms |
| testPdfWriterGetPageTree | WriterTest | PASS | <1ms |
| testPdfWriterSavesToFile | WriterTest | PASS | 367ms |
| testPdfWriterContainsXref | WriterTest | PASS | 186ms |
| testPdfWriterContainsTrailer | WriterTest | PASS | <1ms |
| testPdfWriterAddPageWithRectangle | WriterTest | PASS | 168ms |
| testPdfWriterRegisterObject | WriterTest | PASS | 262ms |
| testPdfWriterFontAddedToPage | WriterTest | PASS | 263ms |
| testSetNamedDestinations | WriterTest | PASS | 328ms |
| testSetEncryptionProducesEncryptedPdf | WriterTest | PASS | 909ms |
| testSetEncryptionAes256RoundTrip | WriterTest | PASS | 239ms |
| testSetMetadataAddsStreamToPdf | XmpMetadataTest | PASS | 208ms |
| testMetadataStreamContainsXmp | XmpMetadataTest | PASS | 156ms |
| testMetadataRoundTrip | XmpMetadataTest | PASS | 324ms |
| testSyncInfoToMetadata | XmpMetadataTest | PASS | 219ms |
| testSyncInfoToMetadataNoInfoIsNoOp | XmpMetadataTest | PASS | 246ms |
| testFlattenAll | AnnotationFlattenerTest | PASS | 267ms |
...
| testSaveToFile | AnnotationFlattenerTest | PASS | 259ms |
...
| testSetBookmarks | BookmarkEditorTest | PASS | 535ms |
| testSetBookmarksWithChildren | BookmarkEditorTest | PASS | 391ms |
| testAddBookmark | BookmarkEditorTest | PASS | 589ms |
| testHasBookmarksReturnsFalseForCleanPdf | BookmarkEditorTest | PASS | <1ms |
| testRemoveBookmarks | BookmarkEditorTest | PASS | 199ms |
| testGetPageCount | BookmarkEditorTest | PASS | <1ms |
| testGetReader | BookmarkEditorTest | PASS | <1ms |
| testSaveToFile | BookmarkEditorTest | PASS | 222ms |
| testNoBytesChangedWhenNoOperations | BookmarkEditorTest | PASS | <1ms |
| testReplaceExistingBookmarks | BookmarkEditorTest | PASS | 188ms |
...
| testFillTextField | FormFillerTest | PASS | 349ms |
| testFillManyFields | FormFillerTest | PASS | 502ms |
| testCheckCheckbox | FormFillerTest | PASS | 155ms |
| testUncheckCheckbox | FormFillerTest | PASS | 274ms |
| testSelectChoiceField | FormFillerTest | PASS | 400ms |
| testFillMultipleFieldTypes | FormFillerTest | PASS | 501ms |
...
| testSaveWritesFile | FormFillerTest | PASS | 312ms |
| testEscapeHatch | FormFillerTest | PASS | 3ms |
| testRoundTripPreservesOtherFields | FormFillerTest | PASS | 157ms |
...
| testSetTitleRoundTrip | MetadataEditorTest | PASS | 220ms |
| testSetMultipleFieldsRoundTrip | MetadataEditorTest | PASS | 154ms |
| testSetMetadataOnPdfWithoutInfo | MetadataEditorTest | PASS | 158ms |
...
| testSaveToFile | MetadataEditorTest | PASS | 545ms |
| testSetLabelsWithArabic | PageLabelerTest | PASS | 174ms |
| testSetRomanNumerals | PageLabelerTest | PASS | 199ms |
| testSetRomanNumeralsUppercase | PageLabelerTest | PASS | 163ms |
| testSetAlphabetic | PageLabelerTest | PASS | 448ms |
| testSetArabicWithStartNumber | PageLabelerTest | PASS | 436ms |
| testSetLabelsWithPrefix | PageLabelerTest | PASS | 343ms |
| testRemoveLabels | PageLabelerTest | PASS | 157ms |
| testMultipleRanges | PageLabelerTest | PASS | 485ms |
| testGetPageCount | PageLabelerTest | PASS | <1ms |
| testGetReader | PageLabelerTest | PASS | <1ms |
| testSaveToFile | PageLabelerTest | PASS | 195ms |
| testNoBytesChangedWhenNoOperations | PageLabelerTest | PASS | 3ms |
| testOpenFromFile | PageLabelerTest | PASS | <1ms |
| testKeepPages | PageSlicerTest | PASS | 224ms |
| testKeepRange | PageSlicerTest | PASS | 236ms |
| testRemovePages | PageSlicerTest | PASS | 266ms |
| testReorder | PageSlicerTest | PASS | 216ms |
| testReverse | PageSlicerTest | PASS | 152ms |
| testSplit | PageSlicerTest | PASS | 569ms |
| testKeepWithPageSelector | PageSlicerTest | PASS | 269ms |
| testNoOpsKeepsAllPages | PageSlicerTest | PASS | 196ms |
| testPageCount | PageSlicerTest | PASS | <1ms |
| testEscapeHatch | PageSlicerTest | PASS | <1ms |
| testRotateAllPages | PageTransformerTest | PASS | 186ms |
| testRotate180 | PageTransformerTest | PASS | 184ms |
| testRotate270 | PageTransformerTest | PASS | 220ms |
| testRotateSpecificPages | PageTransformerTest | PASS | 413ms |
| testRotateCumulative | PageTransformerTest | PASS | 235ms |
| testRotateInvalidAngle | PageTransformerTest | PASS | <1ms |
| testSetCropBox | PageTransformerTest | PASS | 168ms |
| testSetCropBoxSpecificPage | PageTransformerTest | PASS | 175ms |
| testSetMediaBox | PageTransformerTest | PASS | 197ms |
| testSetTrimBox | PageTransformerTest | PASS | 178ms |
| testSetBleedBox | PageTransformerTest | PASS | 229ms |
| testScale | PageTransformerTest | PASS | 184ms |
| testScaleSpecificPages | PageTransformerTest | PASS | 206ms |
| testScaleInvalidFactor | PageTransformerTest | PASS | <1ms |
| testScaleTo | PageTransformerTest | PASS | 234ms |
| testScaleToNonUniform | PageTransformerTest | PASS | 197ms |
| testMultipleOperations | PageTransformerTest | PASS | 239ms |
| testNoBytesChangedWithoutOperations | PageTransformerTest | PASS | <1ms |
| testEvenPages | PageTransformerTest | PASS | 213ms |
| testOddPages | PageTransformerTest | PASS | 203ms |
| testRange | PageTransformerTest | PASS | 191ms |
...
| testEncryptAes128 | PdfEncryptTest | PASS | 302ms |
| testEncryptAes256 | PdfEncryptTest | PASS | 248ms |
| testDecrypt | PdfEncryptTest | PASS | 350ms |
...
| testMergeTwoPdfs | PdfMergerTest | PASS | 254ms |
| testMergeWithPageSelection | PdfMergerTest | PASS | 273ms |
...
| testSaveToFile | PdfMergerTest | PASS | 257ms |
| testStampText | PdfStamperTest | PASS | 181ms |
| testWatermark | PdfStamperTest | PASS | 405ms |
| testWatermarkWithStyle | PdfStamperTest | PASS | 219ms |
| testPageNumbers | PdfStamperTest | PASS | 308ms |
| testStampOnSpecificPages | PdfStamperTest | PASS | 184ms |
| testHeaderAndFooter | PdfStamperTest | PASS | 165ms |
| testStampWithOpacity | PdfStamperTest | PASS | 160ms |
...
| testSaveToFile | PdfStamperTest | PASS | 175ms |
| testStampImageJpeg | PdfStamperTest | PASS | 162ms |
| testStampImagePng | PdfStamperTest | PASS | 155ms |
| testStampImageWithScaleWidth | PdfStamperTest | PASS | 157ms |
| testStampImageWithScaleHeight | PdfStamperTest | PASS | 154ms |
| testStampImageWithExplicitDimensions | PdfStamperTest | PASS | 260ms |
| testStampImageWithOpacity | PdfStamperTest | PASS | 201ms |
| testStampImageOnSpecificPages | PdfStamperTest | PASS | 177ms |
| testStampImageCombinedWithText | PdfStamperTest | PASS | 156ms |
| testStampImageThrowsOnMissingFile | PdfStamperTest | PASS | <1ms |
| testStampImageThrowsOnUnsupportedFormat | PdfStamperTest | PASS | <1ms |
| testStampPdf | PdfStamperTest | PASS | 188ms |
| testStampPdfWithScaling | PdfStamperTest | PASS | 305ms |
| testStampPdfWithOpacity | PdfStamperTest | PASS | 166ms |
| testStampPdfSpecificPage | PdfStamperTest | PASS | 234ms |
| testStampPdfOnSelectedPages | PdfStamperTest | PASS | 281ms |
| testStampPdfDefaultsToCenter | PdfStamperTest | PASS | 369ms |
...
| testRedactArea | TextRedactorTest | PASS | 188ms |
| testRedactMultipleAreas | TextRedactorTest | PASS | 515ms |
| testRedactByText | TextRedactorTest | PASS | 365ms |
| testRedactByPattern | TextRedactorTest | PASS | <1ms |
| testCustomRedactionColor | TextRedactorTest | PASS | 821ms |
...
| testSaveToFile | TextRedactorTest | PASS | 455ms |

### Arlington PDF Model — Dictionary-level spec conformance (keys, types, required fields, version constraints)

**6 tests** | 6 passed | 0 failed | 0 skipped | 2.64s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesBookmarksPdf | BookmarksTest | PASS | 563ms |
| testGeneratesDocumentFeaturesPdf | DocumentFeaturesTest | PASS | 417ms |
| testGeneratesPdfWithEmbeddedTrueTypeFont | DocumentFeaturesTest | PASS | 460ms |
| testGeneratesFormPdf | FormFieldsTest | PASS | 575ms |
| testGeneratesMultiPageComplexPdf | MultiPageComplexTest | PASS | 441ms |
| testGeneratesSimpleTextPdf | SimpleTextTest | PASS | 185ms |

### veraPDF — PDF/A archival conformance (ISO 19005)

**4 tests** | 3 passed | 0 failed | 1 skipped | 14.5s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWithOutputIntent | PdfAConformanceTest | SKIP | 4ms |
| testVeraPdfToolchainWorks | PdfAConformanceTest | PASS | 1.84s |
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 5.54s |
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 7.12s |
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 14.76s
...
| testQpdfCorpus with data set "qpdf/appearances-1.pdf" | Tier2CorpusTest | PASS | 6ms |
...
| testQpdfCorpus with data set "qpdf/issue-202.pdf" | Tier2CorpusTest | PASS | 48ms |
...
| testQpdfCorpus with data set "qpdf/many-nulls.pdf" | Tier2CorpusTest | PASS | 551ms |
...
| testQpdfCorpus with data set "qpdf/remove-metadata-no-moddate.pdf" | Tier2CorpusTest | PASS | 21ms |
...
| testQpdfCorpus with data set "qpdf/weird-tokens.pdf" | Tier2CorpusTest | PASS | 4ms |
...
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 5.69s |
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 7.82s |
...
| testPdfBoxCorpus with data set "pdfbox/pdfbox/src/test/resources/org/apache/pdfbox/multipdf/PDFBOX-6049-ExpectedResult.pdf" | Tier2PdfBoxCorpusTest | PASS | 3ms |
...
| testPdfiumCorpus with data set "pdfium/annotation_stamp_with_ap.pdf" | Tier2PdfiumCorpusTest | PASS | 2ms |
...
| testPdfiumCorpus with data set "pdfium/redirect.pdf" | Tier2PdfiumCorpusTest | PASS | 2ms |
...
**6 tests** | 6 passed | 0 failed | 0 skipped | 11.75s

| Test | Class | Status | Time |
|---|---|---|---|
| testTaggedDocumentValidatesWithUa1 | Tier3MatterhornTest | PASS | 1.97s |
| testAnnotationWithContentsPassesClause718 | Tier3MatterhornTest | PASS | 1.88s |
| testUntaggedDocumentFailsUa1 | Tier3MatterhornTest | PASS | 1.91s |
| testMissingLangFailsUa1 | Tier3MatterhornTest | PASS | 1.85s |
| testMissingDisplayDocTitleFailsUa1 | Tier3MatterhornTest | PASS | 2.06s |
| testAnnotationWithoutContentsFailsUa1 | Tier3MatterhornTest | PASS | 2.06s |
...
**25 tests** | 24 passed | 0 failed | 1 skipped | 12.24s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWellFormedAndValid | Tier4JhoveTest | PASS | 1.07s |
| testMultiPagePdfWellFormedAndValid | Tier4JhoveTest | PASS | 1.76s |
| testPdfWithMetadataWellFormedAndValid | Tier4JhoveTest | PASS | 1.31s |
| testPdfWithEmbeddedFontWellFormedAndValid | Tier4JhoveTest | PASS | 1.38s |
| testJhoveToolchainWorks | Tier4JhoveTest | PASS | 706ms |
| testPdfA1bPassesPdfBoxPreflight | Tier4PdfBoxPreflightTest | SKIP | <1ms |
| testPdfBoxPreflightToolchainWorks | Tier4PdfBoxPreflightTest | PASS | 1.83s |
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 568ms |
| testPdfWithMetadataHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 601ms |
| testPdfWithEmbeddedFontHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 817ms |
| testPdfIdToolchainWorks | Tier4PdfIdTest | PASS | 548ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 UTF-8 string and annotation.pdf" | Tier4Pdf20ExamplesTest | PASS | 178ms |
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 image with BPC.pdf" | Tier4Pdf20ExamplesTest | PASS | 157ms |
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 via incremental save.pdf" | Tier4Pdf20ExamplesTest | PASS | 162ms |
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 with offset start.pdf" | Tier4Pdf20ExamplesTest | PASS | 150ms |
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 with page level output intent.pdf" | Tier4Pdf20ExamplesTest | PASS | 545ms |
| testPdf20ExampleQpdfValid with data set "pdf20/Simple PDF 2.0 file.pdf" | Tier4Pdf20ExamplesTest | PASS | 270ms |
| testPdf20ExampleQpdfValid with data set "pdf20/pdf20-utf8-test.pdf" | Tier4Pdf20ExamplesTest | PASS | 196ms |
