...
Generated: 2026-06-09 04:14:30 UTC
PHP: 8.4.21
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 91.92s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 33.52s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.29s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 18.4s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 18.4s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 11.56s |
| &#x2705; JHOVE + PDF 2.0 + Security + Preflight | PASS | 25 | 24 | 0 | 1 | 8.74s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 33.52s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 714ms |
| testGeneratesAnnotationsPdf | AnnotationsTest | PASS | 186ms |
| testGeneratesBookmarksPdf | BookmarksTest | PASS | 248ms |
...
| testGeneratesFormWithAppearances | FormAppearancesIntegrationTest | PASS | 188ms |
| testGeneratesFormPdf | FormFieldsTest | PASS | 189ms |
| testGeneratesGraphicsPipelinePdf | GraphicsPipelineIntegrationTest | PASS | 189ms |
| testGeneratesGraphicsPdf | GraphicsTest | PASS | 187ms |
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 336ms |
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 198ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 303ms |
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 467ms |
| testGeneratesPdfWithMarkupFields | MarkupAnnotationsIntegrationTest | PASS | 194ms |
...
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 498ms |
| testGeneratesSimpleTextPdf | SimpleTextTest | PASS | 189ms |
| testGeneratesPdfWithType3Font | Type3FontIntegrationTest | PASS | 193ms |
| testGeneratesPdfWithXrefAndObjectStreams | XRefStreamIntegrationTest | PASS | 188ms |
...
| testWinAnsiRoundTripFromShowText | EncodingIntegrationTest | PASS | 193ms |
...
| testBulletListRendersEachItem | ListTest | PASS | 190ms |
...
| testEmptyDocumentHasNoPages | PdfTest | PASS | 183ms |
| testAddTextCreatesFirstPageAutomatically | PdfTest | PASS | 184ms |
| testAddHeadingEmitsLargerText | PdfTest | PASS | 186ms |
| testExplicitNewPageCreatesSecondPage | PdfTest | PASS | 193ms |
...
| testAddTableWithHeaderEmitsBoldVariantAndBackground | TableTest | PASS | 5ms |
...
| testAddCompositeFontSavesToFile | UnicodeFontTest | PASS | 206ms |
| testCompositeFontRoundTripsThroughReader | UnicodeFontTest | PASS | 199ms |
| testCompositeFontAppearsInFontList | UnicodeFontTest | PASS | 5ms |
| testShowTextHexOperator | UnicodeFontTest | PASS | <1ms |
| testCompositeFontPerPage | UnicodeFontTest | PASS | 196ms |
| testPdfWriterGeneratesValidPdfHeader | WriterTest | PASS | 194ms |
...
| testPdfWriterAddContentStream | WriterTest | PASS | 212ms |
| testPdfWriterGetContentStreams | WriterTest | PASS | <1ms |
| testPdfWriterWithInfo | WriterTest | PASS | 192ms |
...
| testSetEncryptionAes256RoundTrip | WriterTest | PASS | 208ms |
...
| testFlattenAll | AnnotationFlattenerTest | PASS | 189ms |
...
| testSetBookmarksWithChildren | BookmarkEditorTest | PASS | 195ms |
| testAddBookmark | BookmarkEditorTest | PASS | 385ms |
| testHasBookmarksReturnsFalseForCleanPdf | BookmarkEditorTest | PASS | <1ms |
| testRemoveBookmarks | BookmarkEditorTest | PASS | 196ms |
...
| testFillManyFields | FormFillerTest | PASS | 186ms |
| testCheckCheckbox | FormFillerTest | PASS | 196ms |
| testUncheckCheckbox | FormFillerTest | PASS | 193ms |
| testSelectChoiceField | FormFillerTest | PASS | 190ms |
...
| testSaveWritesFile | FormFillerTest | PASS | 189ms |
...
| testSetMultipleFieldsRoundTrip | MetadataEditorTest | PASS | 187ms |
| testSetMetadataOnPdfWithoutInfo | MetadataEditorTest | PASS | 189ms |
...
| testSetLabelsWithArabic | PageLabelerTest | PASS | 196ms |
| testSetRomanNumerals | PageLabelerTest | PASS | 190ms |
| testSetRomanNumeralsUppercase | PageLabelerTest | PASS | 181ms |
| testSetAlphabetic | PageLabelerTest | PASS | 200ms |
| testSetArabicWithStartNumber | PageLabelerTest | PASS | 188ms |
| testSetLabelsWithPrefix | PageLabelerTest | PASS | 193ms |
| testRemoveLabels | PageLabelerTest | PASS | 206ms |
...
| testRotate180 | PageTransformerTest | PASS | 185ms |
| testRotate270 | PageTransformerTest | PASS | 195ms |
...
| testSetBleedBox | PageTransformerTest | PASS | 195ms |
...
| testMultipleOperations | PageTransformerTest | PASS | 192ms |
...
| testStampText | PdfStamperTest | PASS | 196ms |
...
| testStampOnSpecificPages | PdfStamperTest | PASS | 193ms |
| testHeaderAndFooter | PdfStamperTest | PASS | 191ms |
...
| testStampImagePng | PdfStamperTest | PASS | 195ms |
...
| testStampImageOnSpecificPages | PdfStamperTest | PASS | 196ms |
...
| testStampPdfSpecificPage | PdfStamperTest | PASS | 202ms |
...
| testRedactArea | TextRedactorTest | PASS | 184ms |
| testRedactMultipleAreas | TextRedactorTest | PASS | 200ms |
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 18.4s
...
| testQpdfCorpus with data set "qpdf/many-nulls.pdf" | Tier2CorpusTest | PASS | 718ms |
...
| testQpdfCorpus with data set "qpdf/resource-from-dr-out.pdf" | Tier2CorpusTest | PASS | 26ms |
...
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 7.17s |
...
| Test | Class | Status | Time |
|---|---|---|---|
| testTaggedDocumentValidatesWithUa1 | Tier3MatterhornTest | PASS | 2.01s |
| testAnnotationWithContentsPassesClause718 | Tier3MatterhornTest | PASS | 2.12s |
| testUntaggedDocumentFailsUa1 | Tier3MatterhornTest | PASS | 1.85s |
| testMissingLangFailsUa1 | Tier3MatterhornTest | PASS | 1.84s |
| testMissingDisplayDocTitleFailsUa1 | Tier3MatterhornTest | PASS | 1.83s |
| testAnnotationWithoutContentsFailsUa1 | Tier3MatterhornTest | PASS | 1.91s |
...
**25 tests** | 24 passed | 0 failed | 1 skipped | 8.74s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWellFormedAndValid | Tier4JhoveTest | PASS | 935ms |
| testMultiPagePdfWellFormedAndValid | Tier4JhoveTest | PASS | 919ms |
| testPdfWithMetadataWellFormedAndValid | Tier4JhoveTest | PASS | 885ms |
| testPdfWithEmbeddedFontWellFormedAndValid | Tier4JhoveTest | PASS | 876ms |
| testJhoveToolchainWorks | Tier4JhoveTest | PASS | 718ms |
...
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 773ms |
| testPdfWithMetadataHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 545ms |
| testPdfWithEmbeddedFontHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 556ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 UTF-8 string and annotation.pdf" | Tier4Pdf20ExamplesTest | PASS | 199ms |
