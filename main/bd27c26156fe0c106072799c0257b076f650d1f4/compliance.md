...
Generated: 2026-06-17 03:25:56 UTC
PHP: 8.4.22
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 86.91s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 31.01s |
...
| &#x2705; JHOVE + PDF 2.0 + Security + Preflight | PASS | 25 | 24 | 0 | 1 | 7.98s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 31.01s
...
| testGeneratesBookmarksPdf | BookmarksTest | PASS | 232ms |
...
| testGeneratesPdfWithEmbeddedFont | EmbeddedFontsTest | PASS | 183ms |
...
| testGeneratesFormWithAppearances | FormAppearancesIntegrationTest | PASS | 177ms |
...
| testGeneratesGraphicsPdf | GraphicsTest | PASS | 182ms |
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 446ms |
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 263ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 179ms |
...
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 440ms |
...
| testWinAnsiRoundTripFromShowText | EncodingIntegrationTest | PASS | 182ms |
...
| testBulletListRendersEachItem | ListTest | PASS | 178ms |
...
| testShowPageNumbersDefaultFormat | PageNumbersTest | PASS | 173ms |
...
| testAddHeadingEmitsLargerText | PdfTest | PASS | 177ms |
...
| testSetFontSwitchesFontFamily | PdfTest | PASS | 176ms |
...
| testToBytesProducesValidPdfOnEachCall | PdfTest | PASS | 353ms |
...
| testUnderlineEmitsStrokeBelowBaseline | TextDecorationTest | PASS | 177ms |
...
| testAddCompositeFontSavesToFile | UnicodeFontTest | PASS | 185ms |
...
| testPdfWriterGeneratesValidPdfHeader | WriterTest | PASS | 171ms |
...
| testPdfWriterRegisterObject | WriterTest | PASS | 172ms |
| testPdfWriterFontAddedToPage | WriterTest | PASS | 179ms |
| testSetNamedDestinations | WriterTest | PASS | 177ms |
| testSetEncryptionProducesEncryptedPdf | WriterTest | PASS | 185ms |
| testSetEncryptionAes256RoundTrip | WriterTest | PASS | 221ms |
| testSetMetadataAddsStreamToPdf | XmpMetadataTest | PASS | 183ms |
| testMetadataStreamContainsXmp | XmpMetadataTest | PASS | 180ms |
| testMetadataRoundTrip | XmpMetadataTest | PASS | 183ms |
| testSyncInfoToMetadata | XmpMetadataTest | PASS | 181ms |
| testSyncInfoToMetadataNoInfoIsNoOp | XmpMetadataTest | PASS | 174ms |
| testFlattenAll | AnnotationFlattenerTest | PASS | 181ms |
...
| testSaveToFile | AnnotationFlattenerTest | PASS | 181ms |
...
| testSetBookmarks | BookmarkEditorTest | PASS | 178ms |
| testSetBookmarksWithChildren | BookmarkEditorTest | PASS | 176ms |
| testAddBookmark | BookmarkEditorTest | PASS | 370ms |
...
| testSaveToFile | BookmarkEditorTest | PASS | 181ms |
...
| testCheckCheckbox | FormFillerTest | PASS | 175ms |
| testUncheckCheckbox | FormFillerTest | PASS | 178ms |
...
| testSetTitleRoundTrip | MetadataEditorTest | PASS | 178ms |
...
| testKeepRange | PageSlicerTest | PASS | 183ms |
| testRemovePages | PageSlicerTest | PASS | 173ms |
| testReorder | PageSlicerTest | PASS | 179ms |
| testReverse | PageSlicerTest | PASS | 173ms |
| testSplit | PageSlicerTest | PASS | 355ms |
| testKeepWithPageSelector | PageSlicerTest | PASS | 172ms |
...
| testRotate180 | PageTransformerTest | PASS | 179ms |
| testRotate270 | PageTransformerTest | PASS | 188ms |
| testRotateSpecificPages | PageTransformerTest | PASS | 184ms |
| testRotateCumulative | PageTransformerTest | PASS | 180ms |
| testRotateInvalidAngle | PageTransformerTest | PASS | <1ms |
| testSetCropBox | PageTransformerTest | PASS | 176ms |
| testSetCropBoxSpecificPage | PageTransformerTest | PASS | 183ms |
| testSetMediaBox | PageTransformerTest | PASS | 177ms |
| testSetTrimBox | PageTransformerTest | PASS | 177ms |
| testSetBleedBox | PageTransformerTest | PASS | 173ms |
| testScale | PageTransformerTest | PASS | 176ms |
...
| testEvenPages | PageTransformerTest | PASS | 180ms |
| testOddPages | PageTransformerTest | PASS | 177ms |
...
| testMergeWithPageSelection | PdfMergerTest | PASS | 173ms |
...
| testSaveToFile | PdfMergerTest | PASS | 176ms |
...
| testHeaderAndFooter | PdfStamperTest | PASS | 180ms |
...
| testStampPdfWithOpacity | PdfStamperTest | PASS | 177ms |
| testStampPdfSpecificPage | PdfStamperTest | PASS | 185ms |
| testStampPdfOnSelectedPages | PdfStamperTest | PASS | 179ms |
...
| testRedactArea | TextRedactorTest | PASS | 177ms |
| testRedactMultipleAreas | TextRedactorTest | PASS | 173ms |
...
| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesBookmarksPdf | BookmarksTest | PASS | 287ms |
...
| testGeneratesSimpleTextPdf | SimpleTextTest | PASS | 174ms |
...
| testVeraPdfToolchainWorks | PdfAConformanceTest | PASS | 2.11s |
...
| testQpdfCorpus with data set "qpdf/default-da-q.pdf" | Tier2CorpusTest | PASS | 8ms |
...
| testQpdfCorpus with data set "qpdf/many-nulls.pdf" | Tier2CorpusTest | PASS | 672ms |
...
| testQpdfCorpus with data set "qpdf/resource-from-dr.pdf" | Tier2CorpusTest | PASS | 24ms |
...
| testAnnotationWithContentsPassesClause718 | Tier3MatterhornTest | PASS | 2.07s |
...
**25 tests** | 24 passed | 0 failed | 1 skipped | 7.98s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWellFormedAndValid | Tier4JhoveTest | PASS | 939ms |
| testMultiPagePdfWellFormedAndValid | Tier4JhoveTest | PASS | 833ms |
| testPdfWithMetadataWellFormedAndValid | Tier4JhoveTest | PASS | 828ms |
| testPdfWithEmbeddedFontWellFormedAndValid | Tier4JhoveTest | PASS | 828ms |
| testJhoveToolchainWorks | Tier4JhoveTest | PASS | 669ms |
| testPdfA1bPassesPdfBoxPreflight | Tier4PdfBoxPreflightTest | SKIP | <1ms |
| testPdfBoxPreflightToolchainWorks | Tier4PdfBoxPreflightTest | PASS | 736ms |
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 525ms |
| testPdfWithMetadataHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 514ms |
| testPdfWithEmbeddedFontHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 507ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 UTF-8 string and annotation.pdf" | Tier4Pdf20ExamplesTest | PASS | 172ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/Simple PDF 2.0 file.pdf" | Tier4Pdf20ExamplesTest | PASS | 177ms |
