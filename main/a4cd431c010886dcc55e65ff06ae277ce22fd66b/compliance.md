...
Generated: 2026-06-24 03:16:52 UTC
PHP: 8.4.22
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 96.24s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 34.21s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.35s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 19.97s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 20.11s |
...
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 672ms |
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 284ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 115ms |
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 389ms |
| testGeneratesPdfWithMarkupFields | MarkupAnnotationsIntegrationTest | PASS | 209ms |
...
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 380ms |
...
| testEnableOutlineThenHeadingRegistersOutlinesEntry | AutoOutlineTest | PASS | 209ms |
...
| testGeneratesHighLevelDocument | PdfIntegrationTest | PASS | 412ms |
...
| testAddHeadingEmitsLargerText | PdfTest | PASS | 211ms |
| testExplicitNewPageCreatesSecondPage | PdfTest | PASS | 199ms |
| testLongTextAutoPaginates | PdfTest | PASS | 209ms |
...
| testAddTableAutoPaginatesAndRepeatsHeader | TableTest | PASS | 11ms |
...
| testCompositeFontPerPage | UnicodeFontTest | PASS | 217ms |
...
| testPdfWriterAddPageWithRectangle | WriterTest | PASS | 200ms |
...
| testAddBookmark | BookmarkEditorTest | PASS | 412ms |
...
| testReplaceExistingBookmarks | BookmarkEditorTest | PASS | 209ms |
...
| testFillMultipleFieldTypes | FormFillerTest | PASS | 199ms |
...
| testCustomField | MetadataEditorTest | PASS | 206ms |
...
| testSetArabicWithStartNumber | PageLabelerTest | PASS | 207ms |
...
| testRotate270 | PageTransformerTest | PASS | 201ms |
...
| testSetBleedBox | PageTransformerTest | PASS | 205ms |
...
| testScaleTo | PageTransformerTest | PASS | 203ms |
...
| testStampImageWithScaleWidth | PdfStamperTest | PASS | 197ms |
...
**4 tests** | 3 passed | 0 failed | 1 skipped | 19.97s
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 20.11s
...
| testQpdfCorpus with data set "qpdf/resolved-appearance-conflicts-generate.pdf" | Tier2CorpusTest | PASS | 31ms |
...
| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWellFormedAndValid | Tier4JhoveTest | PASS | 994ms |
| testMultiPagePdfWellFormedAndValid | Tier4JhoveTest | PASS | 925ms |
| testPdfWithMetadataWellFormedAndValid | Tier4JhoveTest | PASS | 919ms |
| testPdfWithEmbeddedFontWellFormedAndValid | Tier4JhoveTest | PASS | 961ms |
...
| testPdfWithMetadataHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 555ms |
| testPdfWithEmbeddedFontHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 582ms |
