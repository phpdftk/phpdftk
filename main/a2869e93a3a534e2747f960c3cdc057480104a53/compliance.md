...
Generated: 2026-06-12 02:38:27 UTC
PHP: 8.4.22
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 88.83s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 31.89s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.23s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 17.92s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 18.27s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 11.36s |
| &#x2705; JHOVE + PDF 2.0 + Security + Preflight | PASS | 25 | 24 | 0 | 1 | 8.16s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 31.89s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 267ms |
| testGeneratesAnnotationsPdf | AnnotationsTest | PASS | 187ms |
| testGeneratesBookmarksPdf | BookmarksTest | PASS | 238ms |
| testGeneratesFormWithCustomFontAppearances | CustomFontFormAppearancesTest | PASS | 194ms |
...
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 146ms |
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 651ms |
...
| testGeneratesPageLabelsPdf | PageLabelsTest | PASS | 182ms |
| testGeneratesSignatureFieldPdf | SignatureFieldIntegrationTest | PASS | 187ms |
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 564ms |
| testGeneratesSimpleTextPdf | SimpleTextTest | PASS | 180ms |
| testGeneratesPdfWithType3Font | Type3FontIntegrationTest | PASS | 190ms |
| testGeneratesPdfWithXrefAndObjectStreams | XRefStreamIntegrationTest | PASS | 181ms |
...
| testBulletListRendersEachItem | ListTest | PASS | 176ms |
...
| testGeneratesHighLevelDocument | PdfIntegrationTest | PASS | 379ms |
...
| testAddRuleDrawsStroke | PdfTest | PASS | 178ms |
| testAlignmentCenterEmitsCenteredText | PdfTest | PASS | 190ms |
| testSetFontSwitchesFontFamily | PdfTest | PASS | 189ms |
| testBoldAndItalicResolveToCorrectPostScriptName | PdfTest | PASS | 173ms |
...
| testUnderlineEmitsStrokeBelowBaseline | TextDecorationTest | PASS | 179ms |
...
| testAddCompositeFontGeneratesValidPdf | UnicodeFontTest | PASS | 188ms |
...
| testCompositeFontPerPage | UnicodeFontTest | PASS | 194ms |
...
| testPdfWriterAddContentStream | WriterTest | PASS | 185ms |
...
| testSetEncryptionAes256RoundTrip | WriterTest | PASS | 194ms |
| testSetMetadataAddsStreamToPdf | XmpMetadataTest | PASS | 193ms |
| testMetadataStreamContainsXmp | XmpMetadataTest | PASS | 184ms |
...
| testAddBookmark | BookmarkEditorTest | PASS | 366ms |
...
| testSelectChoiceField | FormFillerTest | PASS | 178ms |
| testFillMultipleFieldTypes | FormFillerTest | PASS | 179ms |
...
| testSaveToFile | MetadataEditorTest | PASS | 180ms |
...
| testSetArabicWithStartNumber | PageLabelerTest | PASS | 180ms |
| testSetLabelsWithPrefix | PageLabelerTest | PASS | 187ms |
| testRemoveLabels | PageLabelerTest | PASS | 187ms |
...
| testRemovePages | PageSlicerTest | PASS | 180ms |
| testReorder | PageSlicerTest | PASS | 190ms |
| testReverse | PageSlicerTest | PASS | 176ms |
| testSplit | PageSlicerTest | PASS | 360ms |
...
| testRotate180 | PageTransformerTest | PASS | 176ms |
| testRotate270 | PageTransformerTest | PASS | 174ms |
...
| testSetMediaBox | PageTransformerTest | PASS | 183ms |
...
| testRange | PageTransformerTest | PASS | 178ms |
...
| testDecrypt | PdfEncryptTest | PASS | 182ms |
...
| testStampPdf | PdfStamperTest | PASS | 187ms |
...
| testStampPdfDefaultsToCenter | PdfStamperTest | PASS | 178ms |
...
| testSaveToFile | TextRedactorTest | PASS | 176ms |
...
**4 tests** | 3 passed | 0 failed | 1 skipped | 17.92s
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 18.27s
...
| testQpdfCorpus with data set "qpdf/enc-R2,V1,O=master.pdf" | Tier2CorpusTest | PASS | 11ms |
...
**6 tests** | 6 passed | 0 failed | 0 skipped | 11.36s
...
**25 tests** | 24 passed | 0 failed | 1 skipped | 8.16s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWellFormedAndValid | Tier4JhoveTest | PASS | 929ms |
| testMultiPagePdfWellFormedAndValid | Tier4JhoveTest | PASS | 869ms |
| testPdfWithMetadataWellFormedAndValid | Tier4JhoveTest | PASS | 859ms |
| testPdfWithEmbeddedFontWellFormedAndValid | Tier4JhoveTest | PASS | 853ms |
| testJhoveToolchainWorks | Tier4JhoveTest | PASS | 660ms |
| testPdfA1bPassesPdfBoxPreflight | Tier4PdfBoxPreflightTest | SKIP | <1ms |
| testPdfBoxPreflightToolchainWorks | Tier4PdfBoxPreflightTest | PASS | 793ms |
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 528ms |
| testPdfWithMetadataHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 519ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/pdf20-utf8-test.pdf" | Tier4Pdf20ExamplesTest | PASS | 189ms |
