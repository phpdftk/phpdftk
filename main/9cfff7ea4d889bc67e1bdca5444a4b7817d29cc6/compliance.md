...
Generated: 2026-06-17 01:51:11 UTC
PHP: 8.4.22
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 94.14s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 33.49s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.29s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 19.64s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 19.51s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 11.55s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 33.49s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 308ms |
| testGeneratesAnnotationsPdf | AnnotationsTest | PASS | 192ms |
...
| testGeneratesDocumentFeaturesPdf | DocumentFeaturesTest | PASS | 209ms |
...
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 369ms |
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 362ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 178ms |
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 194ms |
| testGeneratesPdfWithMarkupFields | MarkupAnnotationsIntegrationTest | PASS | 195ms |
| testGeneratesMultiPageComplexPdf | MultiPageComplexTest | PASS | 204ms |
| testGeneratesMultimediaAnd3DPdf | MultimediaAndThreeDIntegrationTest | PASS | 205ms |
...
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 340ms |
| testGeneratesSimpleTextPdf | SimpleTextTest | PASS | 201ms |
...
| testBulletListRendersEachItem | ListTest | PASS | 204ms |
...
| testGeneratesHighLevelDocument | PdfIntegrationTest | PASS | 426ms |
...
| testSaveWritesFile | PdfTest | PASS | 199ms |
...
| testAddTableHonoursPerColumnAlignment | TableTest | PASS | 8ms |
...
| testPdfWriterSavesToFile | WriterTest | PASS | 199ms |
| testPdfWriterContainsXref | WriterTest | PASS | 202ms |
| testPdfWriterContainsTrailer | WriterTest | PASS | <1ms |
| testPdfWriterAddPageWithRectangle | WriterTest | PASS | 199ms |
| testPdfWriterRegisterObject | WriterTest | PASS | 200ms |
...
| testSyncInfoToMetadataNoInfoIsNoOp | XmpMetadataTest | PASS | 191ms |
| testFlattenAll | AnnotationFlattenerTest | PASS | 197ms |
...
| testSetBookmarksWithChildren | BookmarkEditorTest | PASS | 207ms |
| testAddBookmark | BookmarkEditorTest | PASS | 402ms |
...
| testCheckCheckbox | FormFillerTest | PASS | 201ms |
...
| testRoundTripPreservesOtherFields | FormFillerTest | PASS | 192ms |
...
| testSetLabelsWithArabic | PageLabelerTest | PASS | 194ms |
...
| testSetArabicWithStartNumber | PageLabelerTest | PASS | 196ms |
...
| testKeepPages | PageSlicerTest | PASS | 198ms |
| testKeepRange | PageSlicerTest | PASS | 186ms |
| testRemovePages | PageSlicerTest | PASS | 208ms |
| testReorder | PageSlicerTest | PASS | 198ms |
| testReverse | PageSlicerTest | PASS | 194ms |
| testSplit | PageSlicerTest | PASS | 399ms |
| testKeepWithPageSelector | PageSlicerTest | PASS | 201ms |
...
| testRotate180 | PageTransformerTest | PASS | 198ms |
...
| testSetCropBoxSpecificPage | PageTransformerTest | PASS | 201ms |
| testSetMediaBox | PageTransformerTest | PASS | 189ms |
| testSetTrimBox | PageTransformerTest | PASS | 197ms |
| testSetBleedBox | PageTransformerTest | PASS | 199ms |
...
| testScaleToNonUniform | PageTransformerTest | PASS | 193ms |
...
| testOddPages | PageTransformerTest | PASS | 199ms |
...
| testEncryptAes128 | PdfEncryptTest | PASS | 200ms |
...
| testMergeTwoPdfs | PdfMergerTest | PASS | 198ms |
...
| testWatermark | PdfStamperTest | PASS | 194ms |
...
| testStampWithOpacity | PdfStamperTest | PASS | 196ms |
...
| testStampImageJpeg | PdfStamperTest | PASS | 245ms |
...
| testStampImageWithExplicitDimensions | PdfStamperTest | PASS | 198ms |
| testStampImageWithOpacity | PdfStamperTest | PASS | 196ms |
| testStampImageOnSpecificPages | PdfStamperTest | PASS | 199ms |
| testStampImageCombinedWithText | PdfStamperTest | PASS | 194ms |
...
| testStampPdfWithScaling | PdfStamperTest | PASS | 197ms |
| testStampPdfWithOpacity | PdfStamperTest | PASS | 194ms |
...
**4 tests** | 3 passed | 0 failed | 1 skipped | 19.64s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWithOutputIntent | PdfAConformanceTest | SKIP | 5ms |
| testVeraPdfToolchainWorks | PdfAConformanceTest | PASS | 2.15s |
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 7.2s |
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 10.29s |
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 19.51s
...
| testQpdfCorpus with data set "qpdf/delete-and-reuse.pdf" | Tier2CorpusTest | PASS | 15ms |
...
| testQpdfCorpus with data set "qpdf/issue-202.pdf" | Tier2CorpusTest | PASS | 75ms |
...
| testQpdfCorpus with data set "qpdf/many-nulls.pdf" | Tier2CorpusTest | PASS | 698ms |
...
| testQpdfCorpus with data set "qpdf/resource-from-dr.pdf" | Tier2CorpusTest | PASS | 30ms |
...
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 7.72s |
...
**6 tests** | 6 passed | 0 failed | 0 skipped | 11.55s

| Test | Class | Status | Time |
|---|---|---|---|
| testTaggedDocumentValidatesWithUa1 | Tier3MatterhornTest | PASS | 2.19s |
| testAnnotationWithContentsPassesClause718 | Tier3MatterhornTest | PASS | 2.16s |
| testUntaggedDocumentFailsUa1 | Tier3MatterhornTest | PASS | 1.87s |
| testMissingLangFailsUa1 | Tier3MatterhornTest | PASS | 1.84s |
| testMissingDisplayDocTitleFailsUa1 | Tier3MatterhornTest | PASS | 1.71s |
...
| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWellFormedAndValid | Tier4JhoveTest | PASS | 996ms |
| testMultiPagePdfWellFormedAndValid | Tier4JhoveTest | PASS | 919ms |
| testPdfWithMetadataWellFormedAndValid | Tier4JhoveTest | PASS | 886ms |
| testPdfWithEmbeddedFontWellFormedAndValid | Tier4JhoveTest | PASS | 932ms |
| testJhoveToolchainWorks | Tier4JhoveTest | PASS | 691ms |
| testPdfA1bPassesPdfBoxPreflight | Tier4PdfBoxPreflightTest | SKIP | <1ms |
| testPdfBoxPreflightToolchainWorks | Tier4PdfBoxPreflightTest | PASS | 781ms |
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 581ms |
| testPdfWithMetadataHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 556ms |
| testPdfWithEmbeddedFontHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 557ms |
| testPdfIdToolchainWorks | Tier4PdfIdTest | PASS | 351ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 via incremental save.pdf" | Tier4Pdf20ExamplesTest | PASS | 203ms |
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 with offset start.pdf" | Tier4Pdf20ExamplesTest | PASS | 193ms |
