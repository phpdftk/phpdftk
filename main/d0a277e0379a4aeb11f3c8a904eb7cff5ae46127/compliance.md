...
Generated: 2026-06-09 21:58:36 UTC
PHP: 8.4.21
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 88.74s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 32.53s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.28s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 18.04s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 32.53s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 280ms |
...
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 368ms |
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 325ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 326ms |
...
| testCalloutTallerThanPageThrows | CalloutTest | PASS | 26ms |
...
| testGeneratesHighLevelDocument | PdfIntegrationTest | PASS | 429ms |
...
| testSetFontSwitchesFontFamily | PdfTest | PASS | 182ms |
...
| testGetPageCount | BookmarkEditorTest | PASS | 3ms |
...
| testGetReader | PageLabelerTest | PASS | 3ms |
...
**4 tests** | 3 passed | 0 failed | 1 skipped | 18.04s
...
| testQpdfCorpus with data set "qpdf/annotation-no-resources-out.pdf" | Tier2CorpusTest | PASS | 7ms |
...
| testQpdfCorpus with data set "qpdf/uo-2.pdf" | Tier2CorpusTest | PASS | 3ms |
...
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 6.54s |
...
| testPdfBoxCorpus with data set "pdfbox/pdfbox/src/test/resources/org/apache/pdfbox/multipdf/AcrobatMerge-DifferentOptions.pdf" | Tier2PdfBoxCorpusTest | PASS | 3ms |
...
| testPdfWithMetadataWellFormedAndValid | Tier4JhoveTest | PASS | 857ms |
| testPdfWithEmbeddedFontWellFormedAndValid | Tier4JhoveTest | PASS | 865ms |
| testJhoveToolchainWorks | Tier4JhoveTest | PASS | 672ms |
| testPdfA1bPassesPdfBoxPreflight | Tier4PdfBoxPreflightTest | SKIP | <1ms |
| testPdfBoxPreflightToolchainWorks | Tier4PdfBoxPreflightTest | PASS | 743ms |
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 743ms |
| testPdfWithMetadataHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 514ms |
| testPdfWithEmbeddedFontHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 538ms |
