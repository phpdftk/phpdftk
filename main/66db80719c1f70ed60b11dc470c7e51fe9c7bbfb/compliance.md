...
Generated: 2026-05-24 21:50:50 UTC
PHP: 8.4.21
...
**Overall: PASS** | 1662 tests | 1656 passed | 0 failed | 6 skipped | 93.22s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 454 | 450 | 0 | 4 | 32.69s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.25s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 19.83s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 19.11s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 11.94s |
...
**454 tests** | 450 passed | 0 failed | 4 skipped | 32.69s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 680ms |
...
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 215ms |
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 189ms |
...
| testNoteCalloutEmitsLabelAndBody | CalloutTest | PASS | 186ms |
...
| testSaveToFile | BookmarkEditorTest | PASS | 184ms |
...
| testSetCropBox | PageTransformerTest | PASS | 180ms |
...
| testScaleSpecificPages | PageTransformerTest | PASS | 182ms |
...
**4 tests** | 3 passed | 0 failed | 1 skipped | 19.83s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWithOutputIntent | PdfAConformanceTest | SKIP | 4ms |
| testVeraPdfToolchainWorks | PdfAConformanceTest | PASS | 2.09s |
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 7.36s |
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 10.36s |
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 19.11s
...
| testQpdfCorpus with data set "qpdf/enc-R3,V2.pdf" | Tier2CorpusTest | PASS | 8ms |
...
| testQpdfCorpus with data set "qpdf/good17.pdf" | Tier2CorpusTest | PASS | 2ms |
...
| testQpdfCorpus with data set "qpdf/outlines-split-21-30.pdf" | Tier2CorpusTest | PASS | 25ms |
...
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 7.44s |
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 10.12s |
...
| testPdfBoxCorpus with data set "pdfbox/pdfbox/src/test/resources/input/cweb.pdf" | Tier2PdfBoxCorpusTest | PASS | 4ms |
...
**6 tests** | 6 passed | 0 failed | 0 skipped | 11.94s
...
| testMissingLangFailsUa1 | Tier3MatterhornTest | PASS | 1.97s |
...
| testPdfWithMetadataWellFormedAndValid | Tier4JhoveTest | PASS | 849ms |
...
| testPdfBoxPreflightToolchainWorks | Tier4PdfBoxPreflightTest | PASS | 801ms |
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 733ms |
| testPdfWithMetadataHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 521ms |
