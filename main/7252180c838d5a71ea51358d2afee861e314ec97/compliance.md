...
Generated: 2026-05-24 22:56:04 UTC
PHP: 8.4.21
...
**Overall: PASS** | 1662 tests | 1656 passed | 0 failed | 6 skipped | 88.05s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 454 | 450 | 0 | 4 | 32.02s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.24s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 18.03s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 17.6s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 10.95s |
| &#x2705; JHOVE + PDF 2.0 + Security + Preflight | PASS | 25 | 24 | 0 | 1 | 8.21s |
...
**454 tests** | 450 passed | 0 failed | 4 skipped | 32.02s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 299ms |
...
| testGeneratesPdfWithEmbeddedType1 | EmbeddedType1FontTest | PASS | 192ms |
...
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 500ms |
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 326ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 118ms |
...
| testGeneratesPageLabelsPdf | PageLabelsTest | PASS | 199ms |
| testGeneratesSignatureFieldPdf | SignatureFieldIntegrationTest | PASS | 184ms |
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 403ms |
| testGeneratesSimpleTextPdf | SimpleTextTest | PASS | 183ms |
| testGeneratesPdfWithType3Font | Type3FontIntegrationTest | PASS | 188ms |
| testGeneratesPdfWithXrefAndObjectStreams | XRefStreamIntegrationTest | PASS | 184ms |
...
| testAddPageDelegatesToWriter | PdfDocTest | PASS | 178ms |
...
| testAddTextCreatesFirstPageAutomatically | PdfTest | PASS | 181ms |
...
| testAddSpacerConsumesVerticalSpace | PdfTest | PASS | 182ms |
| testAddRuleDrawsStroke | PdfTest | PASS | 187ms |
...
| testAddTableRendersAllCellValues | TableTest | PASS | 185ms |
...
| testUnderlineEmitsStrokeBelowBaseline | TextDecorationTest | PASS | 183ms |
...
| testPdfWriterAddPageWithRectangle | WriterTest | PASS | 184ms |
| testPdfWriterRegisterObject | WriterTest | PASS | 184ms |
| testPdfWriterFontAddedToPage | WriterTest | PASS | 181ms |
| testSetNamedDestinations | WriterTest | PASS | 186ms |
| testSetEncryptionProducesEncryptedPdf | WriterTest | PASS | 184ms |
| testSetEncryptionAes256RoundTrip | WriterTest | PASS | 235ms |
| testSetMetadataAddsStreamToPdf | XmpMetadataTest | PASS | 182ms |
...
| testFillTextField | FormFillerTest | PASS | 186ms |
| testFillManyFields | FormFillerTest | PASS | 184ms |
...
| testSetMetadataOnPdfWithoutInfo | MetadataEditorTest | PASS | 183ms |
...
| testSetRomanNumeralsUppercase | PageLabelerTest | PASS | 189ms |
...
| testRemoveLabels | PageLabelerTest | PASS | 202ms |
| testMultipleRanges | PageLabelerTest | PASS | 185ms |
...
| testSplit | PageSlicerTest | PASS | 365ms |
...
| testRotateSpecificPages | PageTransformerTest | PASS | 189ms |
| testRotateCumulative | PageTransformerTest | PASS | 181ms |
| testRotateInvalidAngle | PageTransformerTest | PASS | <1ms |
| testSetCropBox | PageTransformerTest | PASS | 190ms |
...
| testScaleSpecificPages | PageTransformerTest | PASS | 181ms |
...
| testMultipleOperations | PageTransformerTest | PASS | 193ms |
...
| testSaveToFile | PageTransformerTest | PASS | 184ms |
| testEncryptAes128 | PdfEncryptTest | PASS | 186ms |
| testEncryptAes256 | PdfEncryptTest | PASS | 199ms |
| testDecrypt | PdfEncryptTest | PASS | 184ms |
...
| testMergeTwoPdfs | PdfMergerTest | PASS | 186ms |
...
| testWatermark | PdfStamperTest | PASS | 195ms |
...
| testStampImageWithScaleHeight | PdfStamperTest | PASS | 191ms |
| testStampImageWithExplicitDimensions | PdfStamperTest | PASS | 194ms |
...
| testStampPdfWithScaling | PdfStamperTest | PASS | 186ms |
| testStampPdfWithOpacity | PdfStamperTest | PASS | 180ms |
...
| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesBookmarksPdf | BookmarksTest | PASS | 300ms |
| testGeneratesDocumentFeaturesPdf | DocumentFeaturesTest | PASS | 179ms |
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 17.6s
...
| testQpdfCorpus with data set "qpdf/object-types-os.pdf" | Tier2CorpusTest | PASS | 25ms |
...
| testPdfBoxCorpus with data set "pdfbox/pdfbox/src/test/resources/org/apache/pdfbox/pdmodel/interactive/form/PDFBOX-3835-input-acrobat-wrap.pdf" | Tier2PdfBoxCorpusTest | PASS | 3ms |
...
**6 tests** | 6 passed | 0 failed | 0 skipped | 10.95s

| Test | Class | Status | Time |
|---|---|---|---|
| testTaggedDocumentValidatesWithUa1 | Tier3MatterhornTest | PASS | 2.07s |
...
**25 tests** | 24 passed | 0 failed | 1 skipped | 8.21s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWellFormedAndValid | Tier4JhoveTest | PASS | 929ms |
...
| testJhoveToolchainWorks | Tier4JhoveTest | PASS | 671ms |
| testPdfA1bPassesPdfBoxPreflight | Tier4PdfBoxPreflightTest | SKIP | <1ms |
| testPdfBoxPreflightToolchainWorks | Tier4PdfBoxPreflightTest | PASS | 757ms |
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 551ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 with offset start.pdf" | Tier4Pdf20ExamplesTest | PASS | 184ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/Simple PDF 2.0 file.pdf" | Tier4Pdf20ExamplesTest | PASS | 190ms |
