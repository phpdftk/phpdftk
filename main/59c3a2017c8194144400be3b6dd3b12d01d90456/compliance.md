...
Generated: 2026-06-09 21:49:40 UTC
PHP: 8.4.21
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 88.3s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 31.75s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.25s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 18.3s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 17.66s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 11.19s |
| &#x2705; JHOVE + PDF 2.0 + Security + Preflight | PASS | 25 | 24 | 0 | 1 | 8.15s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 31.75s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 295ms |
| testGeneratesAnnotationsPdf | AnnotationsTest | PASS | 177ms |
| testGeneratesBookmarksPdf | BookmarksTest | PASS | 236ms |
...
| testGeneratesPdfWithEmbeddedFont | EmbeddedFontsTest | PASS | 197ms |
...
| testGeneratesPdfWithEmbeddedType1 | EmbeddedType1FontTest | PASS | 182ms |
...
| testGeneratesFormWithAppearances | FormAppearancesIntegrationTest | PASS | 182ms |
...
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 503ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 315ms |
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 105ms |
| testGeneratesPdfWithMarkupFields | MarkupAnnotationsIntegrationTest | PASS | 188ms |
| testGeneratesMultiPageComplexPdf | MultiPageComplexTest | PASS | 189ms |
| testGeneratesMultimediaAnd3DPdf | MultimediaAndThreeDIntegrationTest | PASS | 178ms |
...
| testGeneratesPageLabelsPdf | PageLabelsTest | PASS | 186ms |
| testGeneratesSignatureFieldPdf | SignatureFieldIntegrationTest | PASS | 184ms |
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 356ms |
...
| testAddTextWithLinkStyleProducesLinkAnnotation | InlineLinkTest | PASS | 189ms |
...
| testBulletListRendersEachItem | ListTest | PASS | 181ms |
...
| testShowPageNumbersDefaultFormat | PageNumbersTest | PASS | 179ms |
...
| testGeneratesHighLevelDocument | PdfIntegrationTest | PASS | 385ms |
| testAddHtmlRendersIntoPdf | PdfTest | PASS | 36ms |
| testEmptyDocumentHasNoPages | PdfTest | PASS | 181ms |
| testAddTextCreatesFirstPageAutomatically | PdfTest | PASS | 180ms |
| testAddHeadingEmitsLargerText | PdfTest | PASS | 178ms |
| testExplicitNewPageCreatesSecondPage | PdfTest | PASS | 182ms |
| testLongTextAutoPaginates | PdfTest | PASS | 189ms |
| testAddSpacerConsumesVerticalSpace | PdfTest | PASS | 179ms |
...
| testBoldAndItalicResolveToCorrectPostScriptName | PdfTest | PASS | 180ms |
| testUnknownFamilyIsRejected | PdfTest | PASS | <1ms |
| testCustomTheme | PdfTest | PASS | 176ms |
| testSaveWritesFile | PdfTest | PASS | 185ms |
| testWriteToStream | PdfTest | PASS | 182ms |
| testWriteToRejectsNonResource | PdfTest | PASS | <1ms |
| testToBytesProducesValidPdfOnEachCall | PdfTest | PASS | 372ms |
...
| testAddTableRendersAllCellValues | TableTest | PASS | 181ms |
...
| testUnderlineEmitsStrokeBelowBaseline | TextDecorationTest | PASS | 184ms |
...
| testAddCompositeFontGeneratesValidPdf | UnicodeFontTest | PASS | 180ms |
| testAddCompositeFontSavesToFile | UnicodeFontTest | PASS | 186ms |
...
| testCompositeFontPerPage | UnicodeFontTest | PASS | 190ms |
...
| testPdfWriterContainsPage | WriterTest | PASS | 179ms |
...
| testPdfWriterSavesToFile | WriterTest | PASS | 182ms |
| testPdfWriterContainsXref | WriterTest | PASS | 185ms |
| testPdfWriterContainsTrailer | WriterTest | PASS | <1ms |
| testPdfWriterAddPageWithRectangle | WriterTest | PASS | 192ms |
| testPdfWriterRegisterObject | WriterTest | PASS | 180ms |
...
| testSetBookmarks | BookmarkEditorTest | PASS | 189ms |
| testSetBookmarksWithChildren | BookmarkEditorTest | PASS | 190ms |
| testAddBookmark | BookmarkEditorTest | PASS | 373ms |
| testHasBookmarksReturnsFalseForCleanPdf | BookmarkEditorTest | PASS | <1ms |
| testRemoveBookmarks | BookmarkEditorTest | PASS | 188ms |
...
| testFillTextField | FormFillerTest | PASS | 184ms |
| testFillManyFields | FormFillerTest | PASS | 190ms |
| testCheckCheckbox | FormFillerTest | PASS | 183ms |
| testUncheckCheckbox | FormFillerTest | PASS | 181ms |
| testSelectChoiceField | FormFillerTest | PASS | 195ms |
...
| testEscapeHatch | FormFillerTest | PASS | 4ms |
...
| testCustomField | MetadataEditorTest | PASS | 187ms |
| testSaveToFile | MetadataEditorTest | PASS | 184ms |
| testSetLabelsWithArabic | PageLabelerTest | PASS | 181ms |
| testSetRomanNumerals | PageLabelerTest | PASS | 193ms |
| testSetRomanNumeralsUppercase | PageLabelerTest | PASS | 188ms |
| testSetAlphabetic | PageLabelerTest | PASS | 187ms |
| testSetArabicWithStartNumber | PageLabelerTest | PASS | 186ms |
| testSetLabelsWithPrefix | PageLabelerTest | PASS | 185ms |
| testRemoveLabels | PageLabelerTest | PASS | 188ms |
...
| testReverse | PageSlicerTest | PASS | 178ms |
| testSplit | PageSlicerTest | PASS | 358ms |
| testKeepWithPageSelector | PageSlicerTest | PASS | 191ms |
| testNoOpsKeepsAllPages | PageSlicerTest | PASS | 177ms |
...
| testRotate180 | PageTransformerTest | PASS | 192ms |
...
| testSetCropBox | PageTransformerTest | PASS | 181ms |
| testSetCropBoxSpecificPage | PageTransformerTest | PASS | 179ms |
...
| testScale | PageTransformerTest | PASS | 178ms |
| testScaleSpecificPages | PageTransformerTest | PASS | 188ms |
| testScaleInvalidFactor | PageTransformerTest | PASS | <1ms |
| testScaleTo | PageTransformerTest | PASS | 179ms |
| testScaleToNonUniform | PageTransformerTest | PASS | 187ms |
| testMultipleOperations | PageTransformerTest | PASS | 179ms |
| testNoBytesChangedWithoutOperations | PageTransformerTest | PASS | <1ms |
| testEvenPages | PageTransformerTest | PASS | 182ms |
| testOddPages | PageTransformerTest | PASS | 190ms |
...
| testSaveToFile | PageTransformerTest | PASS | 181ms |
| testEncryptAes128 | PdfEncryptTest | PASS | 182ms |
| testEncryptAes256 | PdfEncryptTest | PASS | 194ms |
...
| testSaveToFile | PdfMergerTest | PASS | 180ms |
| testStampText | PdfStamperTest | PASS | 183ms |
| testWatermark | PdfStamperTest | PASS | 190ms |
| testWatermarkWithStyle | PdfStamperTest | PASS | 190ms |
| testPageNumbers | PdfStamperTest | PASS | 193ms |
| testStampOnSpecificPages | PdfStamperTest | PASS | 174ms |
| testHeaderAndFooter | PdfStamperTest | PASS | 190ms |
| testStampWithOpacity | PdfStamperTest | PASS | 186ms |
...
| testStampImagePng | PdfStamperTest | PASS | 184ms |
| testStampImageWithScaleWidth | PdfStamperTest | PASS | 178ms |
| testStampImageWithScaleHeight | PdfStamperTest | PASS | 179ms |
| testStampImageWithExplicitDimensions | PdfStamperTest | PASS | 186ms |
| testStampImageWithOpacity | PdfStamperTest | PASS | 188ms |
...
| testStampPdf | PdfStamperTest | PASS | 179ms |
| testStampPdfWithScaling | PdfStamperTest | PASS | 185ms |
| testStampPdfWithOpacity | PdfStamperTest | PASS | 192ms |
| testStampPdfSpecificPage | PdfStamperTest | PASS | 181ms |
| testStampPdfOnSelectedPages | PdfStamperTest | PASS | 180ms |
| testStampPdfDefaultsToCenter | PdfStamperTest | PASS | 179ms |
...
| testRedactArea | TextRedactorTest | PASS | 191ms |
| testRedactMultipleAreas | TextRedactorTest | PASS | 193ms |
| testRedactByText | TextRedactorTest | PASS | 178ms |
| testRedactByPattern | TextRedactorTest | PASS | <1ms |
| testCustomRedactionColor | TextRedactorTest | PASS | 177ms |
...
| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesBookmarksPdf | BookmarksTest | PASS | 314ms |
| testGeneratesDocumentFeaturesPdf | DocumentFeaturesTest | PASS | 182ms |
| testGeneratesPdfWithEmbeddedTrueTypeFont | DocumentFeaturesTest | PASS | 190ms |
...
**4 tests** | 3 passed | 0 failed | 1 skipped | 18.3s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWithOutputIntent | PdfAConformanceTest | SKIP | 5ms |
| testVeraPdfToolchainWorks | PdfAConformanceTest | PASS | 2.04s |
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 6.91s |
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 9.34s |
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 17.66s
...
| testQpdfCorpus with data set "qpdf/appearances-1-rotated.pdf" | Tier2CorpusTest | PASS | 7ms |
...
| testQpdfCorpus with data set "qpdf/many-nulls.pdf" | Tier2CorpusTest | PASS | 691ms |
...
| testQpdfCorpus with data set "qpdf/remove-info.pdf" | Tier2CorpusTest | PASS | 24ms |
...
| testQpdfCorpus with data set "qpdf/weird-tokens.pdf" | Tier2CorpusTest | PASS | 5ms |
...
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 6.91s |
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 9.14s |
...
| testPdfiumCorpus with data set "pdfium/annotation_stamp_with_ap.pdf" | Tier2PdfiumCorpusTest | PASS | 3ms |
...
| testPdfiumCorpus with data set "pdfium/redirect.pdf" | Tier2PdfiumCorpusTest | PASS | 3ms |
...
**6 tests** | 6 passed | 0 failed | 0 skipped | 11.19s

| Test | Class | Status | Time |
|---|---|---|---|
| testTaggedDocumentValidatesWithUa1 | Tier3MatterhornTest | PASS | 2.02s |
| testAnnotationWithContentsPassesClause718 | Tier3MatterhornTest | PASS | 2.12s |
| testUntaggedDocumentFailsUa1 | Tier3MatterhornTest | PASS | 1.76s |
| testMissingLangFailsUa1 | Tier3MatterhornTest | PASS | 1.78s |
...
**25 tests** | 24 passed | 0 failed | 1 skipped | 8.15s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWellFormedAndValid | Tier4JhoveTest | PASS | 913ms |
| testMultiPagePdfWellFormedAndValid | Tier4JhoveTest | PASS | 867ms |
| testPdfWithMetadataWellFormedAndValid | Tier4JhoveTest | PASS | 841ms |
| testPdfWithEmbeddedFontWellFormedAndValid | Tier4JhoveTest | PASS | 849ms |
| testJhoveToolchainWorks | Tier4JhoveTest | PASS | 675ms |
| testPdfA1bPassesPdfBoxPreflight | Tier4PdfBoxPreflightTest | SKIP | <1ms |
| testPdfBoxPreflightToolchainWorks | Tier4PdfBoxPreflightTest | PASS | 796ms |
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 539ms |
| testPdfWithMetadataHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 510ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 UTF-8 string and annotation.pdf" | Tier4Pdf20ExamplesTest | PASS | 181ms |
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 image with BPC.pdf" | Tier4Pdf20ExamplesTest | PASS | 184ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 with page level output intent.pdf" | Tier4Pdf20ExamplesTest | PASS | 180ms |
| testPdf20ExampleQpdfValid with data set "pdf20/Simple PDF 2.0 file.pdf" | Tier4Pdf20ExamplesTest | PASS | 184ms |
| testPdf20ExampleQpdfValid with data set "pdf20/pdf20-utf8-test.pdf" | Tier4Pdf20ExamplesTest | PASS | 187ms |
