...
Generated: 2026-05-25 03:25:23 UTC
PHP: 8.4.21
...
**Overall: PASS** | 1662 tests | 1656 passed | 0 failed | 6 skipped | 88.34s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 454 | 450 | 0 | 4 | 32.42s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.24s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 17.59s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 17.69s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 11.08s |
...
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 622ms |
...
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 537ms |
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 197ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 588ms |
...
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 430ms |
...
| testAddPageDelegatesToWriter | PdfDocTest | PASS | 176ms |
...
| testSetNamedDestinations | WriterTest | PASS | 175ms |
...
| testWatermarkWithStyle | PdfStamperTest | PASS | 178ms |
...
| testStampPdf | PdfStamperTest | PASS | 178ms |
...
**4 tests** | 3 passed | 0 failed | 1 skipped | 17.59s
...
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 8.9s |
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 17.69s
...
| testQpdfCorpus with data set "qpdf/duplicate-page-inherited-2-fixed.pdf" | Tier2CorpusTest | PASS | 6ms |
...
| testQpdfCorpus with data set "qpdf/no-pages-types-fixed.pdf" | Tier2CorpusTest | PASS | 24ms |
...
| testPdfBoxCorpus with data set "pdfbox/pdfbox/src/test/resources/input/PDFBOX-5350-JX57O5E5YG6XM4FZABPULQGTW4OXPCWA-p1-reduced.pdf" | Tier2PdfBoxCorpusTest | PASS | 5ms |
...
| testPdfiumCorpus with data set "pdfium/bug_642.pdf" | Tier2PdfiumCorpusTest | PASS | 3ms |
...
**6 tests** | 6 passed | 0 failed | 0 skipped | 11.08s
