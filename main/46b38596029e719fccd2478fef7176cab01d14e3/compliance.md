...
Generated: 2026-05-08 21:11:33 UTC
PHP: 8.4.21
...
**Overall: PASS** | 1444 tests | 1438 passed | 0 failed | 6 skipped | 82.5s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 236 | 232 | 0 | 4 | 26.23s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.08s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 18.95s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 18.38s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 10.36s |
| &#x2705; JHOVE + PDF 2.0 + Security + Preflight | PASS | 25 | 24 | 0 | 1 | 7.51s |
...
**236 tests** | 232 passed | 0 failed | 4 skipped | 26.23s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 227ms |
| testGeneratesAnnotationsPdf | AnnotationsTest | PASS | 161ms |
| testGeneratesBookmarksPdf | BookmarksTest | PASS | 207ms |
| testGeneratesFormWithCustomFontAppearances | CustomFontFormAppearancesTest | PASS | 174ms |
...
| testGeneratesGraphicsPdf | GraphicsTest | PASS | 172ms |
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 593ms |
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 211ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 174ms |
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 195ms |
...
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 529ms |
...
| testAddTextCreatesFirstPageAutomatically | PdfTest | PASS | 167ms |
...
| testSaveWritesFile | PdfTest | PASS | 160ms |
| testWriteToStream | PdfTest | PASS | 160ms |
| testWriteToRejectsNonResource | PdfTest | PASS | <1ms |
| testToBytesProducesValidPdfOnEachCall | PdfTest | PASS | 326ms |
...
| testPdfWriterGeneratesValidPdfHeader | WriterTest | PASS | 162ms |
...
| testPdfWriterContainsPage | WriterTest | PASS | 164ms |
...
| testPdfWriterFontAddedToPage | WriterTest | PASS | 174ms |
...
| testMetadataStreamContainsXmp | XmpMetadataTest | PASS | 172ms |
| testMetadataRoundTrip | XmpMetadataTest | PASS | 162ms |
| testSyncInfoToMetadata | XmpMetadataTest | PASS | 161ms |
| testSyncInfoToMetadataNoInfoIsNoOp | XmpMetadataTest | PASS | 164ms |
...
| testSelectChoiceField | FormFillerTest | PASS | 157ms |
| testFillMultipleFieldTypes | FormFillerTest | PASS | 162ms |
...
| testRoundTripPreservesOtherFields | FormFillerTest | PASS | 171ms |
...
| testSetMultipleFieldsRoundTrip | MetadataEditorTest | PASS | 181ms |
...
| testRotateCumulative | PageTransformerTest | PASS | 164ms |
...
| testSetBleedBox | PageTransformerTest | PASS | 164ms |
| testScale | PageTransformerTest | PASS | 164ms |
| testScaleSpecificPages | PageTransformerTest | PASS | 159ms |
...
| testMergeTwoPdfs | PdfMergerTest | PASS | 171ms |
...
| testSaveToFile | PdfMergerTest | PASS | 166ms |
...
| testStampImagePng | PdfStamperTest | PASS | 165ms |
| testStampImageWithScaleWidth | PdfStamperTest | PASS | 163ms |
| testStampImageWithScaleHeight | PdfStamperTest | PASS | 166ms |
| testStampImageWithExplicitDimensions | PdfStamperTest | PASS | 158ms |
| testStampImageWithOpacity | PdfStamperTest | PASS | 165ms |
...
| testRedactMultipleAreas | TextRedactorTest | PASS | 164ms |
| testRedactByText | TextRedactorTest | PASS | 176ms |
...
**4 tests** | 3 passed | 0 failed | 1 skipped | 18.95s
...
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 10s |
...
| testQpdfCorpus with data set "qpdf/bad21.pdf" | Tier2CorpusTest | PASS | 4ms |
...
| testQpdfCorpus with data set "qpdf/c-no-options.pdf" | Tier2CorpusTest | PASS | 5ms |
...
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 6.86s |
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 10.22s |
...
| testPdfiumCorpus with data set "pdfium/pixel/generation_numbers2.pdf" | Tier2PdfiumCorpusTest | PASS | 3ms |
...
**6 tests** | 6 passed | 0 failed | 0 skipped | 10.36s
...
| testMissingLangFailsUa1 | Tier3MatterhornTest | PASS | 1.64s |
| testMissingDisplayDocTitleFailsUa1 | Tier3MatterhornTest | PASS | 1.58s |
...
**25 tests** | 24 passed | 0 failed | 1 skipped | 7.51s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWellFormedAndValid | Tier4JhoveTest | PASS | 869ms |
| testMultiPagePdfWellFormedAndValid | Tier4JhoveTest | PASS | 817ms |
| testPdfWithMetadataWellFormedAndValid | Tier4JhoveTest | PASS | 799ms |
| testPdfWithEmbeddedFontWellFormedAndValid | Tier4JhoveTest | PASS | 816ms |
| testJhoveToolchainWorks | Tier4JhoveTest | PASS | 642ms |
...
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 471ms |
| testPdfWithMetadataHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 459ms |
| testPdfWithEmbeddedFontHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 454ms |
| testPdfIdToolchainWorks | Tier4PdfIdTest | PASS | 299ms |
| testPdf20ExampleParseable with data set "pdf20/PDF 2.0 UTF-8 string and annotation.pdf" | Tier4Pdf20ExamplesTest | PASS | 5ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 UTF-8 string and annotation.pdf" | Tier4Pdf20ExamplesTest | PASS | 169ms |
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 image with BPC.pdf" | Tier4Pdf20ExamplesTest | PASS | 172ms |
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 via incremental save.pdf" | Tier4Pdf20ExamplesTest | PASS | 180ms |
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 with offset start.pdf" | Tier4Pdf20ExamplesTest | PASS | 158ms |
