...
Generated: 2026-06-17 15:16:00 UTC
PHP: 8.4.22
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 110.66s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 65.84s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.39s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 11.95s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 12.1s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 7.93s |
| &#x2705; JHOVE + PDF 2.0 + Security + Preflight | PASS | 25 | 24 | 0 | 1 | 11.46s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 65.84s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 1.82s |
| testGeneratesAnnotationsPdf | AnnotationsTest | PASS | 227ms |
| testGeneratesBookmarksPdf | BookmarksTest | PASS | 369ms |
| testGeneratesFormWithCustomFontAppearances | CustomFontFormAppearancesTest | PASS | 862ms |
| testGeneratesDocumentFeaturesPdf | DocumentFeaturesTest | PASS | 584ms |
| testGeneratesPdfWithEmbeddedTrueTypeFont | DocumentFeaturesTest | PASS | 363ms |
| testGeneratesPdfWithEmbeddedFont | EmbeddedFontsTest | PASS | 269ms |
| testEmbeddedFontHasFontDescriptor | EmbeddedFontsTest | PASS | 4ms |
| testEmbeddedFontHasToUnicode | EmbeddedFontsTest | PASS | 4ms |
| testEmbeddedFontWidthsArray | EmbeddedFontsTest | PASS | <1ms |
...
| testGeneratesPdfWithEmbeddedType1 | EmbeddedType1FontTest | PASS | 446ms |
| testPdfOutputContainsFontData | EmbeddedType1FontTest | PASS | <1ms |
| testGeneratesExtGStatePdf | ExtGStateIntegrationTest | PASS | 383ms |
| testGeneratesFormWithAppearances | FormAppearancesIntegrationTest | PASS | 573ms |
| testGeneratesFormPdf | FormFieldsTest | PASS | 151ms |
| testGeneratesGraphicsPipelinePdf | GraphicsPipelineIntegrationTest | PASS | 147ms |
| testGeneratesGraphicsPdf | GraphicsTest | PASS | 193ms |
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 271ms |
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 72ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 213ms |
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 85ms |
| testGeneratesPdfWithMarkupFields | MarkupAnnotationsIntegrationTest | PASS | 150ms |
| testGeneratesMultiPageComplexPdf | MultiPageComplexTest | PASS | 329ms |
| testGeneratesMultimediaAnd3DPdf | MultimediaAndThreeDIntegrationTest | PASS | 190ms |
...
| testGeneratesPageLabelsPdf | PageLabelsTest | PASS | 227ms |
| testGeneratesSignatureFieldPdf | SignatureFieldIntegrationTest | PASS | 302ms |
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 276ms |
| testGeneratesSimpleTextPdf | SimpleTextTest | PASS | 243ms |
| testGeneratesPdfWithType3Font | Type3FontIntegrationTest | PASS | 167ms |
| testGeneratesPdfWithXrefAndObjectStreams | XRefStreamIntegrationTest | PASS | 377ms |
| testEnableOutlineThenHeadingRegistersOutlinesEntry | AutoOutlineTest | PASS | 265ms |
...
| testQrCodeAdapterPlacesA2dMatrix | BarcodeAdapterTest | PASS | 5ms |
...
| testAddQuoteAutoPaginatesAndDrawsBarOnEachPage | BlockquoteTest | PASS | 4ms |
...
| testNoteCalloutEmitsLabelAndBody | CalloutTest | PASS | 157ms |
...
| testCalloutTallerThanPageThrows | CalloutTest | PASS | 12ms |
...
| testWinAnsiRoundTripFromShowText | EncodingIntegrationTest | PASS | 514ms |
| testHighLevelPdfRoundTrip | EncodingIntegrationTest | PASS | 3ms |
| testAddTextWithLinkStyleProducesLinkAnnotation | InlineLinkTest | PASS | 249ms |
...
| testBulletListRendersEachItem | ListTest | PASS | 788ms |
...
| testLongListAutoPaginates | ListTest | PASS | 5ms |
...
| testColumnAdvancesBeforeNewPage | MultiColumnTest | PASS | 1ms |
| testThreeColumnsFillsAllBeforePaging | MultiColumnTest | PASS | <1ms |
| testPageBreakAfterLastColumnResetsToColumnZero | MultiColumnTest | PASS | 4ms |
...
| testShowPageNumbersDefaultFormat | PageNumbersTest | PASS | 884ms |
...
| testAddPageDelegatesToWriter | PdfDocTest | PASS | 571ms |
...
| testAddLinkWithZeroSizeRectStillProducesAnnotation | PdfDocTest | PASS | <1ms |
...
| testGeneratesHighLevelDocument | PdfIntegrationTest | PASS | 488ms |
| testAddHtmlRendersIntoPdf | PdfTest | PASS | 25ms |
| testEmptyDocumentHasNoPages | PdfTest | PASS | 684ms |
| testAddTextCreatesFirstPageAutomatically | PdfTest | PASS | 361ms |
| testAddHeadingEmitsLargerText | PdfTest | PASS | 292ms |
| testExplicitNewPageCreatesSecondPage | PdfTest | PASS | 217ms |
| testLongTextAutoPaginates | PdfTest | PASS | 288ms |
| testAddSpacerConsumesVerticalSpace | PdfTest | PASS | 259ms |
| testAddRuleDrawsStroke | PdfTest | PASS | 343ms |
| testAlignmentCenterEmitsCenteredText | PdfTest | PASS | 551ms |
| testSetFontSwitchesFontFamily | PdfTest | PASS | 592ms |
| testBoldAndItalicResolveToCorrectPostScriptName | PdfTest | PASS | 795ms |
| testUnknownFamilyIsRejected | PdfTest | PASS | <1ms |
| testCustomTheme | PdfTest | PASS | 710ms |
| testSaveWritesFile | PdfTest | PASS | 709ms |
| testWriteToStream | PdfTest | PASS | 764ms |
| testWriteToRejectsNonResource | PdfTest | PASS | <1ms |
| testToBytesProducesValidPdfOnEachCall | PdfTest | PASS | 1.88s |
...
| testLinearGradientExtendEmitsExtendArray | Phase4Batch2Test | PASS | <1ms |
| testLinearGradientDefaultsToNoExtend | Phase4Batch2Test | PASS | <1ms |
| testRadialGradientStopsExtendEmitsExtendArray | Phase4Batch2Test | PASS | <1ms |
...
| testAddTableRendersAllCellValues | TableTest | PASS | 846ms |
...
| testAddTableAutoPaginatesAndRepeatsHeader | TableTest | PASS | 2ms |
| testAddTableEmptyRowsIsNoOp | TableTest | PASS | <1ms |
| testAddTableWrapsLongCellContentAcrossMultipleLines | TableTest | PASS | <1ms |
| testAddTableHonoursPerColumnAlignment | TableTest | PASS | 5ms |
...
| testUnderlineEmitsStrokeBelowBaseline | TextDecorationTest | PASS | 544ms |
...
| testType0FontFactoryCreatesValidStack | UnicodeFontTest | PASS | 3ms |
| testAddCompositeFontGeneratesValidPdf | UnicodeFontTest | PASS | 386ms |
| testAddCompositeFontSavesToFile | UnicodeFontTest | PASS | 379ms |
| testCompositeFontRoundTripsThroughReader | UnicodeFontTest | PASS | 1.18s |
| testCompositeFontAppearsInFontList | UnicodeFontTest | PASS | 2ms |
| testShowTextHexOperator | UnicodeFontTest | PASS | <1ms |
| testCompositeFontPerPage | UnicodeFontTest | PASS | 944ms |
| testPdfWriterGeneratesValidPdfHeader | WriterTest | PASS | 685ms |
...
| testPdfWriterContainsPage | WriterTest | PASS | 476ms |
...
| testPdfWriterAddContentStream | WriterTest | PASS | 317ms |
| testPdfWriterGetContentStreams | WriterTest | PASS | <1ms |
| testPdfWriterWithInfo | WriterTest | PASS | 498ms |
| testPdfWriterGetCatalog | WriterTest | PASS | <1ms |
| testPdfWriterGetPageTree | WriterTest | PASS | <1ms |
| testPdfWriterSavesToFile | WriterTest | PASS | 586ms |
| testPdfWriterContainsXref | WriterTest | PASS | 510ms |
| testPdfWriterContainsTrailer | WriterTest | PASS | <1ms |
| testPdfWriterAddPageWithRectangle | WriterTest | PASS | 258ms |
| testPdfWriterRegisterObject | WriterTest | PASS | 471ms |
| testPdfWriterFontAddedToPage | WriterTest | PASS | 248ms |
| testSetNamedDestinations | WriterTest | PASS | 408ms |
| testSetEncryptionProducesEncryptedPdf | WriterTest | PASS | 386ms |
| testSetEncryptionAes256RoundTrip | WriterTest | PASS | 432ms |
| testSetMetadataAddsStreamToPdf | XmpMetadataTest | PASS | 385ms |
| testMetadataStreamContainsXmp | XmpMetadataTest | PASS | 426ms |
| testMetadataRoundTrip | XmpMetadataTest | PASS | 157ms |
| testSyncInfoToMetadata | XmpMetadataTest | PASS | 258ms |
| testSyncInfoToMetadataNoInfoIsNoOp | XmpMetadataTest | PASS | 423ms |
| testFlattenAll | AnnotationFlattenerTest | PASS | 646ms |
...
| testSaveToFile | AnnotationFlattenerTest | PASS | 287ms |
...
| testSetBookmarks | BookmarkEditorTest | PASS | 407ms |
| testSetBookmarksWithChildren | BookmarkEditorTest | PASS | 368ms |
| testAddBookmark | BookmarkEditorTest | PASS | 1.02s |
| testHasBookmarksReturnsFalseForCleanPdf | BookmarkEditorTest | PASS | <1ms |
| testRemoveBookmarks | BookmarkEditorTest | PASS | 465ms |
| testGetPageCount | BookmarkEditorTest | PASS | <1ms |
| testGetReader | BookmarkEditorTest | PASS | <1ms |
| testSaveToFile | BookmarkEditorTest | PASS | 397ms |
| testNoBytesChangedWhenNoOperations | BookmarkEditorTest | PASS | <1ms |
| testReplaceExistingBookmarks | BookmarkEditorTest | PASS | 408ms |
| testOpenString | FormFillerTest | PASS | 1ms |
...
| testFillTextField | FormFillerTest | PASS | 288ms |
| testFillManyFields | FormFillerTest | PASS | 291ms |
| testCheckCheckbox | FormFillerTest | PASS | 267ms |
| testUncheckCheckbox | FormFillerTest | PASS | 230ms |
| testSelectChoiceField | FormFillerTest | PASS | 282ms |
| testFillMultipleFieldTypes | FormFillerTest | PASS | 185ms |
...
| testSaveWritesFile | FormFillerTest | PASS | 536ms |
| testEscapeHatch | FormFillerTest | PASS | <1ms |
| testRoundTripPreservesOtherFields | FormFillerTest | PASS | 222ms |
...
| testSetTitleRoundTrip | MetadataEditorTest | PASS | 545ms |
| testSetMultipleFieldsRoundTrip | MetadataEditorTest | PASS | 935ms |
| testSetMetadataOnPdfWithoutInfo | MetadataEditorTest | PASS | 432ms |
...
| testPageCount | MetadataEditorTest | PASS | 4ms |
| testEscapeHatch | MetadataEditorTest | PASS | <1ms |
| testCustomField | MetadataEditorTest | PASS | 194ms |
| testSaveToFile | MetadataEditorTest | PASS | 321ms |
| testSetLabelsWithArabic | PageLabelerTest | PASS | 295ms |
| testSetRomanNumerals | PageLabelerTest | PASS | 219ms |
| testSetRomanNumeralsUppercase | PageLabelerTest | PASS | 436ms |
| testSetAlphabetic | PageLabelerTest | PASS | 389ms |
| testSetArabicWithStartNumber | PageLabelerTest | PASS | 287ms |
| testSetLabelsWithPrefix | PageLabelerTest | PASS | 205ms |
| testRemoveLabels | PageLabelerTest | PASS | 205ms |
| testMultipleRanges | PageLabelerTest | PASS | 356ms |
| testGetPageCount | PageLabelerTest | PASS | <1ms |
| testGetReader | PageLabelerTest | PASS | <1ms |
| testSaveToFile | PageLabelerTest | PASS | 197ms |
| testNoBytesChangedWhenNoOperations | PageLabelerTest | PASS | <1ms |
| testOpenFromFile | PageLabelerTest | PASS | <1ms |
| testKeepPages | PageSlicerTest | PASS | 347ms |
| testKeepRange | PageSlicerTest | PASS | 470ms |
| testRemovePages | PageSlicerTest | PASS | 621ms |
| testReorder | PageSlicerTest | PASS | 621ms |
| testReverse | PageSlicerTest | PASS | 780ms |
| testSplit | PageSlicerTest | PASS | 1.2s |
| testKeepWithPageSelector | PageSlicerTest | PASS | 530ms |
| testNoOpsKeepsAllPages | PageSlicerTest | PASS | 328ms |
| testPageCount | PageSlicerTest | PASS | <1ms |
| testEscapeHatch | PageSlicerTest | PASS | <1ms |
| testRotateAllPages | PageTransformerTest | PASS | 840ms |
| testRotate180 | PageTransformerTest | PASS | 615ms |
| testRotate270 | PageTransformerTest | PASS | 343ms |
| testRotateSpecificPages | PageTransformerTest | PASS | 788ms |
| testRotateCumulative | PageTransformerTest | PASS | 422ms |
| testRotateInvalidAngle | PageTransformerTest | PASS | <1ms |
| testSetCropBox | PageTransformerTest | PASS | 609ms |
| testSetCropBoxSpecificPage | PageTransformerTest | PASS | 266ms |
| testSetMediaBox | PageTransformerTest | PASS | 510ms |
| testSetTrimBox | PageTransformerTest | PASS | 897ms |
| testSetBleedBox | PageTransformerTest | PASS | 634ms |
| testScale | PageTransformerTest | PASS | 217ms |
| testScaleSpecificPages | PageTransformerTest | PASS | 173ms |
| testScaleInvalidFactor | PageTransformerTest | PASS | <1ms |
| testScaleTo | PageTransformerTest | PASS | 142ms |
| testScaleToNonUniform | PageTransformerTest | PASS | 257ms |
| testMultipleOperations | PageTransformerTest | PASS | 269ms |
| testNoBytesChangedWithoutOperations | PageTransformerTest | PASS | <1ms |
| testEvenPages | PageTransformerTest | PASS | 241ms |
| testOddPages | PageTransformerTest | PASS | 147ms |
| testRange | PageTransformerTest | PASS | 145ms |
| testGetReader | PageTransformerTest | PASS | 4ms |
| testGetPageCount | PageTransformerTest | PASS | <1ms |
| testSaveToFile | PageTransformerTest | PASS | 287ms |
| testEncryptAes128 | PdfEncryptTest | PASS | 387ms |
| testEncryptAes256 | PdfEncryptTest | PASS | 207ms |
| testDecrypt | PdfEncryptTest | PASS | 625ms |
...
| testEncryptRc4128 | PdfEncryptTest | PASS | 2ms |
| testChangePasswordsDefaultsToAes256 | PdfEncryptTest | PASS | 5ms |
| testSetPermissionsBeforeEncrypt | PdfEncryptTest | PASS | 2ms |
| testIsEncryptedTrueAfterEncryption | PdfEncryptTest | PASS | 2ms |
| testGetVersionWarningsEmptyBeforeToBytes | PdfEncryptTest | PASS | <1ms |
| testSaveWritesEncryptedFile | PdfEncryptTest | PASS | 1ms |
| testOpenFromDiskRoundTrip | PdfEncryptTest | PASS | <1ms |
| testEncryptThenChangePasswordsRetainsMethod | PdfEncryptTest | PASS | 1ms |
| testMergeTwoPdfs | PdfMergerTest | PASS | 337ms |
| testMergeWithPageSelection | PdfMergerTest | PASS | 434ms |
...
| testSaveToFile | PdfMergerTest | PASS | 545ms |
| testStampText | PdfStamperTest | PASS | 334ms |
| testWatermark | PdfStamperTest | PASS | 149ms |
| testWatermarkWithStyle | PdfStamperTest | PASS | 155ms |
| testPageNumbers | PdfStamperTest | PASS | 178ms |
| testStampOnSpecificPages | PdfStamperTest | PASS | 232ms |
| testHeaderAndFooter | PdfStamperTest | PASS | 169ms |
| testStampWithOpacity | PdfStamperTest | PASS | 148ms |
...
| testSaveToFile | PdfStamperTest | PASS | 197ms |
| testStampImageJpeg | PdfStamperTest | PASS | 169ms |
| testStampImagePng | PdfStamperTest | PASS | 213ms |
| testStampImageWithScaleWidth | PdfStamperTest | PASS | 230ms |
| testStampImageWithScaleHeight | PdfStamperTest | PASS | 227ms |
| testStampImageWithExplicitDimensions | PdfStamperTest | PASS | 250ms |
| testStampImageWithOpacity | PdfStamperTest | PASS | 206ms |
| testStampImageOnSpecificPages | PdfStamperTest | PASS | 235ms |
| testStampImageCombinedWithText | PdfStamperTest | PASS | 236ms |
| testStampImageThrowsOnMissingFile | PdfStamperTest | PASS | <1ms |
| testStampImageThrowsOnUnsupportedFormat | PdfStamperTest | PASS | <1ms |
| testStampPdf | PdfStamperTest | PASS | 167ms |
| testStampPdfWithScaling | PdfStamperTest | PASS | 145ms |
| testStampPdfWithOpacity | PdfStamperTest | PASS | 179ms |
| testStampPdfSpecificPage | PdfStamperTest | PASS | 153ms |
| testStampPdfOnSelectedPages | PdfStamperTest | PASS | 320ms |
| testStampPdfDefaultsToCenter | PdfStamperTest | PASS | 258ms |
...
| testRedactArea | TextRedactorTest | PASS | 281ms |
| testRedactMultipleAreas | TextRedactorTest | PASS | 355ms |
| testRedactByText | TextRedactorTest | PASS | 471ms |
| testRedactByPattern | TextRedactorTest | PASS | <1ms |
| testCustomRedactionColor | TextRedactorTest | PASS | 465ms |
...
| testSaveToFile | TextRedactorTest | PASS | 136ms |

### Arlington PDF Model — Dictionary-level spec conformance (keys, types, required fields, version constraints)

**6 tests** | 6 passed | 0 failed | 0 skipped | 1.39s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesBookmarksPdf | BookmarksTest | PASS | 251ms |
| testGeneratesDocumentFeaturesPdf | DocumentFeaturesTest | PASS | 272ms |
| testGeneratesPdfWithEmbeddedTrueTypeFont | DocumentFeaturesTest | PASS | 210ms |
| testGeneratesFormPdf | FormFieldsTest | PASS | 317ms |
| testGeneratesMultiPageComplexPdf | MultiPageComplexTest | PASS | 181ms |
| testGeneratesSimpleTextPdf | SimpleTextTest | PASS | 162ms |

### veraPDF — PDF/A archival conformance (ISO 19005)

**4 tests** | 3 passed | 0 failed | 1 skipped | 11.95s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWithOutputIntent | PdfAConformanceTest | SKIP | 4ms |
| testVeraPdfToolchainWorks | PdfAConformanceTest | PASS | 1.25s |
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 4.46s |
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 6.23s |
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 12.1s

| Test | Class | Status | Time |
|---|---|---|---|
| testPopplerCorpus with data set "poppler-test/tests/blend.pdf" | Tier2CorpusTest | PASS | 3ms |
...
| testPopplerCorpus with data set "poppler-test/unittestcases/Gday garçon - open.pdf" | Tier2CorpusTest | PASS | 2ms |
...
| testPopplerCorpus with data set "poppler-test/unittestcases/PasswordEncrypted.pdf" | Tier2CorpusTest | PASS | 1ms |
...
| testPopplerCorpus with data set "poppler-test/unittestcases/encrypted-256.pdf" | Tier2CorpusTest | PASS | 2ms |
| testPopplerCorpus with data set "poppler-test/unittestcases/fakebold.pdf" | Tier2CorpusTest | PASS | 2ms |
| testPopplerCorpus with data set "poppler-test/unittestcases/fieldWithUtf16Names.pdf" | Tier2CorpusTest | PASS | <1ms |
| testPopplerCorpus with data set "poppler-test/unittestcases/form_set_icon.pdf" | Tier2CorpusTest | PASS | 3ms |
...
| testPopplerCorpus with data set "poppler-test/unittestcases/searchAcrossLines.pdf" | Tier2CorpusTest | PASS | 4ms |
...
| testPopplerCorpus with data set "poppler-test/unittestcases/signature/digest_mismatch/detached_hash_mismatch.pdf" | Tier2CorpusTest | PASS | 2ms |
| testPopplerCorpus with data set "poppler-test/unittestcases/signature/digest_mismatch/etsi_hash_mismatch.pdf" | Tier2CorpusTest | PASS | 2ms |
...
| testPopplerCorpus with data set "poppler-test/unittestcases/tooltip.pdf" | Tier2CorpusTest | PASS | 1ms |
...
| testQpdfCorpus with data set "qpdf/20-pages.pdf" | Tier2CorpusTest | PASS | 1ms |
| testQpdfCorpus with data set "qpdf/V4-aes-clearmeta.pdf" | Tier2CorpusTest | PASS | 1ms |
| testQpdfCorpus with data set "qpdf/V4-aes.pdf" | Tier2CorpusTest | PASS | <1ms |
| testQpdfCorpus with data set "qpdf/V4-clearmeta.pdf" | Tier2CorpusTest | PASS | <1ms |
| testQpdfCorpus with data set "qpdf/V4.pdf" | Tier2CorpusTest | PASS | <1ms |
...
| testQpdfCorpus with data set "qpdf/bad21.pdf" | Tier2CorpusTest | PASS | <1ms |
...
| testQpdfCorpus with data set "qpdf/big-ostream.pdf" | Tier2CorpusTest | PASS | 3ms |
...
| testQpdfCorpus with data set "qpdf/c-object-streams.pdf" | Tier2CorpusTest | PASS | 2ms |
...
| testQpdfCorpus with data set "qpdf/c-r3.pdf" | Tier2CorpusTest | PASS | 1ms |
| testQpdfCorpus with data set "qpdf/c-r4.pdf" | Tier2CorpusTest | PASS | 1ms |
| testQpdfCorpus with data set "qpdf/c-r5-in.pdf" | Tier2CorpusTest | PASS | 2ms |
| testQpdfCorpus with data set "qpdf/c-r6-in.pdf" | Tier2CorpusTest | PASS | 2ms |
...
| testQpdfCorpus with data set "qpdf/copied-positive-P.pdf" | Tier2CorpusTest | PASS | 2ms |
...
| testQpdfCorpus with data set "qpdf/deterministic-id-in.pdf" | Tier2CorpusTest | PASS | <1ms |
...
| testQpdfCorpus with data set "qpdf/enc-R3,V2,O=master.pdf" | Tier2CorpusTest | PASS | <1ms |
| testQpdfCorpus with data set "qpdf/enc-R3,V2,U=view,O=master.pdf" | Tier2CorpusTest | PASS | 1ms |
| testQpdfCorpus with data set "qpdf/enc-R3,V2,U=view,O=view.pdf" | Tier2CorpusTest | PASS | 1ms |
| testQpdfCorpus with data set "qpdf/enc-R3,V2.pdf" | Tier2CorpusTest | PASS | <1ms |
| testQpdfCorpus with data set "qpdf/enc-XI-R6,V5,O=master.pdf" | Tier2CorpusTest | PASS | 2ms |
| testQpdfCorpus with data set "qpdf/enc-XI-R6,V5,U=attachment,encrypted-attachments.pdf" | Tier2CorpusTest | PASS | 2ms |
| testQpdfCorpus with data set "qpdf/enc-XI-R6,V5,U=view,O=master.pdf" | Tier2CorpusTest | PASS | 2ms |
| testQpdfCorpus with data set "qpdf/enc-XI-R6,V5,U=view,attachments,cleartext-metadata.pdf" | Tier2CorpusTest | PASS | 2ms |
| testQpdfCorpus with data set "qpdf/enc-XI-R6,V5,U=wwwww,O=wwwww.pdf" | Tier2CorpusTest | PASS | 2ms |
...
| testQpdfCorpus with data set "qpdf/enc-XI-long-password.pdf" | Tier2CorpusTest | PASS | 2ms |
| testQpdfCorpus with data set "qpdf/enc-base.pdf" | Tier2CorpusTest | PASS | <1ms |
| testQpdfCorpus with data set "qpdf/enc-long-password.pdf" | Tier2CorpusTest | PASS | 1ms |
| testQpdfCorpus with data set "qpdf/encrypted-40-bit-R3.pdf" | Tier2CorpusTest | PASS | 1ms |
| testQpdfCorpus with data set "qpdf/encrypted-positive-P.pdf" | Tier2CorpusTest | PASS | 2ms |
...
| testQpdfCorpus with data set "qpdf/inline-images-ii-all.pdf" | Tier2CorpusTest | PASS | 9ms |
| testQpdfCorpus with data set "qpdf/inline-images-ii-some.pdf" | Tier2CorpusTest | PASS | 7ms |
| testQpdfCorpus with data set "qpdf/inline-images.pdf" | Tier2CorpusTest | PASS | <1ms |
...
| testQpdfCorpus with data set "qpdf/issue-202.pdf" | Tier2CorpusTest | PASS | 28ms |
...
| testQpdfCorpus with data set "qpdf/job-json-encrypt-128.pdf" | Tier2CorpusTest | PASS | 1ms |
...
| testQpdfCorpus with data set "qpdf/many-nulls.pdf" | Tier2CorpusTest | PASS | 366ms |
...
| testQpdfCorpus with data set "qpdf/metadata-crypt-filter.pdf" | Tier2CorpusTest | PASS | <1ms |
...
| testQpdfCorpus with data set "qpdf/nontrivial-crypt-filter.pdf" | Tier2CorpusTest | PASS | 2ms |
...
| testQpdfCorpus with data set "qpdf/overlay-copy-annotations.pdf" | Tier2CorpusTest | PASS | 1ms |
...
| testQpdfCorpus with data set "qpdf/pages-copy-encryption.pdf" | Tier2CorpusTest | PASS | 1ms |
...
| testQpdfCorpus with data set "qpdf/pclm-in.pdf" | Tier2CorpusTest | PASS | <1ms |
| testQpdfCorpus with data set "qpdf/pclm-out.pdf" | Tier2CorpusTest | PASS | 1ms |
...
| testQpdfCorpus with data set "qpdf/qpdfjob-ctest2.pdf" | Tier2CorpusTest | PASS | 1ms |
...
| testQpdfCorpus with data set "qpdf/resource-from-dr.pdf" | Tier2CorpusTest | PASS | 17ms |
...
| testQpdfCorpus with data set "qpdf/sample-form-out.pdf" | Tier2CorpusTest | PASS | 2ms |
| testQpdfCorpus with data set "qpdf/sample-form.pdf" | Tier2CorpusTest | PASS | 4ms |
...
| testQpdfCorpus with data set "qpdf/short-O-U.pdf" | Tier2CorpusTest | PASS | 1ms |
...
| testQpdfCorpus with data set "qpdf/tokens.pdf" | Tier2CorpusTest | PASS | 1ms |
| testQpdfCorpus with data set "qpdf/unfilterable-with-crypt.pdf" | Tier2CorpusTest | PASS | 2ms |
...
| testQpdfCorpus with data set "qpdf/weird-tokens.pdf" | Tier2CorpusTest | PASS | 2ms |
...
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 5.28s |
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 5.95s |
...
| testPdfBoxCorpus with data set "pdfbox/examples/src/test/resources/org/apache/pdfbox/examples/signature/sign_me_protected.pdf" | Tier2PdfBoxCorpusTest | PASS | 1ms |
...
| testPdfBoxCorpus with data set "pdfbox/pdfbox/src/test/resources/input/PDFBOX-5920-Y5U2XZCKG2U6TO3FC36NCGOZECHQA2PY-p39-reduced.pdf" | Tier2PdfBoxCorpusTest | PASS | 1ms |
| testPdfBoxCorpus with data set "pdfbox/pdfbox/src/test/resources/input/compression/acroform.pdf" | Tier2PdfBoxCorpusTest | PASS | 1ms |
...
| testPdfBoxCorpus with data set "pdfbox/pdfbox/src/test/resources/org/apache/pdfbox/encryption/PasswordSample-128bit.pdf" | Tier2PdfBoxCorpusTest | PASS | 1ms |
| testPdfBoxCorpus with data set "pdfbox/pdfbox/src/test/resources/org/apache/pdfbox/encryption/PasswordSample-256bit.pdf" | Tier2PdfBoxCorpusTest | PASS | 2ms |
...
| testPdfBoxCorpus with data set "pdfbox/pdfbox/src/test/resources/org/apache/pdfbox/multipdf/PDFBOX-6049-ExpectedResult.pdf" | Tier2PdfBoxCorpusTest | PASS | <1ms |
...
| testPdfBoxCorpus with data set "pdfbox/pdfbox/src/test/resources/org/apache/pdfbox/pdmodel/documentinterchange/logicalstructure/PDFBOX-2725-878725.pdf" | Tier2PdfBoxCorpusTest | PASS | <1ms |
...
| testPdfBoxCorpus with data set "pdfbox/pdfbox/src/test/resources/org/apache/pdfbox/pdmodel/interactive/form/AcroFormsBasicFields.pdf" | Tier2PdfBoxCorpusTest | PASS | <1ms |
...
| testPdfBoxCorpus with data set "pdfbox/pdfbox/src/test/resources/org/apache/pdfbox/pdmodel/interactive/form/AlignmentTests.pdf" | Tier2PdfBoxCorpusTest | PASS | 1ms |
...
| testPdfBoxCorpus with data set "pdfbox/pdfbox/src/test/resources/org/apache/pdfbox/pdmodel/interactive/form/PDFBOX-5784.pdf" | Tier2PdfBoxCorpusTest | PASS | 4ms |
...
| testPdfBoxCorpus with data set "pdfbox/pdfbox/src/test/resources/org/apache/pdfbox/pdmodel/test_pagelabels.pdf" | Tier2PdfBoxCorpusTest | PASS | 2ms |
...
| testPdfiumCorpus with data set "pdfium/bug_1124998.pdf" | Tier2PdfiumCorpusTest | PASS | 1ms |
...
| testPdfiumCorpus with data set "pdfium/bug_707673.pdf" | Tier2PdfiumCorpusTest | PASS | 3ms |
...
| testPdfiumCorpus with data set "pdfium/encrypted.pdf" | Tier2PdfiumCorpusTest | PASS | 1ms |
...
| testPdfiumCorpus with data set "pdfium/encrypted_hello_world_r3.pdf" | Tier2PdfiumCorpusTest | PASS | 1ms |
| testPdfiumCorpus with data set "pdfium/encrypted_hello_world_r3_bad_okey.pdf" | Tier2PdfiumCorpusTest | PASS | 1ms |
| testPdfiumCorpus with data set "pdfium/encrypted_hello_world_r5.pdf" | Tier2PdfiumCorpusTest | PASS | 2ms |
| testPdfiumCorpus with data set "pdfium/encrypted_hello_world_r6.pdf" | Tier2PdfiumCorpusTest | PASS | 2ms |
...
**6 tests** | 6 passed | 0 failed | 0 skipped | 7.93s

| Test | Class | Status | Time |
|---|---|---|---|
| testTaggedDocumentValidatesWithUa1 | Tier3MatterhornTest | PASS | 1.58s |
| testAnnotationWithContentsPassesClause718 | Tier3MatterhornTest | PASS | 1.73s |
| testUntaggedDocumentFailsUa1 | Tier3MatterhornTest | PASS | 1.19s |
| testMissingLangFailsUa1 | Tier3MatterhornTest | PASS | 1.08s |
| testMissingDisplayDocTitleFailsUa1 | Tier3MatterhornTest | PASS | 1.16s |
| testAnnotationWithoutContentsFailsUa1 | Tier3MatterhornTest | PASS | 1.19s |
...
**25 tests** | 24 passed | 0 failed | 1 skipped | 11.46s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWellFormedAndValid | Tier4JhoveTest | PASS | 742ms |
| testMultiPagePdfWellFormedAndValid | Tier4JhoveTest | PASS | 646ms |
| testPdfWithMetadataWellFormedAndValid | Tier4JhoveTest | PASS | 1.09s |
| testPdfWithEmbeddedFontWellFormedAndValid | Tier4JhoveTest | PASS | 820ms |
| testJhoveToolchainWorks | Tier4JhoveTest | PASS | 1.32s |
| testPdfA1bPassesPdfBoxPreflight | Tier4PdfBoxPreflightTest | SKIP | <1ms |
| testPdfBoxPreflightToolchainWorks | Tier4PdfBoxPreflightTest | PASS | 1.14s |
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 1.27s |
| testPdfWithMetadataHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 830ms |
| testPdfWithEmbeddedFontHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 671ms |
| testPdfIdToolchainWorks | Tier4PdfIdTest | PASS | 350ms |
| testPdf20ExampleParseable with data set "pdf20/PDF 2.0 UTF-8 string and annotation.pdf" | Tier4Pdf20ExamplesTest | PASS | 2ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 UTF-8 string and annotation.pdf" | Tier4Pdf20ExamplesTest | PASS | 279ms |
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 image with BPC.pdf" | Tier4Pdf20ExamplesTest | PASS | 427ms |
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 via incremental save.pdf" | Tier4Pdf20ExamplesTest | PASS | 147ms |
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 with offset start.pdf" | Tier4Pdf20ExamplesTest | PASS | 378ms |
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 with page level output intent.pdf" | Tier4Pdf20ExamplesTest | PASS | 412ms |
| testPdf20ExampleQpdfValid with data set "pdf20/Simple PDF 2.0 file.pdf" | Tier4Pdf20ExamplesTest | PASS | 509ms |
| testPdf20ExampleQpdfValid with data set "pdf20/pdf20-utf8-test.pdf" | Tier4Pdf20ExamplesTest | PASS | 431ms |
