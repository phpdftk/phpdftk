...
Generated: 2026-06-09 18:03:22 UTC
PHP: 8.4.21
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 90.54s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 32.92s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.36s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 18.35s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 17.72s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 11.22s |
| &#x2705; JHOVE + PDF 2.0 + Security + Preflight | PASS | 25 | 24 | 0 | 1 | 8.96s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 32.92s
...
| testGeneratesFormWithCustomFontAppearances | CustomFontFormAppearancesTest | PASS | 227ms |
...
| testGeneratesPdfWithEmbeddedType1 | EmbeddedType1FontTest | PASS | 184ms |
...
| testGeneratesFormWithAppearances | FormAppearancesIntegrationTest | PASS | 198ms |
...
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 469ms |
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 208ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 123ms |
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 349ms |
...
| testGeneratesSignatureFieldPdf | SignatureFieldIntegrationTest | PASS | 190ms |
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 370ms |
| testGeneratesSimpleTextPdf | SimpleTextTest | PASS | 192ms |
...
| testEnableOutlineThenHeadingRegistersOutlinesEntry | AutoOutlineTest | PASS | 189ms |
...
| testCalloutTallerThanPageThrows | CalloutTest | PASS | 23ms |
...
| testWinAnsiRoundTripFromShowText | EncodingIntegrationTest | PASS | 199ms |
...
| testAddPageDelegatesToWriter | PdfDocTest | PASS | 200ms |
...
| testEmptyDocumentHasNoPages | PdfTest | PASS | 182ms |
| testAddTextCreatesFirstPageAutomatically | PdfTest | PASS | 191ms |
| testAddHeadingEmitsLargerText | PdfTest | PASS | 201ms |
| testExplicitNewPageCreatesSecondPage | PdfTest | PASS | 196ms |
| testLongTextAutoPaginates | PdfTest | PASS | 187ms |
...
| testCustomTheme | PdfTest | PASS | 193ms |
| testSaveWritesFile | PdfTest | PASS | 181ms |
| testWriteToStream | PdfTest | PASS | 203ms |
| testWriteToRejectsNonResource | PdfTest | PASS | <1ms |
| testToBytesProducesValidPdfOnEachCall | PdfTest | PASS | 384ms |
...
| testUnderlineEmitsStrokeBelowBaseline | TextDecorationTest | PASS | 208ms |
...
| testCompositeFontRoundTripsThroughReader | UnicodeFontTest | PASS | 192ms |
| testCompositeFontAppearsInFontList | UnicodeFontTest | PASS | 5ms |
| testShowTextHexOperator | UnicodeFontTest | PASS | <1ms |
| testCompositeFontPerPage | UnicodeFontTest | PASS | 188ms |
...
| testPdfWriterContainsPage | WriterTest | PASS | 209ms |
...
| testSyncInfoToMetadata | XmpMetadataTest | PASS | 192ms |
| testSyncInfoToMetadataNoInfoIsNoOp | XmpMetadataTest | PASS | 186ms |
| testFlattenAll | AnnotationFlattenerTest | PASS | 193ms |
...
| testSaveToFile | AnnotationFlattenerTest | PASS | 206ms |
...
| testSetBookmarks | BookmarkEditorTest | PASS | 201ms |
| testSetBookmarksWithChildren | BookmarkEditorTest | PASS | 198ms |
| testAddBookmark | BookmarkEditorTest | PASS | 426ms |
...
| testSaveToFile | BookmarkEditorTest | PASS | 185ms |
| testNoBytesChangedWhenNoOperations | BookmarkEditorTest | PASS | <1ms |
| testReplaceExistingBookmarks | BookmarkEditorTest | PASS | 199ms |
...
| testFillManyFields | FormFillerTest | PASS | 199ms |
...
| testFillMultipleFieldTypes | FormFillerTest | PASS | 200ms |
...
| testSetTitleRoundTrip | MetadataEditorTest | PASS | 195ms |
...
| testMultipleRanges | PageLabelerTest | PASS | 196ms |
...
| testKeepRange | PageSlicerTest | PASS | 190ms |
| testRemovePages | PageSlicerTest | PASS | 195ms |
| testReorder | PageSlicerTest | PASS | 182ms |
| testReverse | PageSlicerTest | PASS | 190ms |
...
| testRotateAllPages | PageTransformerTest | PASS | 184ms |
| testRotate180 | PageTransformerTest | PASS | 189ms |
| testRotate270 | PageTransformerTest | PASS | 184ms |
...
| testSetTrimBox | PageTransformerTest | PASS | 183ms |
| testSetBleedBox | PageTransformerTest | PASS | 187ms |
| testScale | PageTransformerTest | PASS | 188ms |
| testScaleSpecificPages | PageTransformerTest | PASS | 196ms |
| testScaleInvalidFactor | PageTransformerTest | PASS | <1ms |
| testScaleTo | PageTransformerTest | PASS | 189ms |
...
| testRange | PageTransformerTest | PASS | 189ms |
...
| testStampText | PdfStamperTest | PASS | 185ms |
...
| testStampOnSpecificPages | PdfStamperTest | PASS | 194ms |
| testHeaderAndFooter | PdfStamperTest | PASS | 187ms |
| testStampWithOpacity | PdfStamperTest | PASS | 189ms |
...
| testStampImageJpeg | PdfStamperTest | PASS | 220ms |
| testStampImagePng | PdfStamperTest | PASS | 190ms |
| testStampImageWithScaleWidth | PdfStamperTest | PASS | 201ms |
...
| testStampImageCombinedWithText | PdfStamperTest | PASS | 195ms |
...
| testStampPdfWithScaling | PdfStamperTest | PASS | 193ms |
| testStampPdfWithOpacity | PdfStamperTest | PASS | 197ms |
| testStampPdfSpecificPage | PdfStamperTest | PASS | 198ms |
| testStampPdfOnSelectedPages | PdfStamperTest | PASS | 195ms |
...
| testRedactArea | TextRedactorTest | PASS | 200ms |
| testRedactMultipleAreas | TextRedactorTest | PASS | 190ms |
| testRedactByText | TextRedactorTest | PASS | 193ms |
| testRedactByPattern | TextRedactorTest | PASS | 1ms |
| testCustomRedactionColor | TextRedactorTest | PASS | 188ms |
...
**6 tests** | 6 passed | 0 failed | 0 skipped | 1.36s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesBookmarksPdf | BookmarksTest | PASS | 340ms |
| testGeneratesDocumentFeaturesPdf | DocumentFeaturesTest | PASS | 207ms |
| testGeneratesPdfWithEmbeddedTrueTypeFont | DocumentFeaturesTest | PASS | 227ms |
...
**4 tests** | 3 passed | 0 failed | 1 skipped | 18.35s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWithOutputIntent | PdfAConformanceTest | SKIP | 5ms |
| testVeraPdfToolchainWorks | PdfAConformanceTest | PASS | 2.13s |
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 7.09s |
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 17.72s
...
| testQpdfCorpus with data set "qpdf/appearances-12.pdf" | Tier2CorpusTest | PASS | 8ms |
...
| testQpdfCorpus with data set "qpdf/many-nulls.pdf" | Tier2CorpusTest | PASS | 695ms |
...
| testQpdfCorpus with data set "qpdf/resolved-appearance-conflicts.pdf" | Tier2CorpusTest | PASS | 26ms |
...
| testPdfiumCorpus with data set "pdfium/bookmarks.pdf" | Tier2PdfiumCorpusTest | PASS | 2ms |
...
**6 tests** | 6 passed | 0 failed | 0 skipped | 11.22s
...
**25 tests** | 24 passed | 0 failed | 1 skipped | 8.96s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWellFormedAndValid | Tier4JhoveTest | PASS | 967ms |
| testMultiPagePdfWellFormedAndValid | Tier4JhoveTest | PASS | 881ms |
| testPdfWithMetadataWellFormedAndValid | Tier4JhoveTest | PASS | 880ms |
| testPdfWithEmbeddedFontWellFormedAndValid | Tier4JhoveTest | PASS | 903ms |
| testJhoveToolchainWorks | Tier4JhoveTest | PASS | 677ms |
| testPdfA1bPassesPdfBoxPreflight | Tier4PdfBoxPreflightTest | SKIP | <1ms |
| testPdfBoxPreflightToolchainWorks | Tier4PdfBoxPreflightTest | PASS | 773ms |
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 1.05s |
| testPdfWithMetadataHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 548ms |
| testPdfWithEmbeddedFontHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 529ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 via incremental save.pdf" | Tier4Pdf20ExamplesTest | PASS | 220ms |
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 with offset start.pdf" | Tier4Pdf20ExamplesTest | PASS | 202ms |
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 with page level output intent.pdf" | Tier4Pdf20ExamplesTest | PASS | 194ms |
| testPdf20ExampleQpdfValid with data set "pdf20/Simple PDF 2.0 file.pdf" | Tier4Pdf20ExamplesTest | PASS | 205ms |
