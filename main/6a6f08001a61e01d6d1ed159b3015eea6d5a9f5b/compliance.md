...
Generated: 2026-06-17 13:54:55 UTC
PHP: 8.4.22
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 97.69s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 33.93s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.32s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 21.8s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 19.77s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 12.29s |
| &#x2705; JHOVE + PDF 2.0 + Security + Preflight | PASS | 25 | 24 | 0 | 1 | 8.58s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 33.93s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 666ms |
...
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 470ms |
...
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 614ms |
...
| testSaveWritesFile | FormFillerTest | PASS | 205ms |
...
| testScale | PageTransformerTest | PASS | 206ms |
...
| testStampOnSpecificPages | PdfStamperTest | PASS | 211ms |
...
| testStampImagePng | PdfStamperTest | PASS | 200ms |
...
**4 tests** | 3 passed | 0 failed | 1 skipped | 21.8s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWithOutputIntent | PdfAConformanceTest | SKIP | 5ms |
| testVeraPdfToolchainWorks | PdfAConformanceTest | PASS | 2.36s |
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 8.23s |
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 11.2s |
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 19.77s
...
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 10.21s |
...
| testPdfiumCorpus with data set "pdfium/bug_601362.pdf" | Tier2PdfiumCorpusTest | PASS | 6ms |
...
| testAnnotationWithContentsPassesClause718 | Tier3MatterhornTest | PASS | 2.33s |
...
**25 tests** | 24 passed | 0 failed | 1 skipped | 8.58s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWellFormedAndValid | Tier4JhoveTest | PASS | 1s |
| testMultiPagePdfWellFormedAndValid | Tier4JhoveTest | PASS | 903ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 image with BPC.pdf" | Tier4Pdf20ExamplesTest | PASS | 207ms |
