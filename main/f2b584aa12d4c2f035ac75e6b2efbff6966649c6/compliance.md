...
Generated: 2026-09-25 18:43:21 UTC
PHP: 8.4.26
...
**Overall: PASS** | 1673 tests | 1667 passed | 0 failed | 6 skipped | 114.79s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 465 | 461 | 0 | 4 | 57.49s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.74s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 16.06s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 16.83s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 10.91s |
| &#x2705; JHOVE + PDF 2.0 + Security + Preflight | PASS | 25 | 24 | 0 | 1 | 11.75s |
...
**465 tests** | 461 passed | 0 failed | 4 skipped | 57.49s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 1.67s |
| testGeneratesAnnotationsPdf | AnnotationsTest | PASS | 248ms |
| testGeneratesBookmarksPdf | BookmarksTest | PASS | 257ms |
| testGeneratesFormWithCustomFontAppearances | CustomFontFormAppearancesTest | PASS | 250ms |
| testGeneratesDocumentFeaturesPdf | DocumentFeaturesTest | PASS | 220ms |
| testGeneratesPdfWithEmbeddedTrueTypeFont | DocumentFeaturesTest | PASS | 218ms |
| testGeneratesPdfWithEmbeddedFont | EmbeddedFontsTest | PASS | 204ms |
...
| testGeneratesPdfWithEmbeddedType1 | EmbeddedType1FontTest | PASS | 263ms |
| testPdfOutputContainsFontData | EmbeddedType1FontTest | PASS | <1ms |
| testGeneratesExtGStatePdf | ExtGStateIntegrationTest | PASS | 216ms |
| testGeneratesFormWithAppearances | FormAppearancesIntegrationTest | PASS | 294ms |
| testGeneratesFormPdf | FormFieldsTest | PASS | 300ms |
| testGeneratesGraphicsPipelinePdf | GraphicsPipelineIntegrationTest | PASS | 199ms |
| testGeneratesGraphicsPdf | GraphicsTest | PASS | 302ms |
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 417ms |
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 295ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 812ms |
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 205ms |
| testGeneratesPdfWithMarkupFields | MarkupAnnotationsIntegrationTest | PASS | 266ms |
| testGeneratesMultiPageComplexPdf | MultiPageComplexTest | PASS | 294ms |
| testGeneratesMultimediaAnd3DPdf | MultimediaAndThreeDIntegrationTest | PASS | 296ms |
...
| testGeneratesPageLabelsPdf | PageLabelsTest | PASS | 221ms |
| testGeneratesSignatureFieldPdf | SignatureFieldIntegrationTest | PASS | 271ms |
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 558ms |
| testGeneratesSimpleTextPdf | SimpleTextTest | PASS | 186ms |
| testGeneratesPdfWithType3Font | Type3FontIntegrationTest | PASS | 408ms |
| testGeneratesPdfWithXrefAndObjectStreams | XRefStreamIntegrationTest | PASS | 1.51s |
| testEnableOutlineThenHeadingRegistersOutlinesEntry | AutoOutlineTest | PASS | 1.45s |
...
| testNoteCalloutEmitsLabelAndBody | CalloutTest | PASS | 223ms |
...
| testWinAnsiRoundTripFromShowText | EncodingIntegrationTest | PASS | 670ms |
| testHighLevelPdfRoundTrip | EncodingIntegrationTest | PASS | 3ms |
| testAddTextWithLinkStyleProducesLinkAnnotation | InlineLinkTest | PASS | 399ms |
...
| testBulletListRendersEachItem | ListTest | PASS | 318ms |
...
| testShowPageNumbersDefaultFormat | PageNumbersTest | PASS | 215ms |
| testCustomFormatUsesSprintfPlaceholders | PageNumbersTest | PASS | <1ms |
| testShowPageNumbersCalledTwiceKeepsLastFormat | PageNumbersTest | PASS | 7ms |
...
| testAddPageDelegatesToWriter | PdfDocTest | PASS | 183ms |
| testCreateTransparencyGroupEmitsGroupForm | PdfDocTest | PASS | 425ms |
| testEnsureSoftMaskStateRegistersSMaskExtGState | PdfDocTest | PASS | 198ms |
| testAddLinearAlphaShadingEmitsDeviceGrayShading | PdfDocTest | PASS | 213ms |
| testAddLinearAlphaShadingWithThreeStopsStitches | PdfDocTest | PASS | 360ms |
| testAddRadialAlphaShadingEmitsDeviceGrayType3 | PdfDocTest | PASS | 544ms |
| testAddConicShadingStopsEmitsFunctionBasedShading | PdfDocTest | PASS | 746ms |
| testAddConicShadingStopsRepeatingWrapsTheSweep | PdfDocTest | PASS | 194ms |
...
| testGeneratesHighLevelDocument | PdfIntegrationTest | PASS | 948ms |
| testAddHtmlRendersIntoPdf | PdfTest | PASS | 46ms |
| testEmptyDocumentHasNoPages | PdfTest | PASS | 690ms |
| testAddTextCreatesFirstPageAutomatically | PdfTest | PASS | 184ms |
| testAddHeadingEmitsLargerText | PdfTest | PASS | 208ms |
| testExplicitNewPageCreatesSecondPage | PdfTest | PASS | 451ms |
| testLongTextAutoPaginates | PdfTest | PASS | 479ms |
| testAddSpacerConsumesVerticalSpace | PdfTest | PASS | 360ms |
| testAddRuleDrawsStroke | PdfTest | PASS | 172ms |
| testAlignmentCenterEmitsCenteredText | PdfTest | PASS | 368ms |
| testSetFontSwitchesFontFamily | PdfTest | PASS | 181ms |
| testBoldAndItalicResolveToCorrectPostScriptName | PdfTest | PASS | 191ms |
| testUnknownFamilyIsRejected | PdfTest | PASS | <1ms |
| testCustomTheme | PdfTest | PASS | 174ms |
| testSaveWritesFile | PdfTest | PASS | 182ms |
| testWriteToStream | PdfTest | PASS | 207ms |
| testWriteToRejectsNonResource | PdfTest | PASS | <1ms |
| testToBytesProducesValidPdfOnEachCall | PdfTest | PASS | 507ms |
...
| testAddTableRendersAllCellValues | TableTest | PASS | 292ms |
...
| testUnderlineEmitsStrokeBelowBaseline | TextDecorationTest | PASS | 174ms |
...
| testAddCompositeFontGeneratesValidPdf | UnicodeFontTest | PASS | 791ms |
| testAddCompositeFontSavesToFile | UnicodeFontTest | PASS | 223ms |
| testCompositeFontRoundTripsThroughReader | UnicodeFontTest | PASS | 182ms |
| testCompositeFontAppearsInFontList | UnicodeFontTest | PASS | 4ms |
| testShowTextHexOperator | UnicodeFontTest | PASS | <1ms |
| testCompositeFontPerPage | UnicodeFontTest | PASS | 174ms |
| testPdfWriterGeneratesValidPdfHeader | WriterTest | PASS | 170ms |
...
| testPdfWriterContainsPage | WriterTest | PASS | 171ms |
...
| testPdfWriterAddContentStream | WriterTest | PASS | 805ms |
| testPdfWriterGetContentStreams | WriterTest | PASS | <1ms |
| testPdfWriterWithInfo | WriterTest | PASS | 489ms |
| testPdfWriterGetCatalog | WriterTest | PASS | <1ms |
| testPdfWriterGetPageTree | WriterTest | PASS | <1ms |
| testPdfWriterSavesToFile | WriterTest | PASS | 321ms |
| testPdfWriterContainsXref | WriterTest | PASS | 1.1s |
| testPdfWriterContainsTrailer | WriterTest | PASS | <1ms |
| testPdfWriterAddPageWithRectangle | WriterTest | PASS | 188ms |
| testPdfWriterRegisterObject | WriterTest | PASS | 222ms |
| testPdfWriterFontAddedToPage | WriterTest | PASS | 206ms |
| testSetNamedDestinations | WriterTest | PASS | 269ms |
| testSetEncryptionProducesEncryptedPdf | WriterTest | PASS | 548ms |
| testSetEncryptionAes256RoundTrip | WriterTest | PASS | 522ms |
| testSetMetadataAddsStreamToPdf | XmpMetadataTest | PASS | 268ms |
| testMetadataStreamContainsXmp | XmpMetadataTest | PASS | 291ms |
| testMetadataRoundTrip | XmpMetadataTest | PASS | 272ms |
| testSyncInfoToMetadata | XmpMetadataTest | PASS | 446ms |
| testSyncInfoToMetadataNoInfoIsNoOp | XmpMetadataTest | PASS | 185ms |
| testFlattenAll | AnnotationFlattenerTest | PASS | 211ms |
...
| testSaveToFile | AnnotationFlattenerTest | PASS | 204ms |
...
| testSetBookmarks | BookmarkEditorTest | PASS | 182ms |
| testSetBookmarksWithChildren | BookmarkEditorTest | PASS | 550ms |
| testAddBookmark | BookmarkEditorTest | PASS | 590ms |
| testHasBookmarksReturnsFalseForCleanPdf | BookmarkEditorTest | PASS | <1ms |
| testRemoveBookmarks | BookmarkEditorTest | PASS | 220ms |
| testGetPageCount | BookmarkEditorTest | PASS | <1ms |
| testGetReader | BookmarkEditorTest | PASS | <1ms |
| testSaveToFile | BookmarkEditorTest | PASS | 200ms |
| testNoBytesChangedWhenNoOperations | BookmarkEditorTest | PASS | <1ms |
| testReplaceExistingBookmarks | BookmarkEditorTest | PASS | 767ms |
...
| testFillTextField | FormFillerTest | PASS | 180ms |
| testFillManyFields | FormFillerTest | PASS | 538ms |
| testCheckCheckbox | FormFillerTest | PASS | 818ms |
| testUncheckCheckbox | FormFillerTest | PASS | 982ms |
| testSelectChoiceField | FormFillerTest | PASS | 434ms |
| testFillMultipleFieldTypes | FormFillerTest | PASS | 184ms |
...
| testSaveWritesFile | FormFillerTest | PASS | 270ms |
| testEscapeHatch | FormFillerTest | PASS | 1ms |
| testRoundTripPreservesOtherFields | FormFillerTest | PASS | 183ms |
...
| testSetTitleRoundTrip | MetadataEditorTest | PASS | 333ms |
| testSetMultipleFieldsRoundTrip | MetadataEditorTest | PASS | 337ms |
| testSetMetadataOnPdfWithoutInfo | MetadataEditorTest | PASS | 241ms |
...
| testCustomField | MetadataEditorTest | PASS | 288ms |
| testSaveToFile | MetadataEditorTest | PASS | 210ms |
| testSetLabelsWithArabic | PageLabelerTest | PASS | 214ms |
| testSetRomanNumerals | PageLabelerTest | PASS | 191ms |
| testSetRomanNumeralsUppercase | PageLabelerTest | PASS | 437ms |
| testSetAlphabetic | PageLabelerTest | PASS | 405ms |
| testSetArabicWithStartNumber | PageLabelerTest | PASS | 189ms |
| testSetLabelsWithPrefix | PageLabelerTest | PASS | 437ms |
| testRemoveLabels | PageLabelerTest | PASS | 180ms |
| testMultipleRanges | PageLabelerTest | PASS | 202ms |
| testGetPageCount | PageLabelerTest | PASS | <1ms |
| testGetReader | PageLabelerTest | PASS | <1ms |
| testSaveToFile | PageLabelerTest | PASS | 333ms |
| testNoBytesChangedWhenNoOperations | PageLabelerTest | PASS | <1ms |
| testOpenFromFile | PageLabelerTest | PASS | <1ms |
| testKeepPages | PageSlicerTest | PASS | 221ms |
| testKeepRange | PageSlicerTest | PASS | 184ms |
| testRemovePages | PageSlicerTest | PASS | 339ms |
| testReorder | PageSlicerTest | PASS | 220ms |
| testReverse | PageSlicerTest | PASS | 238ms |
| testSplit | PageSlicerTest | PASS | 682ms |
| testKeepWithPageSelector | PageSlicerTest | PASS | 464ms |
| testNoOpsKeepsAllPages | PageSlicerTest | PASS | 563ms |
| testPageCount | PageSlicerTest | PASS | <1ms |
| testEscapeHatch | PageSlicerTest | PASS | <1ms |
| testRotateAllPages | PageTransformerTest | PASS | 412ms |
| testRotate180 | PageTransformerTest | PASS | 513ms |
| testRotate270 | PageTransformerTest | PASS | 180ms |
| testRotateSpecificPages | PageTransformerTest | PASS | 192ms |
| testRotateCumulative | PageTransformerTest | PASS | 241ms |
| testRotateInvalidAngle | PageTransformerTest | PASS | <1ms |
| testSetCropBox | PageTransformerTest | PASS | 194ms |
| testSetCropBoxSpecificPage | PageTransformerTest | PASS | 211ms |
| testSetMediaBox | PageTransformerTest | PASS | 181ms |
| testSetTrimBox | PageTransformerTest | PASS | 180ms |
| testSetBleedBox | PageTransformerTest | PASS | 182ms |
| testScale | PageTransformerTest | PASS | 217ms |
| testScaleSpecificPages | PageTransformerTest | PASS | 189ms |
| testScaleInvalidFactor | PageTransformerTest | PASS | <1ms |
| testScaleTo | PageTransformerTest | PASS | 252ms |
| testScaleToNonUniform | PageTransformerTest | PASS | 243ms |
| testMultipleOperations | PageTransformerTest | PASS | 180ms |
| testNoBytesChangedWithoutOperations | PageTransformerTest | PASS | <1ms |
| testEvenPages | PageTransformerTest | PASS | 184ms |
| testOddPages | PageTransformerTest | PASS | 221ms |
| testRange | PageTransformerTest | PASS | 294ms |
| testGetReader | PageTransformerTest | PASS | <1ms |
| testGetPageCount | PageTransformerTest | PASS | <1ms |
| testSaveToFile | PageTransformerTest | PASS | 166ms |
| testEncryptAes128 | PdfEncryptTest | PASS | 256ms |
| testEncryptAes256 | PdfEncryptTest | PASS | 284ms |
| testDecrypt | PdfEncryptTest | PASS | 416ms |
...
| testMergeTwoPdfs | PdfMergerTest | PASS | 287ms |
| testMergeWithPageSelection | PdfMergerTest | PASS | 310ms |
...
| testSaveToFile | PdfMergerTest | PASS | 296ms |
| testStampText | PdfStamperTest | PASS | 525ms |
| testWatermark | PdfStamperTest | PASS | 254ms |
| testWatermarkWithStyle | PdfStamperTest | PASS | 185ms |
| testPageNumbers | PdfStamperTest | PASS | 393ms |
| testStampOnSpecificPages | PdfStamperTest | PASS | 196ms |
| testHeaderAndFooter | PdfStamperTest | PASS | 226ms |
| testStampWithOpacity | PdfStamperTest | PASS | 220ms |
...
| testSaveToFile | PdfStamperTest | PASS | 249ms |
| testStampImageJpeg | PdfStamperTest | PASS | 244ms |
| testStampImagePng | PdfStamperTest | PASS | 175ms |
| testStampImageWithScaleWidth | PdfStamperTest | PASS | 181ms |
| testStampImageWithScaleHeight | PdfStamperTest | PASS | 233ms |
| testStampImageWithExplicitDimensions | PdfStamperTest | PASS | 256ms |
| testStampImageWithOpacity | PdfStamperTest | PASS | 194ms |
| testStampImageOnSpecificPages | PdfStamperTest | PASS | 182ms |
| testStampImageCombinedWithText | PdfStamperTest | PASS | 522ms |
...
| testStampPdfWithScaling | PdfStamperTest | PASS | 240ms |
| testStampPdfWithOpacity | PdfStamperTest | PASS | 210ms |
| testStampPdfSpecificPage | PdfStamperTest | PASS | 238ms |
| testStampPdfOnSelectedPages | PdfStamperTest | PASS | 312ms |
| testStampPdfDefaultsToCenter | PdfStamperTest | PASS | 472ms |
...
| testRedactArea | TextRedactorTest | PASS | 186ms |
| testRedactMultipleAreas | TextRedactorTest | PASS | 320ms |
| testRedactByText | TextRedactorTest | PASS | 398ms |
| testRedactByPattern | TextRedactorTest | PASS | <1ms |
| testCustomRedactionColor | TextRedactorTest | PASS | 241ms |
...
| testSaveToFile | TextRedactorTest | PASS | 372ms |

### Arlington PDF Model — Dictionary-level spec conformance (keys, types, required fields, version constraints)

**6 tests** | 6 passed | 0 failed | 0 skipped | 1.74s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesBookmarksPdf | BookmarksTest | PASS | 485ms |
| testGeneratesDocumentFeaturesPdf | DocumentFeaturesTest | PASS | 276ms |
| testGeneratesPdfWithEmbeddedTrueTypeFont | DocumentFeaturesTest | PASS | 302ms |
| testGeneratesFormPdf | FormFieldsTest | PASS | 208ms |
| testGeneratesMultiPageComplexPdf | MultiPageComplexTest | PASS | 272ms |
| testGeneratesSimpleTextPdf | SimpleTextTest | PASS | 197ms |

### veraPDF — PDF/A archival conformance (ISO 19005)

**4 tests** | 3 passed | 0 failed | 1 skipped | 16.06s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWithOutputIntent | PdfAConformanceTest | SKIP | 4ms |
| testVeraPdfToolchainWorks | PdfAConformanceTest | PASS | 1.8s |
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 6.36s |
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 16.83s
...
| testQpdfCorpus with data set "qpdf/appearances-11.pdf" | Tier2CorpusTest | PASS | 14ms |
...
| testQpdfCorpus with data set "qpdf/many-nulls.pdf" | Tier2CorpusTest | PASS | 538ms |
...
| testQpdfCorpus with data set "qpdf/need-appearances-more.pdf" | Tier2CorpusTest | PASS | 26ms |
...
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 6.84s |
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 8.72s |
...
| testPdfBoxCorpus with data set "pdfbox/pdfbox/src/test/resources/org/apache/pdfbox/pdmodel/documentinterchange/logicalstructure/PDFBOX-2725-878725.pdf" | Tier2PdfBoxCorpusTest | PASS | 7ms |
...
**6 tests** | 6 passed | 0 failed | 0 skipped | 10.91s

| Test | Class | Status | Time |
|---|---|---|---|
| testTaggedDocumentValidatesWithUa1 | Tier3MatterhornTest | PASS | 1.92s |
| testAnnotationWithContentsPassesClause718 | Tier3MatterhornTest | PASS | 2.62s |
| testUntaggedDocumentFailsUa1 | Tier3MatterhornTest | PASS | 1.64s |
| testMissingLangFailsUa1 | Tier3MatterhornTest | PASS | 1.65s |
| testMissingDisplayDocTitleFailsUa1 | Tier3MatterhornTest | PASS | 1.46s |
| testAnnotationWithoutContentsFailsUa1 | Tier3MatterhornTest | PASS | 1.63s |
...
**25 tests** | 24 passed | 0 failed | 1 skipped | 11.75s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWellFormedAndValid | Tier4JhoveTest | PASS | 917ms |
| testMultiPagePdfWellFormedAndValid | Tier4JhoveTest | PASS | 1.04s |
| testPdfWithMetadataWellFormedAndValid | Tier4JhoveTest | PASS | 899ms |
| testPdfWithEmbeddedFontWellFormedAndValid | Tier4JhoveTest | PASS | 809ms |
| testJhoveToolchainWorks | Tier4JhoveTest | PASS | 607ms |
| testPdfA1bPassesPdfBoxPreflight | Tier4PdfBoxPreflightTest | SKIP | <1ms |
| testPdfBoxPreflightToolchainWorks | Tier4PdfBoxPreflightTest | PASS | 875ms |
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 588ms |
| testPdfWithMetadataHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 1.14s |
| testPdfWithEmbeddedFontHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 747ms |
| testPdfIdToolchainWorks | Tier4PdfIdTest | PASS | 1.16s |
...
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 UTF-8 string and annotation.pdf" | Tier4Pdf20ExamplesTest | PASS | 466ms |
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 image with BPC.pdf" | Tier4Pdf20ExamplesTest | PASS | 190ms |
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 via incremental save.pdf" | Tier4Pdf20ExamplesTest | PASS | 544ms |
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 with offset start.pdf" | Tier4Pdf20ExamplesTest | PASS | 329ms |
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 with page level output intent.pdf" | Tier4Pdf20ExamplesTest | PASS | 700ms |
| testPdf20ExampleQpdfValid with data set "pdf20/Simple PDF 2.0 file.pdf" | Tier4Pdf20ExamplesTest | PASS | 537ms |
| testPdf20ExampleQpdfValid with data set "pdf20/pdf20-utf8-test.pdf" | Tier4Pdf20ExamplesTest | PASS | 194ms |
