...
Generated: 2026-06-14 15:30:19 UTC
PHP: 8.4.22
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 91.66s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 32.88s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.28s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 18.96s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 18.97s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 32.88s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 289ms |
| testGeneratesAnnotationsPdf | AnnotationsTest | PASS | 205ms |
...
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 509ms |
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 151ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 361ms |
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 136ms |
| testGeneratesPdfWithMarkupFields | MarkupAnnotationsIntegrationTest | PASS | 183ms |
| testGeneratesMultiPageComplexPdf | MultiPageComplexTest | PASS | 197ms |
| testGeneratesMultimediaAnd3DPdf | MultimediaAndThreeDIntegrationTest | PASS | 182ms |
...
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 300ms |
...
| testAddTextCreatesFirstPageAutomatically | PdfTest | PASS | 190ms |
| testAddHeadingEmitsLargerText | PdfTest | PASS | 193ms |
...
| testSaveWritesFile | PdfTest | PASS | 195ms |
...
| testUnderlineEmitsStrokeBelowBaseline | TextDecorationTest | PASS | 191ms |
...
| testCompositeFontRoundTripsThroughReader | UnicodeFontTest | PASS | 198ms |
...
| testPdfWriterFontAddedToPage | WriterTest | PASS | 189ms |
| testSetNamedDestinations | WriterTest | PASS | 189ms |
...
| testFillTextField | FormFillerTest | PASS | 204ms |
| testFillManyFields | FormFillerTest | PASS | 191ms |
| testCheckCheckbox | FormFillerTest | PASS | 195ms |
...
| testSaveWritesFile | FormFillerTest | PASS | 203ms |
...
| testSaveToFile | MetadataEditorTest | PASS | 196ms |
...
| testRemoveLabels | PageLabelerTest | PASS | 203ms |
...
| testRotate180 | PageTransformerTest | PASS | 201ms |
...
| testSaveToFile | PageTransformerTest | PASS | 177ms |
| testEncryptAes128 | PdfEncryptTest | PASS | 196ms |
| testEncryptAes256 | PdfEncryptTest | PASS | 206ms |
| testDecrypt | PdfEncryptTest | PASS | 200ms |
...
| testWatermark | PdfStamperTest | PASS | 198ms |
| testWatermarkWithStyle | PdfStamperTest | PASS | 192ms |
| testPageNumbers | PdfStamperTest | PASS | 196ms |
| testStampOnSpecificPages | PdfStamperTest | PASS | 200ms |
| testHeaderAndFooter | PdfStamperTest | PASS | 194ms |
| testStampWithOpacity | PdfStamperTest | PASS | 193ms |
...
| testSaveToFile | PdfStamperTest | PASS | 196ms |
...
| testStampImageWithOpacity | PdfStamperTest | PASS | 198ms |
...
| testStampPdfDefaultsToCenter | PdfStamperTest | PASS | 202ms |
...
| testRedactArea | TextRedactorTest | PASS | 199ms |
| testRedactMultipleAreas | TextRedactorTest | PASS | 219ms |
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 18.97s
...
| testQpdfCorpus with data set "qpdf/direct-outlines.pdf" | Tier2CorpusTest | PASS | 13ms |
...
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 7.34s |
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 9.99s |
...
| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWellFormedAndValid | Tier4JhoveTest | PASS | 988ms |
| testMultiPagePdfWellFormedAndValid | Tier4JhoveTest | PASS | 913ms |
| testPdfWithMetadataWellFormedAndValid | Tier4JhoveTest | PASS | 865ms |
...
| testPdfBoxPreflightToolchainWorks | Tier4PdfBoxPreflightTest | PASS | 738ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 via incremental save.pdf" | Tier4Pdf20ExamplesTest | PASS | 193ms |
