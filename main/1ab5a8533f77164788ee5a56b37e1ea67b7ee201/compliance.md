...
Generated: 2026-06-10 01:53:48 UTC
PHP: 8.4.21
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 88.82s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 33.34s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.3s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 17.63s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 17.22s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 11.06s |
| &#x2705; JHOVE + PDF 2.0 + Security + Preflight | PASS | 25 | 24 | 0 | 1 | 8.27s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 33.34s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 672ms |
...
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 464ms |
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 137ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 298ms |
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 160ms |
...
| testGeneratesSignatureFieldPdf | SignatureFieldIntegrationTest | PASS | 186ms |
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 467ms |
...
| testCalloutAutoBreaksToNewPageWhenItWontFit | CalloutTest | PASS | 7ms |
...
| testAddTextWithLinkStyleProducesLinkAnnotation | InlineLinkTest | PASS | 240ms |
...
| testBulletListRendersEachItem | ListTest | PASS | 253ms |
...
| testShowPageNumbersDefaultFormat | PageNumbersTest | PASS | 198ms |
...
| testAddPageDelegatesToWriter | PdfDocTest | PASS | 239ms |
...
| testAddTextCreatesFirstPageAutomatically | PdfTest | PASS | 205ms |
...
| testAddCompositeFontSavesToFile | UnicodeFontTest | PASS | 270ms |
| testCompositeFontRoundTripsThroughReader | UnicodeFontTest | PASS | 233ms |
| testCompositeFontAppearsInFontList | UnicodeFontTest | PASS | 5ms |
| testShowTextHexOperator | UnicodeFontTest | PASS | <1ms |
| testCompositeFontPerPage | UnicodeFontTest | PASS | 210ms |
| testPdfWriterGeneratesValidPdfHeader | WriterTest | PASS | 201ms |
...
| testPdfWriterFontAddedToPage | WriterTest | PASS | 180ms |
| testSetNamedDestinations | WriterTest | PASS | 188ms |
| testSetEncryptionProducesEncryptedPdf | WriterTest | PASS | 193ms |
...
| testSyncInfoToMetadata | XmpMetadataTest | PASS | 182ms |
...
| testSelectChoiceField | FormFillerTest | PASS | 183ms |
...
| testSetRomanNumerals | PageLabelerTest | PASS | 186ms |
...
| testReverse | PageSlicerTest | PASS | 188ms |
| testSplit | PageSlicerTest | PASS | 363ms |
...
| testRotateSpecificPages | PageTransformerTest | PASS | 200ms |
...
| testSetCropBoxSpecificPage | PageTransformerTest | PASS | 186ms |
| testSetMediaBox | PageTransformerTest | PASS | 191ms |
| testSetTrimBox | PageTransformerTest | PASS | 185ms |
| testSetBleedBox | PageTransformerTest | PASS | 189ms |
...
| testMultipleOperations | PageTransformerTest | PASS | 199ms |
...
| testStampText | PdfStamperTest | PASS | 193ms |
| testWatermark | PdfStamperTest | PASS | 186ms |
| testWatermarkWithStyle | PdfStamperTest | PASS | 184ms |
...
| testStampImageJpeg | PdfStamperTest | PASS | 193ms |
...
| testStampImageWithOpacity | PdfStamperTest | PASS | 215ms |
...
| testStampPdfWithScaling | PdfStamperTest | PASS | 213ms |
| testStampPdfWithOpacity | PdfStamperTest | PASS | 220ms |
| testStampPdfSpecificPage | PdfStamperTest | PASS | 197ms |
| testStampPdfOnSelectedPages | PdfStamperTest | PASS | 191ms |
...
| testRedactMultipleAreas | TextRedactorTest | PASS | 188ms |
...
**4 tests** | 3 passed | 0 failed | 1 skipped | 17.63s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWithOutputIntent | PdfAConformanceTest | SKIP | 5ms |
| testVeraPdfToolchainWorks | PdfAConformanceTest | PASS | 1.97s |
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 6.83s |
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 8.82s |
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 17.22s
...
| testQpdfCorpus with data set "qpdf/V4-clearmeta.pdf" | Tier2CorpusTest | PASS | 8ms |
...
| testQpdfCorpus with data set "qpdf/many-nulls.pdf" | Tier2CorpusTest | PASS | 705ms |
...
| testQpdfCorpus with data set "qpdf/png-filters.pdf" | Tier2CorpusTest | PASS | 24ms |
...
| testQpdfCorpus with data set "qpdf/unreferenced-objects.pdf" | Tier2CorpusTest | PASS | 3ms |
...
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 8.92s |
...
| testPdfBoxCorpus with data set "pdfbox/pdfbox/src/test/resources/org/apache/pdfbox/multipdf/AcrobatMerge-DifferentFieldType.pdf" | Tier2PdfBoxCorpusTest | PASS | 3ms |
...
**6 tests** | 6 passed | 0 failed | 0 skipped | 11.06s
...
**25 tests** | 24 passed | 0 failed | 1 skipped | 8.27s
...
| testPdfWithEmbeddedFontWellFormedAndValid | Tier4JhoveTest | PASS | 847ms |
| testJhoveToolchainWorks | Tier4JhoveTest | PASS | 690ms |
| testPdfA1bPassesPdfBoxPreflight | Tier4PdfBoxPreflightTest | SKIP | <1ms |
| testPdfBoxPreflightToolchainWorks | Tier4PdfBoxPreflightTest | PASS | 762ms |
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 548ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 image with BPC.pdf" | Tier4Pdf20ExamplesTest | PASS | 187ms |
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 via incremental save.pdf" | Tier4Pdf20ExamplesTest | PASS | 189ms |
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 with offset start.pdf" | Tier4Pdf20ExamplesTest | PASS | 189ms |
