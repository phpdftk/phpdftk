...
Generated: 2026-06-25 00:31:53 UTC
PHP: 8.4.22
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 87.14s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 31.43s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.25s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 17.36s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 17.65s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 11.39s |
| &#x2705; JHOVE + PDF 2.0 + Security + Preflight | PASS | 25 | 24 | 0 | 1 | 8.07s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 31.43s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 437ms |
| testGeneratesAnnotationsPdf | AnnotationsTest | PASS | 182ms |
| testGeneratesBookmarksPdf | BookmarksTest | PASS | 224ms |
| testGeneratesFormWithCustomFontAppearances | CustomFontFormAppearancesTest | PASS | 204ms |
| testGeneratesDocumentFeaturesPdf | DocumentFeaturesTest | PASS | 187ms |
| testGeneratesPdfWithEmbeddedTrueTypeFont | DocumentFeaturesTest | PASS | 196ms |
| testGeneratesPdfWithEmbeddedFont | EmbeddedFontsTest | PASS | 187ms |
...
| testGeneratesPdfWithEmbeddedType1 | EmbeddedType1FontTest | PASS | 186ms |
...
| testGeneratesGraphicsPipelinePdf | GraphicsPipelineIntegrationTest | PASS | 183ms |
| testGeneratesGraphicsPdf | GraphicsTest | PASS | 179ms |
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 579ms |
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 267ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 209ms |
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 117ms |
...
| testGeneratesMultimediaAnd3DPdf | MultimediaAndThreeDIntegrationTest | PASS | 181ms |
...
| testGeneratesPageLabelsPdf | PageLabelsTest | PASS | 177ms |
| testGeneratesSignatureFieldPdf | SignatureFieldIntegrationTest | PASS | 179ms |
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 390ms |
| testGeneratesSimpleTextPdf | SimpleTextTest | PASS | 186ms |
| testGeneratesPdfWithType3Font | Type3FontIntegrationTest | PASS | 183ms |
| testGeneratesPdfWithXrefAndObjectStreams | XRefStreamIntegrationTest | PASS | 182ms |
| testEnableOutlineThenHeadingRegistersOutlinesEntry | AutoOutlineTest | PASS | 180ms |
...
| testNoteCalloutEmitsLabelAndBody | CalloutTest | PASS | 181ms |
...
| testWinAnsiRoundTripFromShowText | EncodingIntegrationTest | PASS | 186ms |
| testHighLevelPdfRoundTrip | EncodingIntegrationTest | PASS | 4ms |
| testAddTextWithLinkStyleProducesLinkAnnotation | InlineLinkTest | PASS | 182ms |
...
| testBulletListRendersEachItem | ListTest | PASS | 180ms |
...
| testAddPageDelegatesToWriter | PdfDocTest | PASS | 174ms |
...
| testGeneratesHighLevelDocument | PdfIntegrationTest | PASS | 387ms |
| testAddHtmlRendersIntoPdf | PdfTest | PASS | 40ms |
| testEmptyDocumentHasNoPages | PdfTest | PASS | 184ms |
| testAddTextCreatesFirstPageAutomatically | PdfTest | PASS | 178ms |
| testAddHeadingEmitsLargerText | PdfTest | PASS | 188ms |
| testExplicitNewPageCreatesSecondPage | PdfTest | PASS | 180ms |
| testLongTextAutoPaginates | PdfTest | PASS | 183ms |
| testAddSpacerConsumesVerticalSpace | PdfTest | PASS | 186ms |
| testAddRuleDrawsStroke | PdfTest | PASS | 174ms |
| testAlignmentCenterEmitsCenteredText | PdfTest | PASS | 182ms |
| testSetFontSwitchesFontFamily | PdfTest | PASS | 183ms |
| testBoldAndItalicResolveToCorrectPostScriptName | PdfTest | PASS | 177ms |
| testUnknownFamilyIsRejected | PdfTest | PASS | <1ms |
| testCustomTheme | PdfTest | PASS | 174ms |
| testSaveWritesFile | PdfTest | PASS | 177ms |
| testWriteToStream | PdfTest | PASS | 177ms |
| testWriteToRejectsNonResource | PdfTest | PASS | <1ms |
| testToBytesProducesValidPdfOnEachCall | PdfTest | PASS | 367ms |
...
| testAddTableRendersAllCellValues | TableTest | PASS | 200ms |
...
| testAddCompositeFontGeneratesValidPdf | UnicodeFontTest | PASS | 184ms |
| testAddCompositeFontSavesToFile | UnicodeFontTest | PASS | 190ms |
| testCompositeFontRoundTripsThroughReader | UnicodeFontTest | PASS | 183ms |
| testCompositeFontAppearsInFontList | UnicodeFontTest | PASS | 5ms |
| testShowTextHexOperator | UnicodeFontTest | PASS | <1ms |
| testCompositeFontPerPage | UnicodeFontTest | PASS | 179ms |
...
| testPdfWriterContainsPage | WriterTest | PASS | 184ms |
...
| testPdfWriterWithInfo | WriterTest | PASS | 183ms |
| testPdfWriterGetCatalog | WriterTest | PASS | <1ms |
| testPdfWriterGetPageTree | WriterTest | PASS | <1ms |
| testPdfWriterSavesToFile | WriterTest | PASS | 175ms |
| testPdfWriterContainsXref | WriterTest | PASS | 182ms |
...
| testPdfWriterFontAddedToPage | WriterTest | PASS | 190ms |
| testSetNamedDestinations | WriterTest | PASS | 187ms |
| testSetEncryptionProducesEncryptedPdf | WriterTest | PASS | 194ms |
| testSetEncryptionAes256RoundTrip | WriterTest | PASS | 229ms |
| testSetMetadataAddsStreamToPdf | XmpMetadataTest | PASS | 172ms |
| testMetadataStreamContainsXmp | XmpMetadataTest | PASS | 177ms |
| testMetadataRoundTrip | XmpMetadataTest | PASS | 188ms |
| testSyncInfoToMetadata | XmpMetadataTest | PASS | 185ms |
| testSyncInfoToMetadataNoInfoIsNoOp | XmpMetadataTest | PASS | 177ms |
| testFlattenAll | AnnotationFlattenerTest | PASS | 182ms |
...
| testSaveToFile | AnnotationFlattenerTest | PASS | 173ms |
...
| testSetBookmarks | BookmarkEditorTest | PASS | 181ms |
| testSetBookmarksWithChildren | BookmarkEditorTest | PASS | 187ms |
| testAddBookmark | BookmarkEditorTest | PASS | 364ms |
...
| testSaveToFile | BookmarkEditorTest | PASS | 175ms |
| testNoBytesChangedWhenNoOperations | BookmarkEditorTest | PASS | <1ms |
| testReplaceExistingBookmarks | BookmarkEditorTest | PASS | 192ms |
...
| testFillTextField | FormFillerTest | PASS | 183ms |
| testFillManyFields | FormFillerTest | PASS | 182ms |
| testCheckCheckbox | FormFillerTest | PASS | 190ms |
| testUncheckCheckbox | FormFillerTest | PASS | 185ms |
| testSelectChoiceField | FormFillerTest | PASS | 187ms |
...
| testSaveWritesFile | FormFillerTest | PASS | 173ms |
| testEscapeHatch | FormFillerTest | PASS | 1ms |
| testRoundTripPreservesOtherFields | FormFillerTest | PASS | 178ms |
...
| testSetTitleRoundTrip | MetadataEditorTest | PASS | 182ms |
| testSetMultipleFieldsRoundTrip | MetadataEditorTest | PASS | 181ms |
| testSetMetadataOnPdfWithoutInfo | MetadataEditorTest | PASS | 188ms |
...
| testCustomField | MetadataEditorTest | PASS | 178ms |
| testSaveToFile | MetadataEditorTest | PASS | 187ms |
...
| testSetAlphabetic | PageLabelerTest | PASS | 185ms |
| testSetArabicWithStartNumber | PageLabelerTest | PASS | 189ms |
| testSetLabelsWithPrefix | PageLabelerTest | PASS | 182ms |
| testRemoveLabels | PageLabelerTest | PASS | 181ms |
| testMultipleRanges | PageLabelerTest | PASS | 181ms |
...
| testKeepPages | PageSlicerTest | PASS | 180ms |
| testKeepRange | PageSlicerTest | PASS | 178ms |
| testRemovePages | PageSlicerTest | PASS | 185ms |
| testReorder | PageSlicerTest | PASS | 185ms |
| testReverse | PageSlicerTest | PASS | 192ms |
| testSplit | PageSlicerTest | PASS | 353ms |
| testKeepWithPageSelector | PageSlicerTest | PASS | 180ms |
| testNoOpsKeepsAllPages | PageSlicerTest | PASS | 175ms |
| testPageCount | PageSlicerTest | PASS | <1ms |
| testEscapeHatch | PageSlicerTest | PASS | <1ms |
| testRotateAllPages | PageTransformerTest | PASS | 180ms |
| testRotate180 | PageTransformerTest | PASS | 177ms |
| testRotate270 | PageTransformerTest | PASS | 179ms |
| testRotateSpecificPages | PageTransformerTest | PASS | 174ms |
| testRotateCumulative | PageTransformerTest | PASS | 179ms |
| testRotateInvalidAngle | PageTransformerTest | PASS | <1ms |
| testSetCropBox | PageTransformerTest | PASS | 172ms |
| testSetCropBoxSpecificPage | PageTransformerTest | PASS | 173ms |
| testSetMediaBox | PageTransformerTest | PASS | 172ms |
| testSetTrimBox | PageTransformerTest | PASS | 187ms |
| testSetBleedBox | PageTransformerTest | PASS | 178ms |
| testScale | PageTransformerTest | PASS | 180ms |
| testScaleSpecificPages | PageTransformerTest | PASS | 180ms |
| testScaleInvalidFactor | PageTransformerTest | PASS | <1ms |
| testScaleTo | PageTransformerTest | PASS | 182ms |
| testScaleToNonUniform | PageTransformerTest | PASS | 186ms |
| testMultipleOperations | PageTransformerTest | PASS | 178ms |
| testNoBytesChangedWithoutOperations | PageTransformerTest | PASS | <1ms |
| testEvenPages | PageTransformerTest | PASS | 181ms |
| testOddPages | PageTransformerTest | PASS | 184ms |
| testRange | PageTransformerTest | PASS | 187ms |
...
| testEncryptAes128 | PdfEncryptTest | PASS | 185ms |
| testEncryptAes256 | PdfEncryptTest | PASS | 193ms |
...
| testMergeTwoPdfs | PdfMergerTest | PASS | 178ms |
| testMergeWithPageSelection | PdfMergerTest | PASS | 193ms |
...
| testSaveToFile | PdfMergerTest | PASS | 184ms |
| testStampText | PdfStamperTest | PASS | 184ms |
| testWatermark | PdfStamperTest | PASS | 183ms |
| testWatermarkWithStyle | PdfStamperTest | PASS | 176ms |
| testPageNumbers | PdfStamperTest | PASS | 188ms |
| testStampOnSpecificPages | PdfStamperTest | PASS | 183ms |
| testHeaderAndFooter | PdfStamperTest | PASS | 183ms |
| testStampWithOpacity | PdfStamperTest | PASS | 185ms |
...
| testStampImageJpeg | PdfStamperTest | PASS | 206ms |
| testStampImagePng | PdfStamperTest | PASS | 186ms |
| testStampImageWithScaleWidth | PdfStamperTest | PASS | 180ms |
| testStampImageWithScaleHeight | PdfStamperTest | PASS | 182ms |
| testStampImageWithExplicitDimensions | PdfStamperTest | PASS | 182ms |
| testStampImageWithOpacity | PdfStamperTest | PASS | 179ms |
| testStampImageOnSpecificPages | PdfStamperTest | PASS | 192ms |
| testStampImageCombinedWithText | PdfStamperTest | PASS | 183ms |
| testStampImageThrowsOnMissingFile | PdfStamperTest | PASS | <1ms |
| testStampImageThrowsOnUnsupportedFormat | PdfStamperTest | PASS | <1ms |
| testStampPdf | PdfStamperTest | PASS | 180ms |
| testStampPdfWithScaling | PdfStamperTest | PASS | 187ms |
| testStampPdfWithOpacity | PdfStamperTest | PASS | 179ms |
| testStampPdfSpecificPage | PdfStamperTest | PASS | 183ms |
| testStampPdfOnSelectedPages | PdfStamperTest | PASS | 178ms |
...
| testRedactArea | TextRedactorTest | PASS | 181ms |
...
| testCustomRedactionColor | TextRedactorTest | PASS | 187ms |
...
| testSaveToFile | TextRedactorTest | PASS | 183ms |

### Arlington PDF Model — Dictionary-level spec conformance (keys, types, required fields, version constraints)

**6 tests** | 6 passed | 0 failed | 0 skipped | 1.25s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesBookmarksPdf | BookmarksTest | PASS | 295ms |
| testGeneratesDocumentFeaturesPdf | DocumentFeaturesTest | PASS | 183ms |
| testGeneratesPdfWithEmbeddedTrueTypeFont | DocumentFeaturesTest | PASS | 187ms |
| testGeneratesFormPdf | FormFieldsTest | PASS | 182ms |
| testGeneratesMultiPageComplexPdf | MultiPageComplexTest | PASS | 192ms |
| testGeneratesSimpleTextPdf | SimpleTextTest | PASS | 211ms |

### veraPDF — PDF/A archival conformance (ISO 19005)

**4 tests** | 3 passed | 0 failed | 1 skipped | 17.36s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWithOutputIntent | PdfAConformanceTest | SKIP | 4ms |
| testVeraPdfToolchainWorks | PdfAConformanceTest | PASS | 2.19s |
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 6.7s |
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 8.47s |
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 17.65s
...
| testQpdfCorpus with data set "qpdf/inline-images-ii-all.pdf" | Tier2CorpusTest | PASS | 17ms |
...
| testQpdfCorpus with data set "qpdf/issue-202.pdf" | Tier2CorpusTest | PASS | 57ms |
...
| testQpdfCorpus with data set "qpdf/many-nulls.pdf" | Tier2CorpusTest | PASS | 650ms |
...
| testQpdfCorpus with data set "qpdf/resolved-appearance-conflicts-generate.pdf" | Tier2CorpusTest | PASS | 23ms |
...
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 6.94s |
...
**6 tests** | 6 passed | 0 failed | 0 skipped | 11.39s

| Test | Class | Status | Time |
|---|---|---|---|
| testTaggedDocumentValidatesWithUa1 | Tier3MatterhornTest | PASS | 2.15s |
| testAnnotationWithContentsPassesClause718 | Tier3MatterhornTest | PASS | 1.92s |
| testUntaggedDocumentFailsUa1 | Tier3MatterhornTest | PASS | 1.86s |
| testMissingLangFailsUa1 | Tier3MatterhornTest | PASS | 1.83s |
| testMissingDisplayDocTitleFailsUa1 | Tier3MatterhornTest | PASS | 1.67s |
| testAnnotationWithoutContentsFailsUa1 | Tier3MatterhornTest | PASS | 1.95s |
...
**25 tests** | 24 passed | 0 failed | 1 skipped | 8.07s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWellFormedAndValid | Tier4JhoveTest | PASS | 897ms |
| testMultiPagePdfWellFormedAndValid | Tier4JhoveTest | PASS | 892ms |
| testPdfWithMetadataWellFormedAndValid | Tier4JhoveTest | PASS | 867ms |
| testPdfWithEmbeddedFontWellFormedAndValid | Tier4JhoveTest | PASS | 852ms |
| testJhoveToolchainWorks | Tier4JhoveTest | PASS | 669ms |
| testPdfA1bPassesPdfBoxPreflight | Tier4PdfBoxPreflightTest | SKIP | <1ms |
| testPdfBoxPreflightToolchainWorks | Tier4PdfBoxPreflightTest | PASS | 747ms |
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 529ms |
| testPdfWithMetadataHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 517ms |
| testPdfWithEmbeddedFontHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 504ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 UTF-8 string and annotation.pdf" | Tier4Pdf20ExamplesTest | PASS | 173ms |
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 image with BPC.pdf" | Tier4Pdf20ExamplesTest | PASS | 186ms |
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 via incremental save.pdf" | Tier4Pdf20ExamplesTest | PASS | 179ms |
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 with offset start.pdf" | Tier4Pdf20ExamplesTest | PASS | 173ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/Simple PDF 2.0 file.pdf" | Tier4Pdf20ExamplesTest | PASS | 182ms |
| testPdf20ExampleQpdfValid with data set "pdf20/pdf20-utf8-test.pdf" | Tier4Pdf20ExamplesTest | PASS | 179ms |
