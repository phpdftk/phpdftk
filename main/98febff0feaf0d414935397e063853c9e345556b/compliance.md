...
Generated: 2026-05-25 02:36:33 UTC
PHP: 8.4.21
...
**Overall: PASS** | 1662 tests | 1656 passed | 0 failed | 6 skipped | 87.67s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 454 | 450 | 0 | 4 | 32.3s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.27s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 17.52s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 17.33s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 10.92s |
...
**454 tests** | 450 passed | 0 failed | 4 skipped | 32.3s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 516ms |
...
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 166ms |
...
| testNoOpsKeepsAllPages | PageSlicerTest | PASS | 178ms |
...
| testSetCropBoxSpecificPage | PageTransformerTest | PASS | 181ms |
...
| testStampImageWithExplicitDimensions | PdfStamperTest | PASS | 181ms |
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 17.33s
...
| testQpdfCorpus with data set "qpdf/duplicate-pages.pdf" | Tier2CorpusTest | PASS | 7ms |
...
| testQpdfCorpus with data set "qpdf/no-space-compressed-object.pdf" | Tier2CorpusTest | PASS | 24ms |
...
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 6.62s |
...
| testPdfBoxCorpus with data set "pdfbox/pdfbox/src/test/resources/input/PDFBOX-5747-unicode-surrogate-with-diacritic-reduced.pdf" | Tier2PdfBoxCorpusTest | PASS | 5ms |
...
**6 tests** | 6 passed | 0 failed | 0 skipped | 10.92s

| Test | Class | Status | Time |
|---|---|---|---|
| testTaggedDocumentValidatesWithUa1 | Tier3MatterhornTest | PASS | 2.1s |
| testAnnotationWithContentsPassesClause718 | Tier3MatterhornTest | PASS | 1.98s |
...
| testPdfWithEmbeddedFontWellFormedAndValid | Tier4JhoveTest | PASS | 838ms |
