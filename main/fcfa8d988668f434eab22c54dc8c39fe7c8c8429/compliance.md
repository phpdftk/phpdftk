...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 90s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 32.05s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 32.05s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 386ms |
...
| testGeneratesGraphicsPipelinePdf | GraphicsPipelineIntegrationTest | PASS | 177ms |
| testGeneratesGraphicsPdf | GraphicsTest | PASS | 189ms |
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 360ms |
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 226ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 323ms |
...
| testShowPageNumbersDefaultFormat | PageNumbersTest | PASS | 178ms |
...
| testMultipleRanges | PageLabelerTest | PASS | 184ms |
...
| testReverse | PageSlicerTest | PASS | 179ms |
...
| testRotate180 | PageTransformerTest | PASS | 199ms |
| testRotate270 | PageTransformerTest | PASS | 177ms |
...
| testScaleToNonUniform | PageTransformerTest | PASS | 179ms |
...
| testQpdfCorpus with data set "qpdf/direct-pages.pdf" | Tier2CorpusTest | PASS | 10ms |
...
| testQpdfCorpus with data set "qpdf/many-nulls.pdf" | Tier2CorpusTest | PASS | 677ms |
...
| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWellFormedAndValid | Tier4JhoveTest | PASS | 926ms |
| testMultiPagePdfWellFormedAndValid | Tier4JhoveTest | PASS | 878ms |
| testPdfWithMetadataWellFormedAndValid | Tier4JhoveTest | PASS | 846ms |
...
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 532ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/pdf20-utf8-test.pdf" | Tier4Pdf20ExamplesTest | PASS | 178ms |
