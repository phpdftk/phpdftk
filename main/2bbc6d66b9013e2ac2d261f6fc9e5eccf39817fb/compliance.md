...
Generated: 2026-05-24 20:00:19 UTC
PHP: 8.4.21
...
**Overall: PASS** | 1662 tests | 1656 passed | 0 failed | 6 skipped | 89.44s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 454 | 450 | 0 | 4 | 32.04s |
...
| &#x2705; JHOVE + PDF 2.0 + Security + Preflight | PASS | 25 | 24 | 0 | 1 | 8.09s |
...
**454 tests** | 450 passed | 0 failed | 4 skipped | 32.04s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 678ms |
...
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 106ms |
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 293ms |
...
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 420ms |
...
| testKeepPages | PageSlicerTest | PASS | 177ms |
...
| testQpdfCorpus with data set "qpdf/fax-decode-parms.pdf" | Tier2CorpusTest | PASS | 8ms |
...
| testQpdfCorpus with data set "qpdf/overlay-copy-annotations.pdf" | Tier2CorpusTest | PASS | 25ms |
...
| testPdfBoxCorpus with data set "pdfbox/pdfbox/src/test/resources/input/merge/PDFBOX-5792-240045.pdf" | Tier2PdfBoxCorpusTest | PASS | 5ms |
...
| testPdfiumCorpus with data set "pdfium/bug_925981.pdf" | Tier2PdfiumCorpusTest | PASS | 3ms |
...
**25 tests** | 24 passed | 0 failed | 1 skipped | 8.09s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWellFormedAndValid | Tier4JhoveTest | PASS | 911ms |
| testMultiPagePdfWellFormedAndValid | Tier4JhoveTest | PASS | 862ms |
