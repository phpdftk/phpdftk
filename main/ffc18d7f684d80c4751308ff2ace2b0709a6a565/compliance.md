...
Generated: 2026-05-24 20:22:20 UTC
PHP: 8.4.21
...
**Overall: PASS** | 1662 tests | 1656 passed | 0 failed | 6 skipped | 88.79s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 454 | 450 | 0 | 4 | 32.13s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.24s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 18.3s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 17.45s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 11.5s |
...
**454 tests** | 450 passed | 0 failed | 4 skipped | 32.13s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 445ms |
...
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 394ms |
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 111ms |
...
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 425ms |
...
| testAddRuleDrawsStroke | PdfTest | PASS | 177ms |
...
| testUnderlineEmitsStrokeBelowBaseline | TextDecorationTest | PASS | 222ms |
...
| testSetEncryptionAes256RoundTrip | WriterTest | PASS | 296ms |
...
| testSetMediaBox | PageTransformerTest | PASS | 212ms |
...
| testEvenPages | PageTransformerTest | PASS | 192ms |
...
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 9.47s |
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 17.45s
...
| testQpdfCorpus with data set "qpdf/extra-header-lin-no-newline.pdf" | Tier2CorpusTest | PASS | 7ms |
...
| testQpdfCorpus with data set "qpdf/issue-202.pdf" | Tier2CorpusTest | PASS | 65ms |
...
| testQpdfCorpus with data set "qpdf/many-nulls.pdf" | Tier2CorpusTest | PASS | 709ms |
...
| testPdfBoxCorpus with data set "pdfbox/pdfbox/src/test/resources/input/merge/PDFBOX-5762-722238.pdf" | Tier2PdfBoxCorpusTest | PASS | 4ms |
...
**6 tests** | 6 passed | 0 failed | 0 skipped | 11.5s
...
| testMultiPagePdfWellFormedAndValid | Tier4JhoveTest | PASS | 870ms |
...
| testJhoveToolchainWorks | Tier4JhoveTest | PASS | 656ms |
...
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 622ms |
