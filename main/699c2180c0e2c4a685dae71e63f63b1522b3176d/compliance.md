...
Generated: 2026-06-19 12:37:49 UTC
PHP: 8.4.22
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 89.62s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 33.06s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.28s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 17.97s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 17.73s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 11.31s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 33.06s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 298ms |
| testGeneratesAnnotationsPdf | AnnotationsTest | PASS | 185ms |
| testGeneratesBookmarksPdf | BookmarksTest | PASS | 237ms |
| testGeneratesFormWithCustomFontAppearances | CustomFontFormAppearancesTest | PASS | 254ms |
...
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 496ms |
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 196ms |
...
| testWinAnsiRoundTripFromShowText | EncodingIntegrationTest | PASS | 194ms |
...
| testGeneratesHighLevelDocument | PdfIntegrationTest | PASS | 420ms |
| testAddHtmlRendersIntoPdf | PdfTest | PASS | 41ms |
| testEmptyDocumentHasNoPages | PdfTest | PASS | 200ms |
...
| testCustomTheme | PdfTest | PASS | 196ms |
...
| testPdfWriterFontAddedToPage | WriterTest | PASS | 201ms |
...
| testSyncInfoToMetadataNoInfoIsNoOp | XmpMetadataTest | PASS | 203ms |
...
| testRemoveBookmarks | BookmarkEditorTest | PASS | 207ms |
...
| testSetTrimBox | PageTransformerTest | PASS | 196ms |
...
| testStampImageCombinedWithText | PdfStamperTest | PASS | 181ms |
...
**4 tests** | 3 passed | 0 failed | 1 skipped | 17.97s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWithOutputIntent | PdfAConformanceTest | SKIP | 5ms |
| testVeraPdfToolchainWorks | PdfAConformanceTest | PASS | 2.1s |
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 6.48s |
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 9.39s |
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 17.73s
...
| testQpdfCorpus with data set "qpdf/many-nulls.pdf" | Tier2CorpusTest | PASS | 733ms |
...
**6 tests** | 6 passed | 0 failed | 0 skipped | 11.31s
...
| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWellFormedAndValid | Tier4JhoveTest | PASS | 936ms |
...
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 533ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 UTF-8 string and annotation.pdf" | Tier4Pdf20ExamplesTest | PASS | 202ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 with offset start.pdf" | Tier4Pdf20ExamplesTest | PASS | 177ms |
