...
Generated: 2026-06-19 12:39:20 UTC
PHP: 8.4.22
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 78.02s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 26.36s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.03s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 16.67s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 16.58s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 10.32s |
| &#x2705; JHOVE + PDF 2.0 + Security + Preflight | PASS | 25 | 24 | 0 | 1 | 7.08s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 26.36s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 229ms |
| testGeneratesAnnotationsPdf | AnnotationsTest | PASS | 144ms |
...
| testGeneratesDocumentFeaturesPdf | DocumentFeaturesTest | PASS | 151ms |
| testGeneratesPdfWithEmbeddedTrueTypeFont | DocumentFeaturesTest | PASS | 161ms |
| testGeneratesPdfWithEmbeddedFont | EmbeddedFontsTest | PASS | 160ms |
...
| testGeneratesExtGStatePdf | ExtGStateIntegrationTest | PASS | 157ms |
| testGeneratesFormWithAppearances | FormAppearancesIntegrationTest | PASS | 155ms |
| testGeneratesFormPdf | FormFieldsTest | PASS | 152ms |
| testGeneratesGraphicsPipelinePdf | GraphicsPipelineIntegrationTest | PASS | 151ms |
| testGeneratesGraphicsPdf | GraphicsTest | PASS | 158ms |
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 284ms |
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 249ms |
...
| testGeneratesMultimediaAnd3DPdf | MultimediaAndThreeDIntegrationTest | PASS | 152ms |
...
| testGeneratesPageLabelsPdf | PageLabelsTest | PASS | 151ms |
| testGeneratesSignatureFieldPdf | SignatureFieldIntegrationTest | PASS | 148ms |
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 366ms |
...
| testCalloutTallerThanPageThrows | CalloutTest | PASS | 18ms |
...
| testWinAnsiRoundTripFromShowText | EncodingIntegrationTest | PASS | 160ms |
...
| testBulletListRendersEachItem | ListTest | PASS | 149ms |
...
| testShowPageNumbersDefaultFormat | PageNumbersTest | PASS | 152ms |
...
| testWriteToStream | PdfTest | PASS | 152ms |
...
| testAddCompositeFontGeneratesValidPdf | UnicodeFontTest | PASS | 151ms |
| testAddCompositeFontSavesToFile | UnicodeFontTest | PASS | 167ms |
...
| testCompositeFontPerPage | UnicodeFontTest | PASS | 160ms |
| testPdfWriterGeneratesValidPdfHeader | WriterTest | PASS | 149ms |
...
| testPdfWriterWithInfo | WriterTest | PASS | 159ms |
...
| testPdfWriterAddPageWithRectangle | WriterTest | PASS | 147ms |
...
| testSetEncryptionProducesEncryptedPdf | WriterTest | PASS | 156ms |
| testSetEncryptionAes256RoundTrip | WriterTest | PASS | 173ms |
| testSetMetadataAddsStreamToPdf | XmpMetadataTest | PASS | 147ms |
...
| testSaveToFile | AnnotationFlattenerTest | PASS | 167ms |
...
| testSetBookmarks | BookmarkEditorTest | PASS | 151ms |
| testSetBookmarksWithChildren | BookmarkEditorTest | PASS | 153ms |
| testAddBookmark | BookmarkEditorTest | PASS | 303ms |
...
| testFillTextField | FormFillerTest | PASS | 152ms |
| testFillManyFields | FormFillerTest | PASS | 147ms |
| testCheckCheckbox | FormFillerTest | PASS | 150ms |
| testUncheckCheckbox | FormFillerTest | PASS | 156ms |
| testSelectChoiceField | FormFillerTest | PASS | 154ms |
| testFillMultipleFieldTypes | FormFillerTest | PASS | 148ms |
...
| testSetTitleRoundTrip | MetadataEditorTest | PASS | 154ms |
| testSetMultipleFieldsRoundTrip | MetadataEditorTest | PASS | 155ms |
...
| testSplit | PageSlicerTest | PASS | 302ms |
...
| testRotateAllPages | PageTransformerTest | PASS | 155ms |
| testRotate180 | PageTransformerTest | PASS | 145ms |
| testRotate270 | PageTransformerTest | PASS | 148ms |
| testRotateSpecificPages | PageTransformerTest | PASS | 148ms |
| testRotateCumulative | PageTransformerTest | PASS | 159ms |
...
| testSetMediaBox | PageTransformerTest | PASS | 148ms |
...
| testScaleToNonUniform | PageTransformerTest | PASS | 154ms |
...
| testEncryptAes128 | PdfEncryptTest | PASS | 149ms |
| testEncryptAes256 | PdfEncryptTest | PASS | 158ms |
...
| testMergeWithPageSelection | PdfMergerTest | PASS | 146ms |
...
| testPageNumbers | PdfStamperTest | PASS | 152ms |
...
| testStampImagePng | PdfStamperTest | PASS | 157ms |
| testStampImageWithScaleWidth | PdfStamperTest | PASS | 150ms |
...
| testStampPdfWithScaling | PdfStamperTest | PASS | 146ms |
| testStampPdfWithOpacity | PdfStamperTest | PASS | 153ms |
| testStampPdfSpecificPage | PdfStamperTest | PASS | 159ms |
...
| testRedactArea | TextRedactorTest | PASS | 151ms |
...
| testCustomRedactionColor | TextRedactorTest | PASS | 151ms |
...
**4 tests** | 3 passed | 0 failed | 1 skipped | 16.67s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWithOutputIntent | PdfAConformanceTest | SKIP | 4ms |
| testVeraPdfToolchainWorks | PdfAConformanceTest | PASS | 1.74s |
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 6.38s |
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 8.54s |
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 16.58s
...
| testQpdfCorpus with data set "qpdf/many-nulls.pdf" | Tier2CorpusTest | PASS | 629ms |
...
| testQpdfCorpus with data set "qpdf/resource-from-dr.pdf" | Tier2CorpusTest | PASS | 25ms |
...
**6 tests** | 6 passed | 0 failed | 0 skipped | 10.32s

| Test | Class | Status | Time |
|---|---|---|---|
| testTaggedDocumentValidatesWithUa1 | Tier3MatterhornTest | PASS | 1.98s |
| testAnnotationWithContentsPassesClause718 | Tier3MatterhornTest | PASS | 1.91s |
| testUntaggedDocumentFailsUa1 | Tier3MatterhornTest | PASS | 1.56s |
...
**25 tests** | 24 passed | 0 failed | 1 skipped | 7.08s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWellFormedAndValid | Tier4JhoveTest | PASS | 816ms |
| testMultiPagePdfWellFormedAndValid | Tier4JhoveTest | PASS | 768ms |
| testPdfWithMetadataWellFormedAndValid | Tier4JhoveTest | PASS | 754ms |
| testPdfWithEmbeddedFontWellFormedAndValid | Tier4JhoveTest | PASS | 734ms |
| testJhoveToolchainWorks | Tier4JhoveTest | PASS | 631ms |
| testPdfA1bPassesPdfBoxPreflight | Tier4PdfBoxPreflightTest | SKIP | <1ms |
| testPdfBoxPreflightToolchainWorks | Tier4PdfBoxPreflightTest | PASS | 680ms |
...
| testPdfWithEmbeddedFontHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 429ms |
