...
Generated: 2026-06-10 19:03:51 UTC
PHP: 8.4.21
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 89.85s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 32.02s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.24s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 18.94s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 17.44s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 11.78s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 32.02s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 368ms |
| testGeneratesAnnotationsPdf | AnnotationsTest | PASS | 181ms |
| testGeneratesBookmarksPdf | BookmarksTest | PASS | 224ms |
| testGeneratesFormWithCustomFontAppearances | CustomFontFormAppearancesTest | PASS | 187ms |
...
| testGeneratesExtGStatePdf | ExtGStateIntegrationTest | PASS | 171ms |
...
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 163ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 467ms |
...
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 328ms |
| testGeneratesSimpleTextPdf | SimpleTextTest | PASS | 185ms |
| testGeneratesPdfWithType3Font | Type3FontIntegrationTest | PASS | 181ms |
...
| testCustomTheme | PdfTest | PASS | 175ms |
...
| testAddTableRendersAllCellValues | TableTest | PASS | 179ms |
...
| testWriterPageDrawTextUnderline | TextDecorationTest | PASS | 6ms |
...
| testSetBookmarksWithChildren | BookmarkEditorTest | PASS | 178ms |
...
| testUncheckCheckbox | FormFillerTest | PASS | 176ms |
| testSelectChoiceField | FormFillerTest | PASS | 181ms |
| testFillMultipleFieldTypes | FormFillerTest | PASS | 176ms |
...
| testReverse | PageSlicerTest | PASS | 175ms |
...
| testRotate270 | PageTransformerTest | PASS | 178ms |
...
| testSetCropBox | PageTransformerTest | PASS | 175ms |
...
| testRange | PageTransformerTest | PASS | 181ms |
...
| testSetPermissionsBeforeEncrypt | PdfEncryptTest | PASS | 6ms |
...
| testStampImageOnSpecificPages | PdfStamperTest | PASS | 178ms |
...
**4 tests** | 3 passed | 0 failed | 1 skipped | 18.94s
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 17.44s
...
| testQpdfCorpus with data set "qpdf/extensions-none-force-1.8.5.pdf" | Tier2CorpusTest | PASS | 9ms |
...
| testQpdfCorpus with data set "qpdf/shared-split-01-04.pdf" | Tier2CorpusTest | PASS | 26ms |
...
| testPdfiumCorpus with data set "pdfium/feature_linearized_loading.pdf" | Tier2PdfiumCorpusTest | PASS | 6ms |
...
**6 tests** | 6 passed | 0 failed | 0 skipped | 11.78s

| Test | Class | Status | Time |
|---|---|---|---|
| testTaggedDocumentValidatesWithUa1 | Tier3MatterhornTest | PASS | 2.04s |
| testAnnotationWithContentsPassesClause718 | Tier3MatterhornTest | PASS | 2.21s |
...
| testJhoveToolchainWorks | Tier4JhoveTest | PASS | 686ms |
...
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 567ms |
...
| testPdfIdToolchainWorks | Tier4PdfIdTest | PASS | 369ms |
