...
Generated: 2026-06-13 07:08:42 UTC
PHP: 8.4.22
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 88.19s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 32.26s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.25s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 17.5s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 17.67s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 32.26s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 284ms |
| testGeneratesAnnotationsPdf | AnnotationsTest | PASS | 181ms |
...
| testGeneratesExtGStatePdf | ExtGStateIntegrationTest | PASS | 205ms |
| testGeneratesFormWithAppearances | FormAppearancesIntegrationTest | PASS | 220ms |
...
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 596ms |
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 265ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 128ms |
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 383ms |
...
| testGeneratesMultimediaAnd3DPdf | MultimediaAndThreeDIntegrationTest | PASS | 180ms |
...
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 292ms |
| testGeneratesSimpleTextPdf | SimpleTextTest | PASS | 179ms |
...
| testEnableOutlineThenHeadingRegistersOutlinesEntry | AutoOutlineTest | PASS | 202ms |
...
| testNoteCalloutEmitsLabelAndBody | CalloutTest | PASS | 192ms |
...
| testBulletListRendersEachItem | ListTest | PASS | 185ms |
...
| testAddCompositeFontSavesToFile | UnicodeFontTest | PASS | 189ms |
| testCompositeFontRoundTripsThroughReader | UnicodeFontTest | PASS | 191ms |
...
| testSelectChoiceField | FormFillerTest | PASS | 194ms |
...
| testSaveWritesFile | FormFillerTest | PASS | 188ms |
...
| testSetMultipleFieldsRoundTrip | MetadataEditorTest | PASS | 183ms |
...
| testSetRomanNumeralsUppercase | PageLabelerTest | PASS | 193ms |
...
| testReorder | PageSlicerTest | PASS | 183ms |
...
| testRotateAllPages | PageTransformerTest | PASS | 181ms |
| testRotate180 | PageTransformerTest | PASS | 190ms |
| testRotate270 | PageTransformerTest | PASS | 188ms |
...
| testSetCropBoxSpecificPage | PageTransformerTest | PASS | 182ms |
| testSetMediaBox | PageTransformerTest | PASS | 185ms |
| testSetTrimBox | PageTransformerTest | PASS | 195ms |
...
| testScaleTo | PageTransformerTest | PASS | 181ms |
...
| testSaveToFile | PageTransformerTest | PASS | 195ms |
| testEncryptAes128 | PdfEncryptTest | PASS | 183ms |
...
| testStampImageWithScaleWidth | PdfStamperTest | PASS | 179ms |
...
| testStampImageCombinedWithText | PdfStamperTest | PASS | 190ms |
...
**4 tests** | 3 passed | 0 failed | 1 skipped | 17.5s
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 17.67s
...
| testQpdfCorpus with data set "qpdf/direct-outlines.pdf" | Tier2CorpusTest | PASS | 12ms |
...
| testQpdfCorpus with data set "qpdf/many-nulls.pdf" | Tier2CorpusTest | PASS | 737ms |
...
| testQpdfCorpus with data set "qpdf/sample-form-out.pdf" | Tier2CorpusTest | PASS | 31ms |
...
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 6.9s |
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 9.12s |
...
| testPdfWithMetadataWellFormedAndValid | Tier4JhoveTest | PASS | 851ms |
| testPdfWithEmbeddedFontWellFormedAndValid | Tier4JhoveTest | PASS | 842ms |
...
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 544ms |
| testPdfWithMetadataHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 539ms |
| testPdfWithEmbeddedFontHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 530ms |
| testPdfIdToolchainWorks | Tier4PdfIdTest | PASS | 339ms |
