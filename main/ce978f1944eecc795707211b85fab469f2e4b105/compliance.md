...
Generated: 2026-05-16 02:26:39 UTC
PHP: 8.4.21
...
**Overall: PASS** | 1471 tests | 1465 passed | 0 failed | 6 skipped | 90.48s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 263 | 259 | 0 | 4 | 30.36s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.26s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 19.02s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 19.47s |
...
**263 tests** | 259 passed | 0 failed | 4 skipped | 30.36s
...
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 322ms |
...
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 234ms |
...
**4 tests** | 3 passed | 0 failed | 1 skipped | 19.02s
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 19.47s
...
| testQpdfCorpus with data set "qpdf/big-ostream.pdf" | Tier2CorpusTest | PASS | 11ms |
...
| testQpdfCorpus with data set "qpdf/json-changed-need-appearances.pdf" | Tier2CorpusTest | PASS | 3ms |
...
| testQpdfCorpus with data set "qpdf/outlines-with-old-root-dests-dict.pdf" | Tier2CorpusTest | PASS | 21ms |
...
| testQpdfCorpus with data set "qpdf/shared-form-images.pdf" | Tier2CorpusTest | PASS | 2ms |
...
| testPdfBoxCorpus with data set "pdfbox/pdfbox/src/test/resources/input/merge/PDFA3A.pdf" | Tier2PdfBoxCorpusTest | PASS | 3ms |
