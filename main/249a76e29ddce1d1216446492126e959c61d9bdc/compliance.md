...
Generated: 2026-06-29 15:04:08 UTC
PHP: 8.4.22
...
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 33.33s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.28s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 19.3s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 18.03s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 33.33s
...
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 581ms |
...
| testPdfWriterSavesToFile | WriterTest | PASS | 221ms |
...
| testRoundTripPreservesOtherFields | FormFillerTest | PASS | 185ms |
...
| testStampImagePng | PdfStamperTest | PASS | 226ms |
...
| testStampPdfSpecificPage | PdfStamperTest | PASS | 195ms |
...
**4 tests** | 3 passed | 0 failed | 1 skipped | 19.3s
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 18.03s
...
| testQpdfCorpus with data set "qpdf/collate-even.pdf" | Tier2CorpusTest | PASS | 12ms |
...
| testQpdfCorpus with data set "qpdf/remove-info-no-moddate.pdf" | Tier2CorpusTest | PASS | 28ms |
