...
Generated: 2026-05-24 23:23:50 UTC
PHP: 8.4.21
...
**Overall: PASS** | 1662 tests | 1656 passed | 0 failed | 6 skipped | 85.53s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 454 | 450 | 0 | 4 | 27.85s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.07s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 20.01s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 18.5s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 10.67s |
| &#x2705; JHOVE + PDF 2.0 + Security + Preflight | PASS | 25 | 24 | 0 | 1 | 7.42s |
...
**454 tests** | 450 passed | 0 failed | 4 skipped | 27.85s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 359ms |
...
| testGeneratesExtGStatePdf | ExtGStateIntegrationTest | PASS | 162ms |
| testGeneratesFormWithAppearances | FormAppearancesIntegrationTest | PASS | 160ms |
| testGeneratesFormPdf | FormFieldsTest | PASS | 157ms |
| testGeneratesGraphicsPipelinePdf | GraphicsPipelineIntegrationTest | PASS | 165ms |
| testGeneratesGraphicsPdf | GraphicsTest | PASS | 157ms |
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 350ms |
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 272ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 334ms |
...
| testGeneratesPageLabelsPdf | PageLabelsTest | PASS | 168ms |
| testGeneratesSignatureFieldPdf | SignatureFieldIntegrationTest | PASS | 157ms |
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 337ms |
...
| testWinAnsiRoundTripFromShowText | EncodingIntegrationTest | PASS | 164ms |
...
| testBulletListRendersEachItem | ListTest | PASS | 175ms |
...
| testGeneratesHighLevelDocument | PdfIntegrationTest | PASS | 330ms |
| testAddHtmlRendersIntoPdf | PdfTest | PASS | 27ms |
| testEmptyDocumentHasNoPages | PdfTest | PASS | 155ms |
| testAddTextCreatesFirstPageAutomatically | PdfTest | PASS | 162ms |
...
| testAddSpacerConsumesVerticalSpace | PdfTest | PASS | 160ms |
...
| testSaveWritesFile | PdfTest | PASS | 164ms |
...
| testAddCompositeFontSavesToFile | UnicodeFontTest | PASS | 161ms |
...
| testPdfWriterContainsPage | WriterTest | PASS | 157ms |
...
| testPdfWriterWithInfo | WriterTest | PASS | 158ms |
| testPdfWriterGetCatalog | WriterTest | PASS | <1ms |
| testPdfWriterGetPageTree | WriterTest | PASS | <1ms |
| testPdfWriterSavesToFile | WriterTest | PASS | 160ms |
...
| testSetEncryptionProducesEncryptedPdf | WriterTest | PASS | 172ms |
| testSetEncryptionAes256RoundTrip | WriterTest | PASS | 177ms |
...
| testSetBookmarksWithChildren | BookmarkEditorTest | PASS | 167ms |
...
| testSaveToFile | BookmarkEditorTest | PASS | 165ms |
...
| testSelectChoiceField | FormFillerTest | PASS | 162ms |
...
| testRoundTripPreservesOtherFields | FormFillerTest | PASS | 162ms |
...
| testSetRomanNumerals | PageLabelerTest | PASS | 175ms |
...
| testRemoveLabels | PageLabelerTest | PASS | 166ms |
| testMultipleRanges | PageLabelerTest | PASS | 165ms |
| testGetPageCount | PageLabelerTest | PASS | <1ms |
| testGetReader | PageLabelerTest | PASS | <1ms |
| testSaveToFile | PageLabelerTest | PASS | 159ms |
...
| testRemovePages | PageSlicerTest | PASS | 163ms |
...
| testRotate270 | PageTransformerTest | PASS | 168ms |
| testRotateSpecificPages | PageTransformerTest | PASS | 171ms |
| testRotateCumulative | PageTransformerTest | PASS | 175ms |
...
| testSetTrimBox | PageTransformerTest | PASS | 165ms |
...
| testScaleTo | PageTransformerTest | PASS | 162ms |
| testScaleToNonUniform | PageTransformerTest | PASS | 164ms |
| testMultipleOperations | PageTransformerTest | PASS | 168ms |
| testNoBytesChangedWithoutOperations | PageTransformerTest | PASS | <1ms |
| testEvenPages | PageTransformerTest | PASS | 163ms |
| testOddPages | PageTransformerTest | PASS | 174ms |
...
| testEncryptAes256 | PdfEncryptTest | PASS | 176ms |
...
| testStampText | PdfStamperTest | PASS | 167ms |
| testWatermark | PdfStamperTest | PASS | 168ms |
| testWatermarkWithStyle | PdfStamperTest | PASS | 161ms |
...
| testStampImageJpeg | PdfStamperTest | PASS | 179ms |
| testStampImagePng | PdfStamperTest | PASS | 159ms |
| testStampImageWithScaleWidth | PdfStamperTest | PASS | 154ms |
| testStampImageWithScaleHeight | PdfStamperTest | PASS | 158ms |
...
| testStampImageCombinedWithText | PdfStamperTest | PASS | 163ms |
...
| testStampPdfDefaultsToCenter | PdfStamperTest | PASS | 166ms |
...
**4 tests** | 3 passed | 0 failed | 1 skipped | 20.01s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWithOutputIntent | PdfAConformanceTest | SKIP | 4ms |
| testVeraPdfToolchainWorks | PdfAConformanceTest | PASS | 2.01s |
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 7.68s |
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 10.31s |
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 18.5s
...
| testQpdfCorpus with data set "qpdf/enc-R2,V1.pdf" | Tier2CorpusTest | PASS | 7ms |
...
| testQpdfCorpus with data set "qpdf/object-stream-self-ref.pdf" | Tier2CorpusTest | PASS | 25ms |
...
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 7.46s |
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 9.71s |
...
| testPdfBoxCorpus with data set "pdfbox/pdfbox/src/test/resources/input/PDFBOX-5920-Y5U2XZCKG2U6TO3FC36NCGOZECHQA2PY-p39-reduced.pdf" | Tier2PdfBoxCorpusTest | PASS | 6ms |
...
| Test | Class | Status | Time |
|---|---|---|---|
| testTaggedDocumentValidatesWithUa1 | Tier3MatterhornTest | PASS | 1.82s |
...
| testMissingDisplayDocTitleFailsUa1 | Tier3MatterhornTest | PASS | 1.8s |
...
**25 tests** | 24 passed | 0 failed | 1 skipped | 7.42s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWellFormedAndValid | Tier4JhoveTest | PASS | 842ms |
| testMultiPagePdfWellFormedAndValid | Tier4JhoveTest | PASS | 806ms |
| testPdfWithMetadataWellFormedAndValid | Tier4JhoveTest | PASS | 768ms |
| testPdfWithEmbeddedFontWellFormedAndValid | Tier4JhoveTest | PASS | 775ms |
| testJhoveToolchainWorks | Tier4JhoveTest | PASS | 596ms |
...
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 650ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 via incremental save.pdf" | Tier4Pdf20ExamplesTest | PASS | 153ms |
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 with offset start.pdf" | Tier4Pdf20ExamplesTest | PASS | 162ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/pdf20-utf8-test.pdf" | Tier4Pdf20ExamplesTest | PASS | 153ms |
