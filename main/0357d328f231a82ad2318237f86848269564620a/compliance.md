...
Generated: 2026-06-08 01:03:53 UTC
PHP: 8.4.21
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 91.8s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 32.75s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.28s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 19.37s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 18.47s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 11.22s |
| &#x2705; JHOVE + PDF 2.0 + Security + Preflight | PASS | 25 | 24 | 0 | 1 | 8.71s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 32.75s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 307ms |
| testGeneratesAnnotationsPdf | AnnotationsTest | PASS | 193ms |
| testGeneratesBookmarksPdf | BookmarksTest | PASS | 250ms |
| testGeneratesFormWithCustomFontAppearances | CustomFontFormAppearancesTest | PASS | 266ms |
...
| testGeneratesPdfWithEmbeddedType1 | EmbeddedType1FontTest | PASS | 233ms |
...
| testGeneratesFormWithAppearances | FormAppearancesIntegrationTest | PASS | 203ms |
...
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 311ms |
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 254ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 97ms |
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 210ms |
...
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 424ms |
...
| testNoteCalloutEmitsLabelAndBody | CalloutTest | PASS | 184ms |
...
| testHighLevelPdfRoundTrip | EncodingIntegrationTest | PASS | 6ms |
...
| testShowPageNumbersDefaultFormat | PageNumbersTest | PASS | 192ms |
...
| testGeneratesHighLevelDocument | PdfIntegrationTest | PASS | 393ms |
...
| testCompositeFontPerPage | UnicodeFontTest | PASS | 204ms |
...
| testPdfWriterAddContentStream | WriterTest | PASS | 203ms |
...
| testPdfWriterAddPageWithRectangle | WriterTest | PASS | 234ms |
...
| testMetadataStreamContainsXmp | XmpMetadataTest | PASS | 192ms |
...
| testSaveToFile | AnnotationFlattenerTest | PASS | 195ms |
...
| testAddBookmark | BookmarkEditorTest | PASS | 404ms |
...
| testReplaceExistingBookmarks | BookmarkEditorTest | PASS | 198ms |
...
| testCustomField | MetadataEditorTest | PASS | 198ms |
| testSaveToFile | MetadataEditorTest | PASS | 191ms |
...
| testSetAlphabetic | PageLabelerTest | PASS | 186ms |
...
| testSaveToFile | PageLabelerTest | PASS | 194ms |
...
| testSetCropBoxSpecificPage | PageTransformerTest | PASS | 210ms |
| testSetMediaBox | PageTransformerTest | PASS | 201ms |
| testSetTrimBox | PageTransformerTest | PASS | 199ms |
| testSetBleedBox | PageTransformerTest | PASS | 211ms |
...
| testScaleTo | PageTransformerTest | PASS | 187ms |
...
| testEncryptAes256 | PdfEncryptTest | PASS | 195ms |
| testDecrypt | PdfEncryptTest | PASS | 199ms |
...
| testStampText | PdfStamperTest | PASS | 201ms |
...
| testStampImageOnSpecificPages | PdfStamperTest | PASS | 204ms |
...
| testStampPdfOnSelectedPages | PdfStamperTest | PASS | 185ms |
| testStampPdfDefaultsToCenter | PdfStamperTest | PASS | 185ms |
...
| testRedactByText | TextRedactorTest | PASS | 187ms |
...
**4 tests** | 3 passed | 0 failed | 1 skipped | 19.37s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWithOutputIntent | PdfAConformanceTest | SKIP | 5ms |
| testVeraPdfToolchainWorks | PdfAConformanceTest | PASS | 2.16s |
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 7.16s |
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 10.05s |
...
| testAnnotationWithContentsPassesClause718 | Tier3MatterhornTest | PASS | 2.13s |
...
**25 tests** | 24 passed | 0 failed | 1 skipped | 8.71s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWellFormedAndValid | Tier4JhoveTest | PASS | 950ms |
| testMultiPagePdfWellFormedAndValid | Tier4JhoveTest | PASS | 895ms |
| testPdfWithMetadataWellFormedAndValid | Tier4JhoveTest | PASS | 883ms |
| testPdfWithEmbeddedFontWellFormedAndValid | Tier4JhoveTest | PASS | 893ms |
| testJhoveToolchainWorks | Tier4JhoveTest | PASS | 672ms |
| testPdfA1bPassesPdfBoxPreflight | Tier4PdfBoxPreflightTest | SKIP | <1ms |
| testPdfBoxPreflightToolchainWorks | Tier4PdfBoxPreflightTest | PASS | 803ms |
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 824ms |
| testPdfWithMetadataHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 543ms |
| testPdfWithEmbeddedFontHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 551ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 with offset start.pdf" | Tier4Pdf20ExamplesTest | PASS | 199ms |
