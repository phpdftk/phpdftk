...
Generated: 2026-06-09 21:58:55 UTC
PHP: 8.4.21
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 93.61s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 34.07s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.33s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 18.8s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 18.96s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 11.63s |
| &#x2705; JHOVE + PDF 2.0 + Security + Preflight | PASS | 25 | 24 | 0 | 1 | 8.81s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 34.07s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 362ms |
| testGeneratesAnnotationsPdf | AnnotationsTest | PASS | 202ms |
| testGeneratesBookmarksPdf | BookmarksTest | PASS | 276ms |
...
| testGeneratesPdfWithEmbeddedType1 | EmbeddedType1FontTest | PASS | 202ms |
...
| testGeneratesFormWithAppearances | FormAppearancesIntegrationTest | PASS | 202ms |
| testGeneratesFormPdf | FormFieldsTest | PASS | 202ms |
| testGeneratesGraphicsPipelinePdf | GraphicsPipelineIntegrationTest | PASS | 197ms |
| testGeneratesGraphicsPdf | GraphicsTest | PASS | 200ms |
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 662ms |
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 239ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 199ms |
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 119ms |
...
| testGeneratesPageLabelsPdf | PageLabelsTest | PASS | 203ms |
| testGeneratesSignatureFieldPdf | SignatureFieldIntegrationTest | PASS | 210ms |
...
| testGeneratesPdfWithType3Font | Type3FontIntegrationTest | PASS | 202ms |
...
| testWinAnsiRoundTripFromShowText | EncodingIntegrationTest | PASS | 195ms |
...
| testBulletListRendersEachItem | ListTest | PASS | 206ms |
...
| testAddPageDelegatesToWriter | PdfDocTest | PASS | 198ms |
...
| testGeneratesHighLevelDocument | PdfIntegrationTest | PASS | 414ms |
| testAddHtmlRendersIntoPdf | PdfTest | PASS | 38ms |
| testEmptyDocumentHasNoPages | PdfTest | PASS | 197ms |
...
| testLongTextAutoPaginates | PdfTest | PASS | 201ms |
| testAddSpacerConsumesVerticalSpace | PdfTest | PASS | 200ms |
| testAddRuleDrawsStroke | PdfTest | PASS | 212ms |
| testAlignmentCenterEmitsCenteredText | PdfTest | PASS | 198ms |
| testSetFontSwitchesFontFamily | PdfTest | PASS | 192ms |
| testBoldAndItalicResolveToCorrectPostScriptName | PdfTest | PASS | 200ms |
| testUnknownFamilyIsRejected | PdfTest | PASS | <1ms |
| testCustomTheme | PdfTest | PASS | 207ms |
| testSaveWritesFile | PdfTest | PASS | 201ms |
| testWriteToStream | PdfTest | PASS | 198ms |
| testWriteToRejectsNonResource | PdfTest | PASS | <1ms |
| testToBytesProducesValidPdfOnEachCall | PdfTest | PASS | 409ms |
...
| testUnderlineEmitsStrokeBelowBaseline | TextDecorationTest | PASS | 202ms |
...
| testAddCompositeFontGeneratesValidPdf | UnicodeFontTest | PASS | 201ms |
| testAddCompositeFontSavesToFile | UnicodeFontTest | PASS | 209ms |
| testCompositeFontRoundTripsThroughReader | UnicodeFontTest | PASS | 204ms |
...
| testPdfWriterMultipleFontsIncrement | WriterTest | PASS | 4ms |
| testPdfWriterGetFonts | WriterTest | PASS | <1ms |
| testPdfWriterAddContentStream | WriterTest | PASS | 210ms |
| testPdfWriterGetContentStreams | WriterTest | PASS | <1ms |
| testPdfWriterWithInfo | WriterTest | PASS | 200ms |
| testPdfWriterGetCatalog | WriterTest | PASS | <1ms |
| testPdfWriterGetPageTree | WriterTest | PASS | <1ms |
| testPdfWriterSavesToFile | WriterTest | PASS | 211ms |
| testPdfWriterContainsXref | WriterTest | PASS | 197ms |
| testPdfWriterContainsTrailer | WriterTest | PASS | <1ms |
| testPdfWriterAddPageWithRectangle | WriterTest | PASS | 198ms |
| testPdfWriterRegisterObject | WriterTest | PASS | 195ms |
| testPdfWriterFontAddedToPage | WriterTest | PASS | 228ms |
| testSetNamedDestinations | WriterTest | PASS | 197ms |
| testSetEncryptionProducesEncryptedPdf | WriterTest | PASS | 203ms |
| testSetEncryptionAes256RoundTrip | WriterTest | PASS | 231ms |
| testSetMetadataAddsStreamToPdf | XmpMetadataTest | PASS | 207ms |
| testMetadataStreamContainsXmp | XmpMetadataTest | PASS | 198ms |
| testMetadataRoundTrip | XmpMetadataTest | PASS | 201ms |
| testSyncInfoToMetadata | XmpMetadataTest | PASS | 192ms |
| testSyncInfoToMetadataNoInfoIsNoOp | XmpMetadataTest | PASS | 202ms |
| testFlattenAll | AnnotationFlattenerTest | PASS | 204ms |
...
| testAddBookmark | BookmarkEditorTest | PASS | 391ms |
| testHasBookmarksReturnsFalseForCleanPdf | BookmarkEditorTest | PASS | <1ms |
| testRemoveBookmarks | BookmarkEditorTest | PASS | 203ms |
...
| testSelectChoiceField | FormFillerTest | PASS | 206ms |
...
| testRoundTripPreservesOtherFields | FormFillerTest | PASS | 201ms |
...
| testSaveToFile | MetadataEditorTest | PASS | 204ms |
...
| testSetAlphabetic | PageLabelerTest | PASS | 208ms |
...
| testMultipleRanges | PageLabelerTest | PASS | 203ms |
...
| testKeepRange | PageSlicerTest | PASS | 193ms |
...
| testKeepWithPageSelector | PageSlicerTest | PASS | 196ms |
...
| testRotate270 | PageTransformerTest | PASS | 200ms |
...
| testSetTrimBox | PageTransformerTest | PASS | 211ms |
...
| testScaleTo | PageTransformerTest | PASS | 199ms |
...
| testMergeWithPageSelection | PdfMergerTest | PASS | 186ms |
...
| testSaveToFile | PdfMergerTest | PASS | 197ms |
...
| testSaveToFile | PdfStamperTest | PASS | 208ms |
| testStampImageJpeg | PdfStamperTest | PASS | 282ms |
| testStampImagePng | PdfStamperTest | PASS | 195ms |
| testStampImageWithScaleWidth | PdfStamperTest | PASS | 202ms |
| testStampImageWithScaleHeight | PdfStamperTest | PASS | 212ms |
| testStampImageWithExplicitDimensions | PdfStamperTest | PASS | 202ms |
| testStampImageWithOpacity | PdfStamperTest | PASS | 192ms |
| testStampImageOnSpecificPages | PdfStamperTest | PASS | 200ms |
...
| testStampPdfSpecificPage | PdfStamperTest | PASS | 214ms |
| testStampPdfOnSelectedPages | PdfStamperTest | PASS | 193ms |
| testStampPdfDefaultsToCenter | PdfStamperTest | PASS | 204ms |
...
| testRedactMultipleAreas | TextRedactorTest | PASS | 191ms |
| testRedactByText | TextRedactorTest | PASS | 189ms |
...
| testPageCount | TextRedactorTest | PASS | 5ms |
...
| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesBookmarksPdf | BookmarksTest | PASS | 328ms |
| testGeneratesDocumentFeaturesPdf | DocumentFeaturesTest | PASS | 217ms |
...
| testQpdfCorpus with data set "qpdf/annotations-no-acroform-with-p.out.pdf" | Tier2CorpusTest | PASS | 9ms |
...
| testQpdfCorpus with data set "qpdf/qpdfjob-ctest2.pdf" | Tier2CorpusTest | PASS | 26ms |
...
| testQpdfCorpus with data set "qpdf/uo-3.pdf" | Tier2CorpusTest | PASS | 3ms |
...
| testPdfBoxCorpus with data set "pdfbox/pdfbox/src/test/resources/org/apache/pdfbox/multipdf/AcrobatMerge-SameMerged.pdf" | Tier2PdfBoxCorpusTest | PASS | 4ms |
...
**6 tests** | 6 passed | 0 failed | 0 skipped | 11.63s
...
**25 tests** | 24 passed | 0 failed | 1 skipped | 8.81s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWellFormedAndValid | Tier4JhoveTest | PASS | 978ms |
| testMultiPagePdfWellFormedAndValid | Tier4JhoveTest | PASS | 939ms |
| testPdfWithMetadataWellFormedAndValid | Tier4JhoveTest | PASS | 922ms |
| testPdfWithEmbeddedFontWellFormedAndValid | Tier4JhoveTest | PASS | 913ms |
...
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 685ms |
| testPdfWithMetadataHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 550ms |
| testPdfWithEmbeddedFontHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 554ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 image with BPC.pdf" | Tier4Pdf20ExamplesTest | PASS | 198ms |
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 via incremental save.pdf" | Tier4Pdf20ExamplesTest | PASS | 197ms |
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 with offset start.pdf" | Tier4Pdf20ExamplesTest | PASS | 211ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/Simple PDF 2.0 file.pdf" | Tier4Pdf20ExamplesTest | PASS | 207ms |
