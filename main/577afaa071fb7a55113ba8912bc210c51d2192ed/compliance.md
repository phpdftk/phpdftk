...
Generated: 2026-05-13 19:00:19 UTC
PHP: 8.4.21
...
**Overall: PASS** | 1446 tests | 1440 passed | 0 failed | 6 skipped | 84.58s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 238 | 234 | 0 | 4 | 29.81s |
...
**238 tests** | 234 passed | 0 failed | 4 skipped | 29.81s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 278ms |
...
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 203ms |
...
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 615ms |
...
| testAlignmentCenterEmitsCenteredText | PdfTest | PASS | 176ms |
...
| testQpdfCorpus with data set "qpdf/pclm-out.pdf" | Tier2CorpusTest | PASS | 22ms |
...
| testQpdfCorpus with data set "qpdf/three-files-2-collate-out.pdf" | Tier2CorpusTest | PASS | 2ms |
