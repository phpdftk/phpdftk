...
Generated: 2026-06-08 17:55:30 UTC
PHP: 8.4.21
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 92.16s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 32.79s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.27s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 19.23s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 18.77s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 32.79s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 661ms |
| testGeneratesAnnotationsPdf | AnnotationsTest | PASS | 191ms |
| testGeneratesBookmarksPdf | BookmarksTest | PASS | 253ms |
| testGeneratesFormWithCustomFontAppearances | CustomFontFormAppearancesTest | PASS | 214ms |
...
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 167ms |
...
| testGeneratesMultimediaAnd3DPdf | MultimediaAndThreeDIntegrationTest | PASS | 188ms |
...
| testGeneratesPageLabelsPdf | PageLabelsTest | PASS | 201ms |
...
| testGeneratesPdfWithXrefAndObjectStreams | XRefStreamIntegrationTest | PASS | 202ms |
...
| testWinAnsiRoundTripFromShowText | EncodingIntegrationTest | PASS | 178ms |
...
| testGeneratesHighLevelDocument | PdfIntegrationTest | PASS | 403ms |
...
| testAddSpacerConsumesVerticalSpace | PdfTest | PASS | 199ms |
| testAddRuleDrawsStroke | PdfTest | PASS | 196ms |
...
| testSaveWritesFile | PdfTest | PASS | 193ms |
| testWriteToStream | PdfTest | PASS | 194ms |
| testWriteToRejectsNonResource | PdfTest | PASS | <1ms |
| testToBytesProducesValidPdfOnEachCall | PdfTest | PASS | 386ms |
...
| testSetEncryptionAes256RoundTrip | WriterTest | PASS | 251ms |
| testSetMetadataAddsStreamToPdf | XmpMetadataTest | PASS | 194ms |
| testMetadataStreamContainsXmp | XmpMetadataTest | PASS | 189ms |
| testMetadataRoundTrip | XmpMetadataTest | PASS | 180ms |
| testSyncInfoToMetadata | XmpMetadataTest | PASS | 198ms |
...
| testFillTextField | FormFillerTest | PASS | 182ms |
| testFillManyFields | FormFillerTest | PASS | 185ms |
| testCheckCheckbox | FormFillerTest | PASS | 192ms |
| testUncheckCheckbox | FormFillerTest | PASS | 197ms |
| testSelectChoiceField | FormFillerTest | PASS | 196ms |
| testFillMultipleFieldTypes | FormFillerTest | PASS | 191ms |
...
| testSetMetadataOnPdfWithoutInfo | MetadataEditorTest | PASS | 201ms |
...
| testReorder | PageSlicerTest | PASS | 187ms |
...
| testSetCropBoxSpecificPage | PageTransformerTest | PASS | 193ms |
| testSetMediaBox | PageTransformerTest | PASS | 184ms |
| testSetTrimBox | PageTransformerTest | PASS | 179ms |
...
| testEncryptAes256 | PdfEncryptTest | PASS | 190ms |
| testDecrypt | PdfEncryptTest | PASS | 197ms |
...
| testMergeTwoPdfs | PdfMergerTest | PASS | 197ms |
...
| testSaveToFile | PdfStamperTest | PASS | 182ms |
| testStampImageJpeg | PdfStamperTest | PASS | 196ms |
| testStampImagePng | PdfStamperTest | PASS | 188ms |
...
| testCustomRedactionColor | TextRedactorTest | PASS | 176ms |
...
| testSaveToFile | TextRedactorTest | PASS | 179ms |
...
| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesBookmarksPdf | BookmarksTest | PASS | 303ms |
...
**4 tests** | 3 passed | 0 failed | 1 skipped | 19.23s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWithOutputIntent | PdfAConformanceTest | SKIP | 4ms |
| testVeraPdfToolchainWorks | PdfAConformanceTest | PASS | 2.25s |
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 7.11s |
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 9.86s |
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 18.77s
...
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 7.49s |
...
| testAnnotationWithContentsPassesClause718 | Tier3MatterhornTest | PASS | 2.17s |
| testUntaggedDocumentFailsUa1 | Tier3MatterhornTest | PASS | 1.7s |
| testMissingLangFailsUa1 | Tier3MatterhornTest | PASS | 1.96s |
| testMissingDisplayDocTitleFailsUa1 | Tier3MatterhornTest | PASS | 1.84s |
...
| testPdfWithMetadataWellFormedAndValid | Tier4JhoveTest | PASS | 850ms |
| testPdfWithEmbeddedFontWellFormedAndValid | Tier4JhoveTest | PASS | 858ms |
| testJhoveToolchainWorks | Tier4JhoveTest | PASS | 678ms |
...
| testPdfWithMetadataHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 515ms |
| testPdfWithEmbeddedFontHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 521ms |
