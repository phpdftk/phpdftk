...
Generated: 2026-06-17 14:32:11 UTC
PHP: 8.4.22
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 94.93s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 33.11s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.32s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 20.04s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 19.8s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 12.3s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 33.11s
...
| testGeneratesFormWithCustomFontAppearances | CustomFontFormAppearancesTest | PASS | 289ms |
...
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 85ms |
...
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 579ms |
...
| testAddCompositeFontSavesToFile | UnicodeFontTest | PASS | 216ms |
...
| testSetEncryptionProducesEncryptedPdf | WriterTest | PASS | 201ms |
...
| testOddPages | PageTransformerTest | PASS | 208ms |
...
| testMergeWithPageSelection | PdfMergerTest | PASS | 201ms |
...
| testHeaderAndFooter | PdfStamperTest | PASS | 205ms |
...
| testStampImageJpeg | PdfStamperTest | PASS | 252ms |
...
| testStampPdfWithScaling | PdfStamperTest | PASS | 205ms |
...
| testCustomRedactionColor | TextRedactorTest | PASS | 205ms |
...
| testGeneratesSimpleTextPdf | SimpleTextTest | PASS | 210ms |

### veraPDF — PDF/A archival conformance (ISO 19005)

**4 tests** | 3 passed | 0 failed | 1 skipped | 20.04s
...
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 10.5s |
...
**6 tests** | 6 passed | 0 failed | 0 skipped | 12.3s
...
| testMissingLangFailsUa1 | Tier3MatterhornTest | PASS | 2.08s |
...
| testMultiPagePdfWellFormedAndValid | Tier4JhoveTest | PASS | 910ms |
