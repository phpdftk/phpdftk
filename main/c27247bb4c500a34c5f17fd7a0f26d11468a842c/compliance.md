...
Generated: 2026-06-10 17:30:40 UTC
PHP: 8.4.21
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 33.55s
...
| testGeneratesFormWithCustomFontAppearances | CustomFontFormAppearancesTest | PASS | 213ms |
...
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 379ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 395ms |
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 244ms |
...
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 569ms |
| testGeneratesSimpleTextPdf | SimpleTextTest | PASS | 199ms |
| testGeneratesPdfWithType3Font | Type3FontIntegrationTest | PASS | 199ms |
...
| testGeneratesHighLevelDocument | PdfIntegrationTest | PASS | 413ms |
| testAddHtmlRendersIntoPdf | PdfTest | PASS | 39ms |
| testEmptyDocumentHasNoPages | PdfTest | PASS | 199ms |
...
| testAddTableRendersAllCellValues | TableTest | PASS | 201ms |
...
| testAddCompositeFontGeneratesValidPdf | UnicodeFontTest | PASS | 211ms |
...
| testSaveToFile | PdfMergerTest | PASS | 198ms |
...
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 7.53s |
...
| testQpdfCorpus with data set "qpdf/good17-not-qdf.pdf" | Tier2CorpusTest | PASS | 14ms |
...
| testQpdfCorpus with data set "qpdf/uo-8.pdf" | Tier2CorpusTest | PASS | 30ms |
...
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 9.87s |
...
| testPdfiumCorpus with data set "pdfium/weblinks.pdf" | Tier2PdfiumCorpusTest | PASS | 7ms |
...
**6 tests** | 6 passed | 0 failed | 0 skipped | 11.86s
...
| testMissingLangFailsUa1 | Tier3MatterhornTest | PASS | 2s |
...
| testPdfWithMetadataWellFormedAndValid | Tier4JhoveTest | PASS | 897ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 UTF-8 string and annotation.pdf" | Tier4Pdf20ExamplesTest | PASS | 196ms |
