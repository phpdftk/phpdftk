...
Generated: 2026-09-25 23:20:29 UTC
PHP: 8.4.26
...
**Overall: PASS** | 1673 tests | 1667 passed | 0 failed | 6 skipped | 90.89s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 465 | 461 | 0 | 4 | 33.61s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.26s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 18.17s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 17.66s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 11.84s |
| &#x2705; JHOVE + PDF 2.0 + Security + Preflight | PASS | 25 | 24 | 0 | 1 | 8.35s |
...
**465 tests** | 461 passed | 0 failed | 4 skipped | 33.61s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 333ms |
...
| testGeneratesFormWithAppearances | FormAppearancesIntegrationTest | PASS | 196ms |
...
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 460ms |
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 250ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 198ms |
...
| testGeneratesMultimediaAnd3DPdf | MultimediaAndThreeDIntegrationTest | PASS | 187ms |
...
| testGeneratesSignatureFieldPdf | SignatureFieldIntegrationTest | PASS | 183ms |
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 400ms |
| testGeneratesSimpleTextPdf | SimpleTextTest | PASS | 193ms |
| testGeneratesPdfWithType3Font | Type3FontIntegrationTest | PASS | 196ms |
...
| testAddTextWithLinkStyleProducesLinkAnnotation | InlineLinkTest | PASS | 185ms |
...
| testShowPageNumbersDefaultFormat | PageNumbersTest | PASS | 196ms |
...
| testAddPageDelegatesToWriter | PdfDocTest | PASS | 205ms |
| testCreateTransparencyGroupEmitsGroupForm | PdfDocTest | PASS | 184ms |
| testEnsureSoftMaskStateRegistersSMaskExtGState | PdfDocTest | PASS | 190ms |
| testAddLinearAlphaShadingEmitsDeviceGrayShading | PdfDocTest | PASS | 180ms |
| testAddLinearAlphaShadingWithThreeStopsStitches | PdfDocTest | PASS | 196ms |
| testAddRadialAlphaShadingEmitsDeviceGrayType3 | PdfDocTest | PASS | 193ms |
| testAddConicShadingStopsEmitsFunctionBasedShading | PdfDocTest | PASS | 191ms |
| testAddConicShadingStopsRepeatingWrapsTheSweep | PdfDocTest | PASS | 187ms |
...
| testGeneratesHighLevelDocument | PdfIntegrationTest | PASS | 388ms |
| testAddHtmlRendersIntoPdf | PdfTest | PASS | 58ms |
| testEmptyDocumentHasNoPages | PdfTest | PASS | 192ms |
...
| testLongTextAutoPaginates | PdfTest | PASS | 181ms |
| testAddSpacerConsumesVerticalSpace | PdfTest | PASS | 184ms |
| testAddRuleDrawsStroke | PdfTest | PASS | 189ms |
...
| testCustomTheme | PdfTest | PASS | 181ms |
...
| testAddCompositeFontGeneratesValidPdf | UnicodeFontTest | PASS | 197ms |
| testAddCompositeFontSavesToFile | UnicodeFontTest | PASS | 193ms |
| testCompositeFontRoundTripsThroughReader | UnicodeFontTest | PASS | 205ms |
...
| testPdfWriterAddContentStream | WriterTest | PASS | 183ms |
| testPdfWriterGetContentStreams | WriterTest | PASS | <1ms |
| testPdfWriterWithInfo | WriterTest | PASS | 193ms |
| testPdfWriterGetCatalog | WriterTest | PASS | <1ms |
| testPdfWriterGetPageTree | WriterTest | PASS | <1ms |
| testPdfWriterSavesToFile | WriterTest | PASS | 184ms |
| testPdfWriterContainsXref | WriterTest | PASS | 180ms |
| testPdfWriterContainsTrailer | WriterTest | PASS | <1ms |
| testPdfWriterAddPageWithRectangle | WriterTest | PASS | 182ms |
| testPdfWriterRegisterObject | WriterTest | PASS | 185ms |
| testPdfWriterFontAddedToPage | WriterTest | PASS | 185ms |
| testSetNamedDestinations | WriterTest | PASS | 185ms |
...
| testMetadataStreamContainsXmp | XmpMetadataTest | PASS | 182ms |
| testMetadataRoundTrip | XmpMetadataTest | PASS | 182ms |
| testSyncInfoToMetadata | XmpMetadataTest | PASS | 191ms |
...
| testSaveToFile | AnnotationFlattenerTest | PASS | 190ms |
...
| testSetBookmarks | BookmarkEditorTest | PASS | 200ms |
| testSetBookmarksWithChildren | BookmarkEditorTest | PASS | 190ms |
| testAddBookmark | BookmarkEditorTest | PASS | 395ms |
| testHasBookmarksReturnsFalseForCleanPdf | BookmarkEditorTest | PASS | <1ms |
| testRemoveBookmarks | BookmarkEditorTest | PASS | 190ms |
...
| testReplaceExistingBookmarks | BookmarkEditorTest | PASS | 201ms |
...
| testSaveWritesFile | FormFillerTest | PASS | 181ms |
...
| testCustomField | MetadataEditorTest | PASS | 183ms |
| testSaveToFile | MetadataEditorTest | PASS | 182ms |
| testSetLabelsWithArabic | PageLabelerTest | PASS | 190ms |
| testSetRomanNumerals | PageLabelerTest | PASS | 202ms |
| testSetRomanNumeralsUppercase | PageLabelerTest | PASS | 179ms |
| testSetAlphabetic | PageLabelerTest | PASS | 190ms |
| testSetArabicWithStartNumber | PageLabelerTest | PASS | 192ms |
| testSetLabelsWithPrefix | PageLabelerTest | PASS | 188ms |
| testRemoveLabels | PageLabelerTest | PASS | 183ms |
...
| testKeepPages | PageSlicerTest | PASS | 195ms |
| testKeepRange | PageSlicerTest | PASS | 189ms |
| testRemovePages | PageSlicerTest | PASS | 187ms |
...
| testScale | PageTransformerTest | PASS | 183ms |
...
| testEvenPages | PageTransformerTest | PASS | 185ms |
...
| testEncryptAes128 | PdfEncryptTest | PASS | 197ms |
| testEncryptAes256 | PdfEncryptTest | PASS | 200ms |
| testDecrypt | PdfEncryptTest | PASS | 198ms |
...
| testMergeTwoPdfs | PdfMergerTest | PASS | 189ms |
...
| testStampOnSpecificPages | PdfStamperTest | PASS | 187ms |
| testHeaderAndFooter | PdfStamperTest | PASS | 187ms |
...
| testSaveToFile | PdfStamperTest | PASS | 203ms |
| testStampImageJpeg | PdfStamperTest | PASS | 199ms |
| testStampImagePng | PdfStamperTest | PASS | 182ms |
| testStampImageWithScaleWidth | PdfStamperTest | PASS | 196ms |
| testStampImageWithScaleHeight | PdfStamperTest | PASS | 188ms |
| testStampImageWithExplicitDimensions | PdfStamperTest | PASS | 187ms |
| testStampImageWithOpacity | PdfStamperTest | PASS | 188ms |
| testStampImageOnSpecificPages | PdfStamperTest | PASS | 194ms |
| testStampImageCombinedWithText | PdfStamperTest | PASS | 185ms |
...
| testCustomRedactionColor | TextRedactorTest | PASS | 178ms |
...
| testSaveToFile | TextRedactorTest | PASS | 184ms |
...
| testQpdfCorpus with data set "qpdf/appearances-11.pdf" | Tier2CorpusTest | PASS | 13ms |
...
| testQpdfCorpus with data set "qpdf/many-nulls.pdf" | Tier2CorpusTest | PASS | 700ms |
...
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 9.28s |
...
**6 tests** | 6 passed | 0 failed | 0 skipped | 11.84s

| Test | Class | Status | Time |
|---|---|---|---|
| testTaggedDocumentValidatesWithUa1 | Tier3MatterhornTest | PASS | 2.29s |
...
| testMissingLangFailsUa1 | Tier3MatterhornTest | PASS | 1.92s |
| testMissingDisplayDocTitleFailsUa1 | Tier3MatterhornTest | PASS | 1.92s |
| testAnnotationWithoutContentsFailsUa1 | Tier3MatterhornTest | PASS | 2.02s |
...
**25 tests** | 24 passed | 0 failed | 1 skipped | 8.35s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWellFormedAndValid | Tier4JhoveTest | PASS | 951ms |
| testMultiPagePdfWellFormedAndValid | Tier4JhoveTest | PASS | 901ms |
| testPdfWithMetadataWellFormedAndValid | Tier4JhoveTest | PASS | 888ms |
| testPdfWithEmbeddedFontWellFormedAndValid | Tier4JhoveTest | PASS | 853ms |
| testJhoveToolchainWorks | Tier4JhoveTest | PASS | 692ms |
| testPdfA1bPassesPdfBoxPreflight | Tier4PdfBoxPreflightTest | SKIP | <1ms |
| testPdfBoxPreflightToolchainWorks | Tier4PdfBoxPreflightTest | PASS | 814ms |
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 541ms |
| testPdfWithMetadataHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 533ms |
| testPdfWithEmbeddedFontHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 530ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 image with BPC.pdf" | Tier4Pdf20ExamplesTest | PASS | 182ms |
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 via incremental save.pdf" | Tier4Pdf20ExamplesTest | PASS | 181ms |
