...
Generated: 2026-06-10 02:50:49 UTC
PHP: 8.4.21
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 88.1s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 31.3s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.22s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 18.29s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 17.5s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 11.68s |
| &#x2705; JHOVE + PDF 2.0 + Security + Preflight | PASS | 25 | 24 | 0 | 1 | 8.11s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 31.3s
...
| testGeneratesFormWithCustomFontAppearances | CustomFontFormAppearancesTest | PASS | 193ms |
...
| testGeneratesFormWithAppearances | FormAppearancesIntegrationTest | PASS | 187ms |
...
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 112ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 240ms |
...
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 459ms |
| testGeneratesSimpleTextPdf | SimpleTextTest | PASS | 182ms |
| testGeneratesPdfWithType3Font | Type3FontIntegrationTest | PASS | 176ms |
| testGeneratesPdfWithXrefAndObjectStreams | XRefStreamIntegrationTest | PASS | 179ms |
| testEnableOutlineThenHeadingRegistersOutlinesEntry | AutoOutlineTest | PASS | 179ms |
...
| testNoteCalloutEmitsLabelAndBody | CalloutTest | PASS | 182ms |
| testEachTypeUsesItsOwnBarColor | CalloutTest | PASS | 11ms |
...
| testBulletListRendersEachItem | ListTest | PASS | 177ms |
...
| testShowPageNumbersDefaultFormat | PageNumbersTest | PASS | 180ms |
...
| testGeneratesHighLevelDocument | PdfIntegrationTest | PASS | 386ms |
| testAddHtmlRendersIntoPdf | PdfTest | PASS | 36ms |
| testEmptyDocumentHasNoPages | PdfTest | PASS | 179ms |
| testAddTextCreatesFirstPageAutomatically | PdfTest | PASS | 185ms |
| testAddHeadingEmitsLargerText | PdfTest | PASS | 181ms |
| testExplicitNewPageCreatesSecondPage | PdfTest | PASS | 174ms |
| testLongTextAutoPaginates | PdfTest | PASS | 189ms |
| testAddSpacerConsumesVerticalSpace | PdfTest | PASS | 181ms |
...
| testUnderlineEmitsStrokeBelowBaseline | TextDecorationTest | PASS | 176ms |
...
| testAddCompositeFontGeneratesValidPdf | UnicodeFontTest | PASS | 179ms |
| testAddCompositeFontSavesToFile | UnicodeFontTest | PASS | 186ms |
| testCompositeFontRoundTripsThroughReader | UnicodeFontTest | PASS | 185ms |
...
| testPdfWriterSavesToFile | WriterTest | PASS | 178ms |
| testPdfWriterContainsXref | WriterTest | PASS | 191ms |
| testPdfWriterContainsTrailer | WriterTest | PASS | <1ms |
| testPdfWriterAddPageWithRectangle | WriterTest | PASS | 177ms |
| testPdfWriterRegisterObject | WriterTest | PASS | 174ms |
| testPdfWriterFontAddedToPage | WriterTest | PASS | 178ms |
| testSetNamedDestinations | WriterTest | PASS | 179ms |
| testSetEncryptionProducesEncryptedPdf | WriterTest | PASS | 190ms |
| testSetEncryptionAes256RoundTrip | WriterTest | PASS | 241ms |
| testSetMetadataAddsStreamToPdf | XmpMetadataTest | PASS | 178ms |
...
| testAddBookmark | BookmarkEditorTest | PASS | 372ms |
...
| testFillManyFields | FormFillerTest | PASS | 181ms |
| testCheckCheckbox | FormFillerTest | PASS | 185ms |
| testUncheckCheckbox | FormFillerTest | PASS | 180ms |
| testSelectChoiceField | FormFillerTest | PASS | 179ms |
...
| testSetTitleRoundTrip | MetadataEditorTest | PASS | 176ms |
...
| testSetLabelsWithArabic | PageLabelerTest | PASS | 178ms |
| testSetRomanNumerals | PageLabelerTest | PASS | 187ms |
...
| testRemoveLabels | PageLabelerTest | PASS | 185ms |
...
| testKeepRange | PageSlicerTest | PASS | 179ms |
...
| testRotateAllPages | PageTransformerTest | PASS | 177ms |
...
| testScale | PageTransformerTest | PASS | 179ms |
...
| testScaleToNonUniform | PageTransformerTest | PASS | 183ms |
| testMultipleOperations | PageTransformerTest | PASS | 173ms |
| testNoBytesChangedWithoutOperations | PageTransformerTest | PASS | <1ms |
| testEvenPages | PageTransformerTest | PASS | 178ms |
| testOddPages | PageTransformerTest | PASS | 183ms |
| testRange | PageTransformerTest | PASS | 185ms |
...
| testDecrypt | PdfEncryptTest | PASS | 176ms |
...
| testSaveToFile | PdfMergerTest | PASS | 173ms |
| testStampText | PdfStamperTest | PASS | 179ms |
| testWatermark | PdfStamperTest | PASS | 181ms |
...
| testHeaderAndFooter | PdfStamperTest | PASS | 177ms |
| testStampWithOpacity | PdfStamperTest | PASS | 174ms |
...
| testSaveToFile | PdfStamperTest | PASS | 177ms |
...
| testStampImageWithScaleHeight | PdfStamperTest | PASS | 181ms |
| testStampImageWithExplicitDimensions | PdfStamperTest | PASS | 177ms |
...
| testStampPdfOnSelectedPages | PdfStamperTest | PASS | 181ms |
| testStampPdfDefaultsToCenter | PdfStamperTest | PASS | 181ms |
...
| testRedactArea | TextRedactorTest | PASS | 182ms |
| testRedactMultipleAreas | TextRedactorTest | PASS | 177ms |
| testRedactByText | TextRedactorTest | PASS | 182ms |
...
| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesBookmarksPdf | BookmarksTest | PASS | 293ms |
...
**4 tests** | 3 passed | 0 failed | 1 skipped | 18.29s
...
| testQpdfCorpus with data set "qpdf/good18.pdf" | Tier2CorpusTest | PASS | 11ms |
...
| testQpdfCorpus with data set "qpdf/weird-tokens.pdf" | Tier2CorpusTest | PASS | 26ms |
...
**6 tests** | 6 passed | 0 failed | 0 skipped | 11.68s
...
| testUntaggedDocumentFailsUa1 | Tier3MatterhornTest | PASS | 1.89s |
...
**25 tests** | 24 passed | 0 failed | 1 skipped | 8.11s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWellFormedAndValid | Tier4JhoveTest | PASS | 905ms |
| testMultiPagePdfWellFormedAndValid | Tier4JhoveTest | PASS | 872ms |
| testPdfWithMetadataWellFormedAndValid | Tier4JhoveTest | PASS | 860ms |
| testPdfWithEmbeddedFontWellFormedAndValid | Tier4JhoveTest | PASS | 852ms |
| testJhoveToolchainWorks | Tier4JhoveTest | PASS | 668ms |
...
| testPdfWithMetadataHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 507ms |
| testPdfWithEmbeddedFontHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 516ms |
| testPdfIdToolchainWorks | Tier4PdfIdTest | PASS | 333ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 UTF-8 string and annotation.pdf" | Tier4Pdf20ExamplesTest | PASS | 176ms |
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 image with BPC.pdf" | Tier4Pdf20ExamplesTest | PASS | 178ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/Simple PDF 2.0 file.pdf" | Tier4Pdf20ExamplesTest | PASS | 183ms |
