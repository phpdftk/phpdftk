...
Generated: 2026-06-17 14:09:04 UTC
PHP: 8.4.22
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 95.69s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 34.21s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.32s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 20.07s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 19.6s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 11.98s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 34.21s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 692ms |
...
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 220ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 465ms |
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 212ms |
...
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 353ms |
...
| testWinAnsiRoundTripFromShowText | EncodingIntegrationTest | PASS | 207ms |
...
| testAddPageDelegatesToWriter | PdfDocTest | PASS | 189ms |
...
| testAddTextCreatesFirstPageAutomatically | PdfTest | PASS | 201ms |
| testAddHeadingEmitsLargerText | PdfTest | PASS | 203ms |
| testExplicitNewPageCreatesSecondPage | PdfTest | PASS | 203ms |
| testLongTextAutoPaginates | PdfTest | PASS | 203ms |
...
| testSetEncryptionAes256RoundTrip | WriterTest | PASS | 207ms |
| testSetMetadataAddsStreamToPdf | XmpMetadataTest | PASS | 206ms |
...
| testSyncInfoToMetadataNoInfoIsNoOp | XmpMetadataTest | PASS | 200ms |
| testFlattenAll | AnnotationFlattenerTest | PASS | 208ms |
...
| testSaveWritesFile | FormFillerTest | PASS | 197ms |
| testEscapeHatch | FormFillerTest | PASS | 1ms |
| testRoundTripPreservesOtherFields | FormFillerTest | PASS | 216ms |
...
| testSetTitleRoundTrip | MetadataEditorTest | PASS | 203ms |
...
| testSetAlphabetic | PageLabelerTest | PASS | 209ms |
...
| testSaveToFile | PageLabelerTest | PASS | 200ms |
...
| testRotateAllPages | PageTransformerTest | PASS | 197ms |
...
| testRotateCumulative | PageTransformerTest | PASS | 202ms |
...
| testEvenPages | PageTransformerTest | PASS | 203ms |
...
| testEncryptAes256 | PdfEncryptTest | PASS | 218ms |
...
| testWatermark | PdfStamperTest | PASS | 207ms |
...
| testHeaderAndFooter | PdfStamperTest | PASS | 206ms |
...
**4 tests** | 3 passed | 0 failed | 1 skipped | 20.07s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWithOutputIntent | PdfAConformanceTest | SKIP | 5ms |
| testVeraPdfToolchainWorks | PdfAConformanceTest | PASS | 2.02s |
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 7.85s |
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 10.2s |
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 19.6s
...
| testQpdfCorpus with data set "qpdf/issue-202.pdf" | Tier2CorpusTest | PASS | 56ms |
...
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 10.24s |
...
**6 tests** | 6 passed | 0 failed | 0 skipped | 11.98s
...
| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWellFormedAndValid | Tier4JhoveTest | PASS | 968ms |
| testMultiPagePdfWellFormedAndValid | Tier4JhoveTest | PASS | 907ms |
| testPdfWithMetadataWellFormedAndValid | Tier4JhoveTest | PASS | 891ms |
| testPdfWithEmbeddedFontWellFormedAndValid | Tier4JhoveTest | PASS | 863ms |
| testJhoveToolchainWorks | Tier4JhoveTest | PASS | 721ms |
| testPdfA1bPassesPdfBoxPreflight | Tier4PdfBoxPreflightTest | SKIP | <1ms |
| testPdfBoxPreflightToolchainWorks | Tier4PdfBoxPreflightTest | PASS | 811ms |
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 560ms |
| testPdfWithMetadataHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 541ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 via incremental save.pdf" | Tier4Pdf20ExamplesTest | PASS | 196ms |
