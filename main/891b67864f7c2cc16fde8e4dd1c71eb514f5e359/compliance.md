...
Generated: 2026-06-08 12:47:48 UTC
PHP: 8.4.21
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 92.21s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 32.69s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.29s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 19.79s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 18.55s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 32.69s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 294ms |
| testGeneratesAnnotationsPdf | AnnotationsTest | PASS | 188ms |
...
| testGeneratesPdfWithEmbeddedFont | EmbeddedFontsTest | PASS | 214ms |
...
| testGeneratesExtGStatePdf | ExtGStateIntegrationTest | PASS | 190ms |
| testGeneratesFormWithAppearances | FormAppearancesIntegrationTest | PASS | 206ms |
...
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 400ms |
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 130ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 131ms |
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 168ms |
| testGeneratesPdfWithMarkupFields | MarkupAnnotationsIntegrationTest | PASS | 198ms |
| testGeneratesMultiPageComplexPdf | MultiPageComplexTest | PASS | 203ms |
...
| testGeneratesPageLabelsPdf | PageLabelsTest | PASS | 200ms |
| testGeneratesSignatureFieldPdf | SignatureFieldIntegrationTest | PASS | 208ms |
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 363ms |
| testGeneratesSimpleTextPdf | SimpleTextTest | PASS | 200ms |
| testGeneratesPdfWithType3Font | Type3FontIntegrationTest | PASS | 195ms |
| testGeneratesPdfWithXrefAndObjectStreams | XRefStreamIntegrationTest | PASS | 192ms |
| testEnableOutlineThenHeadingRegistersOutlinesEntry | AutoOutlineTest | PASS | 195ms |
...
| testNoteCalloutEmitsLabelAndBody | CalloutTest | PASS | 196ms |
...
| testWinAnsiRoundTripFromShowText | EncodingIntegrationTest | PASS | 197ms |
...
| testBulletListRendersEachItem | ListTest | PASS | 196ms |
...
| testShowPageNumbersDefaultFormat | PageNumbersTest | PASS | 189ms |
...
| testAddPageDelegatesToWriter | PdfDocTest | PASS | 190ms |
...
| testEmptyDocumentHasNoPages | PdfTest | PASS | 202ms |
| testAddTextCreatesFirstPageAutomatically | PdfTest | PASS | 189ms |
| testAddHeadingEmitsLargerText | PdfTest | PASS | 187ms |
| testExplicitNewPageCreatesSecondPage | PdfTest | PASS | 195ms |
| testLongTextAutoPaginates | PdfTest | PASS | 193ms |
| testAddSpacerConsumesVerticalSpace | PdfTest | PASS | 191ms |
| testAddRuleDrawsStroke | PdfTest | PASS | 193ms |
| testAlignmentCenterEmitsCenteredText | PdfTest | PASS | 196ms |
| testSetFontSwitchesFontFamily | PdfTest | PASS | 197ms |
| testBoldAndItalicResolveToCorrectPostScriptName | PdfTest | PASS | 190ms |
| testUnknownFamilyIsRejected | PdfTest | PASS | <1ms |
| testCustomTheme | PdfTest | PASS | 187ms |
| testSaveWritesFile | PdfTest | PASS | 194ms |
| testWriteToStream | PdfTest | PASS | 184ms |
| testWriteToRejectsNonResource | PdfTest | PASS | <1ms |
| testToBytesProducesValidPdfOnEachCall | PdfTest | PASS | 393ms |
...
| testAddTableRendersAllCellValues | TableTest | PASS | 190ms |
...
| testUnderlineEmitsStrokeBelowBaseline | TextDecorationTest | PASS | 188ms |
...
| testAddCompositeFontSavesToFile | UnicodeFontTest | PASS | 197ms |
...
| testPdfWriterContainsPage | WriterTest | PASS | 183ms |
...
| testPdfWriterWithInfo | WriterTest | PASS | 189ms |
| testPdfWriterGetCatalog | WriterTest | PASS | <1ms |
| testPdfWriterGetPageTree | WriterTest | PASS | <1ms |
| testPdfWriterSavesToFile | WriterTest | PASS | 197ms |
| testPdfWriterContainsXref | WriterTest | PASS | 181ms |
| testPdfWriterContainsTrailer | WriterTest | PASS | <1ms |
| testPdfWriterAddPageWithRectangle | WriterTest | PASS | 189ms |
| testPdfWriterRegisterObject | WriterTest | PASS | 194ms |
| testPdfWriterFontAddedToPage | WriterTest | PASS | 199ms |
| testSetNamedDestinations | WriterTest | PASS | 195ms |
| testSetEncryptionProducesEncryptedPdf | WriterTest | PASS | 191ms |
| testSetEncryptionAes256RoundTrip | WriterTest | PASS | 243ms |
| testSetMetadataAddsStreamToPdf | XmpMetadataTest | PASS | 186ms |
| testMetadataStreamContainsXmp | XmpMetadataTest | PASS | 191ms |
| testMetadataRoundTrip | XmpMetadataTest | PASS | 200ms |
| testSyncInfoToMetadata | XmpMetadataTest | PASS | 199ms |
| testSyncInfoToMetadataNoInfoIsNoOp | XmpMetadataTest | PASS | 188ms |
| testFlattenAll | AnnotationFlattenerTest | PASS | 194ms |
...
| testFillTextField | FormFillerTest | PASS | 191ms |
| testFillManyFields | FormFillerTest | PASS | 188ms |
| testCheckCheckbox | FormFillerTest | PASS | 193ms |
| testUncheckCheckbox | FormFillerTest | PASS | 188ms |
| testSelectChoiceField | FormFillerTest | PASS | 186ms |
...
| testSaveWritesFile | FormFillerTest | PASS | 192ms |
| testEscapeHatch | FormFillerTest | PASS | 1ms |
| testRoundTripPreservesOtherFields | FormFillerTest | PASS | 206ms |
...
| testSetMultipleFieldsRoundTrip | MetadataEditorTest | PASS | 180ms |
...
| testSetLabelsWithPrefix | PageLabelerTest | PASS | 191ms |
| testRemoveLabels | PageLabelerTest | PASS | 199ms |
| testMultipleRanges | PageLabelerTest | PASS | 191ms |
...
| testKeepWithPageSelector | PageSlicerTest | PASS | 191ms |
| testNoOpsKeepsAllPages | PageSlicerTest | PASS | 189ms |
...
| testEvenPages | PageTransformerTest | PASS | 200ms |
| testOddPages | PageTransformerTest | PASS | 197ms |
| testRange | PageTransformerTest | PASS | 192ms |
...
| testEncryptAes256 | PdfEncryptTest | PASS | 205ms |
| testDecrypt | PdfEncryptTest | PASS | 193ms |
...
| testMergeTwoPdfs | PdfMergerTest | PASS | 202ms |
| testMergeWithPageSelection | PdfMergerTest | PASS | 191ms |
...
| testStampText | PdfStamperTest | PASS | 187ms |
| testWatermark | PdfStamperTest | PASS | 188ms |
...
| testHeaderAndFooter | PdfStamperTest | PASS | 185ms |
| testStampWithOpacity | PdfStamperTest | PASS | 188ms |
...
| testStampImageJpeg | PdfStamperTest | PASS | 211ms |
| testStampImagePng | PdfStamperTest | PASS | 194ms |
| testStampImageWithScaleWidth | PdfStamperTest | PASS | 196ms |
| testStampImageWithScaleHeight | PdfStamperTest | PASS | 187ms |
| testStampImageWithExplicitDimensions | PdfStamperTest | PASS | 185ms |
| testStampImageWithOpacity | PdfStamperTest | PASS | 197ms |
| testStampImageOnSpecificPages | PdfStamperTest | PASS | 195ms |
| testStampImageCombinedWithText | PdfStamperTest | PASS | 186ms |
| testStampImageThrowsOnMissingFile | PdfStamperTest | PASS | <1ms |
| testStampImageThrowsOnUnsupportedFormat | PdfStamperTest | PASS | 1ms |
| testStampPdf | PdfStamperTest | PASS | 186ms |
| testStampPdfWithScaling | PdfStamperTest | PASS | 192ms |
| testStampPdfWithOpacity | PdfStamperTest | PASS | 192ms |
| testStampPdfSpecificPage | PdfStamperTest | PASS | 189ms |
| testStampPdfOnSelectedPages | PdfStamperTest | PASS | 189ms |
| testStampPdfDefaultsToCenter | PdfStamperTest | PASS | 192ms |
...
| testRedactMultipleAreas | TextRedactorTest | PASS | 210ms |
...
| testSaveToFile | TextRedactorTest | PASS | 190ms |
...
| testGeneratesMultiPageComplexPdf | MultiPageComplexTest | PASS | 206ms |
| testGeneratesSimpleTextPdf | SimpleTextTest | PASS | 187ms |

### veraPDF — PDF/A archival conformance (ISO 19005)

**4 tests** | 3 passed | 0 failed | 1 skipped | 19.79s
...
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 10.46s |
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 18.55s
...
| testQpdfCorpus with data set "qpdf/enc-R3,V2,O=master.pdf" | Tier2CorpusTest | PASS | 3ms |
...
| testQpdfCorpus with data set "qpdf/many-nulls.pdf" | Tier2CorpusTest | PASS | 707ms |
...
| Test | Class | Status | Time |
|---|---|---|---|
| testTaggedDocumentValidatesWithUa1 | Tier3MatterhornTest | PASS | 2.28s |
| testAnnotationWithContentsPassesClause718 | Tier3MatterhornTest | PASS | 1.93s |
| testUntaggedDocumentFailsUa1 | Tier3MatterhornTest | PASS | 1.84s |
...
| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWellFormedAndValid | Tier4JhoveTest | PASS | 965ms |
| testMultiPagePdfWellFormedAndValid | Tier4JhoveTest | PASS | 898ms |
| testPdfWithMetadataWellFormedAndValid | Tier4JhoveTest | PASS | 854ms |
| testPdfWithEmbeddedFontWellFormedAndValid | Tier4JhoveTest | PASS | 873ms |
...
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 549ms |
| testPdfWithMetadataHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 531ms |
| testPdfWithEmbeddedFontHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 532ms |
| testPdfIdToolchainWorks | Tier4PdfIdTest | PASS | 341ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 UTF-8 string and annotation.pdf" | Tier4Pdf20ExamplesTest | PASS | 194ms |
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 image with BPC.pdf" | Tier4Pdf20ExamplesTest | PASS | 188ms |
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 via incremental save.pdf" | Tier4Pdf20ExamplesTest | PASS | 192ms |
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 with offset start.pdf" | Tier4Pdf20ExamplesTest | PASS | 190ms |
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 with page level output intent.pdf" | Tier4Pdf20ExamplesTest | PASS | 181ms |
