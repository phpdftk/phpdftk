...
Generated: 2026-05-08 15:29:34 UTC
PHP: 8.4.21
...
**Overall: PASS** | 1444 tests | 1438 passed | 0 failed | 6 skipped | 90.21s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 236 | 232 | 0 | 4 | 30.77s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.29s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 19.77s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 18.75s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 11.23s |
...
**236 tests** | 232 passed | 0 failed | 4 skipped | 30.77s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 436ms |
...
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 379ms |
...
| testGeneratesPdfWithMarkupFields | MarkupAnnotationsIntegrationTest | PASS | 204ms |
...
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 774ms |
...
| testFlattenAll | AnnotationFlattenerTest | PASS | 216ms |
...
| testFillMultipleFieldTypes | FormFillerTest | PASS | 215ms |
...
| testScaleToNonUniform | PageTransformerTest | PASS | 230ms |
...
**4 tests** | 3 passed | 0 failed | 1 skipped | 19.77s
...
| testQpdfCorpus with data set "qpdf/other-file-first.pdf" | Tier2CorpusTest | PASS | 23ms |
...
**6 tests** | 6 passed | 0 failed | 0 skipped | 11.23s
...
| testMultiPagePdfWellFormedAndValid | Tier4JhoveTest | PASS | 940ms |
