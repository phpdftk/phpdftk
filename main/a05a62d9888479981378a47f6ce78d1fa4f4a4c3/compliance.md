...
Generated: 2026-06-19 12:28:36 UTC
PHP: 8.4.22
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 91.49s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 32.72s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.27s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 18.62s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 19.12s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 11.31s |
| &#x2705; JHOVE + PDF 2.0 + Security + Preflight | PASS | 25 | 24 | 0 | 1 | 8.45s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 32.72s
...
| testGeneratesFormWithCustomFontAppearances | CustomFontFormAppearancesTest | PASS | 307ms |
...
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 521ms |
...
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 414ms |
...
| testAddTextWithLinkStyleProducesLinkAnnotation | InlineLinkTest | PASS | 183ms |
...
| testBoldAndItalicResolveToCorrectPostScriptName | PdfTest | PASS | 229ms |
| testUnknownFamilyIsRejected | PdfTest | PASS | <1ms |
| testCustomTheme | PdfTest | PASS | 222ms |
...
| testPdfWriterAddPageWithRectangle | WriterTest | PASS | 217ms |
...
| testUncheckCheckbox | FormFillerTest | PASS | 179ms |
...
| testRotateSpecificPages | PageTransformerTest | PASS | 228ms |
...
| testEvenPages | PageTransformerTest | PASS | 220ms |
...
| testMergeWithPageSelection | PdfMergerTest | PASS | 234ms |
...
| testStampImageJpeg | PdfStamperTest | PASS | 208ms |
...
**4 tests** | 3 passed | 0 failed | 1 skipped | 18.62s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWithOutputIntent | PdfAConformanceTest | SKIP | 5ms |
| testVeraPdfToolchainWorks | PdfAConformanceTest | PASS | 1.92s |
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 7.25s |
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 9.44s |
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 19.12s
...
| testQpdfCorpus with data set "qpdf/resource-from-dr.pdf" | Tier2CorpusTest | PASS | 31ms |
...
**25 tests** | 24 passed | 0 failed | 1 skipped | 8.45s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWellFormedAndValid | Tier4JhoveTest | PASS | 964ms |
| testMultiPagePdfWellFormedAndValid | Tier4JhoveTest | PASS | 897ms |
