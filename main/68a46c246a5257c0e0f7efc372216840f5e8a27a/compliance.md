...
Generated: 2026-06-10 20:04:02 UTC
PHP: 8.4.21
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 87.59s
...
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 17.31s |
...
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 291ms |
...
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 547ms |
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 258ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 123ms |
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 176ms |
...
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 557ms |
...
| testGeneratesHighLevelDocument | PdfIntegrationTest | PASS | 376ms |
...
| testToBytesProducesValidPdfOnEachCall | PdfTest | PASS | 362ms |
...
| testPdfWriterRegisterObject | WriterTest | PASS | 225ms |
...
| testSaveWritesFile | FormFillerTest | PASS | 177ms |
...
| testKeepWithPageSelector | PageSlicerTest | PASS | 223ms |
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 17.31s
...
| testQpdfCorpus with data set "qpdf/enc-R3,V2.pdf" | Tier2CorpusTest | PASS | 12ms |
...
| testQpdfCorpus with data set "qpdf/lin5.pdf" | Tier2CorpusTest | PASS | 2ms |
...
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 6.47s |
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 9.19s |
...
| testPdfWithMetadataHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 511ms |
