...
Generated: 2026-06-17 13:43:11 UTC
PHP: 8.4.22
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 93.36s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 33.28s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.29s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 19.07s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 18.99s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 33.28s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 325ms |
...
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 98ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 138ms |
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 144ms |
...
| testAddPageDelegatesToWriter | PdfDocTest | PASS | 206ms |
...
| testSetFontSwitchesFontFamily | PdfTest | PASS | 208ms |
...
| testToBytesProducesValidPdfOnEachCall | PdfTest | PASS | 410ms |
...
| testAddBookmark | BookmarkEditorTest | PASS | 390ms |
...
| testSetCropBox | PageTransformerTest | PASS | 204ms |
...
| testDecrypt | PdfEncryptTest | PASS | 214ms |
...
| testMergeWithPageSelection | PdfMergerTest | PASS | 184ms |
...
| testStampText | PdfStamperTest | PASS | 204ms |
...
**4 tests** | 3 passed | 0 failed | 1 skipped | 19.07s
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 18.99s
...
| testUntaggedDocumentFailsUa1 | Tier3MatterhornTest | PASS | 1.98s |
| testMissingLangFailsUa1 | Tier3MatterhornTest | PASS | 1.86s |
...
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 565ms |
...
| testPdfIdToolchainWorks | Tier4PdfIdTest | PASS | 367ms |
