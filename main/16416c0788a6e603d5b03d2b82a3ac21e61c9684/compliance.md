...
Generated: 2026-05-25 04:08:38 UTC
PHP: 8.4.21
...
**Overall: PASS** | 1662 tests | 1656 passed | 0 failed | 6 skipped | 86.81s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 454 | 450 | 0 | 4 | 30.75s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.19s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 17.88s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 17.53s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 11.41s |
| &#x2705; JHOVE + PDF 2.0 + Security + Preflight | PASS | 25 | 24 | 0 | 1 | 8.05s |
...
**454 tests** | 450 passed | 0 failed | 4 skipped | 30.75s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 373ms |
| testGeneratesAnnotationsPdf | AnnotationsTest | PASS | 183ms |
| testGeneratesBookmarksPdf | BookmarksTest | PASS | 228ms |
...
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 307ms |
...
| testWinAnsiRoundTripFromShowText | EncodingIntegrationTest | PASS | 172ms |
...
| testAddPageDelegatesToWriter | PdfDocTest | PASS | 173ms |
...
| testGeneratesHighLevelDocument | PdfIntegrationTest | PASS | 367ms |
| testAddHtmlRendersIntoPdf | PdfTest | PASS | 26ms |
| testEmptyDocumentHasNoPages | PdfTest | PASS | 191ms |
| testAddTextCreatesFirstPageAutomatically | PdfTest | PASS | 174ms |
...
| testAlignmentCenterEmitsCenteredText | PdfTest | PASS | 177ms |
...
| testAddTableRendersAllCellValues | TableTest | PASS | 170ms |
...
| testPdfWriterAddContentStream | WriterTest | PASS | 176ms |
...
| testPdfWriterRegisterObject | WriterTest | PASS | 173ms |
...
| testSetEncryptionAes256RoundTrip | WriterTest | PASS | 192ms |
| testSetMetadataAddsStreamToPdf | XmpMetadataTest | PASS | 181ms |
| testMetadataStreamContainsXmp | XmpMetadataTest | PASS | 176ms |
...
| testSetBookmarksWithChildren | BookmarkEditorTest | PASS | 182ms |
...
| testSetLabelsWithPrefix | PageLabelerTest | PASS | 180ms |
...
| testReorder | PageSlicerTest | PASS | 176ms |
...
| testNoOpsKeepsAllPages | PageSlicerTest | PASS | 174ms |
...
| testRotate180 | PageTransformerTest | PASS | 178ms |
...
| testSetMediaBox | PageTransformerTest | PASS | 176ms |
...
| testEvenPages | PageTransformerTest | PASS | 175ms |
...
| testSaveToFile | PdfMergerTest | PASS | 177ms |
| testStampText | PdfStamperTest | PASS | 178ms |
| testWatermark | PdfStamperTest | PASS | 178ms |
| testWatermarkWithStyle | PdfStamperTest | PASS | 180ms |
| testPageNumbers | PdfStamperTest | PASS | 175ms |
| testStampOnSpecificPages | PdfStamperTest | PASS | 178ms |
...
| testSaveToFile | PdfStamperTest | PASS | 174ms |
| testStampImageJpeg | PdfStamperTest | PASS | 191ms |
| testStampImagePng | PdfStamperTest | PASS | 170ms |
...
| testStampImageWithOpacity | PdfStamperTest | PASS | 175ms |
...
| testRedactMultipleAreas | TextRedactorTest | PASS | 176ms |
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 17.53s
...
| testQpdfCorpus with data set "qpdf/direct-pages-fixed.pdf" | Tier2CorpusTest | PASS | 6ms |
...
| testQpdfCorpus with data set "qpdf/newline-before-endstream-nl-qdf.pdf" | Tier2CorpusTest | PASS | 22ms |
...
| testPdfBoxCorpus with data set "pdfbox/pdfbox/src/test/resources/input/PDFBOX-4531-bidi-ligature-1.pdf" | Tier2PdfBoxCorpusTest | PASS | 4ms |
...
| testUntaggedDocumentFailsUa1 | Tier3MatterhornTest | PASS | 1.62s |
...
**25 tests** | 24 passed | 0 failed | 1 skipped | 8.05s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWellFormedAndValid | Tier4JhoveTest | PASS | 883ms |
| testMultiPagePdfWellFormedAndValid | Tier4JhoveTest | PASS | 847ms |
...
| testJhoveToolchainWorks | Tier4JhoveTest | PASS | 632ms |
...
| testPdfIdToolchainWorks | Tier4PdfIdTest | PASS | 332ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 image with BPC.pdf" | Tier4Pdf20ExamplesTest | PASS | 176ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/Simple PDF 2.0 file.pdf" | Tier4Pdf20ExamplesTest | PASS | 172ms |
