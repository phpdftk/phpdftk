...
Generated: 2026-06-09 04:12:01 UTC
PHP: 8.4.21
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 91.4s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 32.82s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.28s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 18.55s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 18.44s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 11.95s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 32.82s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 688ms |
| testGeneratesAnnotationsPdf | AnnotationsTest | PASS | 197ms |
| testGeneratesBookmarksPdf | BookmarksTest | PASS | 250ms |
| testGeneratesFormWithCustomFontAppearances | CustomFontFormAppearancesTest | PASS | 230ms |
...
| testGeneratesFormWithAppearances | FormAppearancesIntegrationTest | PASS | 197ms |
...
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 384ms |
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 287ms |
...
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 373ms |
...
| testHighLevelPdfRoundTrip | EncodingIntegrationTest | PASS | 11ms |
| testAddTextWithLinkStyleProducesLinkAnnotation | InlineLinkTest | PASS | 194ms |
...
| testShowPageNumbersDefaultFormat | PageNumbersTest | PASS | 190ms |
...
| testGeneratesHighLevelDocument | PdfIntegrationTest | PASS | 392ms |
| testAddHtmlRendersIntoPdf | PdfTest | PASS | 37ms |
| testEmptyDocumentHasNoPages | PdfTest | PASS | 193ms |
| testAddTextCreatesFirstPageAutomatically | PdfTest | PASS | 199ms |
| testAddHeadingEmitsLargerText | PdfTest | PASS | 190ms |
| testExplicitNewPageCreatesSecondPage | PdfTest | PASS | 187ms |
...
| testAlignmentCenterEmitsCenteredText | PdfTest | PASS | 185ms |
...
| testSaveWritesFile | PdfTest | PASS | 204ms |
...
| testAddTableRendersAllCellValues | TableTest | PASS | 206ms |
...
| testCompositeFontPerPage | UnicodeFontTest | PASS | 186ms |
| testPdfWriterGeneratesValidPdfHeader | WriterTest | PASS | 192ms |
...
| testPdfWriterAddContentStream | WriterTest | PASS | 181ms |
| testPdfWriterGetContentStreams | WriterTest | PASS | <1ms |
| testPdfWriterWithInfo | WriterTest | PASS | 179ms |
| testPdfWriterGetCatalog | WriterTest | PASS | <1ms |
| testPdfWriterGetPageTree | WriterTest | PASS | <1ms |
| testPdfWriterSavesToFile | WriterTest | PASS | 192ms |
...
| testPdfWriterRegisterObject | WriterTest | PASS | 178ms |
...
| testSetBookmarks | BookmarkEditorTest | PASS | 185ms |
| testSetBookmarksWithChildren | BookmarkEditorTest | PASS | 185ms |
...
| testReplaceExistingBookmarks | BookmarkEditorTest | PASS | 185ms |
...
| testFillManyFields | FormFillerTest | PASS | 196ms |
...
| testSaveWritesFile | FormFillerTest | PASS | 190ms |
...
| testSetTitleRoundTrip | MetadataEditorTest | PASS | 185ms |
| testSetMultipleFieldsRoundTrip | MetadataEditorTest | PASS | 187ms |
| testSetMetadataOnPdfWithoutInfo | MetadataEditorTest | PASS | 190ms |
...
| testSaveToFile | MetadataEditorTest | PASS | 189ms |
...
| testSetAlphabetic | PageLabelerTest | PASS | 203ms |
...
| testReorder | PageSlicerTest | PASS | 195ms |
...
| testNoOpsKeepsAllPages | PageSlicerTest | PASS | 183ms |
...
| testRotate180 | PageTransformerTest | PASS | 194ms |
| testRotate270 | PageTransformerTest | PASS | 185ms |
| testRotateSpecificPages | PageTransformerTest | PASS | 178ms |
| testRotateCumulative | PageTransformerTest | PASS | 185ms |
| testRotateInvalidAngle | PageTransformerTest | PASS | <1ms |
| testSetCropBox | PageTransformerTest | PASS | 199ms |
| testSetCropBoxSpecificPage | PageTransformerTest | PASS | 195ms |
| testSetMediaBox | PageTransformerTest | PASS | 190ms |
...
| testMultipleOperations | PageTransformerTest | PASS | 189ms |
| testNoBytesChangedWithoutOperations | PageTransformerTest | PASS | <1ms |
| testEvenPages | PageTransformerTest | PASS | 190ms |
| testOddPages | PageTransformerTest | PASS | 186ms |
...
| testEncryptAes128 | PdfEncryptTest | PASS | 187ms |
...
| testPageNumbers | PdfStamperTest | PASS | 195ms |
| testStampOnSpecificPages | PdfStamperTest | PASS | 207ms |
| testHeaderAndFooter | PdfStamperTest | PASS | 201ms |
...
| testSaveToFile | PdfStamperTest | PASS | 186ms |
| testStampImageJpeg | PdfStamperTest | PASS | 200ms |
| testStampImagePng | PdfStamperTest | PASS | 191ms |
| testStampImageWithScaleWidth | PdfStamperTest | PASS | 190ms |
...
| testStampPdf | PdfStamperTest | PASS | 184ms |
| testStampPdfWithScaling | PdfStamperTest | PASS | 202ms |
| testStampPdfWithOpacity | PdfStamperTest | PASS | 188ms |
| testStampPdfSpecificPage | PdfStamperTest | PASS | 185ms |
...
| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesBookmarksPdf | BookmarksTest | PASS | 308ms |
...
**4 tests** | 3 passed | 0 failed | 1 skipped | 18.55s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWithOutputIntent | PdfAConformanceTest | SKIP | 5ms |
| testVeraPdfToolchainWorks | PdfAConformanceTest | PASS | 2.03s |
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 6.82s |
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 18.44s
...
| testQpdfCorpus with data set "qpdf/resource-from-dr-out.pdf" | Tier2CorpusTest | PASS | 23ms |
...
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 7.51s |
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 9.36s |
...
**6 tests** | 6 passed | 0 failed | 0 skipped | 11.95s
...
| testUntaggedDocumentFailsUa1 | Tier3MatterhornTest | PASS | 1.93s |
| testMissingLangFailsUa1 | Tier3MatterhornTest | PASS | 1.8s |
| testMissingDisplayDocTitleFailsUa1 | Tier3MatterhornTest | PASS | 1.93s |
| testAnnotationWithoutContentsFailsUa1 | Tier3MatterhornTest | PASS | 1.8s |
...
| testPdfWithMetadataWellFormedAndValid | Tier4JhoveTest | PASS | 878ms |
| testPdfWithEmbeddedFontWellFormedAndValid | Tier4JhoveTest | PASS | 856ms |
| testJhoveToolchainWorks | Tier4JhoveTest | PASS | 682ms |
| testPdfA1bPassesPdfBoxPreflight | Tier4PdfBoxPreflightTest | SKIP | <1ms |
| testPdfBoxPreflightToolchainWorks | Tier4PdfBoxPreflightTest | PASS | 795ms |
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 562ms |
...
| testPdfIdToolchainWorks | Tier4PdfIdTest | PASS | 365ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 with offset start.pdf" | Tier4Pdf20ExamplesTest | PASS | 201ms |
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 with page level output intent.pdf" | Tier4Pdf20ExamplesTest | PASS | 193ms |
