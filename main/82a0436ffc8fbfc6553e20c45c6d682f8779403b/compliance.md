...
Generated: 2026-06-14 15:03:19 UTC
PHP: 8.4.22
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 87.5s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 32.55s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.27s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 17.62s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 16.92s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 10.93s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 32.55s
...
| testGeneratesFormPdf | FormFieldsTest | PASS | 216ms |
...
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 236ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 262ms |
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 259ms |
...
| testGeneratesHighLevelDocument | PdfIntegrationTest | PASS | 390ms |
...
| testFlattenAll | AnnotationFlattenerTest | PASS | 199ms |
...
| testCheckCheckbox | FormFillerTest | PASS | 199ms |
...
**4 tests** | 3 passed | 0 failed | 1 skipped | 17.62s
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 16.92s
...
| testQpdfCorpus with data set "qpdf/job-json-encrypt-128.pdf" | Tier2CorpusTest | PASS | 5ms |
...
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 6.53s |
...
**6 tests** | 6 passed | 0 failed | 0 skipped | 10.93s

| Test | Class | Status | Time |
|---|---|---|---|
| testTaggedDocumentValidatesWithUa1 | Tier3MatterhornTest | PASS | 1.95s |
...
| testAnnotationWithoutContentsFailsUa1 | Tier3MatterhornTest | PASS | 1.69s |
...
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 538ms |
