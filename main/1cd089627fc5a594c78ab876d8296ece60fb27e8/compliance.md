...
Generated: 2026-05-24 21:15:58 UTC
PHP: 8.4.21
...
**Overall: PASS** | 1662 tests | 1656 passed | 0 failed | 6 skipped | 88.78s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 454 | 450 | 0 | 4 | 31.34s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.21s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 18.53s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 18.02s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 11.49s |
| &#x2705; JHOVE + PDF 2.0 + Security + Preflight | PASS | 25 | 24 | 0 | 1 | 8.18s |
...
**454 tests** | 450 passed | 0 failed | 4 skipped | 31.34s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 659ms |
...
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 260ms |
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 162ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 185ms |
...
| testNoteCalloutEmitsLabelAndBody | CalloutTest | PASS | 176ms |
...
| testToBytesProducesValidPdfOnEachCall | PdfTest | PASS | 354ms |
...
| testPdfWriterContainsPage | WriterTest | PASS | 172ms |
...
| testPdfWriterAddPageWithRectangle | WriterTest | PASS | 176ms |
| testPdfWriterRegisterObject | WriterTest | PASS | 182ms |
| testPdfWriterFontAddedToPage | WriterTest | PASS | 177ms |
...
| testSetMetadataAddsStreamToPdf | XmpMetadataTest | PASS | 173ms |
| testMetadataStreamContainsXmp | XmpMetadataTest | PASS | 187ms |
| testMetadataRoundTrip | XmpMetadataTest | PASS | 186ms |
| testSyncInfoToMetadata | XmpMetadataTest | PASS | 176ms |
...
| testSaveToFile | AnnotationFlattenerTest | PASS | 180ms |
...
| testSetBookmarks | BookmarkEditorTest | PASS | 176ms |
| testSetBookmarksWithChildren | BookmarkEditorTest | PASS | 183ms |
| testAddBookmark | BookmarkEditorTest | PASS | 360ms |
| testHasBookmarksReturnsFalseForCleanPdf | BookmarkEditorTest | PASS | <1ms |
| testRemoveBookmarks | BookmarkEditorTest | PASS | 178ms |
...
| testCheckCheckbox | FormFillerTest | PASS | 230ms |
| testUncheckCheckbox | FormFillerTest | PASS | 188ms |
| testSelectChoiceField | FormFillerTest | PASS | 184ms |
| testFillMultipleFieldTypes | FormFillerTest | PASS | 181ms |
...
| testSetMultipleFieldsRoundTrip | MetadataEditorTest | PASS | 177ms |
...
| testReverse | PageSlicerTest | PASS | 177ms |
| testSplit | PageSlicerTest | PASS | 365ms |
| testKeepWithPageSelector | PageSlicerTest | PASS | 177ms |
...
| testRotateCumulative | PageTransformerTest | PASS | 178ms |
...
| testScaleSpecificPages | PageTransformerTest | PASS | 175ms |
...
| testStampImageJpeg | PdfStamperTest | PASS | 194ms |
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 18.02s
...
| testQpdfCorpus with data set "qpdf/enc-XI-base.pdf" | Tier2CorpusTest | PASS | 7ms |
...
| testQpdfCorpus with data set "qpdf/many-nulls.pdf" | Tier2CorpusTest | PASS | 680ms |
...
| testQpdfCorpus with data set "qpdf/outlines-with-old-root-dests-dict.pdf" | Tier2CorpusTest | PASS | 22ms |
...
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 9.2s |
...
| testPdfBoxCorpus with data set "pdfbox/pdfbox/src/test/resources/input/merge/PDFBOX-4417-001031.pdf" | Tier2PdfBoxCorpusTest | PASS | 4ms |
...
| testAnnotationWithContentsPassesClause718 | Tier3MatterhornTest | PASS | 2.01s |
...
**25 tests** | 24 passed | 0 failed | 1 skipped | 8.18s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWellFormedAndValid | Tier4JhoveTest | PASS | 902ms |
| testMultiPagePdfWellFormedAndValid | Tier4JhoveTest | PASS | 851ms |
| testPdfWithMetadataWellFormedAndValid | Tier4JhoveTest | PASS | 865ms |
| testPdfWithEmbeddedFontWellFormedAndValid | Tier4JhoveTest | PASS | 821ms |
| testJhoveToolchainWorks | Tier4JhoveTest | PASS | 637ms |
...
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 676ms |
