...
Generated: 2026-05-24 21:21:38 UTC
PHP: 8.4.21
...
**Overall: PASS** | 1662 tests | 1656 passed | 0 failed | 6 skipped | 90.06s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 454 | 450 | 0 | 4 | 31.85s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.25s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 18.7s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 18.29s |
...
**454 tests** | 450 passed | 0 failed | 4 skipped | 31.85s
...
| testGeneratesBookmarksPdf | BookmarksTest | PASS | 227ms |
| testGeneratesFormWithCustomFontAppearances | CustomFontFormAppearancesTest | PASS | 264ms |
...
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 534ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 149ms |
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 292ms |
...
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 318ms |
...
| testAddCompositeFontGeneratesValidPdf | UnicodeFontTest | PASS | 186ms |
...
| testCompositeFontPerPage | UnicodeFontTest | PASS | 181ms |
...
| testTotalPageCount | PdfMergerTest | PASS | 2ms |
...
| testStampImageOnSpecificPages | PdfStamperTest | PASS | 188ms |
...
| testVeraPdfToolchainWorks | PdfAConformanceTest | PASS | 2s |
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 7.14s |
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 9.54s |
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 18.29s
...
| testQpdfCorpus with data set "qpdf/enc-XI-base.pdf" | Tier2CorpusTest | PASS | 8ms |
...
| testQpdfCorpus with data set "qpdf/outlines-with-old-root-dests-dict.pdf" | Tier2CorpusTest | PASS | 24ms |
...
| testPdfBoxCorpus with data set "pdfbox/pdfbox/src/test/resources/input/merge/PDFBOX-4417-001031.pdf" | Tier2PdfBoxCorpusTest | PASS | 5ms |
...
| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWellFormedAndValid | Tier4JhoveTest | PASS | 925ms |
| testMultiPagePdfWellFormedAndValid | Tier4JhoveTest | PASS | 878ms |
| testPdfWithMetadataWellFormedAndValid | Tier4JhoveTest | PASS | 839ms |
| testPdfWithEmbeddedFontWellFormedAndValid | Tier4JhoveTest | PASS | 825ms |
