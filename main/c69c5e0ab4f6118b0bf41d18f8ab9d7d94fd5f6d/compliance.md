...
Generated: 2026-05-15 02:12:12 UTC
PHP: 8.4.21
...
**Overall: PASS** | 1447 tests | 1441 passed | 0 failed | 6 skipped | 92.48s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 239 | 235 | 0 | 4 | 31s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.28s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 19.8s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 19.69s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 12.16s |
...
**239 tests** | 235 passed | 0 failed | 4 skipped | 31s
...
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 515ms |
...
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 576ms |
...
| testSplit | PageSlicerTest | PASS | 391ms |
...
| testStampPdfWithOpacity | PdfStamperTest | PASS | 203ms |
...
| testQpdfCorpus with data set "qpdf/c-linearized.pdf" | Tier2CorpusTest | PASS | 5ms |
...
| testQpdfCorpus with data set "qpdf/manual-appearances-out.pdf" | Tier2CorpusTest | PASS | 2ms |
...
| testQpdfCorpus with data set "qpdf/pclm-out.pdf" | Tier2CorpusTest | PASS | 21ms |
...
| testQpdfCorpus with data set "qpdf/three-files-2-collate-out.pdf" | Tier2CorpusTest | PASS | 3ms |
...
| testPdfBoxCorpus with data set "pdfbox/pdfbox/src/test/resources/org/apache/pdfbox/multipdf/AcroFormForMerge-DifferentOptions.pdf" | Tier2PdfBoxCorpusTest | PASS | 3ms |
...
| testPdfBoxCorpus with data set "pdfbox/tools/src/test/resources/input/ImageIOUtil/JPXTestGrey.pdf" | Tier2PdfBoxCorpusTest | PASS | 2ms |
...
| testPdfiumCorpus with data set "pdfium/pixel/bug_335309995.pdf" | Tier2PdfiumCorpusTest | PASS | 3ms |
...
**6 tests** | 6 passed | 0 failed | 0 skipped | 12.16s
...
| testPdfBoxPreflightToolchainWorks | Tier4PdfBoxPreflightTest | PASS | 828ms |
...
| testPdfIdToolchainWorks | Tier4PdfIdTest | PASS | 373ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 via incremental save.pdf" | Tier4Pdf20ExamplesTest | PASS | 204ms |
