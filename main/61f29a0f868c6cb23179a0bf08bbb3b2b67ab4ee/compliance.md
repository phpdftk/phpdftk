...
Generated: 2026-06-10 18:42:33 UTC
PHP: 8.4.21
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 90.94s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 33.47s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.28s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 18.5s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 33.47s
...
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 471ms |
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 752ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 119ms |
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 100ms |
...
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 889ms |
...
| testAddQuoteFollowedByAddTextResumesUnindentedFlow | BlockquoteTest | PASS | 13ms |
...
| testGeneratesHighLevelDocument | PdfIntegrationTest | PASS | 398ms |
...
| testRemoveLabels | PageLabelerTest | PASS | 213ms |
...
| testSplit | PageSlicerTest | PASS | 369ms |
...
| testStampWithOpacity | PdfStamperTest | PASS | 184ms |
...
**4 tests** | 3 passed | 0 failed | 1 skipped | 18.5s
...
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 9.01s |
...
| testQpdfCorpus with data set "qpdf/uo-5.pdf" | Tier2CorpusTest | PASS | 27ms |
...
| testPdfiumCorpus with data set "pdfium/two_signatures.pdf" | Tier2PdfiumCorpusTest | PASS | 6ms |
...
| testPdfWithMetadataHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 520ms |
