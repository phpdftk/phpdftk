...
Generated: 2026-05-24 22:32:27 UTC
PHP: 8.4.21
...
**Overall: PASS** | 1662 tests | 1656 passed | 0 failed | 6 skipped | 86.79s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 454 | 450 | 0 | 4 | 31.63s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.23s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 17.57s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 17.35s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 10.94s |
| &#x2705; JHOVE + PDF 2.0 + Security + Preflight | PASS | 25 | 24 | 0 | 1 | 8.06s |
...
**454 tests** | 450 passed | 0 failed | 4 skipped | 31.63s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 577ms |
| testGeneratesAnnotationsPdf | AnnotationsTest | PASS | 191ms |
| testGeneratesBookmarksPdf | BookmarksTest | PASS | 233ms |
| testGeneratesFormWithCustomFontAppearances | CustomFontFormAppearancesTest | PASS | 235ms |
...
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 324ms |
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 168ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 184ms |
...
| testGeneratesPageLabelsPdf | PageLabelsTest | PASS | 188ms |
| testGeneratesSignatureFieldPdf | SignatureFieldIntegrationTest | PASS | 183ms |
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 355ms |
...
| testEnableOutlineThenHeadingRegistersOutlinesEntry | AutoOutlineTest | PASS | 178ms |
...
| testSaveWritesFile | PdfTest | PASS | 175ms |
...
| testPdfWriterAddPageWithRectangle | WriterTest | PASS | 181ms |
...
| testSetEncryptionAes256RoundTrip | WriterTest | PASS | 198ms |
...
| testFlattenAll | AnnotationFlattenerTest | PASS | 183ms |
...
| testSetBookmarksWithChildren | BookmarkEditorTest | PASS | 183ms |
...
| testReplaceExistingBookmarks | BookmarkEditorTest | PASS | 190ms |
...
| testFillMultipleFieldTypes | FormFillerTest | PASS | 182ms |
...
| testSaveWritesFile | FormFillerTest | PASS | 182ms |
| testEscapeHatch | FormFillerTest | PASS | 2ms |
| testRoundTripPreservesOtherFields | FormFillerTest | PASS | 190ms |
...
| testSaveToFile | MetadataEditorTest | PASS | 181ms |
...
| testSaveToFile | PageLabelerTest | PASS | 179ms |
...
| testRemovePages | PageSlicerTest | PASS | 177ms |
| testReorder | PageSlicerTest | PASS | 186ms |
| testReverse | PageSlicerTest | PASS | 186ms |
| testSplit | PageSlicerTest | PASS | 370ms |
...
| testRotateSpecificPages | PageTransformerTest | PASS | 182ms |
...
| testSetTrimBox | PageTransformerTest | PASS | 176ms |
...
| testStampOnSpecificPages | PdfStamperTest | PASS | 182ms |
| testHeaderAndFooter | PdfStamperTest | PASS | 181ms |
...
| testStampImageJpeg | PdfStamperTest | PASS | 190ms |
| testStampImagePng | PdfStamperTest | PASS | 180ms |
| testStampImageWithScaleWidth | PdfStamperTest | PASS | 183ms |
| testStampImageWithScaleHeight | PdfStamperTest | PASS | 184ms |
| testStampImageWithExplicitDimensions | PdfStamperTest | PASS | 192ms |
| testStampImageWithOpacity | PdfStamperTest | PASS | 177ms |
| testStampImageOnSpecificPages | PdfStamperTest | PASS | 181ms |
...
| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesBookmarksPdf | BookmarksTest | PASS | 297ms |
...
| testGeneratesFormPdf | FormFieldsTest | PASS | 178ms |
...
**4 tests** | 3 passed | 0 failed | 1 skipped | 17.57s
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 17.35s
...
| testQpdfCorpus with data set "qpdf/enc-R3,V2,O=master.pdf" | Tier2CorpusTest | PASS | 8ms |
...
| testQpdfCorpus with data set "qpdf/many-nulls.pdf" | Tier2CorpusTest | PASS | 768ms |
...
| testQpdfCorpus with data set "qpdf/other-file-first.pdf" | Tier2CorpusTest | PASS | 25ms |
...
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 8.99s |
...
| testPdfBoxCorpus with data set "pdfbox/pdfbox/src/test/resources/org/apache/pdfbox/pdmodel/interactive/form/PDFBOX-4958.pdf" | Tier2PdfBoxCorpusTest | PASS | 3ms |
...
**6 tests** | 6 passed | 0 failed | 0 skipped | 10.94s
...
| testMissingLangFailsUa1 | Tier3MatterhornTest | PASS | 1.59s |
...
**25 tests** | 24 passed | 0 failed | 1 skipped | 8.06s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWellFormedAndValid | Tier4JhoveTest | PASS | 923ms |
| testMultiPagePdfWellFormedAndValid | Tier4JhoveTest | PASS | 859ms |
| testPdfWithMetadataWellFormedAndValid | Tier4JhoveTest | PASS | 824ms |
| testPdfWithEmbeddedFontWellFormedAndValid | Tier4JhoveTest | PASS | 843ms |
| testJhoveToolchainWorks | Tier4JhoveTest | PASS | 657ms |
| testPdfA1bPassesPdfBoxPreflight | Tier4PdfBoxPreflightTest | SKIP | <1ms |
| testPdfBoxPreflightToolchainWorks | Tier4PdfBoxPreflightTest | PASS | 729ms |
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 550ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 UTF-8 string and annotation.pdf" | Tier4Pdf20ExamplesTest | PASS | 179ms |
