...
Generated: 2026-06-27 19:15:57 UTC
PHP: 8.4.22
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 93.87s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 34.13s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.29s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 19.52s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 18.31s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 11.65s |
| &#x2705; JHOVE + PDF 2.0 + Security + Preflight | PASS | 25 | 24 | 0 | 1 | 8.97s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 34.13s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 294ms |
| testGeneratesAnnotationsPdf | AnnotationsTest | PASS | 196ms |
...
| testGeneratesPdfWithEmbeddedTrueTypeFont | DocumentFeaturesTest | PASS | 220ms |
...
| testGeneratesPdfWithEmbeddedType1 | EmbeddedType1FontTest | PASS | 197ms |
...
| testGeneratesGraphicsPdf | GraphicsTest | PASS | 192ms |
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 713ms |
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 321ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 193ms |
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 197ms |
...
| testGeneratesMultimediaAnd3DPdf | MultimediaAndThreeDIntegrationTest | PASS | 193ms |
...
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 753ms |
| testGeneratesSimpleTextPdf | SimpleTextTest | PASS | 194ms |
| testGeneratesPdfWithType3Font | Type3FontIntegrationTest | PASS | 186ms |
...
| testNoteCalloutEmitsLabelAndBody | CalloutTest | PASS | 202ms |
...
| testAddTextCreatesFirstPageAutomatically | PdfTest | PASS | 186ms |
| testAddHeadingEmitsLargerText | PdfTest | PASS | 202ms |
| testExplicitNewPageCreatesSecondPage | PdfTest | PASS | 197ms |
| testLongTextAutoPaginates | PdfTest | PASS | 204ms |
...
| testSetFontSwitchesFontFamily | PdfTest | PASS | 204ms |
...
| testWriteToStream | PdfTest | PASS | 199ms |
| testWriteToRejectsNonResource | PdfTest | PASS | <1ms |
| testToBytesProducesValidPdfOnEachCall | PdfTest | PASS | 412ms |
...
| testPdfWriterGeneratesValidPdfHeader | WriterTest | PASS | 202ms |
...
| testPdfWriterContainsPage | WriterTest | PASS | 198ms |
...
| testPdfWriterAddContentStream | WriterTest | PASS | 205ms |
| testPdfWriterGetContentStreams | WriterTest | PASS | <1ms |
| testPdfWriterWithInfo | WriterTest | PASS | 196ms |
...
| testSetNamedDestinations | WriterTest | PASS | 201ms |
| testSetEncryptionProducesEncryptedPdf | WriterTest | PASS | 205ms |
| testSetEncryptionAes256RoundTrip | WriterTest | PASS | 226ms |
| testSetMetadataAddsStreamToPdf | XmpMetadataTest | PASS | 200ms |
| testMetadataStreamContainsXmp | XmpMetadataTest | PASS | 189ms |
...
| testFlattenAll | AnnotationFlattenerTest | PASS | 195ms |
...
| testSaveToFile | AnnotationFlattenerTest | PASS | 198ms |
...
| testAddBookmark | BookmarkEditorTest | PASS | 393ms |
...
| testSaveToFile | BookmarkEditorTest | PASS | 193ms |
...
| testFillManyFields | FormFillerTest | PASS | 201ms |
| testCheckCheckbox | FormFillerTest | PASS | 198ms |
| testUncheckCheckbox | FormFillerTest | PASS | 201ms |
...
| testSetMultipleFieldsRoundTrip | MetadataEditorTest | PASS | 196ms |
| testSetMetadataOnPdfWithoutInfo | MetadataEditorTest | PASS | 187ms |
| testSetCreatorProducerDatesAndTrappedRoundTrip | MetadataEditorTest | PASS | 7ms |
...
| testSaveToFile | MetadataEditorTest | PASS | 197ms |
| testSetLabelsWithArabic | PageLabelerTest | PASS | 199ms |
...
| testSetArabicWithStartNumber | PageLabelerTest | PASS | 193ms |
| testSetLabelsWithPrefix | PageLabelerTest | PASS | 197ms |
...
| testRotateAllPages | PageTransformerTest | PASS | 191ms |
...
| testSetCropBoxSpecificPage | PageTransformerTest | PASS | 195ms |
...
| testScaleTo | PageTransformerTest | PASS | 197ms |
| testScaleToNonUniform | PageTransformerTest | PASS | 191ms |
...
| testRange | PageTransformerTest | PASS | 199ms |
...
| testSaveToFile | PdfMergerTest | PASS | 196ms |
| testStampText | PdfStamperTest | PASS | 191ms |
| testWatermark | PdfStamperTest | PASS | 201ms |
| testWatermarkWithStyle | PdfStamperTest | PASS | 206ms |
| testPageNumbers | PdfStamperTest | PASS | 191ms |
| testStampOnSpecificPages | PdfStamperTest | PASS | 189ms |
...
| testStampImageJpeg | PdfStamperTest | PASS | 250ms |
...
| testStampImageCombinedWithText | PdfStamperTest | PASS | 188ms |
...
| testStampPdfOnSelectedPages | PdfStamperTest | PASS | 200ms |
...
| testRedactMultipleAreas | TextRedactorTest | PASS | 195ms |
| testRedactByText | TextRedactorTest | PASS | 188ms |
| testRedactByPattern | TextRedactorTest | PASS | 1ms |
| testCustomRedactionColor | TextRedactorTest | PASS | 197ms |
...
**4 tests** | 3 passed | 0 failed | 1 skipped | 19.52s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWithOutputIntent | PdfAConformanceTest | SKIP | 5ms |
| testVeraPdfToolchainWorks | PdfAConformanceTest | PASS | 1.99s |
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 8.02s |
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 9.5s |
...
| testQpdfCorpus with data set "qpdf/resolved-appearance-conflicts-generate.pdf" | Tier2CorpusTest | PASS | 29ms |
...
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 9.43s |
...
**6 tests** | 6 passed | 0 failed | 0 skipped | 11.65s
...
| testUntaggedDocumentFailsUa1 | Tier3MatterhornTest | PASS | 1.79s |
| testMissingLangFailsUa1 | Tier3MatterhornTest | PASS | 1.73s |
| testMissingDisplayDocTitleFailsUa1 | Tier3MatterhornTest | PASS | 1.85s |
| testAnnotationWithoutContentsFailsUa1 | Tier3MatterhornTest | PASS | 1.94s |
...
**25 tests** | 24 passed | 0 failed | 1 skipped | 8.97s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWellFormedAndValid | Tier4JhoveTest | PASS | 959ms |
| testMultiPagePdfWellFormedAndValid | Tier4JhoveTest | PASS | 896ms |
| testPdfWithMetadataWellFormedAndValid | Tier4JhoveTest | PASS | 880ms |
| testPdfWithEmbeddedFontWellFormedAndValid | Tier4JhoveTest | PASS | 867ms |
| testJhoveToolchainWorks | Tier4JhoveTest | PASS | 703ms |
| testPdfA1bPassesPdfBoxPreflight | Tier4PdfBoxPreflightTest | SKIP | <1ms |
| testPdfBoxPreflightToolchainWorks | Tier4PdfBoxPreflightTest | PASS | 806ms |
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 1.02s |
| testPdfWithMetadataHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 557ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 with offset start.pdf" | Tier4Pdf20ExamplesTest | PASS | 192ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/Simple PDF 2.0 file.pdf" | Tier4Pdf20ExamplesTest | PASS | 202ms |
