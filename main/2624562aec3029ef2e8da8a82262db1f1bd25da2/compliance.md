...
Generated: 2026-05-25 03:57:21 UTC
PHP: 8.4.21
...
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 17.43s |
...
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 563ms |
...
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 462ms |
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 97ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 331ms |
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 327ms |
...
| testUnderlineEmitsStrokeBelowBaseline | TextDecorationTest | PASS | 175ms |
...
| testPdfWriterContainsXref | WriterTest | PASS | 173ms |
...
| testKeepRange | PageSlicerTest | PASS | 174ms |
...
| testEncryptAes256 | PdfEncryptTest | PASS | 189ms |
...
| testStampWithOpacity | PdfStamperTest | PASS | 178ms |
...
| testStampImageWithOpacity | PdfStamperTest | PASS | 178ms |
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 17.43s
...
| testQpdfCorpus with data set "qpdf/direct-pages.pdf" | Tier2CorpusTest | PASS | 7ms |
...
| testQpdfCorpus with data set "qpdf/newline-before-endstream-nl.pdf" | Tier2CorpusTest | PASS | 24ms |
...
| testPdfBoxCorpus with data set "pdfbox/pdfbox/src/test/resources/input/PDFBOX-4531-bidi-ligature-2.pdf" | Tier2PdfBoxCorpusTest | PASS | 4ms |
...
| testPdfWithMetadataWellFormedAndValid | Tier4JhoveTest | PASS | 834ms |
| testPdfWithEmbeddedFontWellFormedAndValid | Tier4JhoveTest | PASS | 831ms |
