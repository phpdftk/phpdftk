...
Generated: 2026-06-10 17:18:36 UTC
PHP: 8.4.21
...
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 33.64s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.31s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 19.11s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 18.7s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 33.64s
...
| testGeneratesFormWithCustomFontAppearances | CustomFontFormAppearancesTest | PASS | 221ms |
...
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 279ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 358ms |
...
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 427ms |
...
| testShowPageNumbersDefaultFormat | PageNumbersTest | PASS | 210ms |
...
| testSetEncryptionAes256RoundTrip | WriterTest | PASS | 236ms |
...
| testReplaceExistingBookmarks | BookmarkEditorTest | PASS | 212ms |
...
| testSetLabelsWithArabic | PageLabelerTest | PASS | 213ms |
...
| testRemovePages | PageSlicerTest | PASS | 206ms |
...
| testWatermarkWithStyle | PdfStamperTest | PASS | 207ms |
...
| testStampImagePng | PdfStamperTest | PASS | 206ms |
...
| testStampPdfOnSelectedPages | PdfStamperTest | PASS | 203ms |
...
**4 tests** | 3 passed | 0 failed | 1 skipped | 19.11s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWithOutputIntent | PdfAConformanceTest | SKIP | 5ms |
| testVeraPdfToolchainWorks | PdfAConformanceTest | PASS | 2.09s |
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 8.12s |
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 8.89s |
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 18.7s
...
| testQpdfCorpus with data set "qpdf/many-nulls.pdf" | Tier2CorpusTest | PASS | 685ms |
...
| testQpdfCorpus with data set "qpdf/update-stream-data-updated.pdf" | Tier2CorpusTest | PASS | 28ms |
...
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 7.5s |
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 9.59s |
...
| testMissingDisplayDocTitleFailsUa1 | Tier3MatterhornTest | PASS | 1.86s |
...
| testMultiPagePdfWellFormedAndValid | Tier4JhoveTest | PASS | 875ms |
...
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 742ms |
