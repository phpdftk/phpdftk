...
Generated: 2026-05-08 11:56:21 UTC
PHP: 8.4.20
...
**Overall: PASS** | 1444 tests | 1438 passed | 0 failed | 6 skipped | 90.55s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 236 | 232 | 0 | 4 | 30.93s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.27s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 19.5s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 18.43s |
...
**236 tests** | 232 passed | 0 failed | 4 skipped | 30.93s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 671ms |
...
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 114ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 313ms |
...
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 554ms |
...
| testSetEncryptionProducesEncryptedPdf | WriterTest | PASS | 183ms |
...
| testHasField | FormFillerTest | PASS | 3ms |
...
| testNoBytesChangedWithoutModifications | MetadataEditorTest | PASS | 3ms |
...
| testScaleTo | PageTransformerTest | PASS | 204ms |
| testScaleToNonUniform | PageTransformerTest | PASS | 195ms |
...
| testRange | PageTransformerTest | PASS | 206ms |
...
| testStampImageWithScaleHeight | PdfStamperTest | PASS | 199ms |
...
| testStampPdfSpecificPage | PdfStamperTest | PASS | 199ms |
...
| testRedactArea | TextRedactorTest | PASS | 248ms |
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 18.43s

| Test | Class | Status | Time |
|---|---|---|---|
| testPopplerCorpus with data set "poppler-test/tests/blend.pdf" | Tier2CorpusTest | PASS | 5ms |
...
| testQpdfCorpus with data set "qpdf/other-file-first.pdf" | Tier2CorpusTest | PASS | 20ms |
...
| testAnnotationWithContentsPassesClause718 | Tier3MatterhornTest | PASS | 2.11s |
