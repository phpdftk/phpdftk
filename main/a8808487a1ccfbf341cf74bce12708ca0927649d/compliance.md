...
Generated: 2026-05-15 05:12:30 UTC
PHP: 8.4.21
...
**Overall: PASS** | 1462 tests | 1456 passed | 0 failed | 6 skipped | 88.42s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 254 | 250 | 0 | 4 | 30.98s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.24s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 18.73s |
...
**254 tests** | 250 passed | 0 failed | 4 skipped | 30.98s
...
| testGeneratesFormPdf | FormFieldsTest | PASS | 218ms |
...
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 264ms |
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 158ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 103ms |
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 555ms |
...
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 464ms |
...
| testRemovePages | PageSlicerTest | PASS | 209ms |
...
**4 tests** | 3 passed | 0 failed | 1 skipped | 18.73s
...
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 9.95s |
...
| testQpdfCorpus with data set "qpdf/big-ostream.pdf" | Tier2CorpusTest | PASS | 10ms |
...
| testQpdfCorpus with data set "qpdf/c-r5-in.pdf" | Tier2CorpusTest | PASS | 4ms |
...
| testQpdfCorpus with data set "qpdf/overlay-copy-annotations.pdf" | Tier2CorpusTest | PASS | 22ms |
...
| testQpdfCorpus with data set "qpdf/shared-images.pdf" | Tier2CorpusTest | PASS | 2ms |
...
| testPdfBoxCorpus with data set "pdfbox/pdfbox/src/test/resources/input/merge/PDFBOX-4417-054080.pdf" | Tier2PdfBoxCorpusTest | PASS | 3ms |
...
| testPdfiumCorpus with data set "pdfium/bug_750568.pdf" | Tier2PdfiumCorpusTest | PASS | 2ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 via incremental save.pdf" | Tier4Pdf20ExamplesTest | PASS | 177ms |
