...
Generated: 2026-06-16 23:12:10 UTC
PHP: 8.4.22
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 88.23s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 32.64s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.25s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 17.37s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 17.75s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 11.1s |
| &#x2705; JHOVE + PDF 2.0 + Security + Preflight | PASS | 25 | 24 | 0 | 1 | 8.13s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 32.64s
...
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 432ms |
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 366ms |
...
| testSaveWritesFile | PdfTest | PASS | 214ms |
...
| testWriterPageDrawTableRendersExplicitlyPositionedTable | TableTest | PASS | 8ms |
...
| testPdfWriterContainsPage | WriterTest | PASS | 177ms |
...
| testPdfWriterWithInfo | WriterTest | PASS | 246ms |
| testPdfWriterGetCatalog | WriterTest | PASS | <1ms |
| testPdfWriterGetPageTree | WriterTest | PASS | <1ms |
| testPdfWriterSavesToFile | WriterTest | PASS | 212ms |
| testPdfWriterContainsXref | WriterTest | PASS | 207ms |
...
| testRedactArea | TextRedactorTest | PASS | 178ms |
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 17.75s
...
| testQpdfCorpus with data set "qpdf/deterministic-id-in.pdf" | Tier2CorpusTest | PASS | 12ms |
...
| testPdfiumCorpus with data set "pdfium/bug_680376.pdf" | Tier2PdfiumCorpusTest | PASS | 6ms |
...
**25 tests** | 24 passed | 0 failed | 1 skipped | 8.13s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWellFormedAndValid | Tier4JhoveTest | PASS | 939ms |
| testMultiPagePdfWellFormedAndValid | Tier4JhoveTest | PASS | 850ms |
...
| testPdfWithMetadataHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 518ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 with offset start.pdf" | Tier4Pdf20ExamplesTest | PASS | 176ms |
