...
Generated: 2026-05-24 19:33:57 UTC
PHP: 8.4.21
...
**Overall: PASS** | 1662 tests | 1656 passed | 0 failed | 6 skipped | 90.28s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 454 | 450 | 0 | 4 | 32.74s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.24s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 18.79s |
...
**454 tests** | 450 passed | 0 failed | 4 skipped | 32.74s
...
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 489ms |
...
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 335ms |
...
| testFillThrowsForUnknownField | FormFillerTest | PASS | 4ms |
...
| testStampWithOpacity | PdfStamperTest | PASS | 176ms |
...
**4 tests** | 3 passed | 0 failed | 1 skipped | 18.79s
...
| testQpdfCorpus with data set "qpdf/field-resource-conflict.pdf" | Tier2CorpusTest | PASS | 7ms |
...
| testQpdfCorpus with data set "qpdf/overlay-copy-annotations.pdf" | Tier2CorpusTest | PASS | 27ms |
...
| testPdfBoxCorpus with data set "pdfbox/pdfbox/src/test/resources/input/merge/PDFBOX-5809-509329.pdf" | Tier2PdfBoxCorpusTest | PASS | 4ms |
...
| testPdfBoxCorpus with data set "pdfbox/pdfbox/src/test/resources/org/apache/pdfbox/pdmodel/interactive/form/PDFBOX3812-acrobat-multiline-auto.pdf" | Tier2PdfBoxCorpusTest | PASS | 3ms |
...
| testPdfiumCorpus with data set "pdfium/cropped_no_overlap.pdf" | Tier2PdfiumCorpusTest | PASS | 2ms |
...
| testUntaggedDocumentFailsUa1 | Tier3MatterhornTest | PASS | 1.6s |
...
| testMultiPagePdfWellFormedAndValid | Tier4JhoveTest | PASS | 860ms |
...
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 693ms |
