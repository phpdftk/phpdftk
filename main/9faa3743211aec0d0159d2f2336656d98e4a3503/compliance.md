...
Generated: 2026-06-08 17:40:13 UTC
PHP: 8.4.21
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 94.17s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 33.91s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.28s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 20.89s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 18.47s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 11.25s |
| &#x2705; JHOVE + PDF 2.0 + Security + Preflight | PASS | 25 | 24 | 0 | 1 | 8.36s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 33.91s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 654ms |
| testGeneratesAnnotationsPdf | AnnotationsTest | PASS | 197ms |
| testGeneratesBookmarksPdf | BookmarksTest | PASS | 257ms |
| testGeneratesFormWithCustomFontAppearances | CustomFontFormAppearancesTest | PASS | 242ms |
| testGeneratesDocumentFeaturesPdf | DocumentFeaturesTest | PASS | 191ms |
| testGeneratesPdfWithEmbeddedTrueTypeFont | DocumentFeaturesTest | PASS | 205ms |
| testGeneratesPdfWithEmbeddedFont | EmbeddedFontsTest | PASS | 215ms |
...
| testGeneratesPdfWithEmbeddedType1 | EmbeddedType1FontTest | PASS | 203ms |
| testPdfOutputContainsFontData | EmbeddedType1FontTest | PASS | 1ms |
| testGeneratesExtGStatePdf | ExtGStateIntegrationTest | PASS | 194ms |
| testGeneratesFormWithAppearances | FormAppearancesIntegrationTest | PASS | 201ms |
| testGeneratesFormPdf | FormFieldsTest | PASS | 189ms |
| testGeneratesGraphicsPipelinePdf | GraphicsPipelineIntegrationTest | PASS | 197ms |
| testGeneratesGraphicsPdf | GraphicsTest | PASS | 201ms |
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 323ms |
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 107ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 315ms |
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 448ms |
| testGeneratesPdfWithMarkupFields | MarkupAnnotationsIntegrationTest | PASS | 203ms |
| testGeneratesMultiPageComplexPdf | MultiPageComplexTest | PASS | 205ms |
| testGeneratesMultimediaAnd3DPdf | MultimediaAndThreeDIntegrationTest | PASS | 208ms |
...
| testGeneratesPageLabelsPdf | PageLabelsTest | PASS | 205ms |
| testGeneratesSignatureFieldPdf | SignatureFieldIntegrationTest | PASS | 197ms |
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 538ms |
| testGeneratesSimpleTextPdf | SimpleTextTest | PASS | 197ms |
| testGeneratesPdfWithType3Font | Type3FontIntegrationTest | PASS | 193ms |
| testGeneratesPdfWithXrefAndObjectStreams | XRefStreamIntegrationTest | PASS | 192ms |
| testEnableOutlineThenHeadingRegistersOutlinesEntry | AutoOutlineTest | PASS | 190ms |
...
| testNoteCalloutEmitsLabelAndBody | CalloutTest | PASS | 193ms |
...
| testWinAnsiRoundTripFromShowText | EncodingIntegrationTest | PASS | 202ms |
| testHighLevelPdfRoundTrip | EncodingIntegrationTest | PASS | 4ms |
| testAddTextWithLinkStyleProducesLinkAnnotation | InlineLinkTest | PASS | 195ms |
...
| testBulletListRendersEachItem | ListTest | PASS | 194ms |
...
| testShowPageNumbersDefaultFormat | PageNumbersTest | PASS | 199ms |
...
| testAddPageDelegatesToWriter | PdfDocTest | PASS | 191ms |
...
| testGeneratesHighLevelDocument | PdfIntegrationTest | PASS | 419ms |
| testAddHtmlRendersIntoPdf | PdfTest | PASS | 38ms |
| testEmptyDocumentHasNoPages | PdfTest | PASS | 195ms |
| testAddTextCreatesFirstPageAutomatically | PdfTest | PASS | 194ms |
| testAddHeadingEmitsLargerText | PdfTest | PASS | 197ms |
| testExplicitNewPageCreatesSecondPage | PdfTest | PASS | 205ms |
| testLongTextAutoPaginates | PdfTest | PASS | 199ms |
| testAddSpacerConsumesVerticalSpace | PdfTest | PASS | 193ms |
| testAddRuleDrawsStroke | PdfTest | PASS | 195ms |
| testAlignmentCenterEmitsCenteredText | PdfTest | PASS | 199ms |
| testSetFontSwitchesFontFamily | PdfTest | PASS | 205ms |
| testBoldAndItalicResolveToCorrectPostScriptName | PdfTest | PASS | 194ms |
| testUnknownFamilyIsRejected | PdfTest | PASS | <1ms |
| testCustomTheme | PdfTest | PASS | 197ms |
| testSaveWritesFile | PdfTest | PASS | 197ms |
| testWriteToStream | PdfTest | PASS | 194ms |
| testWriteToRejectsNonResource | PdfTest | PASS | <1ms |
| testToBytesProducesValidPdfOnEachCall | PdfTest | PASS | 405ms |
...
| testAddTableRendersAllCellValues | TableTest | PASS | 195ms |
| testAddTableWithHeaderEmitsBoldVariantAndBackground | TableTest | PASS | 1ms |
| testAddTableUsesExplicitColumnWidthsWhenProvided | TableTest | PASS | 5ms |
...
| testUnderlineEmitsStrokeBelowBaseline | TextDecorationTest | PASS | 197ms |
...
| testAddCompositeFontGeneratesValidPdf | UnicodeFontTest | PASS | 206ms |
| testAddCompositeFontSavesToFile | UnicodeFontTest | PASS | 217ms |
...
| testCompositeFontPerPage | UnicodeFontTest | PASS | 207ms |
| testPdfWriterGeneratesValidPdfHeader | WriterTest | PASS | 188ms |
...
| testPdfWriterContainsPage | WriterTest | PASS | 193ms |
...
| testPdfWriterWithInfo | WriterTest | PASS | 188ms |
| testPdfWriterGetCatalog | WriterTest | PASS | <1ms |
| testPdfWriterGetPageTree | WriterTest | PASS | <1ms |
| testPdfWriterSavesToFile | WriterTest | PASS | 201ms |
| testPdfWriterContainsXref | WriterTest | PASS | 203ms |
| testPdfWriterContainsTrailer | WriterTest | PASS | <1ms |
| testPdfWriterAddPageWithRectangle | WriterTest | PASS | 194ms |
| testPdfWriterRegisterObject | WriterTest | PASS | 196ms |
| testPdfWriterFontAddedToPage | WriterTest | PASS | 194ms |
| testSetNamedDestinations | WriterTest | PASS | 183ms |
| testSetEncryptionProducesEncryptedPdf | WriterTest | PASS | 190ms |
| testSetEncryptionAes256RoundTrip | WriterTest | PASS | 222ms |
| testSetMetadataAddsStreamToPdf | XmpMetadataTest | PASS | 188ms |
| testMetadataStreamContainsXmp | XmpMetadataTest | PASS | 186ms |
| testMetadataRoundTrip | XmpMetadataTest | PASS | 193ms |
| testSyncInfoToMetadata | XmpMetadataTest | PASS | 185ms |
| testSyncInfoToMetadataNoInfoIsNoOp | XmpMetadataTest | PASS | 185ms |
| testFlattenAll | AnnotationFlattenerTest | PASS | 192ms |
...
| testSaveToFile | AnnotationFlattenerTest | PASS | 194ms |
...
| testSetBookmarks | BookmarkEditorTest | PASS | 188ms |
| testSetBookmarksWithChildren | BookmarkEditorTest | PASS | 196ms |
| testAddBookmark | BookmarkEditorTest | PASS | 387ms |
| testHasBookmarksReturnsFalseForCleanPdf | BookmarkEditorTest | PASS | <1ms |
| testRemoveBookmarks | BookmarkEditorTest | PASS | 187ms |
| testGetPageCount | BookmarkEditorTest | PASS | <1ms |
| testGetReader | BookmarkEditorTest | PASS | <1ms |
| testSaveToFile | BookmarkEditorTest | PASS | 189ms |
| testNoBytesChangedWhenNoOperations | BookmarkEditorTest | PASS | <1ms |
| testReplaceExistingBookmarks | BookmarkEditorTest | PASS | 195ms |
...
| testFillManyFields | FormFillerTest | PASS | 191ms |
| testCheckCheckbox | FormFillerTest | PASS | 198ms |
| testUncheckCheckbox | FormFillerTest | PASS | 198ms |
| testSelectChoiceField | FormFillerTest | PASS | 188ms |
| testFillMultipleFieldTypes | FormFillerTest | PASS | 188ms |
...
| testSaveWritesFile | FormFillerTest | PASS | 200ms |
| testEscapeHatch | FormFillerTest | PASS | 1ms |
| testRoundTripPreservesOtherFields | FormFillerTest | PASS | 195ms |
...
| testSetTitleRoundTrip | MetadataEditorTest | PASS | 194ms |
| testSetMultipleFieldsRoundTrip | MetadataEditorTest | PASS | 186ms |
...
| testCustomField | MetadataEditorTest | PASS | 197ms |
| testSaveToFile | MetadataEditorTest | PASS | 195ms |
| testSetLabelsWithArabic | PageLabelerTest | PASS | 191ms |
| testSetRomanNumerals | PageLabelerTest | PASS | 194ms |
| testSetRomanNumeralsUppercase | PageLabelerTest | PASS | 198ms |
| testSetAlphabetic | PageLabelerTest | PASS | 197ms |
| testSetArabicWithStartNumber | PageLabelerTest | PASS | 203ms |
| testSetLabelsWithPrefix | PageLabelerTest | PASS | 200ms |
| testRemoveLabels | PageLabelerTest | PASS | 191ms |
| testMultipleRanges | PageLabelerTest | PASS | 205ms |
| testGetPageCount | PageLabelerTest | PASS | 1ms |
| testGetReader | PageLabelerTest | PASS | <1ms |
| testSaveToFile | PageLabelerTest | PASS | 189ms |
| testNoBytesChangedWhenNoOperations | PageLabelerTest | PASS | 1ms |
| testOpenFromFile | PageLabelerTest | PASS | 1ms |
| testKeepPages | PageSlicerTest | PASS | 200ms |
| testKeepRange | PageSlicerTest | PASS | 191ms |
| testRemovePages | PageSlicerTest | PASS | 184ms |
| testReorder | PageSlicerTest | PASS | 185ms |
| testReverse | PageSlicerTest | PASS | 189ms |
| testSplit | PageSlicerTest | PASS | 382ms |
| testKeepWithPageSelector | PageSlicerTest | PASS | 197ms |
| testNoOpsKeepsAllPages | PageSlicerTest | PASS | 192ms |
| testPageCount | PageSlicerTest | PASS | <1ms |
| testEscapeHatch | PageSlicerTest | PASS | <1ms |
| testRotateAllPages | PageTransformerTest | PASS | 198ms |
| testRotate180 | PageTransformerTest | PASS | 187ms |
| testRotate270 | PageTransformerTest | PASS | 193ms |
| testRotateSpecificPages | PageTransformerTest | PASS | 207ms |
| testRotateCumulative | PageTransformerTest | PASS | 218ms |
| testRotateInvalidAngle | PageTransformerTest | PASS | <1ms |
| testSetCropBox | PageTransformerTest | PASS | 207ms |
| testSetCropBoxSpecificPage | PageTransformerTest | PASS | 197ms |
| testSetMediaBox | PageTransformerTest | PASS | 192ms |
| testSetTrimBox | PageTransformerTest | PASS | 191ms |
| testSetBleedBox | PageTransformerTest | PASS | 188ms |
| testScale | PageTransformerTest | PASS | 199ms |
| testScaleSpecificPages | PageTransformerTest | PASS | 198ms |
| testScaleInvalidFactor | PageTransformerTest | PASS | <1ms |
| testScaleTo | PageTransformerTest | PASS | 183ms |
| testScaleToNonUniform | PageTransformerTest | PASS | 184ms |
| testMultipleOperations | PageTransformerTest | PASS | 186ms |
| testNoBytesChangedWithoutOperations | PageTransformerTest | PASS | <1ms |
| testEvenPages | PageTransformerTest | PASS | 191ms |
| testOddPages | PageTransformerTest | PASS | 195ms |
| testRange | PageTransformerTest | PASS | 198ms |
| testGetReader | PageTransformerTest | PASS | <1ms |
| testGetPageCount | PageTransformerTest | PASS | <1ms |
| testSaveToFile | PageTransformerTest | PASS | 192ms |
| testEncryptAes128 | PdfEncryptTest | PASS | 192ms |
| testEncryptAes256 | PdfEncryptTest | PASS | 203ms |
...
| testMergeTwoPdfs | PdfMergerTest | PASS | 196ms |
| testMergeWithPageSelection | PdfMergerTest | PASS | 195ms |
| testSourceCount | PdfMergerTest | PASS | 4ms |
...
| testStampText | PdfStamperTest | PASS | 198ms |
| testWatermark | PdfStamperTest | PASS | 203ms |
| testWatermarkWithStyle | PdfStamperTest | PASS | 199ms |
| testPageNumbers | PdfStamperTest | PASS | 202ms |
| testStampOnSpecificPages | PdfStamperTest | PASS | 192ms |
| testHeaderAndFooter | PdfStamperTest | PASS | 192ms |
| testStampWithOpacity | PdfStamperTest | PASS | 195ms |
...
| testSaveToFile | PdfStamperTest | PASS | 195ms |
| testStampImageJpeg | PdfStamperTest | PASS | 201ms |
| testStampImagePng | PdfStamperTest | PASS | 197ms |
| testStampImageWithScaleWidth | PdfStamperTest | PASS | 199ms |
...
| testStampImageOnSpecificPages | PdfStamperTest | PASS | 193ms |
| testStampImageCombinedWithText | PdfStamperTest | PASS | 191ms |
| testStampImageThrowsOnMissingFile | PdfStamperTest | PASS | <1ms |
| testStampImageThrowsOnUnsupportedFormat | PdfStamperTest | PASS | 1ms |
| testStampPdf | PdfStamperTest | PASS | 193ms |
| testStampPdfWithScaling | PdfStamperTest | PASS | 200ms |
| testStampPdfWithOpacity | PdfStamperTest | PASS | 190ms |
| testStampPdfSpecificPage | PdfStamperTest | PASS | 190ms |
| testStampPdfOnSelectedPages | PdfStamperTest | PASS | 202ms |
| testStampPdfDefaultsToCenter | PdfStamperTest | PASS | 195ms |
...
| testRedactMultipleAreas | TextRedactorTest | PASS | 194ms |
| testRedactByText | TextRedactorTest | PASS | 190ms |
| testRedactByPattern | TextRedactorTest | PASS | 1ms |
| testCustomRedactionColor | TextRedactorTest | PASS | 191ms |
...
**6 tests** | 6 passed | 0 failed | 0 skipped | 1.28s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesBookmarksPdf | BookmarksTest | PASS | 315ms |
| testGeneratesDocumentFeaturesPdf | DocumentFeaturesTest | PASS | 192ms |
| testGeneratesPdfWithEmbeddedTrueTypeFont | DocumentFeaturesTest | PASS | 206ms |
| testGeneratesFormPdf | FormFieldsTest | PASS | 185ms |
| testGeneratesMultiPageComplexPdf | MultiPageComplexTest | PASS | 190ms |
| testGeneratesSimpleTextPdf | SimpleTextTest | PASS | 191ms |

### veraPDF — PDF/A archival conformance (ISO 19005)

**4 tests** | 3 passed | 0 failed | 1 skipped | 20.89s
...
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 11.06s |
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 18.47s
...
| testPopplerCorpus with data set "poppler-test/unittestcases/vis_policy_test.pdf" | Tier2CorpusTest | PASS | 2ms |
...
| testQpdfCorpus with data set "qpdf/appearances-a-more2.pdf" | Tier2CorpusTest | PASS | 10ms |
...
| testQpdfCorpus with data set "qpdf/bad21.pdf" | Tier2CorpusTest | PASS | 11ms |
...
| testQpdfCorpus with data set "qpdf/inline-images-ii-all.pdf" | Tier2CorpusTest | PASS | 22ms |
| testQpdfCorpus with data set "qpdf/inline-images-ii-some.pdf" | Tier2CorpusTest | PASS | 21ms |
...
| testQpdfCorpus with data set "qpdf/issue-202.pdf" | Tier2CorpusTest | PASS | 68ms |
...
| testQpdfCorpus with data set "qpdf/many-nulls.pdf" | Tier2CorpusTest | PASS | 727ms |
...
| testQpdfCorpus with data set "qpdf/need-appearances-out.pdf" | Tier2CorpusTest | PASS | 2ms |
...
| testQpdfCorpus with data set "qpdf/overlay-copy-annotations.pdf" | Tier2CorpusTest | PASS | 3ms |
...
| testQpdfCorpus with data set "qpdf/pclm-out.pdf" | Tier2CorpusTest | PASS | 4ms |
...
| testQpdfCorpus with data set "qpdf/resolved-field-conflicts.pdf" | Tier2CorpusTest | PASS | 2ms |
| testQpdfCorpus with data set "qpdf/resource-from-dr-out.pdf" | Tier2CorpusTest | PASS | 2ms |
...
| testQpdfCorpus with data set "qpdf/sample-form-out.pdf" | Tier2CorpusTest | PASS | 6ms |
| testQpdfCorpus with data set "qpdf/sample-form.pdf" | Tier2CorpusTest | PASS | 11ms |
...
| testQpdfCorpus with data set "qpdf/test80a2.pdf" | Tier2CorpusTest | PASS | 2ms |
...
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 9.78s |
...
| testPdfBoxCorpus with data set "pdfbox/pdfbox/src/test/resources/input/merge/PDFBOX-4417-054080.pdf" | Tier2PdfBoxCorpusTest | PASS | 2ms |
...
| testPdfBoxCorpus with data set "pdfbox/pdfbox/src/test/resources/input/merge/PDFBOX-5792-240045.pdf" | Tier2PdfBoxCorpusTest | PASS | 2ms |
...
| testPdfBoxCorpus with data set "pdfbox/pdfbox/src/test/resources/org/apache/pdfbox/pdmodel/interactive/form/PDFBOX-3656-SF1199AEG (Complete).pdf" | Tier2PdfBoxCorpusTest | PASS | 2ms |
...
| testPdfBoxCorpus with data set "pdfbox/pdfbox/src/test/resources/org/apache/pdfbox/pdmodel/test_pagelabels.pdf" | Tier2PdfBoxCorpusTest | PASS | 6ms |
...
**6 tests** | 6 passed | 0 failed | 0 skipped | 11.25s
...
| testUntaggedDocumentFailsUa1 | Tier3MatterhornTest | PASS | 1.78s |
| testMissingLangFailsUa1 | Tier3MatterhornTest | PASS | 1.73s |
| testMissingDisplayDocTitleFailsUa1 | Tier3MatterhornTest | PASS | 1.81s |
...
**25 tests** | 24 passed | 0 failed | 1 skipped | 8.36s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWellFormedAndValid | Tier4JhoveTest | PASS | 953ms |
| testMultiPagePdfWellFormedAndValid | Tier4JhoveTest | PASS | 887ms |
| testPdfWithMetadataWellFormedAndValid | Tier4JhoveTest | PASS | 872ms |
| testPdfWithEmbeddedFontWellFormedAndValid | Tier4JhoveTest | PASS | 874ms |
| testJhoveToolchainWorks | Tier4JhoveTest | PASS | 689ms |
| testPdfA1bPassesPdfBoxPreflight | Tier4PdfBoxPreflightTest | SKIP | <1ms |
| testPdfBoxPreflightToolchainWorks | Tier4PdfBoxPreflightTest | PASS | 794ms |
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 556ms |
| testPdfWithMetadataHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 536ms |
| testPdfWithEmbeddedFontHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 515ms |
| testPdfIdToolchainWorks | Tier4PdfIdTest | PASS | 330ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 image with BPC.pdf" | Tier4Pdf20ExamplesTest | PASS | 192ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 with page level output intent.pdf" | Tier4Pdf20ExamplesTest | PASS | 183ms |
| testPdf20ExampleQpdfValid with data set "pdf20/Simple PDF 2.0 file.pdf" | Tier4Pdf20ExamplesTest | PASS | 193ms |
| testPdf20ExampleQpdfValid with data set "pdf20/pdf20-utf8-test.pdf" | Tier4Pdf20ExamplesTest | PASS | 223ms |
