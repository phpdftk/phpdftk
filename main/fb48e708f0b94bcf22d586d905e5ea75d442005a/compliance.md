...
Generated: 2026-06-11 14:40:01 UTC
PHP: 8.4.22
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 91.14s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 33.36s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.3s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 18.57s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 17.94s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 33.36s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 293ms |
| testGeneratesAnnotationsPdf | AnnotationsTest | PASS | 187ms |
| testGeneratesBookmarksPdf | BookmarksTest | PASS | 239ms |
| testGeneratesFormWithCustomFontAppearances | CustomFontFormAppearancesTest | PASS | 247ms |
...
| testGeneratesPdfWithEmbeddedType1 | EmbeddedType1FontTest | PASS | 189ms |
...
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 486ms |
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 604ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 292ms |
...
| testGeneratesMultimediaAnd3DPdf | MultimediaAndThreeDIntegrationTest | PASS | 184ms |
...
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 289ms |
...
| testNoteCalloutEmitsLabelAndBody | CalloutTest | PASS | 198ms |
...
| testPageBreakAfterLastColumnResetsToColumnZero | MultiColumnTest | PASS | 10ms |
...
| testShowPageNumbersDefaultFormat | PageNumbersTest | PASS | 200ms |
...
| testAddTextCreatesFirstPageAutomatically | PdfTest | PASS | 206ms |
| testAddHeadingEmitsLargerText | PdfTest | PASS | 200ms |
...
| testToBytesProducesValidPdfOnEachCall | PdfTest | PASS | 382ms |
...
| testWriterPageDrawTableThrowsWithoutColumnWidths | TableTest | PASS | 9ms |
...
| testAddCompositeFontGeneratesValidPdf | UnicodeFontTest | PASS | 200ms |
...
| testPdfWriterSavesToFile | WriterTest | PASS | 187ms |
...
| testSyncInfoToMetadataNoInfoIsNoOp | XmpMetadataTest | PASS | 198ms |
...
| testSetBookmarks | BookmarkEditorTest | PASS | 209ms |
| testSetBookmarksWithChildren | BookmarkEditorTest | PASS | 213ms |
...
| testUncheckCheckbox | FormFillerTest | PASS | 192ms |
...
| testSaveWritesFile | FormFillerTest | PASS | 202ms |
...
| testSetMetadataOnPdfWithoutInfo | MetadataEditorTest | PASS | 193ms |
...
| testReverse | PageSlicerTest | PASS | 206ms |
| testSplit | PageSlicerTest | PASS | 417ms |
| testKeepWithPageSelector | PageSlicerTest | PASS | 185ms |
| testNoOpsKeepsAllPages | PageSlicerTest | PASS | 205ms |
...
| testSetBleedBox | PageTransformerTest | PASS | 190ms |
...
| testEncryptAes128 | PdfEncryptTest | PASS | 193ms |
...
| testWatermarkWithStyle | PdfStamperTest | PASS | 195ms |
...
| testStampImageWithScaleWidth | PdfStamperTest | PASS | 198ms |
...
| testSaveToFile | TextRedactorTest | PASS | 226ms |
...
| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesBookmarksPdf | BookmarksTest | PASS | 307ms |
...
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 7.13s |
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 17.94s
...
| testQpdfCorpus with data set "qpdf/enc-R2,V1,U=view,O=master.pdf" | Tier2CorpusTest | PASS | 13ms |
...
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 9.55s |
...
| testPdfiumCorpus with data set "pdfium/encrypted.pdf" | Tier2PdfiumCorpusTest | PASS | 4ms |
...
| testPdfiumCorpus with data set "pdfium/encrypted_hello_world_r3.pdf" | Tier2PdfiumCorpusTest | PASS | 4ms |
...
| testAnnotationWithoutContentsFailsUa1 | Tier3MatterhornTest | PASS | 1.97s |
...
| testMultiPagePdfWellFormedAndValid | Tier4JhoveTest | PASS | 891ms |
...
| testJhoveToolchainWorks | Tier4JhoveTest | PASS | 666ms |
...
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 554ms |
