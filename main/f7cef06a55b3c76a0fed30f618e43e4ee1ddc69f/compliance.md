...
Generated: 2026-06-16 19:25:44 UTC
PHP: 8.4.22
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 95.55s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 34.68s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.35s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 21.14s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 18.4s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 11.59s |
| &#x2705; JHOVE + PDF 2.0 + Security + Preflight | PASS | 25 | 24 | 0 | 1 | 8.39s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 34.68s
...
| testGeneratesPdfWithEmbeddedFont | EmbeddedFontsTest | PASS | 201ms |
...
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 495ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 210ms |
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 118ms |
...
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 388ms |
...
| testQrCodeAdapterPlacesA2dMatrix | BarcodeAdapterTest | PASS | 9ms |
...
| testWinAnsiRoundTripFromShowText | EncodingIntegrationTest | PASS | 200ms |
...
| testShowPageNumbersDefaultFormat | PageNumbersTest | PASS | 204ms |
...
| testAddPageDelegatesToWriter | PdfDocTest | PASS | 204ms |
...
| testAlignmentCenterEmitsCenteredText | PdfTest | PASS | 220ms |
| testSetFontSwitchesFontFamily | PdfTest | PASS | 207ms |
| testBoldAndItalicResolveToCorrectPostScriptName | PdfTest | PASS | 212ms |
| testUnknownFamilyIsRejected | PdfTest | PASS | <1ms |
| testCustomTheme | PdfTest | PASS | 199ms |
| testSaveWritesFile | PdfTest | PASS | 207ms |
...
| testWriterPageDrawTableRendersExplicitlyPositionedTable | TableTest | PASS | 9ms |
...
| testPdfWriterGeneratesValidPdfHeader | WriterTest | PASS | 203ms |
...
| testPdfWriterContainsXref | WriterTest | PASS | 204ms |
| testPdfWriterContainsTrailer | WriterTest | PASS | <1ms |
| testPdfWriterAddPageWithRectangle | WriterTest | PASS | 201ms |
...
| testSetBookmarks | BookmarkEditorTest | PASS | 215ms |
| testSetBookmarksWithChildren | BookmarkEditorTest | PASS | 200ms |
| testAddBookmark | BookmarkEditorTest | PASS | 399ms |
...
| testSaveToFile | BookmarkEditorTest | PASS | 201ms |
| testNoBytesChangedWhenNoOperations | BookmarkEditorTest | PASS | <1ms |
| testReplaceExistingBookmarks | BookmarkEditorTest | PASS | 230ms |
...
| testFillTextField | FormFillerTest | PASS | 202ms |
| testFillManyFields | FormFillerTest | PASS | 195ms |
| testCheckCheckbox | FormFillerTest | PASS | 201ms |
| testUncheckCheckbox | FormFillerTest | PASS | 208ms |
| testSelectChoiceField | FormFillerTest | PASS | 198ms |
...
| testRoundTripPreservesOtherFields | FormFillerTest | PASS | 197ms |
...
| testSetMultipleFieldsRoundTrip | MetadataEditorTest | PASS | 206ms |
| testSetMetadataOnPdfWithoutInfo | MetadataEditorTest | PASS | 199ms |
...
| testKeepRange | PageSlicerTest | PASS | 254ms |
| testRemovePages | PageSlicerTest | PASS | 220ms |
| testReorder | PageSlicerTest | PASS | 209ms |
| testReverse | PageSlicerTest | PASS | 218ms |
| testSplit | PageSlicerTest | PASS | 433ms |
| testKeepWithPageSelector | PageSlicerTest | PASS | 214ms |
...
| testRotate180 | PageTransformerTest | PASS | 214ms |
| testRotate270 | PageTransformerTest | PASS | 203ms |
| testRotateSpecificPages | PageTransformerTest | PASS | 205ms |
| testRotateCumulative | PageTransformerTest | PASS | 214ms |
| testRotateInvalidAngle | PageTransformerTest | PASS | 2ms |
| testSetCropBox | PageTransformerTest | PASS | 217ms |
| testSetCropBoxSpecificPage | PageTransformerTest | PASS | 216ms |
| testSetMediaBox | PageTransformerTest | PASS | 221ms |
| testSetTrimBox | PageTransformerTest | PASS | 222ms |
| testSetBleedBox | PageTransformerTest | PASS | 202ms |
| testScale | PageTransformerTest | PASS | 236ms |
| testScaleSpecificPages | PageTransformerTest | PASS | 223ms |
| testScaleInvalidFactor | PageTransformerTest | PASS | <1ms |
| testScaleTo | PageTransformerTest | PASS | 229ms |
| testScaleToNonUniform | PageTransformerTest | PASS | 226ms |
| testMultipleOperations | PageTransformerTest | PASS | 216ms |
| testNoBytesChangedWithoutOperations | PageTransformerTest | PASS | <1ms |
| testEvenPages | PageTransformerTest | PASS | 209ms |
| testOddPages | PageTransformerTest | PASS | 219ms |
| testRange | PageTransformerTest | PASS | 208ms |
| testGetReader | PageTransformerTest | PASS | <1ms |
| testGetPageCount | PageTransformerTest | PASS | <1ms |
| testSaveToFile | PageTransformerTest | PASS | 206ms |
| testEncryptAes128 | PdfEncryptTest | PASS | 201ms |
| testEncryptAes256 | PdfEncryptTest | PASS | 225ms |
| testDecrypt | PdfEncryptTest | PASS | 221ms |
| testIsEncrypted | PdfEncryptTest | PASS | 3ms |
...
| testMergeTwoPdfs | PdfMergerTest | PASS | 216ms |
| testMergeWithPageSelection | PdfMergerTest | PASS | 200ms |
...
| testSaveToFile | PdfMergerTest | PASS | 214ms |
| testStampText | PdfStamperTest | PASS | 208ms |
| testWatermark | PdfStamperTest | PASS | 244ms |
| testWatermarkWithStyle | PdfStamperTest | PASS | 221ms |
| testPageNumbers | PdfStamperTest | PASS | 207ms |
| testStampOnSpecificPages | PdfStamperTest | PASS | 209ms |
| testHeaderAndFooter | PdfStamperTest | PASS | 211ms |
| testStampWithOpacity | PdfStamperTest | PASS | 215ms |
...
| testStampImageJpeg | PdfStamperTest | PASS | 216ms |
| testStampImagePng | PdfStamperTest | PASS | 214ms |
| testStampImageWithScaleWidth | PdfStamperTest | PASS | 212ms |
| testStampImageWithScaleHeight | PdfStamperTest | PASS | 197ms |
| testStampImageWithExplicitDimensions | PdfStamperTest | PASS | 205ms |
| testStampImageWithOpacity | PdfStamperTest | PASS | 219ms |
| testStampImageOnSpecificPages | PdfStamperTest | PASS | 221ms |
...
| testStampPdf | PdfStamperTest | PASS | 203ms |
| testStampPdfWithScaling | PdfStamperTest | PASS | 202ms |
| testStampPdfWithOpacity | PdfStamperTest | PASS | 211ms |
| testStampPdfSpecificPage | PdfStamperTest | PASS | 209ms |
| testStampPdfOnSelectedPages | PdfStamperTest | PASS | 209ms |
| testStampPdfDefaultsToCenter | PdfStamperTest | PASS | 214ms |
...
| testRedactArea | TextRedactorTest | PASS | 205ms |
| testRedactMultipleAreas | TextRedactorTest | PASS | 194ms |
| testRedactByText | TextRedactorTest | PASS | 207ms |
...
| testGeneratesFormPdf | FormFieldsTest | PASS | 201ms |
...
**4 tests** | 3 passed | 0 failed | 1 skipped | 21.14s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWithOutputIntent | PdfAConformanceTest | SKIP | 5ms |
| testVeraPdfToolchainWorks | PdfAConformanceTest | PASS | 2.24s |
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 8.19s |
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 10.7s |
...
| testQpdfCorpus with data set "qpdf/deterministic-id-in.pdf" | Tier2CorpusTest | PASS | 15ms |
...
| testQpdfCorpus with data set "qpdf/rotated-shared-annotations-2.pdf" | Tier2CorpusTest | PASS | 28ms |
...
| testPdfiumCorpus with data set "pdfium/bug_680376.pdf" | Tier2PdfiumCorpusTest | PASS | 7ms |
...
| testMissingDisplayDocTitleFailsUa1 | Tier3MatterhornTest | PASS | 1.91s |
...
**25 tests** | 24 passed | 0 failed | 1 skipped | 8.39s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWellFormedAndValid | Tier4JhoveTest | PASS | 949ms |
| testMultiPagePdfWellFormedAndValid | Tier4JhoveTest | PASS | 904ms |
| testPdfWithMetadataWellFormedAndValid | Tier4JhoveTest | PASS | 870ms |
| testPdfWithEmbeddedFontWellFormedAndValid | Tier4JhoveTest | PASS | 882ms |
...
| testPdfWithEmbeddedFontHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 559ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 image with BPC.pdf" | Tier4Pdf20ExamplesTest | PASS | 202ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 with page level output intent.pdf" | Tier4Pdf20ExamplesTest | PASS | 197ms |
