...
Generated: 2026-06-12 23:16:59 UTC
PHP: 8.4.22
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 89.19s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 31.56s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.26s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 18.69s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 17.89s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 11.65s |
| &#x2705; JHOVE + PDF 2.0 + Security + Preflight | PASS | 25 | 24 | 0 | 1 | 8.14s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 31.56s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 371ms |
| testGeneratesAnnotationsPdf | AnnotationsTest | PASS | 176ms |
| testGeneratesBookmarksPdf | BookmarksTest | PASS | 236ms |
| testGeneratesFormWithCustomFontAppearances | CustomFontFormAppearancesTest | PASS | 211ms |
...
| testGeneratesFormPdf | FormFieldsTest | PASS | 180ms |
| testGeneratesGraphicsPipelinePdf | GraphicsPipelineIntegrationTest | PASS | 179ms |
| testGeneratesGraphicsPdf | GraphicsTest | PASS | 181ms |
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 282ms |
...
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 390ms |
...
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 326ms |
...
| testNoteCalloutEmitsLabelAndBody | CalloutTest | PASS | 178ms |
...
| testBulletListRendersEachItem | ListTest | PASS | 179ms |
...
| testPdfWriterSavesToFile | WriterTest | PASS | 193ms |
...
| testSetMetadataAddsStreamToPdf | XmpMetadataTest | PASS | 176ms |
...
| testFlattenAll | AnnotationFlattenerTest | PASS | 180ms |
...
| testSetBookmarks | BookmarkEditorTest | PASS | 183ms |
...
| testSaveToFile | BookmarkEditorTest | PASS | 183ms |
...
| testSetTitleRoundTrip | MetadataEditorTest | PASS | 181ms |
...
| testNoBytesChangedWhenNoOperations | PageLabelerTest | PASS | 2ms |
...
| testReorder | PageSlicerTest | PASS | 181ms |
...
| testRotateCumulative | PageTransformerTest | PASS | 176ms |
...
| testSetMediaBox | PageTransformerTest | PASS | 171ms |
...
| testScaleSpecificPages | PageTransformerTest | PASS | 178ms |
...
| testMultipleOperations | PageTransformerTest | PASS | 181ms |
...
| testSaveToFile | PageTransformerTest | PASS | 183ms |
...
| testMergeTwoPdfs | PdfMergerTest | PASS | 185ms |
...
| testSaveToFile | PdfMergerTest | PASS | 178ms |
...
| testSaveToFile | PdfStamperTest | PASS | 179ms |
| testStampImageJpeg | PdfStamperTest | PASS | 191ms |
| testStampImagePng | PdfStamperTest | PASS | 179ms |
...
| testStampImageOnSpecificPages | PdfStamperTest | PASS | 179ms |
...
| testStampPdfDefaultsToCenter | PdfStamperTest | PASS | 183ms |
...
| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesBookmarksPdf | BookmarksTest | PASS | 298ms |
...
**4 tests** | 3 passed | 0 failed | 1 skipped | 18.69s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWithOutputIntent | PdfAConformanceTest | SKIP | 5ms |
| testVeraPdfToolchainWorks | PdfAConformanceTest | PASS | 2.13s |
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 6.98s |
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 9.58s |
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 17.89s
...
| testQpdfCorpus with data set "qpdf/direct-pages.pdf" | Tier2CorpusTest | PASS | 11ms |
...
| Test | Class | Status | Time |
|---|---|---|---|
| testTaggedDocumentValidatesWithUa1 | Tier3MatterhornTest | PASS | 2.23s |
...
**25 tests** | 24 passed | 0 failed | 1 skipped | 8.14s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWellFormedAndValid | Tier4JhoveTest | PASS | 937ms |
...
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 530ms |
| testPdfWithMetadataHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 516ms |
| testPdfWithEmbeddedFontHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 520ms |
| testPdfIdToolchainWorks | Tier4PdfIdTest | PASS | 335ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 image with BPC.pdf" | Tier4Pdf20ExamplesTest | PASS | 180ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 with page level output intent.pdf" | Tier4Pdf20ExamplesTest | PASS | 177ms |
