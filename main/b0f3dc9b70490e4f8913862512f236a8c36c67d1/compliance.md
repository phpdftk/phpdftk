...
Generated: 2026-06-10 19:17:56 UTC
PHP: 8.4.21
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 88.8s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 31.63s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.21s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 18.6s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 17.87s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 11.34s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 31.63s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 662ms |
...
| testGeneratesPdfWithEmbeddedType1 | EmbeddedType1FontTest | PASS | 179ms |
...
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 504ms |
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 184ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 144ms |
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 180ms |
| testGeneratesPdfWithMarkupFields | MarkupAnnotationsIntegrationTest | PASS | 179ms |
...
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 411ms |
| testGeneratesSimpleTextPdf | SimpleTextTest | PASS | 187ms |
| testGeneratesPdfWithType3Font | Type3FontIntegrationTest | PASS | 175ms |
...
| testNoteCalloutEmitsLabelAndBody | CalloutTest | PASS | 194ms |
...
| testShowPageNumbersDefaultFormat | PageNumbersTest | PASS | 176ms |
...
| testGeneratesHighLevelDocument | PdfIntegrationTest | PASS | 374ms |
...
| testAddHeadingEmitsLargerText | PdfTest | PASS | 182ms |
| testExplicitNewPageCreatesSecondPage | PdfTest | PASS | 178ms |
...
| testWriteToStream | PdfTest | PASS | 175ms |
| testWriteToRejectsNonResource | PdfTest | PASS | <1ms |
| testToBytesProducesValidPdfOnEachCall | PdfTest | PASS | 368ms |
...
| testUnderlineSpansEveryWrappedLine | TextDecorationTest | PASS | 7ms |
...
| testAddCompositeFontSavesToFile | UnicodeFontTest | PASS | 181ms |
...
| testPdfWriterGeneratesValidPdfHeader | WriterTest | PASS | 180ms |
...
| testPdfWriterContainsPage | WriterTest | PASS | 173ms |
...
| testPdfWriterContainsXref | WriterTest | PASS | 179ms |
| testPdfWriterContainsTrailer | WriterTest | PASS | <1ms |
| testPdfWriterAddPageWithRectangle | WriterTest | PASS | 175ms |
| testPdfWriterRegisterObject | WriterTest | PASS | 178ms |
| testPdfWriterFontAddedToPage | WriterTest | PASS | 190ms |
| testSetNamedDestinations | WriterTest | PASS | 180ms |
...
| testAddBookmark | BookmarkEditorTest | PASS | 361ms |
...
| testFillTextField | FormFillerTest | PASS | 181ms |
| testFillManyFields | FormFillerTest | PASS | 184ms |
| testCheckCheckbox | FormFillerTest | PASS | 177ms |
...
| testSetLabelsWithPrefix | PageLabelerTest | PASS | 183ms |
...
| testKeepPages | PageSlicerTest | PASS | 179ms |
...
| testSetMediaBox | PageTransformerTest | PASS | 173ms |
...
| testSaveToFile | PageTransformerTest | PASS | 174ms |
...
| testEncryptRc4128 | PdfEncryptTest | PASS | 6ms |
...
| testStampText | PdfStamperTest | PASS | 176ms |
...
| testStampImageJpeg | PdfStamperTest | PASS | 202ms |
| testStampImagePng | PdfStamperTest | PASS | 183ms |
| testStampImageWithScaleWidth | PdfStamperTest | PASS | 183ms |
| testStampImageWithScaleHeight | PdfStamperTest | PASS | 176ms |
...
| testRedactByPattern | TextRedactorTest | PASS | 3ms |
...
**6 tests** | 6 passed | 0 failed | 0 skipped | 1.21s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesBookmarksPdf | BookmarksTest | PASS | 287ms |
| testGeneratesDocumentFeaturesPdf | DocumentFeaturesTest | PASS | 175ms |
| testGeneratesPdfWithEmbeddedTrueTypeFont | DocumentFeaturesTest | PASS | 190ms |
| testGeneratesFormPdf | FormFieldsTest | PASS | 177ms |
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 17.87s
...
| testQpdfCorpus with data set "qpdf/enc-base.pdf" | Tier2CorpusTest | PASS | 9ms |
...
| testQpdfCorpus with data set "qpdf/many-nulls.pdf" | Tier2CorpusTest | PASS | 706ms |
...
| testQpdfCorpus with data set "qpdf/shared-form-xobject-split-1.pdf" | Tier2CorpusTest | PASS | 24ms |
...
| testPdfiumCorpus with data set "pdfium/combobox_form.pdf" | Tier2PdfiumCorpusTest | PASS | 5ms |
...
**6 tests** | 6 passed | 0 failed | 0 skipped | 11.34s

| Test | Class | Status | Time |
|---|---|---|---|
| testTaggedDocumentValidatesWithUa1 | Tier3MatterhornTest | PASS | 2.25s |
| testAnnotationWithContentsPassesClause718 | Tier3MatterhornTest | PASS | 2.1s |
| testUntaggedDocumentFailsUa1 | Tier3MatterhornTest | PASS | 1.69s |
...
| testPdfWithEmbeddedFontHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 510ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/pdf20-utf8-test.pdf" | Tier4Pdf20ExamplesTest | PASS | 177ms |
