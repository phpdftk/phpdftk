...
Generated: 2026-06-11 04:15:09 UTC
PHP: 8.4.21
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 81.11s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 27.63s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.07s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 17.77s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 16.85s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 10.53s |
| &#x2705; JHOVE + PDF 2.0 + Security + Preflight | PASS | 25 | 24 | 0 | 1 | 7.25s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 27.63s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 250ms |
| testGeneratesAnnotationsPdf | AnnotationsTest | PASS | 168ms |
| testGeneratesBookmarksPdf | BookmarksTest | PASS | 201ms |
| testGeneratesFormWithCustomFontAppearances | CustomFontFormAppearancesTest | PASS | 205ms |
...
| testGeneratesExtGStatePdf | ExtGStateIntegrationTest | PASS | 150ms |
...
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 465ms |
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 174ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 360ms |
...
| testGeneratesMultiPageComplexPdf | MultiPageComplexTest | PASS | 177ms |
...
| testGeneratesSignatureFieldPdf | SignatureFieldIntegrationTest | PASS | 161ms |
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 273ms |
...
| testBulletListRendersEachItem | ListTest | PASS | 170ms |
...
| testAddPageDelegatesToWriter | PdfDocTest | PASS | 162ms |
...
| testGeneratesHighLevelDocument | PdfIntegrationTest | PASS | 332ms |
...
| testAddHeadingEmitsLargerText | PdfTest | PASS | 156ms |
| testExplicitNewPageCreatesSecondPage | PdfTest | PASS | 168ms |
| testLongTextAutoPaginates | PdfTest | PASS | 164ms |
| testAddSpacerConsumesVerticalSpace | PdfTest | PASS | 156ms |
| testAddRuleDrawsStroke | PdfTest | PASS | 160ms |
| testAlignmentCenterEmitsCenteredText | PdfTest | PASS | 160ms |
| testSetFontSwitchesFontFamily | PdfTest | PASS | 161ms |
...
| testAddTableRendersAllCellValues | TableTest | PASS | 166ms |
...
| testUnderlineEmitsStrokeBelowBaseline | TextDecorationTest | PASS | 164ms |
...
| testAddCompositeFontGeneratesValidPdf | UnicodeFontTest | PASS | 164ms |
...
| testPdfWriterAddContentStream | WriterTest | PASS | 159ms |
...
| testPdfWriterContainsXref | WriterTest | PASS | 165ms |
| testPdfWriterContainsTrailer | WriterTest | PASS | <1ms |
| testPdfWriterAddPageWithRectangle | WriterTest | PASS | 159ms |
| testPdfWriterRegisterObject | WriterTest | PASS | 159ms |
| testPdfWriterFontAddedToPage | WriterTest | PASS | 154ms |
| testSetNamedDestinations | WriterTest | PASS | 158ms |
| testSetEncryptionProducesEncryptedPdf | WriterTest | PASS | 164ms |
| testSetEncryptionAes256RoundTrip | WriterTest | PASS | 214ms |
| testSetMetadataAddsStreamToPdf | XmpMetadataTest | PASS | 164ms |
...
| testFlattenAll | AnnotationFlattenerTest | PASS | 162ms |
...
| testSaveToFile | AnnotationFlattenerTest | PASS | 159ms |
...
| testSetBookmarksWithChildren | BookmarkEditorTest | PASS | 150ms |
| testAddBookmark | BookmarkEditorTest | PASS | 315ms |
...
| testFillTextField | FormFillerTest | PASS | 164ms |
| testFillManyFields | FormFillerTest | PASS | 160ms |
| testCheckCheckbox | FormFillerTest | PASS | 163ms |
...
| testRoundTripPreservesOtherFields | FormFillerTest | PASS | 169ms |
...
| testCustomField | MetadataEditorTest | PASS | 168ms |
| testSaveToFile | MetadataEditorTest | PASS | 164ms |
...
| testMultipleRanges | PageLabelerTest | PASS | 160ms |
...
| testKeepRange | PageSlicerTest | PASS | 166ms |
...
| testRotateAllPages | PageTransformerTest | PASS | 169ms |
| testRotate180 | PageTransformerTest | PASS | 159ms |
| testRotate270 | PageTransformerTest | PASS | 156ms |
| testRotateSpecificPages | PageTransformerTest | PASS | 161ms |
| testRotateCumulative | PageTransformerTest | PASS | 165ms |
...
| testSetBleedBox | PageTransformerTest | PASS | 163ms |
| testScale | PageTransformerTest | PASS | 161ms |
| testScaleSpecificPages | PageTransformerTest | PASS | 162ms |
| testScaleInvalidFactor | PageTransformerTest | PASS | <1ms |
| testScaleTo | PageTransformerTest | PASS | 160ms |
...
| testRange | PageTransformerTest | PASS | 167ms |
...
| testChangePasswordsDefaultsToAes256 | PdfEncryptTest | PASS | 8ms |
...
| testMergeWithPageSelection | PdfMergerTest | PASS | 158ms |
...
| testSaveToFile | PdfMergerTest | PASS | 159ms |
...
| testStampOnSpecificPages | PdfStamperTest | PASS | 169ms |
| testHeaderAndFooter | PdfStamperTest | PASS | 158ms |
...
| testSaveToFile | PdfStamperTest | PASS | 151ms |
| testStampImageJpeg | PdfStamperTest | PASS | 180ms |
...
| testStampPdf | PdfStamperTest | PASS | 161ms |
| testStampPdfWithScaling | PdfStamperTest | PASS | 164ms |
| testStampPdfWithOpacity | PdfStamperTest | PASS | 162ms |
| testStampPdfSpecificPage | PdfStamperTest | PASS | 166ms |
| testStampPdfOnSelectedPages | PdfStamperTest | PASS | 155ms |
| testStampPdfDefaultsToCenter | PdfStamperTest | PASS | 153ms |
...
| testRedactArea | TextRedactorTest | PASS | 163ms |
| testRedactMultipleAreas | TextRedactorTest | PASS | 158ms |
...
| testGeneratesMultiPageComplexPdf | MultiPageComplexTest | PASS | 170ms |
| testGeneratesSimpleTextPdf | SimpleTextTest | PASS | 161ms |

### veraPDF — PDF/A archival conformance (ISO 19005)

**4 tests** | 3 passed | 0 failed | 1 skipped | 17.77s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWithOutputIntent | PdfAConformanceTest | SKIP | 4ms |
| testVeraPdfToolchainWorks | PdfAConformanceTest | PASS | 1.95s |
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 6.72s |
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 9.09s |
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 16.85s
...
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 8.67s |
...
**6 tests** | 6 passed | 0 failed | 0 skipped | 10.53s

| Test | Class | Status | Time |
|---|---|---|---|
| testTaggedDocumentValidatesWithUa1 | Tier3MatterhornTest | PASS | 1.96s |
| testAnnotationWithContentsPassesClause718 | Tier3MatterhornTest | PASS | 1.91s |
| testUntaggedDocumentFailsUa1 | Tier3MatterhornTest | PASS | 1.67s |
| testMissingLangFailsUa1 | Tier3MatterhornTest | PASS | 1.66s |
| testMissingDisplayDocTitleFailsUa1 | Tier3MatterhornTest | PASS | 1.67s |
| testAnnotationWithoutContentsFailsUa1 | Tier3MatterhornTest | PASS | 1.66s |
...
**25 tests** | 24 passed | 0 failed | 1 skipped | 7.25s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWellFormedAndValid | Tier4JhoveTest | PASS | 847ms |
| testMultiPagePdfWellFormedAndValid | Tier4JhoveTest | PASS | 793ms |
| testPdfWithMetadataWellFormedAndValid | Tier4JhoveTest | PASS | 772ms |
| testPdfWithEmbeddedFontWellFormedAndValid | Tier4JhoveTest | PASS | 770ms |
| testJhoveToolchainWorks | Tier4JhoveTest | PASS | 608ms |
...
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 453ms |
| testPdfWithMetadataHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 445ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 image with BPC.pdf" | Tier4Pdf20ExamplesTest | PASS | 154ms |
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 via incremental save.pdf" | Tier4Pdf20ExamplesTest | PASS | 159ms |
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 with offset start.pdf" | Tier4Pdf20ExamplesTest | PASS | 159ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/Simple PDF 2.0 file.pdf" | Tier4Pdf20ExamplesTest | PASS | 163ms |
| testPdf20ExampleQpdfValid with data set "pdf20/pdf20-utf8-test.pdf" | Tier4Pdf20ExamplesTest | PASS | 168ms |
