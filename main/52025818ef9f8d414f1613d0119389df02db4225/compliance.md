...
Generated: 2026-05-24 23:17:01 UTC
PHP: 8.4.21
...
**Overall: PASS** | 1662 tests | 1656 passed | 0 failed | 6 skipped | 87.82s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 454 | 450 | 0 | 4 | 32.55s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.24s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 17.66s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 16.98s |
...
**454 tests** | 450 passed | 0 failed | 4 skipped | 32.55s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 602ms |
...
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 550ms |
...
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 429ms |
...
| testMetadataRoundTrip | XmpMetadataTest | PASS | 204ms |
...
| testRemoveLabels | PageLabelerTest | PASS | 215ms |
...
| testRotateSpecificPages | PageTransformerTest | PASS | 181ms |
...
**4 tests** | 3 passed | 0 failed | 1 skipped | 17.66s
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 16.98s
...
| testQpdfCorpus with data set "qpdf/many-nulls.pdf" | Tier2CorpusTest | PASS | 735ms |
...
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 6.64s |
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 8.73s |
...
| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWellFormedAndValid | Tier4JhoveTest | PASS | 911ms |
...
| testPdfWithEmbeddedFontWellFormedAndValid | Tier4JhoveTest | PASS | 848ms |
...
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 774ms |
