...
Generated: 2026-06-29 12:54:57 UTC
PHP: 8.4.22
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 90.28s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 32.42s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.26s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 18.24s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 17.83s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 32.42s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 374ms |
...
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 680ms |
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 136ms |
...
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 291ms |
...
| testSetMultipleFieldsRoundTrip | MetadataEditorTest | PASS | 178ms |
...
**4 tests** | 3 passed | 0 failed | 1 skipped | 18.24s
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 17.83s
...
| testQpdfCorpus with data set "qpdf/comment-annotation-out.pdf" | Tier2CorpusTest | PASS | 11ms |
...
| testQpdfCorpus with data set "qpdf/many-nulls.pdf" | Tier2CorpusTest | PASS | 710ms |
...
| testQpdfCorpus with data set "qpdf/remove-labels.pdf" | Tier2CorpusTest | PASS | 24ms |
...
| testPdfiumCorpus with data set "pdfium/bug_1333298.pdf" | Tier2PdfiumCorpusTest | PASS | 5ms |
...
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 800ms |
