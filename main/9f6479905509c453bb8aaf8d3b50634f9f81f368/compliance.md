...
Generated: 2026-06-11 01:10:22 UTC
PHP: 8.4.21
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 90.05s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 32.74s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.26s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 18.5s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 18.07s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 11.27s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 32.74s
...
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 183ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 202ms |
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 534ms |
...
| testGeneratesPdfWithXrefAndObjectStreams | XRefStreamIntegrationTest | PASS | 201ms |
...
| testBulletListRendersEachItem | ListTest | PASS | 191ms |
...
| testAddTableRendersAllCellValues | TableTest | PASS | 212ms |
...
| testAddTableAutoPaginatesAndRepeatsHeader | TableTest | PASS | 5ms |
...
| testSetEncryptionAes256RoundTrip | WriterTest | PASS | 238ms |
...
| testSyncInfoToMetadata | XmpMetadataTest | PASS | 178ms |
...
| testSelectChoiceField | FormFillerTest | PASS | 202ms |
...
| testKeepRange | PageSlicerTest | PASS | 199ms |
| testRemovePages | PageSlicerTest | PASS | 205ms |
...
| testSaveToFile | PdfMergerTest | PASS | 182ms |
...
| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesBookmarksPdf | BookmarksTest | PASS | 299ms |
...
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 6.5s |
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 9.9s |
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 18.07s
...
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 9.56s |
...
**6 tests** | 6 passed | 0 failed | 0 skipped | 11.27s
...
| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWellFormedAndValid | Tier4JhoveTest | PASS | 955ms |
...
| testJhoveToolchainWorks | Tier4JhoveTest | PASS | 654ms |
