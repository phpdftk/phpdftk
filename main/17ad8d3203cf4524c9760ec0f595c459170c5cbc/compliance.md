...
Generated: 2026-05-24 21:34:41 UTC
PHP: 8.4.21
...
**Overall: PASS** | 1662 tests | 1656 passed | 0 failed | 6 skipped | 83.31s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 454 | 450 | 0 | 4 | 27.43s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.06s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 18.47s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 18.36s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 10.67s |
| &#x2705; JHOVE + PDF 2.0 + Security + Preflight | PASS | 25 | 24 | 0 | 1 | 7.32s |
...
**454 tests** | 450 passed | 0 failed | 4 skipped | 27.43s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 322ms |
| testGeneratesAnnotationsPdf | AnnotationsTest | PASS | 167ms |
| testGeneratesBookmarksPdf | BookmarksTest | PASS | 206ms |
...
| testGeneratesPdfWithEmbeddedType1 | EmbeddedType1FontTest | PASS | 161ms |
...
| testGeneratesFormWithAppearances | FormAppearancesIntegrationTest | PASS | 155ms |
| testGeneratesFormPdf | FormFieldsTest | PASS | 166ms |
...
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 155ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 140ms |
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 137ms |
| testGeneratesPdfWithMarkupFields | MarkupAnnotationsIntegrationTest | PASS | 153ms |
...
| testGeneratesSignatureFieldPdf | SignatureFieldIntegrationTest | PASS | 157ms |
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 604ms |
| testGeneratesSimpleTextPdf | SimpleTextTest | PASS | 155ms |
...
| testEnableOutlineThenHeadingRegistersOutlinesEntry | AutoOutlineTest | PASS | 170ms |
...
| testAddPageDelegatesToWriter | PdfDocTest | PASS | 156ms |
...
| testGeneratesHighLevelDocument | PdfIntegrationTest | PASS | 320ms |
...
| testLongTextAutoPaginates | PdfTest | PASS | 156ms |
| testAddSpacerConsumesVerticalSpace | PdfTest | PASS | 150ms |
| testAddRuleDrawsStroke | PdfTest | PASS | 149ms |
...
| testAddTableRendersAllCellValues | TableTest | PASS | 154ms |
...
| testCompositeFontRoundTripsThroughReader | UnicodeFontTest | PASS | 161ms |
...
| testPdfWriterContainsPage | WriterTest | PASS | 181ms |
...
| testPdfWriterSavesToFile | WriterTest | PASS | 152ms |
| testPdfWriterContainsXref | WriterTest | PASS | 154ms |
| testPdfWriterContainsTrailer | WriterTest | PASS | <1ms |
| testPdfWriterAddPageWithRectangle | WriterTest | PASS | 156ms |
| testPdfWriterRegisterObject | WriterTest | PASS | 155ms |
| testPdfWriterFontAddedToPage | WriterTest | PASS | 165ms |
| testSetNamedDestinations | WriterTest | PASS | 159ms |
| testSetEncryptionProducesEncryptedPdf | WriterTest | PASS | 159ms |
| testSetEncryptionAes256RoundTrip | WriterTest | PASS | 184ms |
| testSetMetadataAddsStreamToPdf | XmpMetadataTest | PASS | 155ms |
| testMetadataStreamContainsXmp | XmpMetadataTest | PASS | 164ms |
...
| testFlattenAll | AnnotationFlattenerTest | PASS | 155ms |
...
| testSetBookmarks | BookmarkEditorTest | PASS | 167ms |
| testSetBookmarksWithChildren | BookmarkEditorTest | PASS | 159ms |
| testAddBookmark | BookmarkEditorTest | PASS | 320ms |
| testHasBookmarksReturnsFalseForCleanPdf | BookmarkEditorTest | PASS | <1ms |
| testRemoveBookmarks | BookmarkEditorTest | PASS | 159ms |
...
| testCheckCheckbox | FormFillerTest | PASS | 159ms |
| testUncheckCheckbox | FormFillerTest | PASS | 163ms |
| testSelectChoiceField | FormFillerTest | PASS | 161ms |
...
| testSetTitleRoundTrip | MetadataEditorTest | PASS | 169ms |
| testSetMultipleFieldsRoundTrip | MetadataEditorTest | PASS | 163ms |
| testSetMetadataOnPdfWithoutInfo | MetadataEditorTest | PASS | 155ms |
...
| testCustomField | MetadataEditorTest | PASS | 161ms |
...
| testSaveToFile | PageLabelerTest | PASS | 161ms |
...
| testRemovePages | PageSlicerTest | PASS | 160ms |
| testReorder | PageSlicerTest | PASS | 163ms |
| testReverse | PageSlicerTest | PASS | 156ms |
| testSplit | PageSlicerTest | PASS | 317ms |
| testKeepWithPageSelector | PageSlicerTest | PASS | 160ms |
...
| testRotateAllPages | PageTransformerTest | PASS | 165ms |
| testRotate180 | PageTransformerTest | PASS | 152ms |
| testRotate270 | PageTransformerTest | PASS | 157ms |
| testRotateSpecificPages | PageTransformerTest | PASS | 159ms |
...
| testSetTrimBox | PageTransformerTest | PASS | 158ms |
...
| testMultipleOperations | PageTransformerTest | PASS | 164ms |
...
| testEncryptAes128 | PdfEncryptTest | PASS | 154ms |
...
| testMergeTwoPdfs | PdfMergerTest | PASS | 166ms |
| testMergeWithPageSelection | PdfMergerTest | PASS | 159ms |
...
| testSaveToFile | PdfMergerTest | PASS | 158ms |
| testStampText | PdfStamperTest | PASS | 163ms |
| testWatermark | PdfStamperTest | PASS | 162ms |
| testWatermarkWithStyle | PdfStamperTest | PASS | 153ms |
| testPageNumbers | PdfStamperTest | PASS | 159ms |
| testStampOnSpecificPages | PdfStamperTest | PASS | 157ms |
| testHeaderAndFooter | PdfStamperTest | PASS | 161ms |
| testStampWithOpacity | PdfStamperTest | PASS | 164ms |
...
| testSaveToFile | PdfStamperTest | PASS | 172ms |
| testStampImageJpeg | PdfStamperTest | PASS | 164ms |
| testStampImagePng | PdfStamperTest | PASS | 153ms |
| testStampImageWithScaleWidth | PdfStamperTest | PASS | 159ms |
| testStampImageWithScaleHeight | PdfStamperTest | PASS | 159ms |
...
| testStampPdfWithOpacity | PdfStamperTest | PASS | 156ms |
| testStampPdfSpecificPage | PdfStamperTest | PASS | 158ms |
| testStampPdfOnSelectedPages | PdfStamperTest | PASS | 153ms |
...
| testSaveToFile | TextRedactorTest | PASS | 163ms |

### Arlington PDF Model — Dictionary-level spec conformance (keys, types, required fields, version constraints)

**6 tests** | 6 passed | 0 failed | 0 skipped | 1.06s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesBookmarksPdf | BookmarksTest | PASS | 265ms |
| testGeneratesDocumentFeaturesPdf | DocumentFeaturesTest | PASS | 165ms |
...
**4 tests** | 3 passed | 0 failed | 1 skipped | 18.47s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWithOutputIntent | PdfAConformanceTest | SKIP | 4ms |
| testVeraPdfToolchainWorks | PdfAConformanceTest | PASS | 1.8s |
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 7.28s |
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 9.38s |
...
| testPopplerCorpus with data set "poppler-test/unittestcases/orientation.pdf" | Tier2CorpusTest | PASS | 2ms |
...
| testQpdfCorpus with data set "qpdf/enc-XI-attachments-base.pdf" | Tier2CorpusTest | PASS | 7ms |
...
| testQpdfCorpus with data set "qpdf/outlines-with-actions.pdf" | Tier2CorpusTest | PASS | 25ms |
...
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 9.79s |
...
| testPdfBoxCorpus with data set "pdfbox/pdfbox/src/test/resources/input/eu-001.pdf" | Tier2PdfBoxCorpusTest | PASS | 4ms |
...
| Test | Class | Status | Time |
|---|---|---|---|
| testTaggedDocumentValidatesWithUa1 | Tier3MatterhornTest | PASS | 2.06s |
| testAnnotationWithContentsPassesClause718 | Tier3MatterhornTest | PASS | 1.92s |
| testUntaggedDocumentFailsUa1 | Tier3MatterhornTest | PASS | 1.66s |
...
**25 tests** | 24 passed | 0 failed | 1 skipped | 7.32s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWellFormedAndValid | Tier4JhoveTest | PASS | 879ms |
| testMultiPagePdfWellFormedAndValid | Tier4JhoveTest | PASS | 807ms |
| testPdfWithMetadataWellFormedAndValid | Tier4JhoveTest | PASS | 758ms |
| testPdfWithEmbeddedFontWellFormedAndValid | Tier4JhoveTest | PASS | 766ms |
| testJhoveToolchainWorks | Tier4JhoveTest | PASS | 591ms |
...
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 581ms |
| testPdfWithMetadataHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 430ms |
| testPdfWithEmbeddedFontHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 451ms |
| testPdfIdToolchainWorks | Tier4PdfIdTest | PASS | 294ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/pdf20-utf8-test.pdf" | Tier4Pdf20ExamplesTest | PASS | 157ms |
