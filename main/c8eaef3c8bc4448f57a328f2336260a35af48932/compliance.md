...
Generated: 2026-05-24 23:11:09 UTC
PHP: 8.4.21
...
**Overall: PASS** | 1662 tests | 1656 passed | 0 failed | 6 skipped | 98.26s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 454 | 450 | 0 | 4 | 34.52s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.27s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 21.02s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 20.88s |
...
**454 tests** | 450 passed | 0 failed | 4 skipped | 34.52s
...
| testGeneratesDocumentFeaturesPdf | DocumentFeaturesTest | PASS | 206ms |
...
| testGeneratesExtGStatePdf | ExtGStateIntegrationTest | PASS | 243ms |
...
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 378ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 526ms |
...
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 437ms |
...
| testEnableOutlineThenHeadingRegistersOutlinesEntry | AutoOutlineTest | PASS | 208ms |
...
| testNoteCalloutEmitsLabelAndBody | CalloutTest | PASS | 206ms |
...
| testGeneratesHighLevelDocument | PdfIntegrationTest | PASS | 417ms |
...
| testAddRuleDrawsStroke | PdfTest | PASS | 204ms |
| testAlignmentCenterEmitsCenteredText | PdfTest | PASS | 205ms |
...
| testToBytesProducesValidPdfOnEachCall | PdfTest | PASS | 400ms |
...
| testSetEncryptionAes256RoundTrip | WriterTest | PASS | 265ms |
...
| testSaveToFile | AnnotationFlattenerTest | PASS | 208ms |
...
| testRemoveBookmarks | BookmarkEditorTest | PASS | 201ms |
...
| testUncheckCheckbox | FormFillerTest | PASS | 196ms |
| testSelectChoiceField | FormFillerTest | PASS | 196ms |
| testFillMultipleFieldTypes | FormFillerTest | PASS | 195ms |
...
| testMultipleRanges | PageLabelerTest | PASS | 206ms |
...
| testSplit | PageSlicerTest | PASS | 392ms |
...
| testRotate180 | PageTransformerTest | PASS | 197ms |
| testRotate270 | PageTransformerTest | PASS | 212ms |
...
| testSetMediaBox | PageTransformerTest | PASS | 204ms |
...
| testScaleToNonUniform | PageTransformerTest | PASS | 199ms |
...
| testStampImageJpeg | PdfStamperTest | PASS | 336ms |
| testStampImagePng | PdfStamperTest | PASS | 201ms |
...
| testStampPdf | PdfStamperTest | PASS | 219ms |
| testStampPdfWithScaling | PdfStamperTest | PASS | 224ms |
| testStampPdfWithOpacity | PdfStamperTest | PASS | 217ms |
| testStampPdfSpecificPage | PdfStamperTest | PASS | 220ms |
...
| testRedactMultipleAreas | TextRedactorTest | PASS | 196ms |
| testRedactByText | TextRedactorTest | PASS | 215ms |
...
| testSaveToFile | TextRedactorTest | PASS | 244ms |
...
**4 tests** | 3 passed | 0 failed | 1 skipped | 21.02s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWithOutputIntent | PdfAConformanceTest | SKIP | 5ms |
| testVeraPdfToolchainWorks | PdfAConformanceTest | PASS | 2.03s |
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 8.15s |
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 10.84s |
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 20.88s
...
| testQpdfCorpus with data set "qpdf/enc-R2,V1.pdf" | Tier2CorpusTest | PASS | 9ms |
...
| testQpdfCorpus with data set "qpdf/many-nulls.pdf" | Tier2CorpusTest | PASS | 721ms |
...
| testQpdfCorpus with data set "qpdf/object-types-os.pdf" | Tier2CorpusTest | PASS | 27ms |
...
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 8.14s |
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 11.12s |
...
| testMultiPagePdfWellFormedAndValid | Tier4JhoveTest | PASS | 944ms |
| testPdfWithMetadataWellFormedAndValid | Tier4JhoveTest | PASS | 900ms |
...
| testPdfBoxPreflightToolchainWorks | Tier4PdfBoxPreflightTest | PASS | 838ms |
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 614ms |
| testPdfWithMetadataHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 551ms |
| testPdfWithEmbeddedFontHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 577ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 with page level output intent.pdf" | Tier4Pdf20ExamplesTest | PASS | 201ms |
