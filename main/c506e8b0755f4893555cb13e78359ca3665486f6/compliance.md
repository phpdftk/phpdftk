...
Generated: 2026-06-10 02:05:12 UTC
PHP: 8.4.21
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 87.07s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 32s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.26s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 17.3s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 17.04s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 11.21s |
| &#x2705; JHOVE + PDF 2.0 + Security + Preflight | PASS | 25 | 24 | 0 | 1 | 8.26s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 32s
...
| testGeneratesExtGStatePdf | ExtGStateIntegrationTest | PASS | 181ms |
...
| testGeneratesGraphicsPdf | GraphicsTest | PASS | 180ms |
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 551ms |
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 294ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 211ms |
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 177ms |
...
| testGeneratesPdfWithXrefAndObjectStreams | XRefStreamIntegrationTest | PASS | 185ms |
...
| testStyleOverridesBarAndBackgroundColors | CalloutTest | PASS | 6ms |
...
| testWinAnsiRoundTripFromShowText | EncodingIntegrationTest | PASS | 191ms |
...
| testShowPageNumbersDefaultFormat | PageNumbersTest | PASS | 188ms |
...
| testEmptyDocumentHasNoPages | PdfTest | PASS | 178ms |
...
| testAddRuleDrawsStroke | PdfTest | PASS | 180ms |
| testAlignmentCenterEmitsCenteredText | PdfTest | PASS | 182ms |
| testSetFontSwitchesFontFamily | PdfTest | PASS | 184ms |
...
| testSaveWritesFile | PdfTest | PASS | 187ms |
| testWriteToStream | PdfTest | PASS | 173ms |
| testWriteToRejectsNonResource | PdfTest | PASS | <1ms |
| testToBytesProducesValidPdfOnEachCall | PdfTest | PASS | 359ms |
...
| testAddCompositeFontGeneratesValidPdf | UnicodeFontTest | PASS | 196ms |
| testAddCompositeFontSavesToFile | UnicodeFontTest | PASS | 187ms |
...
| testPdfWriterContainsXref | WriterTest | PASS | 187ms |
...
| testSetBookmarks | BookmarkEditorTest | PASS | 184ms |
| testSetBookmarksWithChildren | BookmarkEditorTest | PASS | 185ms |
| testAddBookmark | BookmarkEditorTest | PASS | 378ms |
...
| testReplaceExistingBookmarks | BookmarkEditorTest | PASS | 186ms |
...
| testFillTextField | FormFillerTest | PASS | 189ms |
| testFillManyFields | FormFillerTest | PASS | 187ms |
| testCheckCheckbox | FormFillerTest | PASS | 180ms |
| testUncheckCheckbox | FormFillerTest | PASS | 203ms |
| testSelectChoiceField | FormFillerTest | PASS | 180ms |
...
| testSetTitleRoundTrip | MetadataEditorTest | PASS | 187ms |
| testSetMultipleFieldsRoundTrip | MetadataEditorTest | PASS | 184ms |
| testSetMetadataOnPdfWithoutInfo | MetadataEditorTest | PASS | 194ms |
...
| testCustomField | MetadataEditorTest | PASS | 184ms |
...
| testRemoveLabels | PageLabelerTest | PASS | 192ms |
...
| testKeepPages | PageSlicerTest | PASS | 182ms |
| testKeepRange | PageSlicerTest | PASS | 186ms |
| testRemovePages | PageSlicerTest | PASS | 192ms |
| testReorder | PageSlicerTest | PASS | 184ms |
| testReverse | PageSlicerTest | PASS | 184ms |
| testSplit | PageSlicerTest | PASS | 366ms |
| testKeepWithPageSelector | PageSlicerTest | PASS | 184ms |
...
| testRotate180 | PageTransformerTest | PASS | 181ms |
...
| testSetCropBoxSpecificPage | PageTransformerTest | PASS | 189ms |
| testSetMediaBox | PageTransformerTest | PASS | 190ms |
| testSetTrimBox | PageTransformerTest | PASS | 181ms |
| testSetBleedBox | PageTransformerTest | PASS | 181ms |
| testScale | PageTransformerTest | PASS | 198ms |
...
| testMultipleOperations | PageTransformerTest | PASS | 185ms |
...
| testDecrypt | PdfEncryptTest | PASS | 183ms |
...
| testChangePasswordsDefaultsToAes256 | PdfEncryptTest | PASS | 10ms |
...
| testMergeTwoPdfs | PdfMergerTest | PASS | 180ms |
...
| testPageNumbers | PdfStamperTest | PASS | 180ms |
...
| testStampImageWithOpacity | PdfStamperTest | PASS | 180ms |
| testStampImageOnSpecificPages | PdfStamperTest | PASS | 185ms |
| testStampImageCombinedWithText | PdfStamperTest | PASS | 187ms |
...
| testRedactMultipleAreas | TextRedactorTest | PASS | 181ms |
| testRedactByText | TextRedactorTest | PASS | 181ms |
...
| testSaveToFile | TextRedactorTest | PASS | 180ms |
...
| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesBookmarksPdf | BookmarksTest | PASS | 319ms |
...
**4 tests** | 3 passed | 0 failed | 1 skipped | 17.3s
...
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 8.84s |
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 17.04s
...
| testPopplerCorpus with data set "poppler-test/unittestcases/xr02.pdf" | Tier2CorpusTest | PASS | 7ms |
...
| testQpdfCorpus with data set "qpdf/inline-images-ii-all.pdf" | Tier2CorpusTest | PASS | 23ms |
...
| testQpdfCorpus with data set "qpdf/many-nulls.pdf" | Tier2CorpusTest | PASS | 697ms |
...
| testQpdfCorpus with data set "qpdf/page-with-no-resources.pdf" | Tier2CorpusTest | PASS | 24ms |
...
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 6.64s |
...
| testPdfBoxCorpus with data set "pdfbox/pdfbox/src/test/resources/input/rendering/survey.pdf" | Tier2PdfBoxCorpusTest | PASS | 3ms |
...
| testPdfiumCorpus with data set "pdfium/feature_linearized_loading.pdf" | Tier2PdfiumCorpusTest | PASS | 3ms |
...
**6 tests** | 6 passed | 0 failed | 0 skipped | 11.21s

| Test | Class | Status | Time |
|---|---|---|---|
| testTaggedDocumentValidatesWithUa1 | Tier3MatterhornTest | PASS | 2.09s |
| testAnnotationWithContentsPassesClause718 | Tier3MatterhornTest | PASS | 2.02s |
...
| testAnnotationWithoutContentsFailsUa1 | Tier3MatterhornTest | PASS | 1.72s |
...
**25 tests** | 24 passed | 0 failed | 1 skipped | 8.26s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWellFormedAndValid | Tier4JhoveTest | PASS | 934ms |
| testMultiPagePdfWellFormedAndValid | Tier4JhoveTest | PASS | 892ms |
| testPdfWithMetadataWellFormedAndValid | Tier4JhoveTest | PASS | 864ms |
...
| testPdfBoxPreflightToolchainWorks | Tier4PdfBoxPreflightTest | PASS | 765ms |
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 575ms |
| testPdfWithMetadataHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 535ms |
| testPdfWithEmbeddedFontHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 525ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/pdf20-utf8-test.pdf" | Tier4Pdf20ExamplesTest | PASS | 181ms |
