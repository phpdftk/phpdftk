...
Generated: 2026-06-19 13:05:34 UTC
PHP: 8.4.22
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 91.31s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 32.23s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.25s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 19.4s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 18.1s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 12.17s |
...
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 388ms |
...
| testGeneratesPdfWithEmbeddedTrueTypeFont | DocumentFeaturesTest | PASS | 224ms |
...
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 293ms |
...
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 588ms |
...
| testSetEncryptionAes256RoundTrip | WriterTest | PASS | 193ms |
...
| testSaveToFile | PageLabelerTest | PASS | 178ms |
...
| testStampImageWithScaleHeight | PdfStamperTest | PASS | 177ms |
...
**4 tests** | 3 passed | 0 failed | 1 skipped | 19.4s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWithOutputIntent | PdfAConformanceTest | SKIP | 5ms |
| testVeraPdfToolchainWorks | PdfAConformanceTest | PASS | 2.26s |
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 18.1s
...
| testQpdfCorpus with data set "qpdf/job-json-encrypt-128.pdf" | Tier2CorpusTest | PASS | 4ms |
...
**6 tests** | 6 passed | 0 failed | 0 skipped | 12.17s
...
| testJhoveToolchainWorks | Tier4JhoveTest | PASS | 651ms |
...
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 534ms |
