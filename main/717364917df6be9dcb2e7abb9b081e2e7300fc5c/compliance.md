...
Generated: 2026-06-29 03:19:38 UTC
PHP: 8.4.22
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 89.29s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 32.37s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.27s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 17.51s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 32.37s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 708ms |
...
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 282ms |
...
| testAddRuleDrawsStroke | PdfTest | PASS | 179ms |
...
| testNoOpsKeepsAllPages | PageSlicerTest | PASS | 179ms |
...
| testSetMediaBox | PageTransformerTest | PASS | 178ms |
...
| testEvenPages | PageTransformerTest | PASS | 176ms |
...
| testStampPdfSpecificPage | PdfStamperTest | PASS | 203ms |
...
**4 tests** | 3 passed | 0 failed | 1 skipped | 17.51s
...
| testQpdfCorpus with data set "qpdf/compressed-metadata.pdf" | Tier2CorpusTest | PASS | 10ms |
...
| testQpdfCorpus with data set "qpdf/replace-input.pdf" | Tier2CorpusTest | PASS | 24ms |
...
| testPdfiumCorpus with data set "pdfium/bug_1919.pdf" | Tier2PdfiumCorpusTest | PASS | 5ms |
...
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 840ms |
