...
Generated: 2026-06-07 22:32:43 UTC
PHP: 8.4.21
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 91.62s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 32.23s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.28s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 19.22s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 32.23s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 392ms |
| testGeneratesAnnotationsPdf | AnnotationsTest | PASS | 197ms |
| testGeneratesBookmarksPdf | BookmarksTest | PASS | 237ms |
...
| testGeneratesPdfWithEmbeddedType1 | EmbeddedType1FontTest | PASS | 183ms |
...
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 447ms |
...
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 174ms |
| testGeneratesPdfWithMarkupFields | MarkupAnnotationsIntegrationTest | PASS | 194ms |
| testGeneratesMultiPageComplexPdf | MultiPageComplexTest | PASS | 202ms |
...
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 448ms |
| testGeneratesSimpleTextPdf | SimpleTextTest | PASS | 189ms |
| testGeneratesPdfWithType3Font | Type3FontIntegrationTest | PASS | 179ms |
| testGeneratesPdfWithXrefAndObjectStreams | XRefStreamIntegrationTest | PASS | 200ms |
| testEnableOutlineThenHeadingRegistersOutlinesEntry | AutoOutlineTest | PASS | 193ms |
...
| testGeneratesHighLevelDocument | PdfIntegrationTest | PASS | 383ms |
...
| testExplicitNewPageCreatesSecondPage | PdfTest | PASS | 189ms |
| testLongTextAutoPaginates | PdfTest | PASS | 194ms |
| testAddSpacerConsumesVerticalSpace | PdfTest | PASS | 184ms |
| testAddRuleDrawsStroke | PdfTest | PASS | 184ms |
| testAlignmentCenterEmitsCenteredText | PdfTest | PASS | 183ms |
| testSetFontSwitchesFontFamily | PdfTest | PASS | 198ms |
| testBoldAndItalicResolveToCorrectPostScriptName | PdfTest | PASS | 183ms |
...
| testAddCompositeFontGeneratesValidPdf | UnicodeFontTest | PASS | 195ms |
| testAddCompositeFontSavesToFile | UnicodeFontTest | PASS | 197ms |
| testCompositeFontRoundTripsThroughReader | UnicodeFontTest | PASS | 195ms |
...
| testPdfWriterAddContentStream | WriterTest | PASS | 182ms |
...
| testSyncInfoToMetadata | XmpMetadataTest | PASS | 181ms |
...
| testSetBookmarksWithChildren | BookmarkEditorTest | PASS | 197ms |
...
| testCheckCheckbox | FormFillerTest | PASS | 182ms |
| testUncheckCheckbox | FormFillerTest | PASS | 202ms |
...
| testSaveWritesFile | FormFillerTest | PASS | 187ms |
...
| testSetMetadataOnPdfWithoutInfo | MetadataEditorTest | PASS | 186ms |
...
| testCustomField | MetadataEditorTest | PASS | 188ms |
...
| testSetRomanNumeralsUppercase | PageLabelerTest | PASS | 192ms |
...
| testRemoveLabels | PageLabelerTest | PASS | 193ms |
...
| testKeepRange | PageSlicerTest | PASS | 198ms |
| testRemovePages | PageSlicerTest | PASS | 194ms |
| testReorder | PageSlicerTest | PASS | 200ms |
...
| testSetMediaBox | PageTransformerTest | PASS | 185ms |
...
| testMultipleOperations | PageTransformerTest | PASS | 205ms |
...
| testRange | PageTransformerTest | PASS | 180ms |
| testGetReader | PageTransformerTest | PASS | <1ms |
| testGetPageCount | PageTransformerTest | PASS | <1ms |
| testSaveToFile | PageTransformerTest | PASS | 189ms |
| testEncryptAes128 | PdfEncryptTest | PASS | 195ms |
| testEncryptAes256 | PdfEncryptTest | PASS | 198ms |
...
| testMergeTwoPdfs | PdfMergerTest | PASS | 182ms |
| testMergeWithPageSelection | PdfMergerTest | PASS | 190ms |
...
| testSaveToFile | PdfMergerTest | PASS | 194ms |
...
| testPageNumbers | PdfStamperTest | PASS | 183ms |
| testStampOnSpecificPages | PdfStamperTest | PASS | 198ms |
...
| testStampPdfWithOpacity | PdfStamperTest | PASS | 187ms |
| testStampPdfSpecificPage | PdfStamperTest | PASS | 192ms |
| testStampPdfOnSelectedPages | PdfStamperTest | PASS | 187ms |
| testStampPdfDefaultsToCenter | PdfStamperTest | PASS | 186ms |
...
| testCustomRedactionColor | TextRedactorTest | PASS | 186ms |
...
**4 tests** | 3 passed | 0 failed | 1 skipped | 19.22s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWithOutputIntent | PdfAConformanceTest | SKIP | 5ms |
| testVeraPdfToolchainWorks | PdfAConformanceTest | PASS | 2.25s |
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 7.2s |
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 9.76s |
...
| testQpdfCorpus with data set "qpdf/appearances-a-more2.pdf" | Tier2CorpusTest | PASS | 7ms |
...
| testQpdfCorpus with data set "qpdf/bad21.pdf" | Tier2CorpusTest | PASS | 10ms |
...
| testQpdfCorpus with data set "qpdf/many-nulls.pdf" | Tier2CorpusTest | PASS | 681ms |
...
| testAnnotationWithContentsPassesClause718 | Tier3MatterhornTest | PASS | 2.19s |
...
| testAnnotationWithoutContentsFailsUa1 | Tier3MatterhornTest | PASS | 2.03s |
...
| testMultiPagePdfWellFormedAndValid | Tier4JhoveTest | PASS | 906ms |
| testPdfWithMetadataWellFormedAndValid | Tier4JhoveTest | PASS | 861ms |
| testPdfWithEmbeddedFontWellFormedAndValid | Tier4JhoveTest | PASS | 871ms |
| testJhoveToolchainWorks | Tier4JhoveTest | PASS | 694ms |
| testPdfA1bPassesPdfBoxPreflight | Tier4PdfBoxPreflightTest | SKIP | <1ms |
| testPdfBoxPreflightToolchainWorks | Tier4PdfBoxPreflightTest | PASS | 789ms |
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 730ms |
| testPdfWithMetadataHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 522ms |
| testPdfWithEmbeddedFontHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 536ms |
| testPdfIdToolchainWorks | Tier4PdfIdTest | PASS | 331ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 via incremental save.pdf" | Tier4Pdf20ExamplesTest | PASS | 173ms |
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 with offset start.pdf" | Tier4Pdf20ExamplesTest | PASS | 180ms |
