...
Generated: 2026-06-11 05:08:35 UTC
PHP: 8.4.21
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 91.25s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 45.44s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.43s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 14.31s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 14.05s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 9.08s |
| &#x2705; JHOVE + PDF 2.0 + Security + Preflight | PASS | 25 | 24 | 0 | 1 | 6.93s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 45.44s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 2.26s |
| testGeneratesAnnotationsPdf | AnnotationsTest | PASS | 226ms |
| testGeneratesBookmarksPdf | BookmarksTest | PASS | 551ms |
| testGeneratesFormWithCustomFontAppearances | CustomFontFormAppearancesTest | PASS | 481ms |
| testGeneratesDocumentFeaturesPdf | DocumentFeaturesTest | PASS | 777ms |
| testGeneratesPdfWithEmbeddedTrueTypeFont | DocumentFeaturesTest | PASS | 357ms |
| testGeneratesPdfWithEmbeddedFont | EmbeddedFontsTest | PASS | 340ms |
...
| testGeneratesPdfWithEmbeddedType1 | EmbeddedType1FontTest | PASS | 712ms |
| testPdfOutputContainsFontData | EmbeddedType1FontTest | PASS | <1ms |
| testGeneratesExtGStatePdf | ExtGStateIntegrationTest | PASS | 170ms |
| testGeneratesFormWithAppearances | FormAppearancesIntegrationTest | PASS | 651ms |
| testGeneratesFormPdf | FormFieldsTest | PASS | 355ms |
| testGeneratesGraphicsPipelinePdf | GraphicsPipelineIntegrationTest | PASS | 359ms |
| testGeneratesGraphicsPdf | GraphicsTest | PASS | 419ms |
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 648ms |
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 197ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 120ms |
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 281ms |
| testGeneratesPdfWithMarkupFields | MarkupAnnotationsIntegrationTest | PASS | 493ms |
| testGeneratesMultiPageComplexPdf | MultiPageComplexTest | PASS | 492ms |
| testGeneratesMultimediaAnd3DPdf | MultimediaAndThreeDIntegrationTest | PASS | 321ms |
...
| testGeneratesPageLabelsPdf | PageLabelsTest | PASS | 171ms |
| testGeneratesSignatureFieldPdf | SignatureFieldIntegrationTest | PASS | 241ms |
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 679ms |
| testGeneratesSimpleTextPdf | SimpleTextTest | PASS | 301ms |
| testGeneratesPdfWithType3Font | Type3FontIntegrationTest | PASS | 376ms |
| testGeneratesPdfWithXrefAndObjectStreams | XRefStreamIntegrationTest | PASS | 710ms |
| testEnableOutlineThenHeadingRegistersOutlinesEntry | AutoOutlineTest | PASS | 271ms |
...
| testNoteCalloutEmitsLabelAndBody | CalloutTest | PASS | 239ms |
...
| testWinAnsiRoundTripFromShowText | EncodingIntegrationTest | PASS | 294ms |
| testHighLevelPdfRoundTrip | EncodingIntegrationTest | PASS | 3ms |
| testAddTextWithLinkStyleProducesLinkAnnotation | InlineLinkTest | PASS | 395ms |
...
| testBulletListRendersEachItem | ListTest | PASS | 303ms |
...
| testShowPageNumbersDefaultFormat | PageNumbersTest | PASS | 449ms |
...
| testAddPageDelegatesToWriter | PdfDocTest | PASS | 640ms |
...
| testGeneratesHighLevelDocument | PdfIntegrationTest | PASS | 831ms |
| testAddHtmlRendersIntoPdf | PdfTest | PASS | 28ms |
| testEmptyDocumentHasNoPages | PdfTest | PASS | 238ms |
| testAddTextCreatesFirstPageAutomatically | PdfTest | PASS | 296ms |
| testAddHeadingEmitsLargerText | PdfTest | PASS | 218ms |
| testExplicitNewPageCreatesSecondPage | PdfTest | PASS | 281ms |
| testLongTextAutoPaginates | PdfTest | PASS | 629ms |
| testAddSpacerConsumesVerticalSpace | PdfTest | PASS | 433ms |
| testAddRuleDrawsStroke | PdfTest | PASS | 775ms |
| testAlignmentCenterEmitsCenteredText | PdfTest | PASS | 163ms |
| testSetFontSwitchesFontFamily | PdfTest | PASS | 618ms |
| testBoldAndItalicResolveToCorrectPostScriptName | PdfTest | PASS | 371ms |
| testUnknownFamilyIsRejected | PdfTest | PASS | <1ms |
| testCustomTheme | PdfTest | PASS | 310ms |
| testSaveWritesFile | PdfTest | PASS | 220ms |
| testWriteToStream | PdfTest | PASS | 534ms |
| testWriteToRejectsNonResource | PdfTest | PASS | <1ms |
| testToBytesProducesValidPdfOnEachCall | PdfTest | PASS | 1.5s |
...
| testAddTableRendersAllCellValues | TableTest | PASS | 453ms |
...
| testWriterPageDrawTableThrowsWithoutColumnWidths | TableTest | PASS | 6ms |
...
| testUnderlineEmitsStrokeBelowBaseline | TextDecorationTest | PASS | 1.22s |
...
| testAddCompositeFontGeneratesValidPdf | UnicodeFontTest | PASS | 741ms |
| testAddCompositeFontSavesToFile | UnicodeFontTest | PASS | 248ms |
| testCompositeFontRoundTripsThroughReader | UnicodeFontTest | PASS | 166ms |
...
| testPdfWriterGeneratesValidPdfHeader | WriterTest | PASS | 167ms |
...
| testPdfWriterContainsPage | WriterTest | PASS | 167ms |
...
| testPdfWriterAddContentStream | WriterTest | PASS | 157ms |
| testPdfWriterGetContentStreams | WriterTest | PASS | <1ms |
| testPdfWriterWithInfo | WriterTest | PASS | 171ms |
| testPdfWriterGetCatalog | WriterTest | PASS | <1ms |
| testPdfWriterGetPageTree | WriterTest | PASS | <1ms |
| testPdfWriterSavesToFile | WriterTest | PASS | 181ms |
| testPdfWriterContainsXref | WriterTest | PASS | 153ms |
| testPdfWriterContainsTrailer | WriterTest | PASS | <1ms |
| testPdfWriterAddPageWithRectangle | WriterTest | PASS | 167ms |
| testPdfWriterRegisterObject | WriterTest | PASS | 169ms |
| testPdfWriterFontAddedToPage | WriterTest | PASS | 167ms |
| testSetNamedDestinations | WriterTest | PASS | 156ms |
| testSetEncryptionProducesEncryptedPdf | WriterTest | PASS | 162ms |
| testSetEncryptionAes256RoundTrip | WriterTest | PASS | 178ms |
| testSetMetadataAddsStreamToPdf | XmpMetadataTest | PASS | 155ms |
| testMetadataStreamContainsXmp | XmpMetadataTest | PASS | 196ms |
| testMetadataRoundTrip | XmpMetadataTest | PASS | 160ms |
| testSyncInfoToMetadata | XmpMetadataTest | PASS | 174ms |
| testSyncInfoToMetadataNoInfoIsNoOp | XmpMetadataTest | PASS | 214ms |
| testFlattenAll | AnnotationFlattenerTest | PASS | 170ms |
...
| testSetBookmarks | BookmarkEditorTest | PASS | 177ms |
| testSetBookmarksWithChildren | BookmarkEditorTest | PASS | 253ms |
| testAddBookmark | BookmarkEditorTest | PASS | 335ms |
| testHasBookmarksReturnsFalseForCleanPdf | BookmarkEditorTest | PASS | <1ms |
| testRemoveBookmarks | BookmarkEditorTest | PASS | 182ms |
...
| testReplaceExistingBookmarks | BookmarkEditorTest | PASS | 155ms |
...
| testFillTextField | FormFillerTest | PASS | 171ms |
| testFillManyFields | FormFillerTest | PASS | 161ms |
| testCheckCheckbox | FormFillerTest | PASS | 157ms |
| testUncheckCheckbox | FormFillerTest | PASS | 160ms |
| testSelectChoiceField | FormFillerTest | PASS | 173ms |
| testFillMultipleFieldTypes | FormFillerTest | PASS | 156ms |
...
| testSaveWritesFile | FormFillerTest | PASS | 153ms |
| testEscapeHatch | FormFillerTest | PASS | 1ms |
| testRoundTripPreservesOtherFields | FormFillerTest | PASS | 159ms |
...
| testSetTitleRoundTrip | MetadataEditorTest | PASS | 161ms |
| testSetMultipleFieldsRoundTrip | MetadataEditorTest | PASS | 160ms |
| testSetMetadataOnPdfWithoutInfo | MetadataEditorTest | PASS | 160ms |
...
| testCustomField | MetadataEditorTest | PASS | 150ms |
| testSaveToFile | MetadataEditorTest | PASS | 159ms |
| testSetLabelsWithArabic | PageLabelerTest | PASS | 157ms |
| testSetRomanNumerals | PageLabelerTest | PASS | 160ms |
| testSetRomanNumeralsUppercase | PageLabelerTest | PASS | 159ms |
| testSetAlphabetic | PageLabelerTest | PASS | 164ms |
| testSetArabicWithStartNumber | PageLabelerTest | PASS | 165ms |
| testSetLabelsWithPrefix | PageLabelerTest | PASS | 186ms |
| testRemoveLabels | PageLabelerTest | PASS | 167ms |
| testMultipleRanges | PageLabelerTest | PASS | 164ms |
| testGetPageCount | PageLabelerTest | PASS | <1ms |
| testGetReader | PageLabelerTest | PASS | <1ms |
| testSaveToFile | PageLabelerTest | PASS | 213ms |
| testNoBytesChangedWhenNoOperations | PageLabelerTest | PASS | <1ms |
| testOpenFromFile | PageLabelerTest | PASS | <1ms |
| testKeepPages | PageSlicerTest | PASS | 166ms |
| testKeepRange | PageSlicerTest | PASS | 152ms |
| testRemovePages | PageSlicerTest | PASS | 155ms |
| testReorder | PageSlicerTest | PASS | 161ms |
| testReverse | PageSlicerTest | PASS | 163ms |
| testSplit | PageSlicerTest | PASS | 318ms |
...
| testRotateAllPages | PageTransformerTest | PASS | 157ms |
| testRotate180 | PageTransformerTest | PASS | 158ms |
| testRotate270 | PageTransformerTest | PASS | 153ms |
...
| testSetCropBoxSpecificPage | PageTransformerTest | PASS | 158ms |
| testSetMediaBox | PageTransformerTest | PASS | 160ms |
| testSetTrimBox | PageTransformerTest | PASS | 156ms |
| testSetBleedBox | PageTransformerTest | PASS | 152ms |
| testScale | PageTransformerTest | PASS | 158ms |
| testScaleSpecificPages | PageTransformerTest | PASS | 274ms |
| testScaleInvalidFactor | PageTransformerTest | PASS | <1ms |
| testScaleTo | PageTransformerTest | PASS | 309ms |
| testScaleToNonUniform | PageTransformerTest | PASS | 153ms |
| testMultipleOperations | PageTransformerTest | PASS | 163ms |
| testNoBytesChangedWithoutOperations | PageTransformerTest | PASS | <1ms |
| testEvenPages | PageTransformerTest | PASS | 171ms |
| testOddPages | PageTransformerTest | PASS | 280ms |
| testRange | PageTransformerTest | PASS | 163ms |
| testGetReader | PageTransformerTest | PASS | <1ms |
| testGetPageCount | PageTransformerTest | PASS | <1ms |
| testSaveToFile | PageTransformerTest | PASS | 204ms |
| testEncryptAes128 | PdfEncryptTest | PASS | 163ms |
| testEncryptAes256 | PdfEncryptTest | PASS | 201ms |
| testDecrypt | PdfEncryptTest | PASS | 218ms |
...
| testMergeTwoPdfs | PdfMergerTest | PASS | 226ms |
...
| testSaveToFile | PdfMergerTest | PASS | 168ms |
| testStampText | PdfStamperTest | PASS | 191ms |
| testWatermark | PdfStamperTest | PASS | 215ms |
| testWatermarkWithStyle | PdfStamperTest | PASS | 157ms |
| testPageNumbers | PdfStamperTest | PASS | 166ms |
| testStampOnSpecificPages | PdfStamperTest | PASS | 165ms |
| testHeaderAndFooter | PdfStamperTest | PASS | 605ms |
...
| testSaveToFile | PdfStamperTest | PASS | 167ms |
| testStampImageJpeg | PdfStamperTest | PASS | 163ms |
| testStampImagePng | PdfStamperTest | PASS | 160ms |
| testStampImageWithScaleWidth | PdfStamperTest | PASS | 165ms |
| testStampImageWithScaleHeight | PdfStamperTest | PASS | 198ms |
| testStampImageWithExplicitDimensions | PdfStamperTest | PASS | 164ms |
| testStampImageWithOpacity | PdfStamperTest | PASS | 307ms |
| testStampImageOnSpecificPages | PdfStamperTest | PASS | 175ms |
| testStampImageCombinedWithText | PdfStamperTest | PASS | 165ms |
| testStampImageThrowsOnMissingFile | PdfStamperTest | PASS | <1ms |
| testStampImageThrowsOnUnsupportedFormat | PdfStamperTest | PASS | <1ms |
| testStampPdf | PdfStamperTest | PASS | 399ms |
| testStampPdfWithScaling | PdfStamperTest | PASS | 169ms |
| testStampPdfWithOpacity | PdfStamperTest | PASS | 160ms |
| testStampPdfSpecificPage | PdfStamperTest | PASS | 165ms |
| testStampPdfOnSelectedPages | PdfStamperTest | PASS | 163ms |
| testStampPdfDefaultsToCenter | PdfStamperTest | PASS | 167ms |
| testStampPdfThrowsOnMissingFile | PdfStamperTest | PASS | <1ms |
| testStampPdfThrowsOnInvalidPageIndex | PdfStamperTest | PASS | 3ms |
| testStampPdfThrowsOnNegativePageIndex | PdfStamperTest | PASS | <1ms |
| testImageStampStyleDefaults | PdfStamperTest | PASS | <1ms |
| testRedactArea | TextRedactorTest | PASS | 169ms |
| testRedactMultipleAreas | TextRedactorTest | PASS | 169ms |
| testRedactByText | TextRedactorTest | PASS | 155ms |
| testRedactByPattern | TextRedactorTest | PASS | <1ms |
| testCustomRedactionColor | TextRedactorTest | PASS | 163ms |
...
| testSaveToFile | TextRedactorTest | PASS | 162ms |

### Arlington PDF Model — Dictionary-level spec conformance (keys, types, required fields, version constraints)

**6 tests** | 6 passed | 0 failed | 0 skipped | 1.43s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesBookmarksPdf | BookmarksTest | PASS | 369ms |
| testGeneratesDocumentFeaturesPdf | DocumentFeaturesTest | PASS | 325ms |
| testGeneratesPdfWithEmbeddedTrueTypeFont | DocumentFeaturesTest | PASS | 194ms |
| testGeneratesFormPdf | FormFieldsTest | PASS | 179ms |
| testGeneratesMultiPageComplexPdf | MultiPageComplexTest | PASS | 190ms |
| testGeneratesSimpleTextPdf | SimpleTextTest | PASS | 175ms |

### veraPDF — PDF/A archival conformance (ISO 19005)

**4 tests** | 3 passed | 0 failed | 1 skipped | 14.31s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWithOutputIntent | PdfAConformanceTest | SKIP | 4ms |
| testVeraPdfToolchainWorks | PdfAConformanceTest | PASS | 1.68s |
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 5.28s |
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 7.34s |
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 14.05s
...
| testQpdfCorpus with data set "qpdf/enc-R2,V1.pdf" | Tier2CorpusTest | PASS | 10ms |
...
| testQpdfCorpus with data set "qpdf/many-nulls.pdf" | Tier2CorpusTest | PASS | 555ms |
...
| testQpdfCorpus with data set "qpdf/sample-form.pdf" | Tier2CorpusTest | PASS | 28ms |
...
**6 tests** | 6 passed | 0 failed | 0 skipped | 9.08s

| Test | Class | Status | Time |
|---|---|---|---|
| testTaggedDocumentValidatesWithUa1 | Tier3MatterhornTest | PASS | 1.69s |
| testAnnotationWithContentsPassesClause718 | Tier3MatterhornTest | PASS | 1.6s |
| testUntaggedDocumentFailsUa1 | Tier3MatterhornTest | PASS | 1.43s |
| testMissingLangFailsUa1 | Tier3MatterhornTest | PASS | 1.39s |
...
**25 tests** | 24 passed | 0 failed | 1 skipped | 6.93s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWellFormedAndValid | Tier4JhoveTest | PASS | 764ms |
| testMultiPagePdfWellFormedAndValid | Tier4JhoveTest | PASS | 730ms |
| testPdfWithMetadataWellFormedAndValid | Tier4JhoveTest | PASS | 735ms |
| testPdfWithEmbeddedFontWellFormedAndValid | Tier4JhoveTest | PASS | 740ms |
| testJhoveToolchainWorks | Tier4JhoveTest | PASS | 542ms |
| testPdfA1bPassesPdfBoxPreflight | Tier4PdfBoxPreflightTest | SKIP | <1ms |
| testPdfBoxPreflightToolchainWorks | Tier4PdfBoxPreflightTest | PASS | 623ms |
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 458ms |
| testPdfWithMetadataHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 461ms |
| testPdfWithEmbeddedFontHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 448ms |
| testPdfIdToolchainWorks | Tier4PdfIdTest | PASS | 295ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 UTF-8 string and annotation.pdf" | Tier4Pdf20ExamplesTest | PASS | 162ms |
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 image with BPC.pdf" | Tier4Pdf20ExamplesTest | PASS | 169ms |
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 via incremental save.pdf" | Tier4Pdf20ExamplesTest | PASS | 164ms |
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 with offset start.pdf" | Tier4Pdf20ExamplesTest | PASS | 157ms |
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 with page level output intent.pdf" | Tier4Pdf20ExamplesTest | PASS | 162ms |
| testPdf20ExampleQpdfValid with data set "pdf20/Simple PDF 2.0 file.pdf" | Tier4Pdf20ExamplesTest | PASS | 162ms |
