...
Generated: 2026-06-11 15:31:53 UTC
PHP: 8.4.22
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 94.38s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 33.32s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.28s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 19.81s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 19.19s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 12.24s |
| &#x2705; JHOVE + PDF 2.0 + Security + Preflight | PASS | 25 | 24 | 0 | 1 | 8.54s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 33.32s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 304ms |
| testGeneratesAnnotationsPdf | AnnotationsTest | PASS | 193ms |
| testGeneratesBookmarksPdf | BookmarksTest | PASS | 234ms |
| testGeneratesFormWithCustomFontAppearances | CustomFontFormAppearancesTest | PASS | 237ms |
| testGeneratesDocumentFeaturesPdf | DocumentFeaturesTest | PASS | 203ms |
| testGeneratesPdfWithEmbeddedTrueTypeFont | DocumentFeaturesTest | PASS | 204ms |
| testGeneratesPdfWithEmbeddedFont | EmbeddedFontsTest | PASS | 202ms |
...
| testGeneratesPdfWithEmbeddedType1 | EmbeddedType1FontTest | PASS | 196ms |
| testPdfOutputContainsFontData | EmbeddedType1FontTest | PASS | <1ms |
| testGeneratesExtGStatePdf | ExtGStateIntegrationTest | PASS | 193ms |
| testGeneratesFormWithAppearances | FormAppearancesIntegrationTest | PASS | 189ms |
| testGeneratesFormPdf | FormFieldsTest | PASS | 200ms |
| testGeneratesGraphicsPipelinePdf | GraphicsPipelineIntegrationTest | PASS | 193ms |
| testGeneratesGraphicsPdf | GraphicsTest | PASS | 191ms |
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 411ms |
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 153ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 352ms |
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 121ms |
| testGeneratesPdfWithMarkupFields | MarkupAnnotationsIntegrationTest | PASS | 202ms |
| testGeneratesMultiPageComplexPdf | MultiPageComplexTest | PASS | 221ms |
| testGeneratesMultimediaAnd3DPdf | MultimediaAndThreeDIntegrationTest | PASS | 196ms |
...
| testGeneratesPageLabelsPdf | PageLabelsTest | PASS | 207ms |
| testGeneratesSignatureFieldPdf | SignatureFieldIntegrationTest | PASS | 194ms |
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 523ms |
| testGeneratesSimpleTextPdf | SimpleTextTest | PASS | 200ms |
| testGeneratesPdfWithType3Font | Type3FontIntegrationTest | PASS | 190ms |
| testGeneratesPdfWithXrefAndObjectStreams | XRefStreamIntegrationTest | PASS | 200ms |
| testEnableOutlineThenHeadingRegistersOutlinesEntry | AutoOutlineTest | PASS | 196ms |
...
| testNoteCalloutEmitsLabelAndBody | CalloutTest | PASS | 195ms |
...
| testCalloutTallerThanPageThrows | CalloutTest | PASS | 20ms |
...
| testBulletListRendersEachItem | ListTest | PASS | 198ms |
...
| testAddPageDelegatesToWriter | PdfDocTest | PASS | 194ms |
...
| testGeneratesHighLevelDocument | PdfIntegrationTest | PASS | 407ms |
| testAddHtmlRendersIntoPdf | PdfTest | PASS | 38ms |
| testEmptyDocumentHasNoPages | PdfTest | PASS | 193ms |
| testAddTextCreatesFirstPageAutomatically | PdfTest | PASS | 197ms |
| testAddHeadingEmitsLargerText | PdfTest | PASS | 191ms |
| testExplicitNewPageCreatesSecondPage | PdfTest | PASS | 198ms |
| testLongTextAutoPaginates | PdfTest | PASS | 199ms |
| testAddSpacerConsumesVerticalSpace | PdfTest | PASS | 198ms |
| testAddRuleDrawsStroke | PdfTest | PASS | 202ms |
| testAlignmentCenterEmitsCenteredText | PdfTest | PASS | 193ms |
| testSetFontSwitchesFontFamily | PdfTest | PASS | 199ms |
| testBoldAndItalicResolveToCorrectPostScriptName | PdfTest | PASS | 195ms |
| testUnknownFamilyIsRejected | PdfTest | PASS | <1ms |
| testCustomTheme | PdfTest | PASS | 189ms |
| testSaveWritesFile | PdfTest | PASS | 208ms |
| testWriteToStream | PdfTest | PASS | 193ms |
...
| testAddTableRendersAllCellValues | TableTest | PASS | 191ms |
...
| testWriterPageDrawTableThrowsWithoutColumnWidths | TableTest | PASS | 8ms |
...
| testUnderlineEmitsStrokeBelowBaseline | TextDecorationTest | PASS | 199ms |
...
| testAddCompositeFontSavesToFile | UnicodeFontTest | PASS | 205ms |
| testCompositeFontRoundTripsThroughReader | UnicodeFontTest | PASS | 215ms |
...
| testPdfWriterGeneratesValidPdfHeader | WriterTest | PASS | 195ms |
...
| testPdfWriterContainsPage | WriterTest | PASS | 190ms |
...
| testPdfWriterAddContentStream | WriterTest | PASS | 196ms |
| testPdfWriterGetContentStreams | WriterTest | PASS | <1ms |
| testPdfWriterWithInfo | WriterTest | PASS | 194ms |
...
| testPdfWriterContainsXref | WriterTest | PASS | 198ms |
| testPdfWriterContainsTrailer | WriterTest | PASS | <1ms |
| testPdfWriterAddPageWithRectangle | WriterTest | PASS | 185ms |
| testPdfWriterRegisterObject | WriterTest | PASS | 182ms |
| testPdfWriterFontAddedToPage | WriterTest | PASS | 191ms |
| testSetNamedDestinations | WriterTest | PASS | 192ms |
| testSetEncryptionProducesEncryptedPdf | WriterTest | PASS | 202ms |
| testSetEncryptionAes256RoundTrip | WriterTest | PASS | 213ms |
| testSetMetadataAddsStreamToPdf | XmpMetadataTest | PASS | 199ms |
| testMetadataStreamContainsXmp | XmpMetadataTest | PASS | 187ms |
| testMetadataRoundTrip | XmpMetadataTest | PASS | 195ms |
| testSyncInfoToMetadata | XmpMetadataTest | PASS | 196ms |
| testSyncInfoToMetadataNoInfoIsNoOp | XmpMetadataTest | PASS | 195ms |
...
| testSaveToFile | AnnotationFlattenerTest | PASS | 192ms |
...
| testSetBookmarks | BookmarkEditorTest | PASS | 190ms |
| testSetBookmarksWithChildren | BookmarkEditorTest | PASS | 199ms |
| testAddBookmark | BookmarkEditorTest | PASS | 389ms |
...
| testSaveToFile | BookmarkEditorTest | PASS | 188ms |
...
| testFillTextField | FormFillerTest | PASS | 196ms |
| testFillManyFields | FormFillerTest | PASS | 197ms |
| testCheckCheckbox | FormFillerTest | PASS | 194ms |
| testUncheckCheckbox | FormFillerTest | PASS | 187ms |
| testSelectChoiceField | FormFillerTest | PASS | 188ms |
| testFillMultipleFieldTypes | FormFillerTest | PASS | 192ms |
...
| testSaveWritesFile | FormFillerTest | PASS | 198ms |
| testEscapeHatch | FormFillerTest | PASS | 1ms |
| testRoundTripPreservesOtherFields | FormFillerTest | PASS | 187ms |
...
| testSetTitleRoundTrip | MetadataEditorTest | PASS | 191ms |
| testSetMultipleFieldsRoundTrip | MetadataEditorTest | PASS | 195ms |
| testSetMetadataOnPdfWithoutInfo | MetadataEditorTest | PASS | 191ms |
...
| testCustomField | MetadataEditorTest | PASS | 192ms |
| testSaveToFile | MetadataEditorTest | PASS | 193ms |
| testSetLabelsWithArabic | PageLabelerTest | PASS | 198ms |
| testSetRomanNumerals | PageLabelerTest | PASS | 203ms |
| testSetRomanNumeralsUppercase | PageLabelerTest | PASS | 206ms |
| testSetAlphabetic | PageLabelerTest | PASS | 198ms |
| testSetArabicWithStartNumber | PageLabelerTest | PASS | 187ms |
| testSetLabelsWithPrefix | PageLabelerTest | PASS | 199ms |
| testRemoveLabels | PageLabelerTest | PASS | 196ms |
| testMultipleRanges | PageLabelerTest | PASS | 192ms |
| testGetPageCount | PageLabelerTest | PASS | <1ms |
| testGetReader | PageLabelerTest | PASS | <1ms |
| testSaveToFile | PageLabelerTest | PASS | 192ms |
| testNoBytesChangedWhenNoOperations | PageLabelerTest | PASS | 1ms |
| testOpenFromFile | PageLabelerTest | PASS | 1ms |
| testKeepPages | PageSlicerTest | PASS | 194ms |
| testKeepRange | PageSlicerTest | PASS | 189ms |
| testRemovePages | PageSlicerTest | PASS | 190ms |
| testReorder | PageSlicerTest | PASS | 193ms |
| testReverse | PageSlicerTest | PASS | 195ms |
| testSplit | PageSlicerTest | PASS | 386ms |
| testKeepWithPageSelector | PageSlicerTest | PASS | 186ms |
...
| testRotateAllPages | PageTransformerTest | PASS | 188ms |
| testRotate180 | PageTransformerTest | PASS | 212ms |
| testRotate270 | PageTransformerTest | PASS | 192ms |
| testRotateSpecificPages | PageTransformerTest | PASS | 187ms |
| testRotateCumulative | PageTransformerTest | PASS | 194ms |
| testRotateInvalidAngle | PageTransformerTest | PASS | <1ms |
| testSetCropBox | PageTransformerTest | PASS | 195ms |
| testSetCropBoxSpecificPage | PageTransformerTest | PASS | 187ms |
| testSetMediaBox | PageTransformerTest | PASS | 187ms |
| testSetTrimBox | PageTransformerTest | PASS | 194ms |
| testSetBleedBox | PageTransformerTest | PASS | 193ms |
| testScale | PageTransformerTest | PASS | 193ms |
| testScaleSpecificPages | PageTransformerTest | PASS | 199ms |
| testScaleInvalidFactor | PageTransformerTest | PASS | <1ms |
| testScaleTo | PageTransformerTest | PASS | 190ms |
| testScaleToNonUniform | PageTransformerTest | PASS | 188ms |
| testMultipleOperations | PageTransformerTest | PASS | 191ms |
| testNoBytesChangedWithoutOperations | PageTransformerTest | PASS | <1ms |
| testEvenPages | PageTransformerTest | PASS | 194ms |
| testOddPages | PageTransformerTest | PASS | 196ms |
...
| testMergeTwoPdfs | PdfMergerTest | PASS | 201ms |
...
| testSaveToFile | PdfMergerTest | PASS | 185ms |
| testStampText | PdfStamperTest | PASS | 200ms |
| testWatermark | PdfStamperTest | PASS | 199ms |
| testWatermarkWithStyle | PdfStamperTest | PASS | 194ms |
| testPageNumbers | PdfStamperTest | PASS | 196ms |
...
| testStampImageJpeg | PdfStamperTest | PASS | 203ms |
| testStampImagePng | PdfStamperTest | PASS | 190ms |
| testStampImageWithScaleWidth | PdfStamperTest | PASS | 195ms |
| testStampImageWithScaleHeight | PdfStamperTest | PASS | 190ms |
| testStampImageWithExplicitDimensions | PdfStamperTest | PASS | 199ms |
| testStampImageWithOpacity | PdfStamperTest | PASS | 200ms |
| testStampImageOnSpecificPages | PdfStamperTest | PASS | 191ms |
| testStampImageCombinedWithText | PdfStamperTest | PASS | 198ms |
| testStampImageThrowsOnMissingFile | PdfStamperTest | PASS | <1ms |
| testStampImageThrowsOnUnsupportedFormat | PdfStamperTest | PASS | <1ms |
| testStampPdf | PdfStamperTest | PASS | 195ms |
| testStampPdfWithScaling | PdfStamperTest | PASS | 187ms |
| testStampPdfWithOpacity | PdfStamperTest | PASS | 186ms |
| testStampPdfSpecificPage | PdfStamperTest | PASS | 194ms |
| testStampPdfOnSelectedPages | PdfStamperTest | PASS | 197ms |
| testStampPdfDefaultsToCenter | PdfStamperTest | PASS | 199ms |
...
| testRedactMultipleAreas | TextRedactorTest | PASS | 187ms |
| testRedactByText | TextRedactorTest | PASS | 192ms |
| testRedactByPattern | TextRedactorTest | PASS | 1ms |
| testCustomRedactionColor | TextRedactorTest | PASS | 199ms |
...
| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesBookmarksPdf | BookmarksTest | PASS | 306ms |
| testGeneratesDocumentFeaturesPdf | DocumentFeaturesTest | PASS | 199ms |
| testGeneratesPdfWithEmbeddedTrueTypeFont | DocumentFeaturesTest | PASS | 195ms |
| testGeneratesFormPdf | FormFieldsTest | PASS | 187ms |
| testGeneratesMultiPageComplexPdf | MultiPageComplexTest | PASS | 199ms |
| testGeneratesSimpleTextPdf | SimpleTextTest | PASS | 198ms |

### veraPDF — PDF/A archival conformance (ISO 19005)

**4 tests** | 3 passed | 0 failed | 1 skipped | 19.81s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWithOutputIntent | PdfAConformanceTest | SKIP | 5ms |
| testVeraPdfToolchainWorks | PdfAConformanceTest | PASS | 2.42s |
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 7.69s |
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 9.7s |
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 19.19s
...
| testQpdfCorpus with data set "qpdf/enc-R2,V1,O=master.pdf" | Tier2CorpusTest | PASS | 13ms |
...
| testQpdfCorpus with data set "qpdf/many-nulls.pdf" | Tier2CorpusTest | PASS | 712ms |
...
| testQpdfCorpus with data set "qpdf/sample-form.pdf" | Tier2CorpusTest | PASS | 33ms |
...
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 7.38s |
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 10.15s |
...
| testPdfiumCorpus with data set "pdfium/bug_707673.pdf" | Tier2PdfiumCorpusTest | PASS | 13ms |
...
**6 tests** | 6 passed | 0 failed | 0 skipped | 12.24s

| Test | Class | Status | Time |
|---|---|---|---|
| testTaggedDocumentValidatesWithUa1 | Tier3MatterhornTest | PASS | 2.34s |
| testAnnotationWithContentsPassesClause718 | Tier3MatterhornTest | PASS | 2.2s |
| testUntaggedDocumentFailsUa1 | Tier3MatterhornTest | PASS | 1.8s |
| testMissingLangFailsUa1 | Tier3MatterhornTest | PASS | 1.77s |
| testMissingDisplayDocTitleFailsUa1 | Tier3MatterhornTest | PASS | 2.02s |
| testAnnotationWithoutContentsFailsUa1 | Tier3MatterhornTest | PASS | 2.1s |
...
**25 tests** | 24 passed | 0 failed | 1 skipped | 8.54s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWellFormedAndValid | Tier4JhoveTest | PASS | 969ms |
| testMultiPagePdfWellFormedAndValid | Tier4JhoveTest | PASS | 920ms |
| testPdfWithMetadataWellFormedAndValid | Tier4JhoveTest | PASS | 896ms |
| testPdfWithEmbeddedFontWellFormedAndValid | Tier4JhoveTest | PASS | 881ms |
| testJhoveToolchainWorks | Tier4JhoveTest | PASS | 707ms |
| testPdfA1bPassesPdfBoxPreflight | Tier4PdfBoxPreflightTest | SKIP | <1ms |
| testPdfBoxPreflightToolchainWorks | Tier4PdfBoxPreflightTest | PASS | 784ms |
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 570ms |
| testPdfWithMetadataHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 538ms |
| testPdfWithEmbeddedFontHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 550ms |
| testPdfIdToolchainWorks | Tier4PdfIdTest | PASS | 353ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 UTF-8 string and annotation.pdf" | Tier4Pdf20ExamplesTest | PASS | 204ms |
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 image with BPC.pdf" | Tier4Pdf20ExamplesTest | PASS | 195ms |
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 via incremental save.pdf" | Tier4Pdf20ExamplesTest | PASS | 188ms |
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 with offset start.pdf" | Tier4Pdf20ExamplesTest | PASS | 202ms |
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 with page level output intent.pdf" | Tier4Pdf20ExamplesTest | PASS | 190ms |
| testPdf20ExampleQpdfValid with data set "pdf20/Simple PDF 2.0 file.pdf" | Tier4Pdf20ExamplesTest | PASS | 195ms |
