...
Generated: 2026-06-08 19:26:10 UTC
PHP: 8.4.21
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 90.84s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 32.46s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.31s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 18.56s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 18.32s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 11.53s |
| &#x2705; JHOVE + PDF 2.0 + Security + Preflight | PASS | 25 | 24 | 0 | 1 | 8.66s |
...
| testGeneratesFormWithCustomFontAppearances | CustomFontFormAppearancesTest | PASS | 219ms |
...
| testGeneratesPdfWithEmbeddedFont | EmbeddedFontsTest | PASS | 206ms |
...
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 346ms |
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 152ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 234ms |
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 252ms |
...
| testGeneratesPageLabelsPdf | PageLabelsTest | PASS | 184ms |
| testGeneratesSignatureFieldPdf | SignatureFieldIntegrationTest | PASS | 189ms |
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 298ms |
| testGeneratesSimpleTextPdf | SimpleTextTest | PASS | 194ms |
| testGeneratesPdfWithType3Font | Type3FontIntegrationTest | PASS | 192ms |
| testGeneratesPdfWithXrefAndObjectStreams | XRefStreamIntegrationTest | PASS | 183ms |
...
| testWinAnsiRoundTripFromShowText | EncodingIntegrationTest | PASS | 183ms |
...
| testGeneratesHighLevelDocument | PdfIntegrationTest | PASS | 402ms |
...
| testExplicitNewPageCreatesSecondPage | PdfTest | PASS | 194ms |
...
| testSetFontSwitchesFontFamily | PdfTest | PASS | 188ms |
...
| testToBytesProducesValidPdfOnEachCall | PdfTest | PASS | 381ms |
...
| testUnderlineEmitsStrokeBelowBaseline | TextDecorationTest | PASS | 180ms |
| testStrikethroughEmitsStroke | TextDecorationTest | PASS | 2ms |
...
| testAddCompositeFontGeneratesValidPdf | UnicodeFontTest | PASS | 189ms |
| testAddCompositeFontSavesToFile | UnicodeFontTest | PASS | 188ms |
...
| testPdfWriterGeneratesValidPdfHeader | WriterTest | PASS | 184ms |
...
| testPdfWriterContainsPage | WriterTest | PASS | 187ms |
...
| testPdfWriterAddContentStream | WriterTest | PASS | 193ms |
...
| testPdfWriterSavesToFile | WriterTest | PASS | 209ms |
| testPdfWriterContainsXref | WriterTest | PASS | 177ms |
...
| testSaveToFile | AnnotationFlattenerTest | PASS | 182ms |
...
| testSetBookmarksWithChildren | BookmarkEditorTest | PASS | 208ms |
| testAddBookmark | BookmarkEditorTest | PASS | 394ms |
...
| testSaveToFile | BookmarkEditorTest | PASS | 202ms |
...
| testSetTitleRoundTrip | MetadataEditorTest | PASS | 190ms |
| testSetMultipleFieldsRoundTrip | MetadataEditorTest | PASS | 191ms |
| testSetMetadataOnPdfWithoutInfo | MetadataEditorTest | PASS | 207ms |
...
| testCustomField | MetadataEditorTest | PASS | 199ms |
| testSaveToFile | MetadataEditorTest | PASS | 197ms |
| testSetLabelsWithArabic | PageLabelerTest | PASS | 202ms |
| testSetRomanNumerals | PageLabelerTest | PASS | 195ms |
| testSetRomanNumeralsUppercase | PageLabelerTest | PASS | 197ms |
...
| testMultipleRanges | PageLabelerTest | PASS | 183ms |
...
| testRotateCumulative | PageTransformerTest | PASS | 183ms |
| testRotateInvalidAngle | PageTransformerTest | PASS | <1ms |
| testSetCropBox | PageTransformerTest | PASS | 211ms |
| testSetCropBoxSpecificPage | PageTransformerTest | PASS | 198ms |
...
| testEncryptAes256 | PdfEncryptTest | PASS | 212ms |
...
| testSaveToFile | PdfMergerTest | PASS | 190ms |
| testStampText | PdfStamperTest | PASS | 185ms |
| testWatermark | PdfStamperTest | PASS | 186ms |
| testWatermarkWithStyle | PdfStamperTest | PASS | 181ms |
| testPageNumbers | PdfStamperTest | PASS | 189ms |
| testStampOnSpecificPages | PdfStamperTest | PASS | 195ms |
| testHeaderAndFooter | PdfStamperTest | PASS | 188ms |
| testStampWithOpacity | PdfStamperTest | PASS | 182ms |
...
| testStampImagePng | PdfStamperTest | PASS | 196ms |
...
| testRedactArea | TextRedactorTest | PASS | 201ms |
| testRedactMultipleAreas | TextRedactorTest | PASS | 193ms |
| testRedactByText | TextRedactorTest | PASS | 199ms |
...
| testSaveToFile | TextRedactorTest | PASS | 203ms |
...
| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesBookmarksPdf | BookmarksTest | PASS | 327ms |
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 18.32s
...
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 6.92s |
...
**6 tests** | 6 passed | 0 failed | 0 skipped | 11.53s

| Test | Class | Status | Time |
|---|---|---|---|
| testTaggedDocumentValidatesWithUa1 | Tier3MatterhornTest | PASS | 1.98s |
| testAnnotationWithContentsPassesClause718 | Tier3MatterhornTest | PASS | 2.18s |
...
**25 tests** | 24 passed | 0 failed | 1 skipped | 8.66s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWellFormedAndValid | Tier4JhoveTest | PASS | 952ms |
| testMultiPagePdfWellFormedAndValid | Tier4JhoveTest | PASS | 911ms |
| testPdfWithMetadataWellFormedAndValid | Tier4JhoveTest | PASS | 881ms |
| testPdfWithEmbeddedFontWellFormedAndValid | Tier4JhoveTest | PASS | 880ms |
| testJhoveToolchainWorks | Tier4JhoveTest | PASS | 710ms |
| testPdfA1bPassesPdfBoxPreflight | Tier4PdfBoxPreflightTest | SKIP | <1ms |
| testPdfBoxPreflightToolchainWorks | Tier4PdfBoxPreflightTest | PASS | 799ms |
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 733ms |
| testPdfWithMetadataHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 526ms |
| testPdfWithEmbeddedFontHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 541ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 with offset start.pdf" | Tier4Pdf20ExamplesTest | PASS | 197ms |
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 with page level output intent.pdf" | Tier4Pdf20ExamplesTest | PASS | 200ms |
