...
Generated: 2026-06-09 03:51:47 UTC
PHP: 8.4.21
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 94.71s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 33.25s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.28s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 20.93s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 19.06s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 11.66s |
| &#x2705; JHOVE + PDF 2.0 + Security + Preflight | PASS | 25 | 24 | 0 | 1 | 8.52s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 33.25s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 354ms |
...
| testGeneratesPdfWithEmbeddedFont | EmbeddedFontsTest | PASS | 208ms |
...
| testGeneratesGraphicsPipelinePdf | GraphicsPipelineIntegrationTest | PASS | 198ms |
| testGeneratesGraphicsPdf | GraphicsTest | PASS | 198ms |
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 701ms |
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 182ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 166ms |
...
| testGeneratesPageLabelsPdf | PageLabelsTest | PASS | 198ms |
| testGeneratesSignatureFieldPdf | SignatureFieldIntegrationTest | PASS | 195ms |
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 657ms |
| testGeneratesSimpleTextPdf | SimpleTextTest | PASS | 195ms |
| testGeneratesPdfWithType3Font | Type3FontIntegrationTest | PASS | 187ms |
| testGeneratesPdfWithXrefAndObjectStreams | XRefStreamIntegrationTest | PASS | 203ms |
...
| testNoteCalloutEmitsLabelAndBody | CalloutTest | PASS | 190ms |
...
| testHighLevelPdfRoundTrip | EncodingIntegrationTest | PASS | 9ms |
...
| testAddTextCreatesFirstPageAutomatically | PdfTest | PASS | 196ms |
| testAddHeadingEmitsLargerText | PdfTest | PASS | 195ms |
| testExplicitNewPageCreatesSecondPage | PdfTest | PASS | 199ms |
| testLongTextAutoPaginates | PdfTest | PASS | 202ms |
| testAddSpacerConsumesVerticalSpace | PdfTest | PASS | 195ms |
| testAddRuleDrawsStroke | PdfTest | PASS | 200ms |
| testAlignmentCenterEmitsCenteredText | PdfTest | PASS | 199ms |
| testSetFontSwitchesFontFamily | PdfTest | PASS | 193ms |
| testBoldAndItalicResolveToCorrectPostScriptName | PdfTest | PASS | 187ms |
| testUnknownFamilyIsRejected | PdfTest | PASS | <1ms |
| testCustomTheme | PdfTest | PASS | 191ms |
| testSaveWritesFile | PdfTest | PASS | 183ms |
| testWriteToStream | PdfTest | PASS | 191ms |
| testWriteToRejectsNonResource | PdfTest | PASS | <1ms |
| testToBytesProducesValidPdfOnEachCall | PdfTest | PASS | 378ms |
...
| testUnderlineEmitsStrokeBelowBaseline | TextDecorationTest | PASS | 196ms |
...
| testPdfWriterGeneratesValidPdfHeader | WriterTest | PASS | 197ms |
...
| testPdfWriterContainsXref | WriterTest | PASS | 189ms |
| testPdfWriterContainsTrailer | WriterTest | PASS | <1ms |
| testPdfWriterAddPageWithRectangle | WriterTest | PASS | 186ms |
| testPdfWriterRegisterObject | WriterTest | PASS | 186ms |
| testPdfWriterFontAddedToPage | WriterTest | PASS | 200ms |
| testSetNamedDestinations | WriterTest | PASS | 203ms |
| testSetEncryptionProducesEncryptedPdf | WriterTest | PASS | 192ms |
| testSetEncryptionAes256RoundTrip | WriterTest | PASS | 229ms |
| testSetMetadataAddsStreamToPdf | XmpMetadataTest | PASS | 191ms |
| testMetadataStreamContainsXmp | XmpMetadataTest | PASS | 186ms |
| testMetadataRoundTrip | XmpMetadataTest | PASS | 183ms |
...
| testAddBookmark | BookmarkEditorTest | PASS | 382ms |
...
| testSaveToFile | BookmarkEditorTest | PASS | 190ms |
...
| testFillManyFields | FormFillerTest | PASS | 198ms |
| testCheckCheckbox | FormFillerTest | PASS | 188ms |
| testUncheckCheckbox | FormFillerTest | PASS | 191ms |
| testSelectChoiceField | FormFillerTest | PASS | 192ms |
...
| testSetMultipleFieldsRoundTrip | MetadataEditorTest | PASS | 200ms |
...
| testCustomField | MetadataEditorTest | PASS | 196ms |
| testSaveToFile | MetadataEditorTest | PASS | 195ms |
| testSetLabelsWithArabic | PageLabelerTest | PASS | 187ms |
| testSetRomanNumerals | PageLabelerTest | PASS | 200ms |
| testSetRomanNumeralsUppercase | PageLabelerTest | PASS | 187ms |
| testSetAlphabetic | PageLabelerTest | PASS | 191ms |
| testSetArabicWithStartNumber | PageLabelerTest | PASS | 200ms |
...
| testSaveToFile | PageLabelerTest | PASS | 193ms |
| testNoBytesChangedWhenNoOperations | PageLabelerTest | PASS | <1ms |
| testOpenFromFile | PageLabelerTest | PASS | 3ms |
| testKeepPages | PageSlicerTest | PASS | 189ms |
| testKeepRange | PageSlicerTest | PASS | 203ms |
| testRemovePages | PageSlicerTest | PASS | 195ms |
| testReorder | PageSlicerTest | PASS | 190ms |
| testReverse | PageSlicerTest | PASS | 183ms |
| testSplit | PageSlicerTest | PASS | 378ms |
| testKeepWithPageSelector | PageSlicerTest | PASS | 198ms |
| testNoOpsKeepsAllPages | PageSlicerTest | PASS | 182ms |
...
| testRotateSpecificPages | PageTransformerTest | PASS | 203ms |
| testRotateCumulative | PageTransformerTest | PASS | 189ms |
| testRotateInvalidAngle | PageTransformerTest | PASS | <1ms |
| testSetCropBox | PageTransformerTest | PASS | 187ms |
| testSetCropBoxSpecificPage | PageTransformerTest | PASS | 190ms |
| testSetMediaBox | PageTransformerTest | PASS | 184ms |
| testSetTrimBox | PageTransformerTest | PASS | 189ms |
| testSetBleedBox | PageTransformerTest | PASS | 191ms |
| testScale | PageTransformerTest | PASS | 181ms |
...
| testMultipleOperations | PageTransformerTest | PASS | 188ms |
...
| testEncryptAes128 | PdfEncryptTest | PASS | 190ms |
| testEncryptAes256 | PdfEncryptTest | PASS | 209ms |
| testDecrypt | PdfEncryptTest | PASS | 190ms |
...
| testWatermarkWithStyle | PdfStamperTest | PASS | 188ms |
| testPageNumbers | PdfStamperTest | PASS | 184ms |
...
| testStampImageWithExplicitDimensions | PdfStamperTest | PASS | 196ms |
| testStampImageWithOpacity | PdfStamperTest | PASS | 184ms |
| testStampImageOnSpecificPages | PdfStamperTest | PASS | 198ms |
| testStampImageCombinedWithText | PdfStamperTest | PASS | 189ms |
| testStampImageThrowsOnMissingFile | PdfStamperTest | PASS | <1ms |
| testStampImageThrowsOnUnsupportedFormat | PdfStamperTest | PASS | 3ms |
| testStampPdf | PdfStamperTest | PASS | 201ms |
...
| testStampPdfOnSelectedPages | PdfStamperTest | PASS | 192ms |
...
| testCustomRedactionColor | TextRedactorTest | PASS | 192ms |
...
| testGeneratesSimpleTextPdf | SimpleTextTest | PASS | 202ms |

### veraPDF — PDF/A archival conformance (ISO 19005)

**4 tests** | 3 passed | 0 failed | 1 skipped | 20.93s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWithOutputIntent | PdfAConformanceTest | SKIP | 4ms |
| testVeraPdfToolchainWorks | PdfAConformanceTest | PASS | 2.17s |
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 7.58s |
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 11.18s |
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 19.06s
...
| testQpdfCorpus with data set "qpdf/appearances-a-more.pdf" | Tier2CorpusTest | PASS | 9ms |
...
| testQpdfCorpus with data set "qpdf/many-nulls.pdf" | Tier2CorpusTest | PASS | 686ms |
...
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 10.27s |
...
**6 tests** | 6 passed | 0 failed | 0 skipped | 11.66s
...
| testMissingLangFailsUa1 | Tier3MatterhornTest | PASS | 1.95s |
...
**25 tests** | 24 passed | 0 failed | 1 skipped | 8.52s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWellFormedAndValid | Tier4JhoveTest | PASS | 928ms |
| testMultiPagePdfWellFormedAndValid | Tier4JhoveTest | PASS | 882ms |
| testPdfWithMetadataWellFormedAndValid | Tier4JhoveTest | PASS | 879ms |
| testPdfWithEmbeddedFontWellFormedAndValid | Tier4JhoveTest | PASS | 858ms |
| testJhoveToolchainWorks | Tier4JhoveTest | PASS | 694ms |
| testPdfA1bPassesPdfBoxPreflight | Tier4PdfBoxPreflightTest | SKIP | <1ms |
| testPdfBoxPreflightToolchainWorks | Tier4PdfBoxPreflightTest | PASS | 812ms |
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 746ms |
| testPdfWithMetadataHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 533ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 via incremental save.pdf" | Tier4Pdf20ExamplesTest | PASS | 184ms |
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 with offset start.pdf" | Tier4Pdf20ExamplesTest | PASS | 182ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/Simple PDF 2.0 file.pdf" | Tier4Pdf20ExamplesTest | PASS | 189ms |
| testPdf20ExampleQpdfValid with data set "pdf20/pdf20-utf8-test.pdf" | Tier4Pdf20ExamplesTest | PASS | 192ms |
