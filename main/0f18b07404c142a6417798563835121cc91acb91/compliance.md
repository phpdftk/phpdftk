...
Generated: 2026-05-25 00:19:39 UTC
PHP: 8.4.21
...
**Overall: PASS** | 1662 tests | 1656 passed | 0 failed | 6 skipped | 94.15s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 454 | 450 | 0 | 4 | 33.54s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.35s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 18.77s |
...
**454 tests** | 450 passed | 0 failed | 4 skipped | 33.54s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 471ms |
| testGeneratesAnnotationsPdf | AnnotationsTest | PASS | 201ms |
| testGeneratesBookmarksPdf | BookmarksTest | PASS | 246ms |
| testGeneratesFormWithCustomFontAppearances | CustomFontFormAppearancesTest | PASS | 249ms |
...
| testGeneratesPdfWithEmbeddedType1 | EmbeddedType1FontTest | PASS | 199ms |
...
| testGeneratesGraphicsPipelinePdf | GraphicsPipelineIntegrationTest | PASS | 200ms |
| testGeneratesGraphicsPdf | GraphicsTest | PASS | 193ms |
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 320ms |
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 150ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 284ms |
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 151ms |
...
| testGeneratesMultimediaAnd3DPdf | MultimediaAndThreeDIntegrationTest | PASS | 192ms |
...
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 364ms |
...
| testEnableOutlineThenHeadingRegistersOutlinesEntry | AutoOutlineTest | PASS | 194ms |
...
| testNoteCalloutEmitsLabelAndBody | CalloutTest | PASS | 200ms |
...
| testAddTextWithLinkStyleProducesLinkAnnotation | InlineLinkTest | PASS | 204ms |
...
| testGeneratesHighLevelDocument | PdfIntegrationTest | PASS | 389ms |
| testAddHtmlRendersIntoPdf | PdfTest | PASS | 33ms |
| testEmptyDocumentHasNoPages | PdfTest | PASS | 186ms |
...
| testLongTextAutoPaginates | PdfTest | PASS | 192ms |
...
| testSetFontSwitchesFontFamily | PdfTest | PASS | 189ms |
...
| testAddTableRendersAllCellValues | TableTest | PASS | 192ms |
...
| testCompositeFontRoundTripsThroughReader | UnicodeFontTest | PASS | 190ms |
| testCompositeFontAppearsInFontList | UnicodeFontTest | PASS | 6ms |
| testShowTextHexOperator | UnicodeFontTest | PASS | <1ms |
| testCompositeFontPerPage | UnicodeFontTest | PASS | 231ms |
...
| testMetadataStreamContainsXmp | XmpMetadataTest | PASS | 195ms |
| testMetadataRoundTrip | XmpMetadataTest | PASS | 198ms |
| testSyncInfoToMetadata | XmpMetadataTest | PASS | 187ms |
| testSyncInfoToMetadataNoInfoIsNoOp | XmpMetadataTest | PASS | 190ms |
...
| testSaveToFile | AnnotationFlattenerTest | PASS | 188ms |
...
| testReplaceExistingBookmarks | BookmarkEditorTest | PASS | 200ms |
...
| testFillManyFields | FormFillerTest | PASS | 200ms |
...
| testRoundTripPreservesOtherFields | FormFillerTest | PASS | 200ms |
...
| testSetMultipleFieldsRoundTrip | MetadataEditorTest | PASS | 190ms |
| testSetMetadataOnPdfWithoutInfo | MetadataEditorTest | PASS | 195ms |
...
| testSetRomanNumeralsUppercase | PageLabelerTest | PASS | 199ms |
| testSetAlphabetic | PageLabelerTest | PASS | 202ms |
...
| testMultipleRanges | PageLabelerTest | PASS | 194ms |
| testGetPageCount | PageLabelerTest | PASS | 1ms |
| testGetReader | PageLabelerTest | PASS | <1ms |
| testSaveToFile | PageLabelerTest | PASS | 199ms |
...
| testRotate270 | PageTransformerTest | PASS | 241ms |
| testRotateSpecificPages | PageTransformerTest | PASS | 199ms |
| testRotateCumulative | PageTransformerTest | PASS | 197ms |
| testRotateInvalidAngle | PageTransformerTest | PASS | <1ms |
| testSetCropBox | PageTransformerTest | PASS | 202ms |
| testSetCropBoxSpecificPage | PageTransformerTest | PASS | 192ms |
| testSetMediaBox | PageTransformerTest | PASS | 194ms |
| testSetTrimBox | PageTransformerTest | PASS | 223ms |
| testSetBleedBox | PageTransformerTest | PASS | 200ms |
...
| testScaleTo | PageTransformerTest | PASS | 196ms |
| testScaleToNonUniform | PageTransformerTest | PASS | 198ms |
| testMultipleOperations | PageTransformerTest | PASS | 209ms |
| testNoBytesChangedWithoutOperations | PageTransformerTest | PASS | <1ms |
| testEvenPages | PageTransformerTest | PASS | 205ms |
...
| testSaveToFile | PageTransformerTest | PASS | 202ms |
| testEncryptAes128 | PdfEncryptTest | PASS | 205ms |
| testEncryptAes256 | PdfEncryptTest | PASS | 214ms |
...
| testStampText | PdfStamperTest | PASS | 203ms |
| testWatermark | PdfStamperTest | PASS | 210ms |
| testWatermarkWithStyle | PdfStamperTest | PASS | 194ms |
| testPageNumbers | PdfStamperTest | PASS | 198ms |
| testStampOnSpecificPages | PdfStamperTest | PASS | 204ms |
| testHeaderAndFooter | PdfStamperTest | PASS | 200ms |
...
| testSaveToFile | PdfStamperTest | PASS | 210ms |
| testStampImageJpeg | PdfStamperTest | PASS | 211ms |
| testStampImagePng | PdfStamperTest | PASS | 209ms |
| testStampImageWithScaleWidth | PdfStamperTest | PASS | 203ms |
| testStampImageWithScaleHeight | PdfStamperTest | PASS | 201ms |
...
| testStampImageCombinedWithText | PdfStamperTest | PASS | 200ms |
...
| testStampPdfWithScaling | PdfStamperTest | PASS | 196ms |
...
| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesBookmarksPdf | BookmarksTest | PASS | 324ms |
| testGeneratesDocumentFeaturesPdf | DocumentFeaturesTest | PASS | 215ms |
...
**4 tests** | 3 passed | 0 failed | 1 skipped | 18.77s
...
| testQpdfCorpus with data set "qpdf/enc-R2,V1,O=master.pdf" | Tier2CorpusTest | PASS | 10ms |
...
| testQpdfCorpus with data set "qpdf/many-nulls.pdf" | Tier2CorpusTest | PASS | 701ms |
...
| testQpdfCorpus with data set "qpdf/obj0.pdf" | Tier2CorpusTest | PASS | 27ms |
...
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 7.91s |
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 10.55s |
...
| testPdfBoxCorpus with data set "pdfbox/pdfbox/src/test/resources/input/PDFBOX-5920-4MQTG6ZXOYSMTQ444KGQOVC6ZFQHWFNY-spaces-reduced.pdf" | Tier2PdfBoxCorpusTest | PASS | 6ms |
...
| testPdfBoxCorpus with data set "pdfbox/pdfbox/src/test/resources/org/apache/pdfbox/pdmodel/interactive/form/PDFBOX-3656-SF1199AEG (Complete).pdf" | Tier2PdfBoxCorpusTest | PASS | 4ms |
...
| testUntaggedDocumentFailsUa1 | Tier3MatterhornTest | PASS | 1.74s |
| testMissingLangFailsUa1 | Tier3MatterhornTest | PASS | 1.79s |
| testMissingDisplayDocTitleFailsUa1 | Tier3MatterhornTest | PASS | 1.75s |
| testAnnotationWithoutContentsFailsUa1 | Tier3MatterhornTest | PASS | 1.96s |
...
| testMultiPagePdfWellFormedAndValid | Tier4JhoveTest | PASS | 905ms |
| testPdfWithMetadataWellFormedAndValid | Tier4JhoveTest | PASS | 929ms |
| testPdfWithEmbeddedFontWellFormedAndValid | Tier4JhoveTest | PASS | 902ms |
...
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 775ms |
| testPdfWithMetadataHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 556ms |
| testPdfWithEmbeddedFontHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 597ms |
| testPdfIdToolchainWorks | Tier4PdfIdTest | PASS | 361ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 image with BPC.pdf" | Tier4Pdf20ExamplesTest | PASS | 194ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 with page level output intent.pdf" | Tier4Pdf20ExamplesTest | PASS | 202ms |
| testPdf20ExampleQpdfValid with data set "pdf20/Simple PDF 2.0 file.pdf" | Tier4Pdf20ExamplesTest | PASS | 198ms |
