...
Generated: 2026-06-19 18:36:17 UTC
PHP: 8.4.22
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 93.8s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 32.97s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.29s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 19.68s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 19.03s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 12.38s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 32.97s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 627ms |
...
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 80ms |
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 110ms |
...
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 518ms |
...
| testReorder | PageSlicerTest | PASS | 210ms |
...
| testStampImagePng | PdfStamperTest | PASS | 203ms |
...
**4 tests** | 3 passed | 0 failed | 1 skipped | 19.68s
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 19.03s
...
| testQpdfCorpus with data set "qpdf/enc-XI-attachments-base.pdf" | Tier2CorpusTest | PASS | 2ms |
...
**6 tests** | 6 passed | 0 failed | 0 skipped | 12.38s
...
| testPdfWithEmbeddedFontHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 568ms |
