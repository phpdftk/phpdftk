...
Generated: 2026-05-25 13:41:01 UTC
PHP: 8.4.21
...
**Overall: PASS** | 1662 tests | 1656 passed | 0 failed | 6 skipped | 94.11s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 454 | 450 | 0 | 4 | 32.16s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.28s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 20.67s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 19.76s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 11.88s |
...
**454 tests** | 450 passed | 0 failed | 4 skipped | 32.16s
...
| testGeneratesGraphicsPipelinePdf | GraphicsPipelineIntegrationTest | PASS | 210ms |
| testGeneratesGraphicsPdf | GraphicsTest | PASS | 191ms |
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 420ms |
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 215ms |
...
| testGeneratesSignatureFieldPdf | SignatureFieldIntegrationTest | PASS | 174ms |
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 449ms |
...
| testAddLinkWithZeroSizeRectStillProducesAnnotation | PdfDocTest | PASS | 6ms |
...
| testAddTableRendersAllCellValues | TableTest | PASS | 180ms |
...
| testAddCompositeFontSavesToFile | UnicodeFontTest | PASS | 203ms |
...
| testCustomField | MetadataEditorTest | PASS | 182ms |
...
**4 tests** | 3 passed | 0 failed | 1 skipped | 20.67s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWithOutputIntent | PdfAConformanceTest | SKIP | 5ms |
| testVeraPdfToolchainWorks | PdfAConformanceTest | PASS | 2.14s |
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 8.09s |
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 10.43s |
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 19.76s
...
| testQpdfCorpus with data set "qpdf/direct-outlines.pdf" | Tier2CorpusTest | PASS | 8ms |
...
| testQpdfCorpus with data set "qpdf/nested-images.pdf" | Tier2CorpusTest | PASS | 24ms |
...
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 7.9s |
...
**6 tests** | 6 passed | 0 failed | 0 skipped | 11.88s
...
| testPdfWithEmbeddedFontHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 539ms |
