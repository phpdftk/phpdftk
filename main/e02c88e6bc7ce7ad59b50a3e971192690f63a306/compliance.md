...
Generated: 2026-06-17 03:04:08 UTC
PHP: 8.4.22
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 91.7s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 34.18s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.33s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 17.55s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 18.71s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 11.58s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 34.18s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 296ms |
...
| testGeneratesExtGStatePdf | ExtGStateIntegrationTest | PASS | 195ms |
...
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 160ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 566ms |
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 182ms |
...
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 371ms |
| testGeneratesSimpleTextPdf | SimpleTextTest | PASS | 192ms |
| testGeneratesPdfWithType3Font | Type3FontIntegrationTest | PASS | 200ms |
| testGeneratesPdfWithXrefAndObjectStreams | XRefStreamIntegrationTest | PASS | 198ms |
...
| testGeneratesHighLevelDocument | PdfIntegrationTest | PASS | 408ms |
...
| testAddTableRendersAllCellValues | TableTest | PASS | 207ms |
...
| testAddTableHonoursPerColumnAlignment | TableTest | PASS | 10ms |
...
| testPdfWriterGeneratesValidPdfHeader | WriterTest | PASS | 199ms |
...
| testSyncInfoToMetadataNoInfoIsNoOp | XmpMetadataTest | PASS | 206ms |
...
| testSaveToFile | AnnotationFlattenerTest | PASS | 199ms |
...
| testSetBookmarks | BookmarkEditorTest | PASS | 207ms |
| testSetBookmarksWithChildren | BookmarkEditorTest | PASS | 202ms |
| testAddBookmark | BookmarkEditorTest | PASS | 397ms |
...
| testSaveToFile | BookmarkEditorTest | PASS | 209ms |
| testNoBytesChangedWhenNoOperations | BookmarkEditorTest | PASS | <1ms |
| testReplaceExistingBookmarks | BookmarkEditorTest | PASS | 213ms |
...
| testFillTextField | FormFillerTest | PASS | 195ms |
...
| testSetTitleRoundTrip | MetadataEditorTest | PASS | 201ms |
...
| testSetRomanNumerals | PageLabelerTest | PASS | 208ms |
...
| testSaveToFile | PageLabelerTest | PASS | 204ms |
...
| testSplit | PageSlicerTest | PASS | 389ms |
...
| testRotate270 | PageTransformerTest | PASS | 206ms |
...
| testSetTrimBox | PageTransformerTest | PASS | 210ms |
...
| testSaveToFile | PageTransformerTest | PASS | 200ms |
...
| testMergeWithPageSelection | PdfMergerTest | PASS | 204ms |
...
| testWatermark | PdfStamperTest | PASS | 209ms |
...
| testSaveToFile | PdfStamperTest | PASS | 207ms |
| testStampImageJpeg | PdfStamperTest | PASS | 209ms |
| testStampImagePng | PdfStamperTest | PASS | 198ms |
...
| testStampImageWithOpacity | PdfStamperTest | PASS | 317ms |
...
| testStampPdfOnSelectedPages | PdfStamperTest | PASS | 222ms |
| testStampPdfDefaultsToCenter | PdfStamperTest | PASS | 236ms |
...
| testRedactArea | TextRedactorTest | PASS | 217ms |
...
| testSaveToFile | TextRedactorTest | PASS | 205ms |
...
**4 tests** | 3 passed | 0 failed | 1 skipped | 17.55s
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 18.71s
...
| testQpdfCorpus with data set "qpdf/delete-and-reuse.pdf" | Tier2CorpusTest | PASS | 14ms |
...
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 9.77s |
...
**6 tests** | 6 passed | 0 failed | 0 skipped | 11.58s

| Test | Class | Status | Time |
|---|---|---|---|
| testTaggedDocumentValidatesWithUa1 | Tier3MatterhornTest | PASS | 2.21s |
...
| testMultiPagePdfWellFormedAndValid | Tier4JhoveTest | PASS | 883ms |
...
| testPdfBoxPreflightToolchainWorks | Tier4PdfBoxPreflightTest | PASS | 785ms |
