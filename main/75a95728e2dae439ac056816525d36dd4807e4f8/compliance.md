...
Generated: 2026-06-17 03:07:41 UTC
PHP: 8.4.22
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 98.89s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 35.35s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.27s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 21.33s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 19.73s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 12.62s |
| &#x2705; JHOVE + PDF 2.0 + Security + Preflight | PASS | 25 | 24 | 0 | 1 | 8.59s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 35.35s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 337ms |
| testGeneratesAnnotationsPdf | AnnotationsTest | PASS | 210ms |
| testGeneratesBookmarksPdf | BookmarksTest | PASS | 251ms |
| testGeneratesFormWithCustomFontAppearances | CustomFontFormAppearancesTest | PASS | 215ms |
...
| testGeneratesPdfWithEmbeddedFont | EmbeddedFontsTest | PASS | 212ms |
...
| testGeneratesExtGStatePdf | ExtGStateIntegrationTest | PASS | 215ms |
| testGeneratesFormWithAppearances | FormAppearancesIntegrationTest | PASS | 204ms |
| testGeneratesFormPdf | FormFieldsTest | PASS | 197ms |
| testGeneratesGraphicsPipelinePdf | GraphicsPipelineIntegrationTest | PASS | 204ms |
| testGeneratesGraphicsPdf | GraphicsTest | PASS | 195ms |
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 406ms |
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 187ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 558ms |
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 277ms |
| testGeneratesPdfWithMarkupFields | MarkupAnnotationsIntegrationTest | PASS | 201ms |
...
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 505ms |
| testGeneratesSimpleTextPdf | SimpleTextTest | PASS | 201ms |
| testGeneratesPdfWithType3Font | Type3FontIntegrationTest | PASS | 215ms |
| testGeneratesPdfWithXrefAndObjectStreams | XRefStreamIntegrationTest | PASS | 208ms |
...
| testAddTextWithLinkStyleProducesLinkAnnotation | InlineLinkTest | PASS | 202ms |
...
| testBulletListRendersEachItem | ListTest | PASS | 212ms |
...
| testAddTextCreatesFirstPageAutomatically | PdfTest | PASS | 219ms |
| testAddHeadingEmitsLargerText | PdfTest | PASS | 204ms |
| testExplicitNewPageCreatesSecondPage | PdfTest | PASS | 223ms |
...
| testAlignmentCenterEmitsCenteredText | PdfTest | PASS | 213ms |
| testSetFontSwitchesFontFamily | PdfTest | PASS | 200ms |
...
| testSaveWritesFile | PdfTest | PASS | 224ms |
| testWriteToStream | PdfTest | PASS | 203ms |
| testWriteToRejectsNonResource | PdfTest | PASS | <1ms |
| testToBytesProducesValidPdfOnEachCall | PdfTest | PASS | 392ms |
...
| testAddTableRendersAllCellValues | TableTest | PASS | 196ms |
...
| testUnderlineEmitsStrokeBelowBaseline | TextDecorationTest | PASS | 204ms |
...
| testAddCompositeFontGeneratesValidPdf | UnicodeFontTest | PASS | 218ms |
| testAddCompositeFontSavesToFile | UnicodeFontTest | PASS | 222ms |
| testCompositeFontRoundTripsThroughReader | UnicodeFontTest | PASS | 218ms |
...
| testPdfWriterAddContentStream | WriterTest | PASS | 204ms |
| testPdfWriterGetContentStreams | WriterTest | PASS | <1ms |
| testPdfWriterWithInfo | WriterTest | PASS | 208ms |
| testPdfWriterGetCatalog | WriterTest | PASS | <1ms |
| testPdfWriterGetPageTree | WriterTest | PASS | <1ms |
| testPdfWriterSavesToFile | WriterTest | PASS | 198ms |
...
| testPdfWriterRegisterObject | WriterTest | PASS | 215ms |
| testPdfWriterFontAddedToPage | WriterTest | PASS | 210ms |
| testSetNamedDestinations | WriterTest | PASS | 207ms |
| testSetEncryptionProducesEncryptedPdf | WriterTest | PASS | 208ms |
| testSetEncryptionAes256RoundTrip | WriterTest | PASS | 221ms |
| testSetMetadataAddsStreamToPdf | XmpMetadataTest | PASS | 204ms |
| testMetadataStreamContainsXmp | XmpMetadataTest | PASS | 200ms |
| testMetadataRoundTrip | XmpMetadataTest | PASS | 203ms |
...
| testSetBookmarks | BookmarkEditorTest | PASS | 206ms |
...
| testRemoveBookmarks | BookmarkEditorTest | PASS | 200ms |
...
| testReplaceExistingBookmarks | BookmarkEditorTest | PASS | 211ms |
...
| testFillManyFields | FormFillerTest | PASS | 212ms |
| testCheckCheckbox | FormFillerTest | PASS | 208ms |
| testUncheckCheckbox | FormFillerTest | PASS | 212ms |
...
| testSaveWritesFile | FormFillerTest | PASS | 199ms |
| testEscapeHatch | FormFillerTest | PASS | 1ms |
| testRoundTripPreservesOtherFields | FormFillerTest | PASS | 207ms |
...
| testSetTitleRoundTrip | MetadataEditorTest | PASS | 206ms |
| testSetMultipleFieldsRoundTrip | MetadataEditorTest | PASS | 206ms |
| testSetMetadataOnPdfWithoutInfo | MetadataEditorTest | PASS | 211ms |
...
| testCustomField | MetadataEditorTest | PASS | 203ms |
| testSaveToFile | MetadataEditorTest | PASS | 216ms |
| testSetLabelsWithArabic | PageLabelerTest | PASS | 230ms |
| testSetRomanNumerals | PageLabelerTest | PASS | 206ms |
| testSetRomanNumeralsUppercase | PageLabelerTest | PASS | 209ms |
| testSetAlphabetic | PageLabelerTest | PASS | 205ms |
| testSetArabicWithStartNumber | PageLabelerTest | PASS | 204ms |
| testSetLabelsWithPrefix | PageLabelerTest | PASS | 203ms |
...
| testKeepPages | PageSlicerTest | PASS | 206ms |
| testKeepRange | PageSlicerTest | PASS | 198ms |
| testRemovePages | PageSlicerTest | PASS | 215ms |
| testReorder | PageSlicerTest | PASS | 193ms |
| testReverse | PageSlicerTest | PASS | 204ms |
| testSplit | PageSlicerTest | PASS | 399ms |
| testKeepWithPageSelector | PageSlicerTest | PASS | 206ms |
...
| testRotateAllPages | PageTransformerTest | PASS | 210ms |
| testRotate180 | PageTransformerTest | PASS | 203ms |
| testRotate270 | PageTransformerTest | PASS | 214ms |
...
| testSetCropBox | PageTransformerTest | PASS | 210ms |
| testSetCropBoxSpecificPage | PageTransformerTest | PASS | 212ms |
| testSetMediaBox | PageTransformerTest | PASS | 201ms |
| testSetTrimBox | PageTransformerTest | PASS | 201ms |
| testSetBleedBox | PageTransformerTest | PASS | 212ms |
| testScale | PageTransformerTest | PASS | 197ms |
...
| testMultipleOperations | PageTransformerTest | PASS | 202ms |
| testNoBytesChangedWithoutOperations | PageTransformerTest | PASS | <1ms |
| testEvenPages | PageTransformerTest | PASS | 214ms |
| testOddPages | PageTransformerTest | PASS | 209ms |
| testRange | PageTransformerTest | PASS | 219ms |
| testGetReader | PageTransformerTest | PASS | 5ms |
| testGetPageCount | PageTransformerTest | PASS | <1ms |
| testSaveToFile | PageTransformerTest | PASS | 192ms |
| testEncryptAes128 | PdfEncryptTest | PASS | 209ms |
| testEncryptAes256 | PdfEncryptTest | PASS | 216ms |
| testDecrypt | PdfEncryptTest | PASS | 205ms |
...
| testMergeTwoPdfs | PdfMergerTest | PASS | 214ms |
...
| testStampText | PdfStamperTest | PASS | 215ms |
| testWatermark | PdfStamperTest | PASS | 217ms |
| testWatermarkWithStyle | PdfStamperTest | PASS | 216ms |
| testPageNumbers | PdfStamperTest | PASS | 212ms |
| testStampOnSpecificPages | PdfStamperTest | PASS | 208ms |
| testHeaderAndFooter | PdfStamperTest | PASS | 213ms |
| testStampWithOpacity | PdfStamperTest | PASS | 204ms |
...
| testStampImagePng | PdfStamperTest | PASS | 204ms |
| testStampImageWithScaleWidth | PdfStamperTest | PASS | 222ms |
| testStampImageWithScaleHeight | PdfStamperTest | PASS | 201ms |
| testStampImageWithExplicitDimensions | PdfStamperTest | PASS | 200ms |
| testStampImageWithOpacity | PdfStamperTest | PASS | 193ms |
| testStampImageOnSpecificPages | PdfStamperTest | PASS | 210ms |
| testStampImageCombinedWithText | PdfStamperTest | PASS | 207ms |
...
| testStampPdfWithScaling | PdfStamperTest | PASS | 204ms |
| testStampPdfWithOpacity | PdfStamperTest | PASS | 210ms |
| testStampPdfSpecificPage | PdfStamperTest | PASS | 221ms |
...
| testRedactMultipleAreas | TextRedactorTest | PASS | 192ms |
| testRedactByText | TextRedactorTest | PASS | 203ms |
| testRedactByPattern | TextRedactorTest | PASS | 1ms |
| testCustomRedactionColor | TextRedactorTest | PASS | 207ms |
...
**4 tests** | 3 passed | 0 failed | 1 skipped | 21.33s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWithOutputIntent | PdfAConformanceTest | SKIP | 5ms |
| testVeraPdfToolchainWorks | PdfAConformanceTest | PASS | 2.29s |
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 8.19s |
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 10.85s |
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 19.73s
...
| testQpdfCorpus with data set "qpdf/delete-and-reuse.pdf" | Tier2CorpusTest | PASS | 13ms |
...
| testQpdfCorpus with data set "qpdf/resource-from-dr.pdf" | Tier2CorpusTest | PASS | 29ms |
...
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 7.97s |
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 10.14s |
...
**6 tests** | 6 passed | 0 failed | 0 skipped | 12.62s

| Test | Class | Status | Time |
|---|---|---|---|
| testTaggedDocumentValidatesWithUa1 | Tier3MatterhornTest | PASS | 2.32s |
| testAnnotationWithContentsPassesClause718 | Tier3MatterhornTest | PASS | 2.1s |
| testUntaggedDocumentFailsUa1 | Tier3MatterhornTest | PASS | 2.02s |
| testMissingLangFailsUa1 | Tier3MatterhornTest | PASS | 2.02s |
| testMissingDisplayDocTitleFailsUa1 | Tier3MatterhornTest | PASS | 2.13s |
| testAnnotationWithoutContentsFailsUa1 | Tier3MatterhornTest | PASS | 2.04s |
...
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 558ms |
...
| testPdfIdToolchainWorks | Tier4PdfIdTest | PASS | 371ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 UTF-8 string and annotation.pdf" | Tier4Pdf20ExamplesTest | PASS | 198ms |
