...
Generated: 2026-05-24 23:52:31 UTC
PHP: 8.4.21
...
**Overall: PASS** | 1662 tests | 1656 passed | 0 failed | 6 skipped | 87.59s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 454 | 450 | 0 | 4 | 31.82s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.24s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 17.43s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 17.57s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 11.33s |
...
**454 tests** | 450 passed | 0 failed | 4 skipped | 31.82s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 319ms |
| testGeneratesAnnotationsPdf | AnnotationsTest | PASS | 178ms |
| testGeneratesBookmarksPdf | BookmarksTest | PASS | 234ms |
| testGeneratesFormWithCustomFontAppearances | CustomFontFormAppearancesTest | PASS | 319ms |
...
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 497ms |
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 339ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 317ms |
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 183ms |
...
| testGeneratesPdfWithXrefAndObjectStreams | XRefStreamIntegrationTest | PASS | 178ms |
| testEnableOutlineThenHeadingRegistersOutlinesEntry | AutoOutlineTest | PASS | 186ms |
...
| testAddTextWithLinkStyleProducesLinkAnnotation | InlineLinkTest | PASS | 175ms |
...
| testAddPageDelegatesToWriter | PdfDocTest | PASS | 177ms |
...
| testGeneratesHighLevelDocument | PdfIntegrationTest | PASS | 373ms |
...
| testAddSpacerConsumesVerticalSpace | PdfTest | PASS | 178ms |
...
| testSaveWritesFile | PdfTest | PASS | 180ms |
...
| testPdfWriterGeneratesValidPdfHeader | WriterTest | PASS | 181ms |
...
| testPdfWriterContainsPage | WriterTest | PASS | 170ms |
...
| testPdfWriterContainsXref | WriterTest | PASS | 176ms |
| testPdfWriterContainsTrailer | WriterTest | PASS | <1ms |
| testPdfWriterAddPageWithRectangle | WriterTest | PASS | 180ms |
...
| testMetadataRoundTrip | XmpMetadataTest | PASS | 181ms |
...
| testFillManyFields | FormFillerTest | PASS | 174ms |
| testCheckCheckbox | FormFillerTest | PASS | 183ms |
| testUncheckCheckbox | FormFillerTest | PASS | 191ms |
| testSelectChoiceField | FormFillerTest | PASS | 184ms |
...
| testSetMetadataOnPdfWithoutInfo | MetadataEditorTest | PASS | 182ms |
...
| testSetLabelsWithArabic | PageLabelerTest | PASS | 180ms |
...
| testSetCropBox | PageTransformerTest | PASS | 186ms |
...
| testStampOnSpecificPages | PdfStamperTest | PASS | 177ms |
...
| testStampImageJpeg | PdfStamperTest | PASS | 240ms |
| testStampImagePng | PdfStamperTest | PASS | 183ms |
...
| testRedactByText | TextRedactorTest | PASS | 179ms |
...
| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesBookmarksPdf | BookmarksTest | PASS | 289ms |
...
**4 tests** | 3 passed | 0 failed | 1 skipped | 17.43s
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 17.57s
...
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 9.07s |
...
**6 tests** | 6 passed | 0 failed | 0 skipped | 11.33s

| Test | Class | Status | Time |
|---|---|---|---|
| testTaggedDocumentValidatesWithUa1 | Tier3MatterhornTest | PASS | 2.14s |
...
| testMissingLangFailsUa1 | Tier3MatterhornTest | PASS | 1.76s |
...
| testPdfWithMetadataWellFormedAndValid | Tier4JhoveTest | PASS | 822ms |
| testPdfWithEmbeddedFontWellFormedAndValid | Tier4JhoveTest | PASS | 834ms |
| testJhoveToolchainWorks | Tier4JhoveTest | PASS | 648ms |
| testPdfA1bPassesPdfBoxPreflight | Tier4PdfBoxPreflightTest | SKIP | <1ms |
| testPdfBoxPreflightToolchainWorks | Tier4PdfBoxPreflightTest | PASS | 725ms |
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 744ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/PDF 2.0 with offset start.pdf" | Tier4Pdf20ExamplesTest | PASS | 175ms |
