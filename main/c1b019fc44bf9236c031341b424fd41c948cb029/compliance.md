...
Generated: 2026-05-13 16:13:33 UTC
PHP: 8.4.21
...
**Overall: PASS** | 1446 tests | 1440 passed | 0 failed | 6 skipped | 90.06s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 238 | 234 | 0 | 4 | 30.86s |
...
**238 tests** | 234 passed | 0 failed | 4 skipped | 30.86s
...
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 224ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 275ms |
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 225ms |
...
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 342ms |
...
| testSyncInfoToMetadataNoInfoIsNoOp | XmpMetadataTest | PASS | 237ms |
| testFlattenAll | AnnotationFlattenerTest | PASS | 223ms |
...
| testQpdfCorpus with data set "qpdf/c-linearized.pdf" | Tier2CorpusTest | PASS | 6ms |
...
| testQpdfCorpus with data set "qpdf/manual-appearances-out.pdf" | Tier2CorpusTest | PASS | 3ms |
...
| testPdfWithMetadataHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 566ms |
