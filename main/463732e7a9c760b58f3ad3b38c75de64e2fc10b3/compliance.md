...
Generated: 2026-06-10 12:19:53 UTC
PHP: 8.4.21
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 92.12s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 33.2s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.26s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 18.84s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 18.64s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 11.61s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 33.2s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 480ms |
...
| testGeneratesPdfWithEmbeddedType1 | EmbeddedType1FontTest | PASS | 222ms |
...
| testGeneratesFormWithAppearances | FormAppearancesIntegrationTest | PASS | 211ms |
...
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 565ms |
...
| testDataMatrixAdapterEmits2DGrid | BarcodeAdapterTest | PASS | 2ms |
...
| testEachTypeUsesItsOwnBarColor | CalloutTest | PASS | 15ms |
...
| testUnderlineEmitsStrokeBelowBaseline | TextDecorationTest | PASS | 182ms |
...
| testSetEncryptionAes256RoundTrip | WriterTest | PASS | 206ms |
...
| testSplit | PageSlicerTest | PASS | 383ms |
...
| testOddPages | PageTransformerTest | PASS | 204ms |
...
| testEncryptAes256 | PdfEncryptTest | PASS | 213ms |
...
| testMergeWithPageSelection | PdfMergerTest | PASS | 202ms |
...
| testWatermark | PdfStamperTest | PASS | 202ms |
...
| testSaveToFile | TextRedactorTest | PASS | 217ms |
...
**4 tests** | 3 passed | 0 failed | 1 skipped | 18.84s
...
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 9.41s |
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 18.64s
...
| testQpdfCorpus with data set "qpdf/many-nulls.pdf" | Tier2CorpusTest | PASS | 703ms |
...
| testPdfA1bCorpus | Tier2PdfACorpusTest | PASS | 7.18s |
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 9.83s |
...
| testPdfiumCorpus with data set "pdfium/zero_length_stream.pdf" | Tier2PdfiumCorpusTest | PASS | 9ms |
...
**6 tests** | 6 passed | 0 failed | 0 skipped | 11.61s
...
| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWellFormedAndValid | Tier4JhoveTest | PASS | 1s |
| testMultiPagePdfWellFormedAndValid | Tier4JhoveTest | PASS | 909ms |
| testPdfWithMetadataWellFormedAndValid | Tier4JhoveTest | PASS | 890ms |
| testPdfWithEmbeddedFontWellFormedAndValid | Tier4JhoveTest | PASS | 898ms |
| testJhoveToolchainWorks | Tier4JhoveTest | PASS | 696ms |
...
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 600ms |
