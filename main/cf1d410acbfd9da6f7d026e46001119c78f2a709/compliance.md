...
Generated: 2026-06-10 18:14:26 UTC
PHP: 8.4.21
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 93.51s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 33.01s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.28s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 19.09s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 19.2s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 12.25s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 33.01s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 321ms |
...
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 302ms |
...
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 379ms |
...
| testSaveToFile | PageLabelerTest | PASS | 201ms |
...
| testStampImageJpeg | PdfStamperTest | PASS | 239ms |
...
**4 tests** | 3 passed | 0 failed | 1 skipped | 19.09s
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 19.2s
...
| testQpdfCorpus with data set "qpdf/good16.pdf" | Tier2CorpusTest | PASS | 13ms |
...
| testQpdfCorpus with data set "qpdf/minimal-signed-restricted.pdf" | Tier2CorpusTest | PASS | 4ms |
| testQpdfCorpus with data set "qpdf/minimal-signed-restrictions-removed.pdf" | Tier2CorpusTest | PASS | 2ms |
...
**6 tests** | 6 passed | 0 failed | 0 skipped | 12.25s
...
| testPdfWithEmbeddedFontHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 546ms |
