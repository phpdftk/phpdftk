...
Generated: 2026-06-13 07:04:03 UTC
PHP: 8.4.22
...
**Overall: PASS** | 1665 tests | 1659 passed | 0 failed | 6 skipped | 88.02s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 457 | 453 | 0 | 4 | 31.77s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.23s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 18.35s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 17.51s |
| &#x2705; Matterhorn (PDF/UA) | PASS | 6 | 6 | 0 | 0 | 11.15s |
| &#x2705; JHOVE + PDF 2.0 + Security + Preflight | PASS | 25 | 24 | 0 | 1 | 8s |
...
**457 tests** | 453 passed | 0 failed | 4 skipped | 31.77s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 290ms |
| testGeneratesAnnotationsPdf | AnnotationsTest | PASS | 175ms |
...
| testGeneratesPdfWithEmbeddedType1 | EmbeddedType1FontTest | PASS | 177ms |
...
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 845ms |
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 182ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 107ms |
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 396ms |
...
| testGeneratesSignatureFieldPdf | SignatureFieldIntegrationTest | PASS | 181ms |
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 304ms |
...
| testGeneratesHighLevelDocument | PdfIntegrationTest | PASS | 368ms |
...
| testSetNamedDestinations | WriterTest | PASS | 178ms |
...
| testMetadataRoundTrip | XmpMetadataTest | PASS | 175ms |
...
| testAddBookmark | BookmarkEditorTest | PASS | 369ms |
...
| testFillTextField | FormFillerTest | PASS | 173ms |
...
| testKeepPages | PageSlicerTest | PASS | 183ms |
...
| testSplit | PageSlicerTest | PASS | 362ms |
...
| testWatermark | PdfStamperTest | PASS | 182ms |
...
| testSaveToFile | PdfStamperTest | PASS | 181ms |
...
| testStampImageWithExplicitDimensions | PdfStamperTest | PASS | 183ms |
...
| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesBookmarksPdf | BookmarksTest | PASS | 290ms |
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 17.51s
...
| testQpdfCorpus with data set "qpdf/sample-form-out.pdf" | Tier2CorpusTest | PASS | 27ms |
...
**6 tests** | 6 passed | 0 failed | 0 skipped | 11.15s
...
**25 tests** | 24 passed | 0 failed | 1 skipped | 8s

| Test | Class | Status | Time |
|---|---|---|---|
| testMinimalPdfWellFormedAndValid | Tier4JhoveTest | PASS | 882ms |
| testMultiPagePdfWellFormedAndValid | Tier4JhoveTest | PASS | 855ms |
| testPdfWithMetadataWellFormedAndValid | Tier4JhoveTest | PASS | 828ms |
| testPdfWithEmbeddedFontWellFormedAndValid | Tier4JhoveTest | PASS | 826ms |
| testJhoveToolchainWorks | Tier4JhoveTest | PASS | 662ms |
| testPdfA1bPassesPdfBoxPreflight | Tier4PdfBoxPreflightTest | SKIP | <1ms |
| testPdfBoxPreflightToolchainWorks | Tier4PdfBoxPreflightTest | PASS | 788ms |
...
| testPdfWithEmbeddedFontHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 505ms |
