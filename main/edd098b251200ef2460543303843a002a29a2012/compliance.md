...
Generated: 2026-05-25 18:32:59 UTC
PHP: 8.4.21
...
**Overall: PASS** | 1662 tests | 1656 passed | 0 failed | 6 skipped | 91.6s

| Suite | Status | Tests | Passed | Failed | Skipped | Time |
|---|---|---|---|---|---|---|
| &#x2705; QPDF | PASS | 454 | 450 | 0 | 4 | 32.24s |
| &#x2705; Arlington PDF Model | PASS | 6 | 6 | 0 | 0 | 1.25s |
| &#x2705; veraPDF | PASS | 4 | 3 | 0 | 1 | 19.14s |
| &#x2705; Test Corpora | PASS | 1167 | 1167 | 0 | 0 | 18.54s |
...
**454 tests** | 450 passed | 0 failed | 4 skipped | 32.24s

| Test | Class | Status | Time |
|---|---|---|---|
| testGeneratesAnnotationSubtypesPdf | AnnotationSubtypesTest | PASS | 347ms |
| testGeneratesAnnotationsPdf | AnnotationsTest | PASS | 182ms |
| testGeneratesBookmarksPdf | BookmarksTest | PASS | 251ms |
| testGeneratesFormWithCustomFontAppearances | CustomFontFormAppearancesTest | PASS | 208ms |
...
| testGeneratesSignedPdfWithDss | LtvSignedPdfIntegrationTest | PASS | 403ms |
| testDssContainsCertificateStreams | LtvSignedPdfIntegrationTest | PASS | 318ms |
| testVriDictionaryMatchesSignatureHash | LtvSignedPdfIntegrationTest | PASS | 293ms |
| testOriginalSignatureRemainsVerifiable | LtvSignedPdfIntegrationTest | PASS | 114ms |
...
| testGeneratesPageLabelsPdf | PageLabelsTest | PASS | 183ms |
| testGeneratesSignatureFieldPdf | SignatureFieldIntegrationTest | PASS | 189ms |
| testGeneratesAndVerifiesSignedPdf | SignedPdfIntegrationTest | PASS | 359ms |
...
| testEnableOutlineThenHeadingRegistersOutlinesEntry | AutoOutlineTest | PASS | 184ms |
...
| testAddLinkAcceptsCorePageDirectly | PdfDocTest | PASS | 6ms |
...
| testGeneratesHighLevelDocument | PdfIntegrationTest | PASS | 409ms |
...
| testAddHeadingEmitsLargerText | PdfTest | PASS | 194ms |
...
| testAddCompositeFontGeneratesValidPdf | UnicodeFontTest | PASS | 198ms |
...
| testPdfWriterContainsXref | WriterTest | PASS | 194ms |
...
| testSetEncryptionProducesEncryptedPdf | WriterTest | PASS | 196ms |
| testSetEncryptionAes256RoundTrip | WriterTest | PASS | 225ms |
| testSetMetadataAddsStreamToPdf | XmpMetadataTest | PASS | 189ms |
| testMetadataStreamContainsXmp | XmpMetadataTest | PASS | 202ms |
...
| testSetAlphabetic | PageLabelerTest | PASS | 182ms |
...
| testSplit | PageSlicerTest | PASS | 368ms |
...
| testStampImageWithExplicitDimensions | PdfStamperTest | PASS | 184ms |
...
**1167 tests** | 1167 passed | 0 failed | 0 skipped | 18.54s
...
| testQpdfCorpus with data set "qpdf/digitally-signed.pdf" | Tier2CorpusTest | PASS | 7ms |
...
| testQpdfCorpus with data set "qpdf/many-nulls.pdf" | Tier2CorpusTest | PASS | 687ms |
...
| testQpdfCorpus with data set "qpdf/need-appearances2.pdf" | Tier2CorpusTest | PASS | 32ms |
...
| testQpdfCorpus with data set "qpdf/nontrivial-crypt-filter.pdf" | Tier2CorpusTest | PASS | 4ms |
...
| testPdfA2bCorpus | Tier2PdfACorpusTest | PASS | 9.72s |
...
| testPdfBoxCorpus with data set "pdfbox/pdfbox/src/test/resources/input/PDFBOX-3062-N2MOQ7YZICIYGTPLQJAWJ4HLN6CCEMHZ-reduced.pdf" | Tier2PdfBoxCorpusTest | PASS | 4ms |
...
| testPdfiumCorpus with data set "pdfium/bug_547706.pdf" | Tier2PdfiumCorpusTest | PASS | 2ms |
...
| testMissingLangFailsUa1 | Tier3MatterhornTest | PASS | 1.94s |
...
| testMultiPagePdfWellFormedAndValid | Tier4JhoveTest | PASS | 874ms |
...
| testJhoveToolchainWorks | Tier4JhoveTest | PASS | 655ms |
...
| testMinimalPdfHasNoSuspiciousIndicators | Tier4PdfIdTest | PASS | 907ms |
...
| testPdf20ExampleQpdfValid with data set "pdf20/Simple PDF 2.0 file.pdf" | Tier4Pdf20ExamplesTest | PASS | 178ms |
