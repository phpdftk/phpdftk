...
/**
 * Tier 2 — PDFBox test corpus compliance tests.
 *
 * Parses every PDF from the Apache PDFBox test corpus with PdfReader in lenient
 * mode and asserts no crashes. Encrypted PDFs that require a password are expected
 * to throw -- those are caught and counted as passes.
 *
 * Run with: vendor/bin/phpunit --group tier2-pdfbox
 */
#[Group('tier2')]
#[Group('tier2-pdfbox')]
class Tier2PdfBoxCorpusTest extends TestCase
{
    private const CORPUS_DIR = __DIR__ . '/../../../../../vendor-data/pdfbox';

    /** @return iterable<string, array{string}> */
    public static function pdfboxProvider(): iterable
    {
