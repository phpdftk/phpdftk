...
namespace Phpdftk\Tests\Annotation;

use PHPUnit\Framework\TestCase;
use Phpdftk\Annotation\FreeTextAnnotation;
use Phpdftk\Annotation\HighlightAnnotation;
use Phpdftk\Annotation\InkAnnotation;
use Phpdftk\Annotation\LinkAnnotation;
use Phpdftk\Annotation\PopupAnnotation;
use Phpdftk\Annotation\StampAnnotation;
use Phpdftk\Annotation\TextAnnotation;
use Phpdftk\Annotation\WidgetAnnotation;
