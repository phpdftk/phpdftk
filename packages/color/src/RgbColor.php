...
final class RgbColor implements ColorInterface {
    public function __construct(
        ...
        if ($r < 0.0 || $r > 1.0) throw new \InvalidArgumentException("Red value must be 0.0–1.0, got $r");
        if ($g < 0.0 || $g > 1.0) throw new \InvalidArgumentException("Green value must be 0.0–1.0, got $g");
        if ($b < 0.0 || $b > 1.0) throw new \InvalidArgumentException("Blue value must be 0.0–1.0, got $b");
    }
