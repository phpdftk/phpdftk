...
<Example
	source="toolkit/pdf-encrypt.php"
	inputPdf="samples/toolkit/pdf-encrypt/input.pdf"
	outputPdf="samples/toolkit/pdf-encrypt/output.pdf"
/>

The output PDF requires the user password `reader` (or owner password `admin`) to open.
