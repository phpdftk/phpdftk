...
<Example
	source="toolkit/annotation-flattener.php"
	inputPdf="samples/toolkit/annotation-flattener/input.pdf"
	outputPdf="samples/toolkit/annotation-flattener/output.pdf"
/>
