...
The merger combines two inputs ([cover letter](/samples/toolkit/pdf-merger/input-cover.pdf) and [resume](/samples/toolkit/pdf-merger/input-resume.pdf)) into a single document.
